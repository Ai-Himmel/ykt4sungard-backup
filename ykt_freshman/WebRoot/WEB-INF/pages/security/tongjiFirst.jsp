...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong> 
        <font class="medium">首页访问统计</font></strong></td>
    </tr>
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
            <tr align="center" valign=center> 
              <td height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >起始日期</td>
            ...
            name="beginDate" class="input_box"  maxlength=50 value="<%=dateStr%>" readonly="readonly"> 
              ...
              <td height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >终止日期</td>
              <td width="35%" align="left" valign="middle" class="tableHeader3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td width="130"> <input 
    ...
    <tr> 
      ...
      <strong><font color="#990000">起始日期：</font></strong><strong><bean:write name="beginDate"/>&nbsp;&nbsp;&nbsp;
      <font color="#990000">终止日期：</font></strong><strong><bean:write name="endDate"/>    
      </strong>       
      </td>           
    </tr>    
    </logic:present>  
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <logic:present name="tjlist">
            ...
            <tr align="center" valign=center> 
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><a href="javascript:DoFirstAccessView('<bean:write name="tj" property="accessDate"/>')"><bean:write name="tj" property="accessNum"/></a></td>                         
            </tr>
            </c:when></c:choose>
            <c:choose><c:when test="${i%2 == 0}">
            <tr align="center" valign=center> 
              <td height="24" align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="tj" property="accessDate" formatKey="dateFormat"/></td>
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><a href="javascript:DoFirstAccessView('<bean:write name="tj" property="accessDate"/>')"><bean:write name="tj" property="accessNum"/></a></td>                            
            </tr>
            </c:when></c:choose>
           </logic:iterate> 
...
function DoCheck(){
   ...
   // alert("ok");  
   document.forms[0].action="userAccessAction.do?method=tongjiFirst";
   document.forms[0].submit();

}

function DoFirstAccessView(str){

  document.all.viewDate.value=str;
  document.forms[0].action="userAccessAction.do?method=firstAccessview";
  document.forms[0].submit();
