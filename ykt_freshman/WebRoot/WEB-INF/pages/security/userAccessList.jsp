...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">首页访问明细表</font></strong></td>
    </tr>     
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody>
            <tr align="center" valign=center> 
              <td width="30%" height="24" valign="middle" class="tableHeader" >访问日期</td>
              <td width="30%" valign="middle" class="tableHeader" >访问时间</td>
