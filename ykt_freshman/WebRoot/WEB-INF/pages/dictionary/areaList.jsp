...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">校区字典维护</font></strong></td>
  </tr>
  <tr> 
    <td align="center" valign="top" >&nbsp;</td>
  </tr>
  <logic:notPresent name="dictlist" scope="request">
  <font size="2.5" color="#990000">当前没有可维护的校区。</font>
  </logic:notPresent>  
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody>
           ...
           <tr align="center" valign="middle"> 
              <td align="center" valign="middle" class="tableHeader" >校区代码</td>
  ...
  <tr> 
    <td height="40" align="left" valign="middle">
       <input name="dictionaryId.dictNo" type="hidden" value="17"><input name="dictionary.dictName" type="hidden" value="校区">
        校区代码：<input name="dictionaryId.dictValue" value="" maxlength="10">&nbsp;&nbsp;校区名称：<input name="dictionary.dictCaption" value="" maxlength="10">&nbsp;&nbsp;
