...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">楼号字典维护</font></strong></td>
  </tr>
  <tr> 
    <td align="center" valign="top" >&nbsp;</td>
  </tr>
  <logic:notPresent name="dictlist" scope="request">
  <font size="2.5" color="#990000">当前没有可维护的楼号。</font>
  </logic:notPresent>  
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
            <tr align="center" valign="middle">               
			  ...
			  <td width="15%" align="left" valign="middle" class="tableHeader2" >区域名称</td>
              <td align="left" valign="middle" class="tableHeader3" >
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody>
           ...
           <tr align="center" valign="middle">
              ...
              <td align="center" valign="middle" class="tableHeader" >楼号代码</td>
              <td align="center" valign="middle" class="tableHeader" >楼号名称</td>
  ...
  <tr> 
    <td height="40" align="left" valign="middle">
       <input name="dictionaryId.dictNo" type="hidden" value="21"><input name="dictionary.dictName" type="hidden" value="新楼号">
        校区名称：
  ...
  <tr> 
    <td height="40" align="left" valign="middle">
        楼号代码：<input name="dictionaryId.dictValue" value="" maxlength="10">&nbsp;&nbsp;楼号名称：<input name="dictionary.dictCaption" value="" maxlength="10">&nbsp;&nbsp;排序编号：<input name="dictionary.dictSort" value="" maxlength="5">&nbsp;&nbsp;
...
<script>
   ...
   if(request.getAttribute("allist")!=null)
       resultset=(String[][])request.getAttribute("allist");//读取数据
   
   if(resultset!=null){
     for(count=0;count<resultset.length;count++)
     {
     %>
      dataset[<%=count%>] = new Array("<%=resultset[count][0]%>","<%=resultset[count][1]%>","<%=resultset[count][2]%>");//产生javascript二维数组
     <%
     }
   }
   %>
...
function setLocation(sel){
    ...
    document.all.search_location.length=1; //清空原区域列表        
    if(id!='')
...
function setLoc(sel){
    ...
    id=sel.options[sel.selectedIndex].value;
    document.dictionaryForm.elements["dictionary.dictParent"].length=1; //清空原区域列表        
    if(id!='')
        for (i=0;i < datacount; i++)
        {
            if (dataset[i][2] == id)
