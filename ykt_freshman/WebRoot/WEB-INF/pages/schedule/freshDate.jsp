...
function on_validate(){
	if(document.all("freshDate").value!=''){
...
<%}%>
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<form method="post" action="scheduleAction.do?method=addDate">
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium">日程时间设置</font></strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100">请选择迎新日期：</td>
							<td width="130">
								<input name="freshDate" class="input_box" maxlength="50" onclick="javascript:on_FD();" readonly="true" />
							</td>
							<td>
								<img name="sd" class="img_nor" width="21" height="21" border="0" onclick="setday(this,document.all('freshDate'))">
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td height="40" align="right" valign="middle">
					<input name="Submit2" type="button" class="button_nor" value="添加" onclick="javasctipt:on_validate();" />
				</td>
			</tr>
			</form>
			<tr>
			...
			<tr>
				<td height="40" align="center" valign="top">
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=submenu1>
						<tbody>
							<logic:present name="freshDate" scope="request">
								<logic:iterate name="freshDate" id="freshDate" indexId="i">
									<tr align="center" valign=center>
										<c:if test="${i%2 == 0}">
											<td height="24" align="center" valign="middle" bgcolor="#FFFFFF">
												<bean:write name="freshDate" property="dictCaption" />
											</td>
											<td align="center" valign="middle" bgcolor="#FFFFFF">
												<html:link action="scheduleAction.do?method=deleteDate" paramId="dateId" paramName="freshDate" paramProperty="id.dictValue">删除</html:link>
											</td>
										</c:if>
										<c:if test="${i%2 != 0}">
