	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium"><a name="top">复旦学院迎新整体日程安排</a></font></strong>
			</td>
		</tr>
		<c:if test="${!view}">
		<tr>
			<td align="right" valign="middle" class="tdborder02">
				<html:button property="search" styleClass="button_nor" onclick="javascript: window.location='scheduleAction.do?method=addCollegeSchedule'">
							...
							<logic:iterate name="scheduledateList" id="scheduledate">
								<tr align="center" valign="middle">
									...
									<td colspan="<%=collegeCount%>" valign="middle" class="tableHeader">
										...
										<a name="<bean:write name="scheduledate" property="dictCaption" />"><bean:write name="scheduledate" property="dictCaption" /></a>
						...
						%>
									...
									<logic:present name="collegeList" scope="request">
										<logic:iterate name="collegeList" id="college" indexId="i">
											<c:if test="${i%2 == 0}">
												<td id='<%=hours+minites%>.<bean:write name="scheduledate" property="id.dictValue"/>.<bean:write name="college" property="collegeId"/>' class="<%=tdCss%>" valign="middle" bgcolor="#FFFFFF">
													&nbsp;
												</td>
											</c:if>
											<c:if test="${i%2 != 0}">
												<td id='<%=hours+minites%>.<bean:write name="scheduledate" property="id.dictValue"/>.<bean:write name="college" property="collegeId"/>' class="<%=tdCss%>" " valign="middle" bgcolor="#F6F4F5">
													&nbsp;
												</td>
											</c:if>
										</logic:iterate>
