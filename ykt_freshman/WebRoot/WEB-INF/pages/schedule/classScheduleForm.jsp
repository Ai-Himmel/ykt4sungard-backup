...
function on_validate(){
	...
	if(document.all("classSchedulemanage.fromdate").value == ''){
		alert('请选择日期');			
		return false;
	}else if(document.all("classSchedulemanage.fromtime").value == ''){
		alert('请选择起始时间');			
		return false;
		...
		alert('请选择班级');	
		return false;
	}else if(document.all("classSchedulemanage.remark").value != '' && document.all("classSchedulemanage.remark").value.length > 200){
...
window.open('shuyuanrichenganpai1.htm','_self');
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<%String collegeId = request.getParameter("collegeId").toString();%>
		<html:form method="post" action="scheduleAction.do?method=classSave" onsubmit="javascript:return on_validate();">
			<input type="hidden" name="collegeId" value="<%=collegeId%>">	
			<logic:present name="classScheduleId">
				<%String classscheduleId = request.getAttribute("classScheduleId")
					.toString();%>
				<html:hidden property="classSchedulemanage.scheduleId" value="<%=classscheduleId%>" />
			</logic:present>
			<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tbody>
								<tr align="center" valign=middle>
									...
									<td width="35%" align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01" property="classSchedulemanage.fromdate">
											...
											<tr>
												...
												<td width="130">
													<OBJECT id="stime" class="TxtInput" border="1" style="HEIGHT: 16; WIDTH: 120;" tabIndex="4" type="text/x-scriptlet" VIEWASTEXT>
														<PARAM NAME="URL" VALUE="timesetup.do?timeStr=<logic:present name="scheduleForm" property="classSchedulemanage.fromtime"><bean:write name="scheduleForm" property="classSchedulemanage.fromtime"/></logic:present><logic:notPresent name="scheduleForm" property="classSchedulemanage.fromtime">0600</logic:notPresent>">
													</OBJECT>
												</td>
											</tr>
										</table>
											...
											<tr>
												...
												<td width="130">
													<OBJECT id="etime" class="TxtInput" border="1" style="HEIGHT: 16; WIDTH: 120;" tabIndex="4" type="text/x-scriptlet" VIEWASTEXT>
														<PARAM NAME="URL" VALUE="timesetup.do?timeStr=<logic:present name="scheduleForm" property="classSchedulemanage.titime"><bean:write name="scheduleForm" property="classSchedulemanage.titime"/></logic:present><logic:notPresent name="scheduleForm" property="classSchedulemanage.titime">0605</logic:notPresent>">
													</OBJECT>
												</td>
											</tr>
										</table>
								...
								<tr align="center" valign=middle>
									...
									<td colspan="3" align="left" valign="middle" class="tableHeader3">
										<html:textarea property="classSchedulemanage.remark" cols="70" rows="2" />
									</td>
								</tr>
							</tbody>
						</table>
				...
				<tr>
					...
					<td height="40" align="right" valign="middle">
						<logic:notPresent name="classScheduleId">
