...
<html:form action = "gznoticeAction.do?method=find&notice.title=">
<html:errors/>
<br>
         ...
         <logic:present name="noticelist" scope="request">
          ...
          <tr align="center" valign=center>             
            ...
            <td width=40% align="left" valign="middle" class="tableHeader3" colspan="3">
                 <input 
                name="notice.title" style="height:18px; width:400px; border:#000000 solid 1px; margin:0px; padding:0px; FONT-SIZE:12px" maxlength=50 value="<bean:write name="nl" property="title"/>">
                &nbsp;&nbsp;
                <c:choose><c:when test="${nl.ifDeleted == '0'}">
                  ...
                  <input type="radio" name="notice.ifDeleted" value="2" checked> 
                  </c:when><c:otherwise>
                  <input type="radio" name="notice.ifDeleted" value="2">
                  </c:otherwise></c:choose>管理员可见            
            </td>
          </tr>  
          <tr align="center" valign=center>             
...
function DoCheck(){
  ...
  document.noticeForm.action="gznoticeAction.do?method=update";
