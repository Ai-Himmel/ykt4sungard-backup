...
function loadEditor(){
  editor.HtmlEdit.document.body.innerHTML =document.forms[0].elements["body"].value;
  editor.HtmlEdit.document.oncontextmenu=new Function('event.returnValue=false;');
  editor.HtmlEdit.document.onselectstart=new Function('event.returnValue=false;');
}
