...
<html:form action = "rcvmanageAction.do?method=stuadd">
<html:errors/>
<br>
    ...
    <table 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
        ...
        <tr align="center" valign=center>
           <td align="center" valign="middle" colspan="4"> <font size="2.5" color="#990000">非新生或新生数据尚未入库，无法登记抵沪信息！</font></td>
        </tr>          
        </logic:notPresent>       
          <logic:present name="stuinfo" scope="request">  
          <logic:iterate name="stuinfo" id="al" type="java.util.Map" length="1">
          ...
          <tr height="30" align="center" valign=center> 
            ...
            <td width="35%" align="left" valign="middle" class="tableHeader3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="130"><input class="Wdate" type="text" name="arriveDate" onfocus="new WdatePicker(this)" readonly="readonly"/>
                  </td>                  
                </tr>
              </table></td>              
          ...
          <tr height="30" align="center" valign=center>                        
            ...
            <td align="left" valign="middle" bgcolor="#FFFFFF" class="tableHeader3" colspan="3"><input 
            name="stuarriveinfo.tempconcact" class="input_box"  maxlength=25>&nbsp;(请填写在您抵沪或到校当天可以联系到您的电话或手机)</td>            
          </tr>
          <tr align="center" valign=center> 
...
function init(){
 ...
 function ChangeFocus1(){
    document.all.select_arriveDate.focus();
}
...
function DoCheck(){
  ...
  document.stuarriveinfoForm.action="rcvmanageAction.do?method=stuadd";
