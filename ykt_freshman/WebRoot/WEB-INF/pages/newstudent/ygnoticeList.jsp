  ...
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <thead>
            ...
            <!--page offset start -->
		  <pg:pager url="./noticelistpageroll.do" items="0" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
           <pg:param name="notice.noticeNo" />
		   <pg:param name="notice.title" />
