						...
						<tbody>
							<tr align="center" valign=center>								
								...
								<td width=40% align="left" valign="middle" class="tableHeader3" colspan="3">
									<input name="notice.title" style="height:18px; width:480px; border:#000000 solid 1px; margin:0px; padding:0px; FONT-SIZE:12px" maxlength=50 value="">
								    &nbsp;&nbsp;<input name="notice.ifDeleted" type="radio" value="0" checked>公开&nbsp;<input name="notice.ifDeleted" type="radio" value="1">登录可见
								</td>
							</tr>
							<tr align="center" valign=center>							
...
function DoCheck(){
  ...
  document.noticeForm.action="ygnoticeAction.do?method=add";
