...
<html:form action = "gznoticeAction.do?method=stufind">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <!--page offset start -->
		  <pg:pager url="./noticelistviewpageroll.do" items="0" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
           <pg:param name="notice.noticeNo" />
		   <pg:param name="notice.title" />
...
function DoFind(){
   ...
   document.noticeForm.action="gznoticeAction.do?method=stufind";
...
function DoView(str){
   ...
   document.noticeForm.action="gznoticeAction.do?method=stuview";
   document.noticeForm.submit();
}
