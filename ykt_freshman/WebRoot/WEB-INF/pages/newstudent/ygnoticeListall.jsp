...
<html:form action = "ygnoticeAction.do?method=find">
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <thead>
            <tr align="center" valign=center>
              ...
              <td width="45%" valign="middle" class="tableHeader" >公告标题</td>              
              <td width="10%" valign="middle" class="tableHeader" >创建人</td>
              <td width="15%" valign="middle" class="tableHeader" >创建时间</td>
		  ...
		  <pg:pager url="./ygnoticeAction.do" items="<%=listcount%>" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
          ...
          <thead>
            ...
            <!--page offset start -->
		  <pg:pager url="./noticelistallpageroll.do" items="0" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
           <pg:param name="notice.noticeNo" />
		   <pg:param name="notice.title" />
...
function DoFind(){
   ...
   document.noticeForm.action="ygnoticeAction.do?method=find";
...
function DoAdd(){
   ...
   document.noticeForm.action="ygnoticeAction.do?method=load4add";   
   document.noticeForm.submit();
}
...
function DoView(str){
   ...
   //alert(document.all.updateid.value);
   document.noticeForm.action="ygnoticeAction.do?method=view";
   document.noticeForm.submit();
}
...
function DoDelete(){
   ...
   if(confirm("您确定要删除此入学事项公告吗？")){   
       document.noticeForm.action="ygnoticeAction.do?method=delete";       
       document.noticeForm.submit();
   }
   else
       return;
...
function DoUpdate(){
   ...
   document.noticeForm.action="ygnoticeAction.do?method=load4update";
   document.noticeForm.submit();
