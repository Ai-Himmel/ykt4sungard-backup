...
<html:form action = "ygnoticeAction.do?method=stufind">
...
function DoFind(){
   ...
   document.noticeForm.action="ygnoticeAction.do?method=stufind";
...
function DoView(str){
   ...
   document.noticeForm.action="ygnoticeAction.do?method=stuview";
   document.noticeForm.submit();
}
