...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
		  ...
		  <pg:pager url="./gznoticeAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
...
function DoFind(){
   ...
   document.noticeForm.action="gznoticeAction.do?method=find";
...
function DoAdd(){
   ...
   document.noticeForm.action="gznoticeAction.do?method=load4add";   
   document.noticeForm.submit();
}
...
function DoView(str){
   ...
   //alert(document.all.updateid.value);
   document.noticeForm.action="gznoticeAction.do?method=view";
   document.noticeForm.submit();
}
...
function DoDelete(){
   ...
   if(confirm("您确定要删除此入学事项公告吗？")){   
       document.noticeForm.action="gznoticeAction.do?method=delete";       
       document.noticeForm.submit();
   }
   else
       return;
...
function DoUpdate(){
   ...
   document.noticeForm.action="gznoticeAction.do?method=load4update";
   document.noticeForm.submit();
