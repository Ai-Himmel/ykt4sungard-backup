		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="30" align="left" valign="middle" class="medium">
					<strong><font color="#990000"><a name="2"><bean:message bundle="classmanage" key="classStatistic.fromprovincStatistic" />:</a></font></strong>
				</td>
			</tr>
			<tr>
					...
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable>
						<tbody>
							...
							<tr align="center" valign="middle">
								...
								<logic:present name="provinceList" scope="request">
									<logic:iterate name="provinceList" id="province">
										<td valign="middle" class="tableHeader" id="<bean:write name="province" property="dictValue" />">
											<strong><bean:write name="province" property="dictCaption" /></strong>
										</td>
									</logic:iterate>
								</logic:present>
							</tr>
								...
								<logic:iterate name="collegeclassList" id="colcls" indexId="i">
									<c:if test="${colcls.collegeName!='allCount'}">
										<tr align="center" valign="middle">
											...
											<c:if test="${colcls.classNo=='smallCount'}">
												...
												<logic:present name="provinceList" scope="request">
													<logic:iterate name="provinceList" id="nationality">
											...
											<c:if test="${colcls.classNo!='smallCount'}">
												<c:if test="${i%2 == 0}">
													...
													<logic:present name="provinceList" scope="request">
														<logic:iterate name="provinceList" id="province">
															<td align="center" valign="middle" bgcolor="#FFFFFF" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="province" property="dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>
												...
												<c:if test="${i%2 != 0}">
													...
													<logic:present name="provinceList" scope="request">
														<logic:iterate name="provinceList" id="province">
															<td align="center" valign="middle" bgcolor="#F6F4F5" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="province" property="dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>			
									...
									<c:if test="${colcls.collegeName=='allCount'}">
										<tr align="center" valign="middle" bgcolor="#FF9999">
											...
											<logic:present name="provinceList" scope="request">
												<logic:iterate name="provinceList" id="province">
													<td align="center" valign="middle" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="province" property="dictValue" />">
														&nbsp;
													</td>
												</logic:iterate>
											</logic:present>				
...
<Script language="Javascript">
	<%
		List majorStatistic = (List)request.getAttribute("nativeplaceStatistic");
		String collegeId = "";
		String classNo="";
		String majorin="";
		String stuCount="";
