...
<center>
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<html:form action="classAction.do?method=save">
				<tr>
					...
					<td align="center" valign="top">
						<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
							<tbody>
								...
								<tr align="center" valign="middle">
									<td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage" key="class.tutor1" /></span>
									</td>
									<td align="left" valign="middle" class="tableHeader3" colspan="3">
								...
								<tr align="center" valign="middle">
									<td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage" key="class.tutor2" /></span>
									</td>
									<td align="left" valign="middle" class="tableHeader3" colspan="3">
										<html:select styleClass="select01" property="tutor2">
											<html:option value="" >-----------------------</html:option>
											<html:options collection="tutorList" labelProperty="managerName" property="managerId" />
										</html:select>
									</td>
...
//		if(document.all("tutor2").value==""){
//			alert("导师不可为空");
//			document.all("tutor2").focus();
//			return false;
//		}
	...
	function fucCheckNUMABC(NUM)
	{
	 ...
	 return true;
		...
		if(document.all.myerror.value != ""){
			window.location.href='classAction.do?method=load4Search';
		}else{
			window.location.href='classAction.do?method=load4Search';
		}
	}
