...
function clearAll(){
	document.all("beginDate").value="<%=dateStr%>";
	document.all("endDate").value="<%=dateStr%>";
	document.all("userName").value="";
	document.all("trueName").value="";
}
</script>
<center>
<html:form action = "stuadddelAction.do?method=hisfind">
<html:errors/>
<br>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong> 
        <font class="medium">新生名单维护历史查询</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
            ...
            <tr align="center" valign=center> 
              <td width="10%" height="30" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >学号</td>
              <td align="left" valign="middle" class="tableHeader3" ><input 
            name="userName" class="input_box"  maxlength=50 value="" onkeydown="if(event.keyCode==13) document.onkeydown();"></td>
              <td width="10%" align="right" valign="middle" class="tableHeader2" >姓名</td>
              <td align="left" valign="middle" class="tableHeader3" ><input 
            name="trueName" class="input_box"  maxlength=50 value="" onkeydown="if(event.keyCode==13) document.onkeydown();"></td>
            </tr>
    ...
    <tr> 
      ...
      <input name="Submit" type="button" class="button_nor" value="查 询" onClick="DoCheck()"> 
      <input name="Submit" type="button" class="button_nor" value="重 置" onClick="clearAll()"> 
      </td>      
    </tr>    
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <logic:present name="tjlist">
            <tr align="center" valign=center> 
              <td width="20%" height="24" valign="middle" class="tableHeader" >学号</td>              
              <td valign="middle" class="tableHeader" >姓名</td>
              <td valign="middle" class="tableHeader" >操作</td>
              <td valign="middle" class="tableHeader" >操作人</td> 
              <td valign="middle" class="tableHeader" >操作时间</td>                 
            </tr>
            
            <logic:iterate name="tjlist" id="tj" type="java.util.Map" indexId="i">
            <c:choose><c:when test="${i%2 != 0}">
            <tr align="center" valign=center> 
              <td height="24" align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="tj" property="studentNo"/></td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="tj" property="stuName"/>&nbsp;</td> 
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
              <c:choose><c:when test="${tj.addOrDel == '1'}">添加
              </c:when></c:choose>
              <c:choose><c:when test="${tj.addOrDel == '2'}">删除
              </c:when></c:choose>
              </td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="tj" property="operatorId"/></td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="tj" property="operateTime" formatKey="dateTimeFormat"/></td>
            </tr>
            </c:when></c:choose>
            <c:choose><c:when test="${i%2 == 0}">
            <tr align="center" valign=center bgcolor="#F6F4F5" > 
              <td height="24" align="center" valign="middle"><bean:write name="tj" property="studentNo"/></td>
              <td align="center" valign="middle"><bean:write name="tj" property="stuName"/>&nbsp;</td> 
              ...
              <td align="center" valign="middle"><bean:write name="tj" property="operatorId"/></td>
              <td align="center" valign="middle"><bean:write name="tj" property="operateTime" formatKey="dateTimeFormat"/></td>
            </tr>
            </c:when></c:choose>
           </logic:iterate>                     
           </logic:present>  
...
function DoCheck(){
   ...
   // alert("ok");  
   document.forms[0].action="stuadddelAction.do?method=hisfind";
