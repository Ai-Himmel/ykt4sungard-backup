		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium">本班宿舍对应查询</font></strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" valign="top">
					<html:form action="classAction.do?method=load4fdyClassSearch&getrole=2">
									...
									<logic:iterate name="classsearchmodels" id="classsearch" indexId="i">
										<pg:item>
											<tr align="center" valign="middle">
												...
												<input type="hidden" name="hly" value="<bean:write name="classsearch" property="classNo" /><bean:write name="classsearch" property="assistantName" />">
