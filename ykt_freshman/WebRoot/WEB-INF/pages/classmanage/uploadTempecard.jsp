...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<html:form action="tempecarduploadAction.do?method=importTempecardFile" enctype="multipart/form-data" onsubmit="javascript:return on_validate();">
		<tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium">临时一卡通卡号导入</font></strong>
			</td>
		</tr>
		<tr>
					...
					<tbody>
						<tr align="center" valign="middle">
							<td width="25%" height="32" align="left" valign="middle" bgcolor="#ECE6E6">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="./importtempecard.xls">数据模板<IMG src="./pages/style/default/images/xls.gif" border="0"></a>
							</td>
						</tr>
						<tr>
