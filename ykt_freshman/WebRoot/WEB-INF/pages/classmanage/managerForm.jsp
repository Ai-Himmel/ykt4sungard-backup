...
<center>
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<html:form action="managerAction.do?method=save">
				<tr>
...
<script language="javascript">
	...
	function add_check(){	
		...
		if((document.all("leader").checked==false)&&(document.all("assistant").checked==false)&&(document.all("tutor").checked==false)&&(document.all("teacher").checked==false)){
			alert("人员职务不能为空");
			return false;
		}					
		return true;
	...
	function search_check(){
		...
		document.forms[0].action='managerAction.do?method=load4NameSearch';
		return true;
	}
