...
<center>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<html:form action="classAction.do?method=load4AlertSearch&getrole=2" onsubmit="javascript:return on_validate();">
							...
							<tbody>
								<tr align="center" valign="middle">
									<td height="24" valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black" href="javascript:DoSort('studentNo')"><bean:message bundle="classmanage" key="studentsearch.enterenceNo" /></a>
									</td>
...
function DoSort(col){
  ...
  document.classForm.action="classAction.do?method=load4AlertSearch&getrole=2";
