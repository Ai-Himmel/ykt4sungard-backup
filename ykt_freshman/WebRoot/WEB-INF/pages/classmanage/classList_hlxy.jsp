		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center" valign="top">
					<html:form action="classAction.do?method=load4Search&&getrole=2">
			...
			<tr>
				<td height="40" align="center" valign="top">
					<html:form action="classAction.do?method=delete&&getrole=2">
						<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=submenu1>
							<tbody>
								...
								<tr align="center" valign="middle">
									...
									<td valign="middle" class="tableHeader">
										<bean:message bundle="classmanage" key="class.tutor" />
									</td>
									<td valign="middle" class="tableHeader">
											...
											<pg:item>
												...
												<c:if test="${i%2 != 0}">
													<tr align="center" valign="middle" bgcolor="#F6F4F5">
														...
														<td align="center" valign="middle">
															<a href="classAction.do?method=load4Edit&getrole=2&classId=<bean:write name="classwithrole" property="classId"/>"><bean:write name="classwithrole" property="classNo" /></a>
														</td>
														<td align="center" valign="middle">
        ...
        <%} %>
						...
						<tr>
							<td height="30" align="right" valign="middle">
								<html:submit property="add" styleClass="button_nor" onclick="document.forms[1].action='classAction.do?method=load4Add&&getrole=2'">
