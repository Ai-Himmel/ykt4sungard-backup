...
<center>
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium"><bean:message bundle="classmanage" key="classStatistic.collegeStuStatistic" /></font></strong>
				</td>
			</tr>
			<tr>
				<td align="left" valign="middle">
					...
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable1>
						<tbody>
							...
							<logic:present name="collegeList" scope="request">
								<logic:iterate name="collegeList" id="college" indexId="k">
									<c:if test="${college.collegeName!='daleiCount'}">
										<tr align="center" valign="middle">
											<td align="center" valign="middle" bgcolor="#FFFFFF" class="medium" id="<bean:write name="college" property="collegeId" />">
												<bean:write name="college" property="collegeName" />
											</td>
											<c:if test="${k%2 == 0}">
												<logic:present name="daleiList" scope="request">
													<logic:iterate name="daleiList" id="dalei">
														<td align="center" valign="middle" bgcolor="#FFFFFF" class="medium" id="<bean:write name="college" property="collegeId" />.<bean:write name="dalei" property="id.dictValue" />">
															&nbsp;
														</td>
													</logic:iterate>
												</logic:present>
											...
											<c:if test="${k%2 != 0}">
												<logic:present name="daleiList" scope="request">
													<logic:iterate name="daleiList" id="dalei">
														<td align="center" valign="middle" bgcolor="#F6F4F5" class="medium" id="<bean:write name="college" property="collegeId" />.<bean:write name="dalei" property="id.dictValue" />">
															&nbsp;
														</td>
													</logic:iterate>
												</logic:present>
									...
									<c:if test="${college.collegeName=='daleiCount'}">
										<tr align="center" valign="middle" bgcolor="#FF9999">
											...
											<logic:present name="daleiList" scope="request">
												<logic:iterate name="daleiList" id="dalei">
													<td align="center" valign="middle" class="medium" id="daleiCount.<bean:write name="dalei" property="id.dictValue" />">
														&nbsp;
													</td>
												</logic:iterate>
											</logic:present>
			...
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium"><bean:message bundle="classmanage" key="classStatistic.collclsMajorinStatistic" /></font></strong>
				</td>
			</tr>
			<tr>
				<td align="left" valign="middle">
								...
								<logic:iterate name="collegeclassList" id="colcls" indexId="i">
										...
										<tr align="center" valign="middle">
											...
											<c:if test="${colcls.classNo!='smallCount'}">
												...
												<c:if test="${i%2 == 0}">
													<logic:present name="daleiList" scope="request">
														<logic:iterate name="daleiList" id="dalei">
															<td align="center" valign="middle" bgcolor="#FFFFFF" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="dalei" property="id.dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>
												...
												<c:if test="${i%2 != 0}">
													<logic:present name="daleiList" scope="request">
														<logic:iterate name="daleiList" id="dalei">
															<td align="center" valign="middle" bgcolor="#F6F4F5" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="dalei" property="id.dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>
											...
											<c:if test="${colcls.classNo=='smallCount'}">
												...
												<logic:present name="daleiList" scope="request">
													<logic:iterate name="daleiList" id="dalei">
														<td align="center" valign="middle" bgcolor="#FFFFCC" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="dalei" property="id.dictValue" />">
															&nbsp;
														</td>
													</logic:iterate>
												</logic:present>
									...
									<c:if test="${colcls.collegeName=='allCount'}">
										<tr align="center" valign="middle" bgcolor="#FF9999">
											...
											<td align="center" valign="middle" class="medium" id="allCount.<bean:write name="colcls" property="classNo" />">
												<bean:write name="colcls" property="classNo" />
											</td>
											<logic:present name="daleiList" scope="request">
												<logic:iterate name="daleiList" id="dalei">
													<td align="center" valign="middle" class="medium" id="allCount.<bean:write name="colcls" property="classNo" />.<bean:write name="dalei" property="id.dictValue" />">
														&nbsp;
													</td>
												</logic:iterate>
											</logic:present>
...
<Script language="Javascript">
	...
	if(document.getElementById("<%=collegeId%>.<%=majorin%>")!=null){
		document.getElementById("<%=collegeId%>.<%=majorin%>").innerHTML='<%=stuCount%>';
	}
	<%
		}
		List zhuanyeResultStatistic = (List)request.getAttribute("zhuanyeResultStatistic");
		collegeId = "";
		classNo="";
		majorin="";
		stuCount="";
		for(int j=0;j<zhuanyeResultStatistic.size();j++){
			NationDistributionInfo nationdistributionInfo = (NationDistributionInfo)zhuanyeResultStatistic.get(j);
			collegeId = nationdistributionInfo.getCollegeName();
			classNo =  nationdistributionInfo.getClassName();
			majorin = nationdistributionInfo.getNation();
			if(nationdistributionInfo.getStudentCount()!=0){
	...
	%>
	if(document.getElementById("<%=collegeId%>.<%=classNo%>.<%=majorin%>")){
