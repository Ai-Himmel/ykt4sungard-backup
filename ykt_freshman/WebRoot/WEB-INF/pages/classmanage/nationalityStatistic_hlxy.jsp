		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="30" align="left" valign="middle" class="medium">
					<strong><font color="#990000"><a name="2"><bean:message bundle="classmanage" key="classStatistic.nationalityStatistic" />:</a></font></strong>
				</td>
			</tr>
			<tr>
					...
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id="maintable">
						<tbody>
							<tr align="center" valign="middle">
								...
								<td width="8%" height="24" valign="middle" class="tableHeader">
									<strong><bean:message bundle="classmanage" key="classStatistic.classes" /></strong>
								</td>
								<logic:present name="nationalityList" scope="request">
									<logic:iterate name="nationalityList" id="nationality">
										<td valign="middle" class="tableHeader" id="<bean:write name="nationality" property="dictValue" />">
											<strong><bean:write name="nationality" property="dictCaption" /></strong>
										</td>
									</logic:iterate>
								</logic:present>
							</tr>
								...
								<logic:iterate name="collegeclassList" id="colcls">
									<c:if test="${colcls.collegeName!='allCount'}">
										<tr align="center" valign="middle">
											...
											<c:if test="${colcls.classNo=='smallCount'}">
												...
												<logic:present name="nationalityList" scope="request">
													<logic:iterate name="nationalityList" id="nationality">
														<td align="center" valign="middle" bgcolor="#FFFFCC" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="nationality" property="dictValue" />">
															&nbsp;
														</td>
													</logic:iterate>
												</logic:present>												
											...
											<c:if test="${colcls.classNo!='smallCount'}">
												<c:if test="${i%2 == 0}">
													...
													<logic:present name="nationalityList" scope="request">
														<logic:iterate name="nationalityList" id="nationality">
															<td align="center" valign="middle" bgcolor="#FFFFFF" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="nationality" property="dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>											
												...
												<c:if test="${i%2 != 0}">
													...
													<logic:present name="nationalityList" scope="request">
														<logic:iterate name="nationalityList" id="nationality">
															<td align="center" valign="middle" bgcolor="#F6F4F5" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="nationality" property="dictValue" />">
																&nbsp;
															</td>
														</logic:iterate>
													</logic:present>			
									...
									<c:if test="${colcls.collegeName=='allCount'}">
										<tr align="center" valign="middle" bgcolor="#FF9999">
											...
											<logic:present name="nationalityList" scope="request">
												<logic:iterate name="nationalityList" id="nationality">
													<td align="center" valign="middle" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="nationality" property="dictValue" />">
														&nbsp;
													</td>
												</logic:iterate>
											</logic:present>											
...
<Script language="Javascript">
	<%
		List nationalityStatistic = (List)request.getAttribute("nationalityStatistic");
		String collegeId = "";
		String classNo="";
		String nationality="";
		String stuCount="";
		for(int j=0;j<nationalityStatistic.size();j++){
			NationDistributionInfo nationdistributionInfo = (NationDistributionInfo)nationalityStatistic.get(j);
			collegeId = nationdistributionInfo.getCollegeName();
			classNo =  nationdistributionInfo.getClassName();
			nationality = nationdistributionInfo.getNation();
	...
	%>
	if(document.getElementById("<%=collegeId%>.<%=classNo%>.<%=nationality%>")!=null){
		document.getElementById("<%=collegeId%>.<%=classNo%>.<%=nationality%>").innerHTML='<%=stuCount%>';
	}
	<%
		}
	%>
