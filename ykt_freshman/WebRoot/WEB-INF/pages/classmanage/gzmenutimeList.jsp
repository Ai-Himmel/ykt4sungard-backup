...
<html:form action = "gzclassAction.do?method=menutimelist">
...
function DoFind(){
   ...
   document.classForm.action="gzclassAction.do?method=menutimelist";
...
function DoSave(str){
   ...
   document.classForm.action="gzclassAction.do?method=updatemenutime";
   document.classForm.submit();
}
