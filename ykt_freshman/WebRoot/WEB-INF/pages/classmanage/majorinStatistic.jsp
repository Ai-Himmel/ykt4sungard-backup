...
<center>
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="200%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			<tr align="left">
				<td height="30" align="left" valign="middle" class="tdborder02">
					<table width=50% border=1 align="left" cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff>
						<tr>
							<td>
								报到前统计：
							</td>
			...
			<tr>
				<td height="30" align="left" valign="middle" class="medium">
					<strong><font color="#990000"><a name="2"><bean:message bundle="classmanage" key="classStatistic.majorinStatistic" />:</a></font></strong>
				</td>
			</tr>
			<tr>
					...
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable>
						<tbody>
							<tr align="center" valign="middle">
								<td width="60px" valign="middle" class="tableHeader">
									<strong><bean:message bundle="classmanage" key="classStatistic.college" /></strong>
								</td>
								<td width="60px" height="24" valign="middle" class="tableHeader">
								...
								<logic:present name="majorList" scope="request">
									<logic:iterate name="majorList" id="majorin">
										<td valign="middle" class="tableHeader" id="<bean:write name="majorin" property="dictValue" />">
								...
								<logic:iterate name="collegeclassList" id="colcls" indexId="i">
									<c:if test="${colcls.collegeName!='allCount'}">
										<tr align="center" valign="middle">
											...
											<c:if test="${colcls.classNo=='smallCount'}">
												...
												<td width="60px" align="center" valign="middle" bgcolor="#FFFFCC" class="medium" id="<bean:write name="colcls" property="collegeId" />">
													<bean:write name="colcls" property="collegeName" />
												</td>
											</c:if>
											<c:if test="${colcls.classNo!='smallCount'}">
									...
									<c:if test="${colcls.collegeName=='allCount'}">
										<tr align="center" valign="middle" bgcolor="#FF9999">
											...
											<logic:present name="majorList" scope="request">
												<logic:iterate name="majorList" id="majorin">
													<td align="center" valign="middle" class="medium" id="<bean:write name="colcls" property="collegeId" />.<bean:write name="colcls" property="classNo" />.<bean:write name="majorin" property="dictValue" />">
														&nbsp;
													</td>
												</logic:iterate>
											</logic:present>
											...
											<td width="60px" align="center" valign="middle" class="medium" id="<bean:write name="colcls" property="collegeId" />">
												总计
											</td>
										</tr>
									</c:if>
...
<Script language="Javascript">
	...
	%>
uniteTable1(document.all.maintable);
