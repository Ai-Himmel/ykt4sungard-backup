...
function newpage(){
	window.open ('studentAction.do?method=load4StudentListColumnSelect','studentListColumnSelect','height=400,width=600,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no'); 
}
...
<center>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<table width="<bean:write name="width"/>" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
						...
						<tr>
							<td>
								<strong><font class="medium"><bean:message
											bundle="classmanage" key="studentsearch.studentsearch" /> </font> </strong>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr align="left">
				<td align="left" valign="top" width="50%">
					<html:form action="studentAction.do?method=load4Search&getrole=1">
						<table width="900px" border=1 align="left" cellpadding=1 cellspacing=0
							bordercolor=#FFFFFF id=resetFrom>
							<tr>
								<td>
									<%
								...
								<td>
									<%
											...
											.toString();
									%>
									<INPUT type="hidden" name="mydormitory"
										value="<%=mydormitory%>">
									<%
									} else {
									%>
							...
							<tr>
								<td>
									<INPUT type="hidden" name="myerror"
										value="<html:errors bundle="classmanage" />">
								</td>
							</tr>
							<tbody>
								<tr align="center" valign="middle">
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage" key="studentsearch.college" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01" property="college"
											onchange="changeCollge(this.value)">
											<html:option value="">-------------------------</html:option>
											<html:options collection="collegeList"
												labelProperty="collegeName" property="collegeId" />
										</html:select>
									</td>
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="class.name" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01" property="classId">
											<html:option value="">-------------------------</html:option>
											<html:options collection="classList" labelProperty="classNo"
												property="classId" />
										</html:select>
									</td>
									<td width="10%" align="right" valign="middle"
										class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="classsearch.assistant" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01" property="assistant">
											<html:option value="">-------------------------</html:option>
											<html:options collection="assistantList"
												labelProperty="managerName" property="managerId" />
										</html:select>
									</td>
								</tr>
								<tr align="center" valign="middle">
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="studentsearch.studentNo" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:text property="studentmodel.studentNo"
											styleClass="input_box_stu" maxlength="20"
											onkeydown="if(event.keyCode==13) document.onkeydown();" />
									</td>

									<td width="10%" align="right" valign="middle" bgcolor="#FFFFFF"
										class="tableHeader2">
										<bean:message bundle="classmanage" key="studentsearch.stuName" />
									</td>
									<td align="left" valign="middle" bgcolor="#FFFFFF"
										class="tableHeader3">
										<html:text property="studentmodel.stuName"
											styleClass="input_box_stu" maxlength="20"
											onkeydown="if(event.keyCode==13) document.onkeydown();" />
									</td>
									<td width="10%" height="24" align="right" valign="middle"
									...
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.gender">
											<html:option value="">-------------------------</html:option>
											<html:options collection="genderList"
								...
								<tr align="center" valign="middle">
									...
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01" property="location"
											onchange="changeLocation(this.value)">
											<html:option value="">-------------------------</html:option>
											<html:options collection="locationList1"
									...
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="studentsearch.dormitory" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
									...
									<td width="10%" align="right" valign="middle"
										class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="studentsearch.roomnumber" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:text property="roomnumber" styleClass="input_box_stu"
											maxlength="20"
											onkeydown="if(event.keyCode==13) document.onkeydown();" />
									</td>
								</tr>
								<tr align="right" valign="middle">
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.province" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.fromProvince">
											<html:option value="">-------------------------</html:option>
											<html:options collection="provinceList"
												labelProperty="dictCaption" property="dictValue" />
										</html:select>
									</td>
									<td width="10%" align="right" valign="middle" bgcolor="#FFFFFF"
									...
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.nationality" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.nationality">
											<html:option value="">-----------------------------------------</html:option>
											<html:options collection="nationalityList"
												labelProperty="dictCaption" property="dictValue" />
										</html:select>
									</td>
								</tr>
								<tr align="right" valign="middle">
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.department" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.department">
											<html:option value="">-------------------------------------</html:option>
									...
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.majorin">
											<html:option value="">-------------------------------------</html:option>
											<html:options collection="majorinList"
												labelProperty="dictCaption" property="dictValue" />
										</html:select>
									</td>
									<td width="10%" align="right" valign="middle" bgcolor="#FFFFFF"
										class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.politybg" />
									</td>
									<td align="left" valign="middle" bgcolor="#FFFFFF"
										class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.polityBg">
											<html:option value="">-------------------------</html:option>
								...
								<tr align="right" valign="middle">
									...
									<td align="left" valign="middle" class="tableHeader3">
										<html:text property="studentmodel.idCard"
											styleClass="input_box_stu" maxlength="20"
											onkeydown="if(event.keyCode==13) document.onkeydown();" />
									</td>
									...
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.cultureMode" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.cultureMode">
											<html:option value="">-------------------------</html:option>
											<html:options collection="cultureModeList"
												labelProperty="dictCaption" property="id.dictValue" />
										</html:select>
									</td>
									<td width="10%" height="24" align="right" valign="middle"
										bgcolor="#FFFFFF" class="tableHeader2">
										<bean:message bundle="classmanage"
											key="studentsearch.studentChar" />
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:select styleClass="select01"
											property="studentmodel.studentChar">
											<html:option value="">-------------------------</html:option>
											<html:options collection="studentCharList"
												labelProperty="dictCaption" property="id.dictValue" />
										</html:select>
									</td>
								</tr>
								<tr align="right" valign="middle">
									...
									<td width="10%" height="24" align="left" valign="left"
										bgcolor="#FFFFFF" class="tableHeader2">
										<span class="medium"><bean:message bundle="classmanage"
												key="studentsearch.enterenceNo" /> </span>
									</td>
									<td align="left" valign="middle" class="tableHeader3">
										<html:text property="studentmodel.enterenceNo"
											styleClass="input_box_stu" maxlength="20"
											onkeydown="if(event.keyCode==13) document.onkeydown();" />
									</td>
								</tr>
								...
								<table width="50%" align="left">
									<tr align="left">
										<td width="100%" height="40" align="left" valign="middle"
											class="tdborder02" onclick="javascript:NotExport();">
											<html:submit property="search" styleClass="button_nor">
												<bean:message key="button.query" />
											</html:submit>
											<html:button property="reset" styleClass="button_nor"
												onclick="clearAll();">
			...
			<tr>
				<td height="20" align="left" valign="middle" class="medium">
					<a href="javascript:DoExport()">导出Excel<IMG
							src="./pages/style/default/images/xls.gif" border="0"> </a>
				</td>
			</tr>
			<tr>
				<td height="40" align="center" valign="top">
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0
						...
						<tbody>
							<tr align="center" valign="middle">
								<logic:equal name="studentlc" value="1" property="college">
									<td valign="middle" class="tableHeader" >
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('college')"><bean:message
												bundle="classmanage" key="studentsearch.college" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="name">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('name')"><bean:message
												bundle="classmanage" key="class.name" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="assistant">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('assistant')"><bean:message
												bundle="classmanage" key="class.assistant" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="studentNo">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('studentNo')"><bean:message
												bundle="classmanage" key="studentsearch.studentNo" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="enterenceNo">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('enterenceNo')"><bean:message
												bundle="classmanage" key="studentsearch.enterenceNo" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="stuName">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('stuName')"><bean:message
												bundle="classmanage" key="studentsearch.stuName" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="gender">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('gender')"><bean:message
												bundle="classmanage" key="studentsearch.gender" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="department">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('department')"><bean:message
												bundle="classmanage" key="studentsearch.department" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="majorin">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('majorin')"><bean:message
												bundle="classmanage" key="studentsearch.majorin" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="nation">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('nation')"><bean:message
												bundle="classmanage" key="studentsearch.nation" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="nationality">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('nationality')"><bean:message
												bundle="classmanage" key="studentsearch.nationality" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="province">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('province')"><bean:message
												bundle="classmanage" key="studentsearch.province" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="idType">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('idType')"><bean:message
												bundle="classmanage" key="studentsearch.idType" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="idCard">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('idCard')"><bean:message
												bundle="classmanage" key="studentsearch.idCard" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="cultureMode">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('cultureMode')"><bean:message
												bundle="classmanage" key="studentsearch.cultureMode" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="studentChar">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('studentChar')"><bean:message
												bundle="classmanage" key="studentsearch.studentChar" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="checkornot">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('checkornot')"><bean:message
												bundle="classmanage" key="studentsearch.checkornot" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="schoolornot">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('schoolornot')"><bean:message
												bundle="classmanage" key="studentsearch.schoolornot" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="polityBg">
									...
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('polityBg')"><bean:message
												bundle="classmanage" key="studentsearch.politybg" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="location">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('location')"><bean:message
												bundle="classmanage" key="studentsearch.location" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="dormitory">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('dormitory')"><bean:message
												bundle="classmanage" key="studentsearch.dormitory" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="roomNumber">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('roomNumber')"><bean:message
												bundle="classmanage" key="studentsearch.roomnumber" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="birthday">
									<td height="24" valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('birthday')"><bean:message
												bundle="classmanage" key="studentsearch.birthday" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="homeTelephone">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('homeTelephone')"><bean:message
												bundle="classmanage" key="studentsearch.homeTelephone" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="tempecardNo">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('tempecardNo')"><bean:message
												bundle="classmanage" key="studentsearch.tempecardNo" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="bathcardNo">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('bathcardNo')"><bean:message
												bundle="classmanage" key="studentsearch.bathcardNo" /> </a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="examNo">
									<td valign="middle" class="tableHeader">
										<a style="font-size:14px;color: black"
											href="javascript:DoSort('examNo')"><bean:message
												bundle="classmanage" key="studentsearch.examNo" />
										</a>
									</td>
								</logic:equal>
								<logic:equal name="studentlc" value="1" property="studentNo">
							...
							<logic:present name="studentmodels" scope="request">
								<%
											...
											.intValue();
								%>
								<pg:pager url="./studentAction.do" items="<%=itemNo%>"
									...
									<logic:iterate name="studentmodels" id="studentwithallinfo"
										indexId="k">
										<pg:item>
											<c:if test="${k%2 == 0}">
											...
											<logic:equal name="studentlc" value="1" property="college">
												...
												<td align="center" valign="middle" width="60px">
											...
											<logic:equal name="studentlc" value="1"
												property="enterenceNo">
												<td align="center" valign="middle">
													<bean:write name="studentwithallinfo"
														property="enterenceNo" />
													<logic:empty name="studentwithallinfo"
														property="enterenceNo">
														&nbsp;													
													</logic:empty>
												</td>
											...
											<logic:equal name="studentlc" value="1" property="examNo">
												<td align="center" valign="middle">
													<c:choose>
														<c:when test="${studentwithallinfo.examNo == '1'}">已报到
													...
													<logic:empty name="studentwithallinfo" property="examNo">
														&nbsp;													
												</logic:empty>
												</td>
											</logic:equal>
		...
		<tr>
			<td height="40" align="left" valign="middle">
				<c:if test="${listcount!=null}">
					<font color="#000000" size="2.5"><bean:message
							bundle="classmanage" key="studentsearch.sum" /> <c:out
							value="${listcount}" /> <bean:message bundle="classmanage"
							key="studentsearch.count" /> </font>
				</c:if>
...
function DoSort(col){
 NotExport();
  ...
  document.studentForm.action="studentAction.do?method=load4Search&getrole=1";
