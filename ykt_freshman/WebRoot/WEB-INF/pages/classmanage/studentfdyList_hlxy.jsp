...
function newpage(){
	window.open ('studentAction.do?method=load4StudentfdyhlxyListColumnSelect','studentListColumnSelect','height=400,width=600,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no'); 
}
		...
		<table width="<bean:write name="width"/>" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<TABLE width="50%" align="center">
						<tr>
							<td>
								<strong><font class="medium">本班新生基本信息查询</font></strong>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td align="left" valign="top" width="50%">
					<html:form action="studentAction.do?method=load4fdySearch&&getrole=2">
			...
			%>
							...
							<tbody>
								...
								<tr align="center" valign="middle">
									...
									<td width="13%" height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2">
...
NotExport();
  ...
  document.studentForm.action="studentAction.do?method=load4fdySearch&getrole=2";
