...
<html:form action = "classAction.do?method=menutimelist">
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=maintable>
        ...
        <logic:present name="checkinlist" scope="request">
		  ...
		  <pg:pager url="./classAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
...
function DoFind(){
   ...
   document.classForm.action="classAction.do?method=menutimelist";
...
function DoSave(str){
   ...
   document.classForm.action="classAction.do?method=updatemenutime";
   document.classForm.submit();
}
