...
<html:form action="ecardPhotoAction.do?method=importExcelFile" enctype="multipart/form-data">
        <tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium">新生一卡通拍照情况导入</font></strong>
			</td>
		</tr>
		<tr>
				...
				<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
					<tbody>
						<tr align="center" valign="middle">
	                        ...
	                        <input name="theFile" type="file" value="">&nbsp;<input name="notfinish" type="checkbox" onclick="DoChange(this)" value="1">未拍照
	                        <input name="hnotfinish" type="hidden" value="1">
                            ...
                            <input type="button" class="button_nor" value="提交" onClick="DoCheck()">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="./ephotomodel.xls">新生一卡通拍照导入模板<IMG src="./pages/style/default/images/xls.gif" border="0"></a>
							</td>
						</tr>
				   </tbody>
				</table>
...
function DoCheck(){
    ...
    if(document.forms[0].elements["theFile"].value!=''){
		...
		if (fileext!='.xls')
		{
          ...
          document.feeuploadForm.action="ecardPhotoAction.do?method=importExcelFile";
...
function DoChange(chk){
    if(chk.checked)
        document.all.hnotfinish.value="0";
    else
        document.all.hnotfinish.value="1";
