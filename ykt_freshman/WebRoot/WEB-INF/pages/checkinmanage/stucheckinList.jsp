...
<html:form action = "checkinmanageAction.do?method=stuinfofind">
...
<table width="185%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <TABLE width="55%" align="center">
		<tr>
			<td>
				<strong><font class="medium">新生入学信息表</font></strong>
			</td>
		</tr>
	</table>
    </td>
  ...
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <td width=6% align="center" valign="middle" class="tableHeader" ><a style="font-size:14px;color: black" href="javascript:DoSort('stuName')"><bean:message bundle="checkinmanage" key="checkin.stuName"/></a></td>
          ...
          <td width=8% align="center" valign="middle" class="tableHeader" ><a style="font-size:14px;color: black" href="javascript:DoSort('majorin')"><bean:message bundle="checkinmanage" key="checkin.majorin"/></a></td>          
          <td width=6% align="center" valign="middle" class="tableHeader" ><a style="font-size:14px;color: black" href="javascript:DoSort('fromProvince')"><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></a></td>
          ...
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap><a style="font-size:14px;color: black" href="javascript:DoSort('ecardPhoto')">一卡通拍照</a></td>
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap><a style="font-size:14px;color: black" href="javascript:DoSort('ifGotEcard')">正式一卡通</a></td> 
          ...
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap><a style="font-size:14px;color: black" href="javascript:DoSort('ifGotStucard')">学生证/校徽</a></td>         
          
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap><bean:message bundle="checkinmanage" key="checkin.stuName"/></td>
  ...
  <tr> 
    <td height="24" align="left" valign="middle">
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <td width=6% align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.stuName"/></td>
          <td width=4% align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.gender"/></td>
          <td width=8% align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.majorin"/></td>          
          <td width=6% align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></td>
          ...
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap>一卡通拍照</td>
          <td width=6% align="center" valign="middle" class="tableHeader" nowrap>一卡通/浴卡</td> 
          ...
          <td align="center" height="24" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.studentNo"/></td>               
           ...
           <!--page offset start -->
		  <pg:pager url="./stucheckinpageroll.do" items="0" index="center" maxPageItems="50" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
           <pg:param name="hstuName" />
           <pg:param name="hstudentNo" />
           <pg:param name="hgender" />
...
function DoFind(){
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=stucheckinlist";
