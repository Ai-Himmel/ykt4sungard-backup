...
<html:form action = "gzarchivesAction.do?method=find">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
   ...
   <logic:iterate name="checkinlist" id="cl" type="java.util.Map" length="1">
    <bean:write name="cl" property="classNo"/>&nbsp;<bean:message bundle="checkinmanage" key="archives.title"/>
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody><input type="hidden" name="updateid" value="">
           ...
           <tr align="center" valign=center> 
              ...
              <td width="6%" rowspan="2" valign="middle" class="tableHeader" nowrap style="display:none"><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></td>
...
function DoFind(){   
   ...
   document.stuarchivesinfoForm.action="gzarchivesAction.do?method=find";
...
function DoSave(str){
   ...
   document.stuarchivesinfoForm.action="gzarchivesAction.do?method=update";
   document.stuarchivesinfoForm.submit();
}
...
function DoSaveAll(){
   ...
   document.stuarchivesinfoForm.action="gzarchivesAction.do?method=updateall";
   document.stuarchivesinfoForm.submit();
