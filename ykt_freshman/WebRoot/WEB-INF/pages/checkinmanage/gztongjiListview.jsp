...
<center>
<html:form action = "gzcheckinmanageAction.do?method=tongjilistview">
<html:errors/>
<br>
    ...
    <tr> 
     ...
     <tr> 
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
         ...
         <input type="hidden" name="myAction" value="gzcheckinmanageAction.do?method=tongjilistview">       
        </tbody>
     </table>
     </td>
    </tr>
...
function DoFind(){   
   ...
   document.stucheckininfoForm.action="gzcheckinmanageAction.do?method=tongjilistview";
...
function DoNotcheckinView(str,flag){
  ...
  document.stucheckininfoForm.action="gzcheckinsubminAction.do?method=notcheckinstu&gender="+flag;
  document.stucheckininfoForm.submit();
}
...
function DoAskforlateView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="gzcheckinsubminAction.do?method=askforlatestu";
  document.stucheckininfoForm.submit();
}
...
function DoAskreserveView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="gzcheckinsubminAction.do?method=askreservestu";
  document.stucheckininfoForm.submit();
...
function DoNoreasonView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="gzcheckinsubminAction.do?method=noreasonstu";
  document.stucheckininfoForm.submit();
...
function DoNotcomeView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="gzcheckinsubminAction.do?method=donotcomestu";
  document.stucheckininfoForm.submit();
