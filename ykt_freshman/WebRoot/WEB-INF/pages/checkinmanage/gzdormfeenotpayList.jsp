...
<html:form action = "gzstufeeinfoAction.do?method=dormfeenotpaylist">
   ...
   <tr> 
    <td height="24" align="left" valign="middle">
        <jsp:include page="./page.jsp" flush="true" />
          ...
          <!--page offset start -->           
		  <pg:pager url="./dormfeenotpaypageroll.do" items="0" index="center" maxPageItems="10" maxIndexPages="50" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
...
function DoFind(){
   ...
   document.stufeeinfoForm.action="gzstufeeinfoAction.do?method=dormfeenotpaylist";
