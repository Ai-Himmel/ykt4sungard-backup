          ...
          <logic:present name="unhealthlist" scope="request">
           <thead>
            <tr align="center" valign=center>  
              ...
              <td width="8%" valign="middle" class="tableHeader" nowrap style="display:none">书院</td>           
              <td width="8%" valign="middle" class="tableHeader" nowrap><bean:message bundle="checkinmanage" key="checkin.classNo"/></td>
              <td width="10%" valign="middle" class="tableHeader" nowrap><bean:message bundle="checkinmanage" key="checkin.studentNo"/></td>
              <td width="10%" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.stuName"/></td>
              <td width="6%" valign="middle" class="tableHeader" nowrap><bean:message bundle="checkinmanage" key="checkin.gender"/></td>
              <td width="10%" valign="middle" class="tableHeader" nowrap style="display:none"><bean:message bundle="checkinmanage" key="checkin.majorin"/></td> 
              <td width="8%" valign="middle" class="tableHeader" >报到</td>             
              <td width="10%" valign="middle" class="tableHeader" nowrap><bean:message bundle="checkinmanage" key="health.healthresult"/></td>
              <td width="8%" valign="middle" class="tableHeader" nowrap>辅导员</td>
		  ...
		  <pg:pager url="./gzhealthAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
		   ...
		   <pg:param name="hifUnhealthy" />
            ...
            <td align="center" valign="middle" bgcolor="#FFFFFF" ><input type="checkbox" name="cbgroup" value="<bean:write name="cl" property="id"/>"></td>             
              <td align="center" valign="middle" bgcolor="#FFFFFF" style="display:none"><bean:write name="cl" property="collegeName"/></td>
            ...
            <td align="center" valign="middle" bgcolor="#F6F4F5"><input type="checkbox" name="cbgroup" value="<bean:write name="cl" property="id"/>"></td>              
              <td align="center" valign="middle" bgcolor="#F6F4F5" style="display:none"><bean:write name="cl" property="collegeName"/></td>
...
function DoFind(){
   ...
   document.stuhealthinfoForm.action="gzhealthAction.do?method=unhealthlist";
...
function DoUpdate(str){
   ...
   document.stuhealthinfoForm.action="gzhealthAction.do?method=update";
   document.stuhealthinfoForm.submit();
