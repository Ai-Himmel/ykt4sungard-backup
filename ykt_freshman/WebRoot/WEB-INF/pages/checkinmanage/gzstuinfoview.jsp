...
<html:form action = "gzstufeeinfoAction.do?method=view">
<html:errors/>
<br>
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody>
            ...
            <tr align="center" valign=center> 
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" style="display:none">
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" colspan="3"><bean:write name="sl" property="classNo"/></td>
            </tr>
            </logic:iterate>
            </logic:present>
            <tr align="center" valign=center>               
...
<input type="hidden" name="hclassNo" value="<%=request.getParameter("hclassNo")==null||request.getParameter("hclassNo").equals("null")?"":request.getParameter("hclassNo")%>">
...
function DoView(str){
    ...
    document.stufeeinfoForm.action="gzstufeeinfoAction.do?method=view";
...
function Goback(){
  if(document.all.myAction.value!=''){
    document.stufeeinfoForm.action=document.all.myAction.value;
    document.stufeeinfoForm.submit();
 }
 else
    history.go(-1);
