    ...
    <tr> 
     ...
     <tr> 
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
         ...
         <input type="hidden" name="myAction" value="checkinmanageAction.do?method=tongjilistallviewabroad">      
        </tbody>
     </table>
     </td>
    </tr>
...
document.stucheckininfoForm.action="checkinmanageAction.do?method=tongjilistallviewabroad";
document.stucheckininfoForm.submit();
