      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <thead>
            <tr align="center" valign=center> 
              ...
              <td valign="middle" class="tableHeader" >国籍</td>
              <td valign="middle" class="tableHeader" >录取院系</td>
              <td valign="middle" class="tableHeader" >录取专业</td>
		   ...
		   <pg:pager url="./checkinsubminAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           ...
           <%-- save pager offset during form changes --%>
            ...
            <tr align="center" valign=center> 
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="cl" property="departmentName"/>&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
            ...
            <tr align="center" valign=center bgcolor="#F6F4F5"> 
              ...
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="cl" property="departmentName"/>&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#F6F4F5">
              <logic:present name="majorinlist" scope="request">            
               <logic:iterate name="majorinlist" id="ml" type="java.util.Map">
                <c:choose><c:when test="${ml.dictValue == cl.majorin}">              
...
function DoExport(){
   ...
   document.checkinsubminForm.action="checkinsubminAction.do?method="+document.all.md.value+"&viewclassNo="+document.all.viewclassNo.value+"&viewmajor="+document.all.viewmajor.value+"&hcollegeId="+document.all.hcollegeId.value+"&hclassNo="+document.all.hclassNo.value+"&hmajorin="+document.all.hmajorin.value+"&gender="+document.all.gender.value+"&nationality="+document.all.nationality.value;
   document.checkinsubminForm.submit();

}
function Goback(){
  document.all.doexl.value="";
  if(document.all.hcollegeId.value!='null'&&document.all.hcollegeId.value!='')
   document.checkinsubminForm.action=document.all.myAction.value+"&hcollegeId="+document.all.hcollegeId.value+"&hclassNo="+document.all.hclassNo.value;
  else if(document.all.hmajorin.value!='null'&&document.all.hmajorin.value!='')
   document.checkinsubminForm.action=document.all.myAction.value+"&hmajorin="+document.all.hmajorin.value;
  else
