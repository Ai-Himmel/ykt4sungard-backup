...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">学费未缴纳名单</font></strong></td>
    </tr>     
    ...
    <tr> 
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          ...
          <tr align="center" valign=center>
           <td align="right" valign="middle" class="tableHeader2" style="display:none">书院</td>
    ...
    <logic:present name="tuitionnotpaylist" scope="request">
    <tr>
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable>
          <tbody>
           ...
           <thead>
            <tr align="center" valign=center>               
              ...
              <td height="24" valign="middle" class="tableHeader" style="display:none">书院</td>  
              <td height="24" valign="middle" class="tableHeader" >更新日期</td>         
            </tr>
            </thead>
           <!--page offset start -->
		  ...
		  <pg:pager url="./gzstufeeinfoAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
            ...
            <logic:iterate name="tuitionnotpaylist" id="cl" type="java.util.Map"  indexId="i">
            <pg:item>
    ...
    <td height="24" align="left" valign="middle">
        <jsp:include page="./page.jsp" flush="true" />
          ...
          <logic:notPresent name="tuitionnotpaylist" scope="request">
          <!--page offset start -->           
		  <pg:pager url="./tuitionnotpaypageroll.do" items="0" index="center" maxPageItems="50" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
    ...
    <logic:present name="tuitionnotpaylist">
    <tr> 
...
function DoFind(){
   ...
   document.stufeeinfoForm.action="gzstufeeinfoAction.do?method=tuitionnotpaylist";
