...
<html:errors/>
<br>
<input type="hidden" name="myAction" value="checkinmanageAction.do?method=tongjilist">
...
function DoBack(str,strid){
  ...
  document.checkinsubminForm.action="checkinsubminAction.do?method=tongjibackto";
...
function DoSubmit(str,strid){
  ...
  document.checkinsubminForm.action="checkinsubminAction.do?method=tongjisubmit";
  document.checkinsubminForm.submit();
...
function DoNotcheckinView(str){
  ...
  document.checkinsubminForm.action="checkinsubminAction.do?method=notcheckinstu";
  document.checkinsubminForm.submit();
}

function DoAskforlateView(str){
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=askforlatestu";
  document.checkinsubminForm.submit();
}

function DoAskreserveView(str){
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=askreservestu";
  document.checkinsubminForm.submit();
...
function DoNoreasonView(str){
  ...
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=noreasonstu";
  document.checkinsubminForm.submit();
...
function DoNotcomeView(str){
  ...
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=donotcomestu";
  document.checkinsubminForm.submit();
...
function DoReserveView(str){
  ...
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=reservestu";
  document.checkinsubminForm.submit();
...
function DoLeaveschoolView(str){
  ...
  document.all.viewclassNo.value=str;
  document.checkinsubminForm.action="checkinsubminAction.do?method=leaveschoolstu";
  document.checkinsubminForm.submit();
