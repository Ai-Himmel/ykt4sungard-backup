...
<html:form action = "checkinmanageAction.do?method=addreserve">
<html:errors/>
<br>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium"><bean:message bundle="checkinmanage" key="checkin.reservetitle"/></font></strong></td>
    </tr>
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          ...
          <tr align="center" valign=center>
            ...
            <td align="left" valign="middle" class="tableHeader3" >
                <input 
                name="stuName" class="input_box"  maxlength=50 value="" disabled style="background:#ECE6E6">
            </td>
            <td align="left" valign="middle" class="tableHeader2" ><bean:message bundle="checkinmanage" key="checkin.classNo"/></td>
            <td align="left" valign="middle" class="tableHeader3" >
                <input 
                name="classNo" class="input_box"  maxlength=50 value="" disabled style="background:#ECE6E6">
            </td>
          </tr>
          ...
          <tr align="center" valign=center> 
            ...
            <td align="left" valign="middle" class="tableHeader3" colspan="3">          
              <logic:iterate name="stuinfo" id="si" type="java.util.Map" length="1">
                <input 
                name="stucheckininfo.enrollNo" class="input_box"  maxlength=50 value="<bean:write name="si" property="enrollNo"/>">&nbsp;
                <input name="searchstu" type="button" class="button_nor" value="<bean:message bundle="checkinmanage" key="checkin.search"/>" onClick="ShowName()">
                </td>
              </logic:iterate>
          </tr>
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          <tbody><input name="updateid" type="hidden" value="">
            ...
            <tr align="center" valign=center> 
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:message bundle="checkinmanage" key="checkin.reserve"/></td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
            ...
            <tr align="center" valign=center bgcolor="#F6F4F5"> 
              ...
              <td align="center" valign="middle" bgcolor="#F6F4F5"><bean:message bundle="checkinmanage" key="checkin.reserve"/></td>
              <td align="center" valign="middle" bgcolor="#F6F4F5">
              <input name="cancelReserve" type="button" class="button_nor" value="<bean:message bundle="checkinmanage" key="checkin.cancel"/>" onClick="DoCancel('<bean:write name="cl" property="id"/>')">
              </td>
            </tr>
...
function ShowName(){
    //alert("ok");
    document.stucheckininfoForm.action="checkinmanageAction.do?method=findstuinfo";
...
function DoAdd(){
  ...
  document.stucheckininfoForm.action="checkinmanageAction.do?method=addreserve";
  document.stucheckininfoForm.submit();  
...
function DoCancel(str){
  ...
  if(confirm("您确定要撤销吗？")){
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=cancelreserve";
   document.stucheckininfoForm.submit();
  }
  else
    return;
