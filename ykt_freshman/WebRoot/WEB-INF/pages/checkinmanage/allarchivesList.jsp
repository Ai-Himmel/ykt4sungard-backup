...
<html:form action = "archivesAction.do?method=allfind">
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
            ...
            <tr align="center" valign=center> 
              ...
              <td align="right" valign="middle" class="tableHeader2" ><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></td>
              <td align="left" valign="middle" class="tableHeader3"> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <thead>
           <tr align="center" valign=center> 
              ...
              <td width="8%" rowspan="2" valign="middle" class="tableHeader" nowrap>出生日期</td>
              <td width="12%" rowspan="2" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.majorin"/></td>
              <td width="6%" rowspan="2" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.classNo"/></td>
              <td width="8%" rowspan="2" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></td>
              ...
              <td rowspan="2" width="20%" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="archives.memo"/></td>
...
function DoFind(){
   ...
   document.stuarchivesinfoForm.action="archivesAction.do?method=allfind";
...
function DoSave(str){
   ...
   document.stuarchivesinfoForm.action="archivesAction.do?method=allupdate";
   document.stuarchivesinfoForm.submit();
}
...
function DoSaveAll(){
   ...
   document.stuarchivesinfoForm.action="archivesAction.do?method=allupdateall";
   document.stuarchivesinfoForm.submit();
