  ...
  <tr> 
    <td height="24" align="left" valign="middle">
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <td width=8% align="center" valign="middle" class="tableHeader" nowrap>学生证/校徽</td>         
...
function DoFind(){
   ...
   document.stucheckininfoForm.action="gzcheckinmanageAction.do?method=stucheckinlist";
