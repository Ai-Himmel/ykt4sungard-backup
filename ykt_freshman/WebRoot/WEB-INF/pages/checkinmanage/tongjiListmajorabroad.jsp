...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">留学生报到情况按专业统计</font></strong></td>
    </tr>    
    <tr> 
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
         ...
         <input type="hidden" name="myAction" value="checkinmanageAction.do?method=tongjilistmajorabroad">      
        </tbody>
     </table>
     </td>
    </tr>    
...
function DoFind(){   
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=tongjilistmajorabroad";
...
function DoNotcheckinView(str){
  ...
  document.stucheckininfoForm.action="checkinsubminAction.do?method=mjnotcheckinstuabroad";
  document.stucheckininfoForm.submit();
}
...
function DoAskforlateView(str){
  document.all.doexl.value="";
  document.all.viewmajor.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=mjaskforlatestuabroad";
  document.stucheckininfoForm.submit();
}
...
function DoAskreserveView(str){
  document.all.doexl.value="";
  document.all.viewmajor.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=mjaskreservestuabroad";
  document.stucheckininfoForm.submit();
...
function DoNoreasonView(str){
  document.all.doexl.value="";
  document.all.viewmajor.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=mjnoreasonstuabroad";
  document.stucheckininfoForm.submit();
...
function DoNotcomeView(str){
  document.all.doexl.value="";
  document.all.viewmajor.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=mjnotcomestuabroad";
  document.stucheckininfoForm.submit();
