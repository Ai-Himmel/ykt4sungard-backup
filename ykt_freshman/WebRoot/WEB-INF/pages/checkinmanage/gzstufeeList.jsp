...
<html:form action = "gzstufeeinfoAction.do?method=stufeelist">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">新生入学费用应缴查询</font></strong></td>
    </tr>     
    ...
    <logic:present name="stufeelist" scope="request">
    <tr>
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable>
		  ...
		  <pg:pager url="./gzstufeeinfoAction.do" items="<%=listcount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
            ...
            <logic:iterate name="stufeelist" id="cl" type="java.util.Map"  indexId="i">
            <pg:item>
            ...
            <tr align="center" valign=center> 
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
              <bean:write name="cl" property="tuitionpayed"/>&nbsp;
              </td>              
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
              <bean:write name="cl" property="dormfeepayed"/>&nbsp;
              </td>                               
            </tr>
            </c:when></c:choose>
            <c:choose><c:when test="${i%2 == 0}">
   ...
   <tr> 
    <td height="24" align="left" valign="middle">
        <jsp:include page="./page.jsp" flush="true" />
          ...
          <logic:notPresent name="stufeelist" scope="request">
          <!--page offset start -->           
		  <pg:pager url="./stufeepageroll.do" items="0" index="center" maxPageItems="50" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
...
function DoFind(){
   ...
   document.stufeeinfoForm.action="gzstufeeinfoAction.do?method=stufeelist";
