...
<center>
	...
	<html:form action="checkinmanageAction.do?method=find">
				...
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium"> <logic:present name="checkinlist" scope="request">
								<logic:iterate name="checkinlist" id="cl" type="java.util.Map" length="1">
									<bean:write name="cl" property="classNo" />班&nbsp;新生报到信息登记
				...
				<td align="center" valign="top">
					<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
						<tbody>
							...
							<input type="hidden" name="myAction" value="checkinmanageAction.do?method=find">
						</tbody>
					</table>
				</td>
			</tr>
...
<script type="text/javascript" charset="gbk" src="<c:url value='/pages/scripts/checkinList.js'/>"></script>
