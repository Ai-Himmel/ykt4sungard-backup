...
<html:form action="bathcardAction.do?method=importExcelFile" enctype="multipart/form-data">
        <tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium">本班新生浴卡卡号导入</font></strong>
			</td>
		</tr>
		<tr>
					...
					<tbody>
						<tr align="center" valign="middle">
                            ...
                            <input type="button" class="button_nor" value="提交" onClick="DoCheck()">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="./bathcardmodel.xls">新生浴卡卡号导入模板<IMG src="./pages/style/default/images/xls.gif" border="0"></a>
							</td>
						</tr>
				   </tbody>
				</table>
...
function DoCheck(){
    ...
    if(document.forms[0].elements["theFile"].value!=''){
		...
		if (fileext!='.xls')
		{
          ...
          document.feeuploadForm.action="bathcardAction.do?method=importExcelFile";
