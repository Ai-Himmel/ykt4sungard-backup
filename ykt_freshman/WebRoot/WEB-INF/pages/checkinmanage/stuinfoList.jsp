...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <td align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.majorin"/></td>
          <td align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.classNo"/></td>
          <td align="center" valign="middle" class="tableHeader" ><bean:message bundle="checkinmanage" key="checkin.fromProvince"/></td>      
          </tr>
          </thead>          
           <!--page offset start -->
...
function DoFind(){
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=stuinfofind";
