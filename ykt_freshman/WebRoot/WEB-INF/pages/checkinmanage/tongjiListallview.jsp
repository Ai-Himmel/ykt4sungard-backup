    ...
    <tr> 
     ...
     <tr> 
      ...
      <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
         ...
         <input type="hidden" name="myAction" value="checkinmanageAction.do?method=tongjilistallview">      
        </tbody>
     </table>
     </td>
    </tr>
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=maintable>
          ...
          <input name="viewclassNo" type="hidden" value="">        
            ...
            <tr align="center" valign=center>
              ...
              <td width=4% valign="middle" class="tableHeader" >男</td>
              <td width=4% valign="middle" class="tableHeader" >女</td>
              <td width=4% valign="middle" class="tableHeader" >总</td>
              <td width=4% valign="middle" class="tableHeader" >男</td>
              <td width=4% valign="middle" class="tableHeader" >女</td>
              <td width=4% valign="middle" class="tableHeader" >总</td>
            ...
            <c:choose><c:when test="${tj.classNo != '书院小计'}">
              ...
              <td height="24" align="center" valign="middle" bgcolor="#FFFFCC"  style="font-weight:bold"><bean:write name="tj" property="classNo"/></td>
                           
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.shouldcheckinNum != 0}">      
                <bean:write name="tj" property="shouldcheckinNum"/>
              </c:when><c:otherwise>
              0
              ...
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.notcheckinmaleNum != 0}">                     
                 <bean:write name="tj" property="notcheckinmaleNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>
              </td> 
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.notcheckinfemaleNum != 0}">                     
                 <bean:write name="tj" property="notcheckinfemaleNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>
              </td>
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.askforlateNum != 0}">      
                <bean:write name="tj" property="askforlateNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>
              </td>              
              ...
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.askreserveNum != 0}">      
                <bean:write name="tj" property="askreserveNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>             
              </td>             
              ...
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
              <c:choose><c:when test="${tj.noreasonNum !=0}">      
                <bean:write name="tj" property="noreasonNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>
              </td>
              <td align="center" valign="middle" bgcolor="#FFFFCC" style="font-weight:bold">
               <c:choose><c:when test="${tj.notcomeNum != 0}">      
                <bean:write name="tj" property="notcomeNum"/>
              </c:when><c:otherwise>
              0
              </c:otherwise> </c:choose>    
              </td>
              ...
              <c:choose><c:when test="${tj.classNo =='书院小计'}"><!-- 小计 -->
           ...
           <tr align="center" valign=center bgcolor="#FF9999" style="font-weight:bold"> 
              <td height="24" align="center" valign="middle" colspan="2">复旦学院总计</td>
...
function DoFind(){   
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=tongjilistview";
...
document.stucheckininfoForm.action="checkinmanageAction.do?method=tongjilistallview";
document.stucheckininfoForm.submit();
...
function DoNotcheckinView(str,flag){
  ...
  document.stucheckininfoForm.action="checkinsubminAction.do?method=notcheckinstu&gender="+flag;
  document.stucheckininfoForm.submit();
}
...
function DoReserveView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=reservestu";
  document.stucheckininfoForm.submit();
...
function DoLeaveschoolView(str){
  document.all.doexl.value="";
  document.all.viewclassNo.value=str;
  document.stucheckininfoForm.action="checkinsubminAction.do?method=leaveschoolstu";
  document.stucheckininfoForm.submit();
