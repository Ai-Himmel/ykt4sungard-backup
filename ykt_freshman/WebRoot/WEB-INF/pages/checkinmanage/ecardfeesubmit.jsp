...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">新生一卡通缴费卡中心登记</font></strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <input name="updateclassNo" type="hidden" value="">               
            ...
            <td width=6% valign="middle" class="tableHeader" >确认</td>
            </tr>
            ...
            <tr align="center" valign=center> 
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
                <input name="submitto" type="button" class="button_nor" value="确 认" onClick="DoSubmit('<bean:write name="tj" property="classNo"/>','<bean:write name="tj" property="csid"/>')" disabled>
              </td>
              </c:when></c:choose>
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
                <input name="submitto" type="button" class="button_nor" value="确 认" onClick="DoSubmit('<bean:write name="tj" property="classNo"/>','<bean:write name="tj" property="csid"/>')" >
              </td>
              </c:when></c:choose>
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" >
                <input name="submitto" type="button" class="button_nor" value="确 认" onClick="DoSubmit('<bean:write name="tj" property="classNo"/>',null)" >
              </td>
              </c:when></c:choose>
            </tr>
            </c:when></c:choose>
...
function DoBack(str,strid){
  ...
  document.cardfeesubmitForm.action="cardfeesubmitAction.do?method=ecardfeebackto";
  document.cardfeesubmitForm.submit();
}
...
function DoSubmit(str,strid){
  ...
  document.cardfeesubmitForm.action="cardfeesubmitAction.do?method=ecardfeesubmit";
  document.cardfeesubmitForm.submit();
