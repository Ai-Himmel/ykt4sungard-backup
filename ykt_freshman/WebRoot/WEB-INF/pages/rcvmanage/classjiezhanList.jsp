...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">班级接站信息查询</font></strong></td>
    </tr>
    <tr>
    ...
    </tr><input type="hidden" name="updateid" value="">  
    <input name="orderby" type="hidden" value=""><input name="doexl" type="hidden" value=""> 
    ...
    <td height="24" align="left" valign="middle">
        <jsp:include page="./page.jsp" flush="true" />
          ...
          <!--page offset start -->
		  <pg:pager url="./classjiezhanpageroll.do" items="0" index="center" maxPageItems="50" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
			<pg:param name="hstudentNo" />
			<pg:param name="hstuName" />			
			<pg:param name="stuarriveinfo.trainNo" />
...
function DoFind(){
   ...
   document.stuarriveinfoForm.action="rcvmanageAction.do?method=classjiezhanfind";
