  ...
  function fnHandleDown() {
    switch(currInput) {
      ...
      case 2:
        ...
        if(value == 0 ) {
          form1.elements[currInput].value = "59";
          return;
        }
        value = value - 1;
        if(value <= 9) {
...
<table border=0 cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td rowspan="2" height="20"><input type="hidden" name="second" maxlength="2" onfocus="fnHandleFoucs(2);" onblur="fnHandleBlur(2);"  onkeypress="return fnHandleOnKeyPress();"></td>
