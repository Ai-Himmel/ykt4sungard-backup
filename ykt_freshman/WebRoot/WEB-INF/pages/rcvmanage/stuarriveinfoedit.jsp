        ...
        <tbody>
          ...
          <tr height="30" align="center" valign=center> 
            ...
            <td width="35%" align="left" valign="middle" class="tableHeader3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="130"> <input 
            name="arriveDate" class="input_box"  maxlength=50 value="<bean:write name="al" property="arriveDate"/>" onFocus="ChangeFocus1()" readonly="readonly"> 
                    </td>
            ...
            <td align="left" valign="middle" bgcolor="#FFFFFF" class="tableHeader3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td><OBJECT id="time" class="TxtInput"  border="1" style="HEIGHT: 16; WIDTH: 120;" tabIndex="4" type="text/x-scriptlet" VIEWASTEXT>
          ...
          <tr id="trhelp" height="30" align="center" valign=center>             
            ...
            <td align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >到上海站乘坐校车</td>
            <td align="left" valign="middle" bgcolor="#FFFFFF" class="tableHeader3"><table border="0" cellspacing="0" cellpadding="0">
                <tr align="center" valign="middle"> 
          ...
          <tr height="30" align="center" valign=center>             
            ...
            <td align="left" valign="middle" bgcolor="#FFFFFF" class="tableHeader3" colspan="3"><input 
            name="stuarriveinfo.tempconcact" class="input_box"  maxlength=25 value="<bean:write name="al" property="tempconcact"/>">&nbsp;(请填写在该新生抵沪或到校当天可以联系到他/她的电话或手机)</td>            
          </tr>
...
function init(){
  ...
  document.all.time.setTime(document.all.arriveTime.value);
...
function DoCheck(){
  ...
  document.stuarriveinfoForm.action="rcvmanageAction.do?method=update";
