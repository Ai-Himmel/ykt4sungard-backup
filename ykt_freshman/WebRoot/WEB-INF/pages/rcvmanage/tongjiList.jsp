...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="30" align="center" valign="middle" class="tdborder02"><strong> 
        <font class="medium">新生到站统计</font></strong></td>
    </tr>
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
            <tr align="center" valign=center> 
              <td height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >统计日期</td>
            ...
            name="arriveDate" class="input_box"  maxlength=50 value="<%=dateStr%>" onFocus="ChangeFocus1()" readonly="readonly"> 
              ...
              <td width="15%" align="left" valign="middle" class="tableHeader2" >统计地点</td>
              <td align="left" valign="middle" class="tableHeader3" >
              <select name="arrivePlace" class="select01">                  
                  <option value="01" selected>火车抵沪</option> 
                  <option value="011" selected>上海站</option>
                  <option value="012" selected>上海南站</option>                 
              </select>
              </td>
            </tr>
            <tr align="center" valign=center> 
              <td height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >起始时间</td>
              ...
              <td align="left" valign="middle" class="tableHeader2" >终止时间</td>
              <td align="left" valign="middle" class="tableHeader3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td>
            ...
            <tr align="center" valign=center> 
              <td width="15%" height="24" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >时间段间隔</td>
    ...
    <tr> 
      <td height="30" align="left" valign="middle" class="medium"><strong><font color="#990000">抵沪日期：</font></strong><strong><bean:write name="tj" property="arriveDate"/>&nbsp;&nbsp;&nbsp;
      <font color="#990000">抵沪地点：</font>
    ...
    <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <logic:present name="tjlist">
            <tr align="center" valign=center> 
              <td height="24" valign="middle" class="tableHeader" >开始时间</td>
              <td valign="middle" class="tableHeader" >结束时间</td>
              <td valign="middle" class="tableHeader" >到站新生人数</td>
              <td valign="middle" class="tableHeader" >陪同人员数</td>  
              <td valign="middle" class="tableHeader" >总人数</td>     
            </tr>
