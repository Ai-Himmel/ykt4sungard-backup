...
<script>
	function lookup(obj){
		...
		obj.action="../gzstufeeinfoAction.do?method=tuitionnotpaylist";
		if (selectedValue=="benke") {
			obj.action="../stufeeinfoAction.do?method=tuitionnotpaylist";
		}
		obj.submit();
	}
</script>
		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium">学费未缴纳本科生/高职生名单一览</font></strong>
				</td>
			</tr>
			<tr>
							...
							<tbody>
								...
								<tr align="center" valign="middle">
									<td width="15%" align="left" valign="middle" class="tableHeader2">
										<span class="medium">请选择未缴纳学费学生类别</span>
									</td>
