...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td align="right" valign="middle">
			<html:form method="post" action="DormitoryAdjustAction.do?method=alertHisSearch&getrole=2" onsubmit="javascript:return on_validate();">
  ...
  <tr> 
	...
	<%	
		...
		for(l1=0;l1<locationlist.size();l1++){
			...
			String area = (String)map1.get("dictParent");
	%>
...
function DoSort(col){
  ...
  document.adjustForm.action="DormitoryAdjustAction.do?method=alertHisSearch&getrole=2";
