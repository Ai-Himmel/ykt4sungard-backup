	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td align="center" valign="top">
				<html:form method="post" action="DormitorySearchAction.do?method=searchfdyDetail">
								...
								<logic:iterate name="dormitorys" id="dormitory" indexId="i">
									<pg:item>
										<tr align="center" valign=middle>
											...
											<c:if test="${i%2 == 0}">
												<td align="center" valign="middle" bgcolor="#FFFFFF">
													<bean:write name="dormitory" property="collegeName" />
													&nbsp;
												</td>
												<td align="center" valign="middle" bgcolor="#FFFFFF">
												...
												<td align="center" valign="middle" bgcolor="#FFFFFF">
													<bean:write name="dormitory" property="majorin" />
													&nbsp;
												</td>
												<td align="center" valign="middle" bgcolor="#FFFFFF">
													<bean:write name="dormitory" property="fromProvince" />
													&nbsp;
												</td>
												<td align="center" valign="middle" bgcolor="#FFFFFF">
