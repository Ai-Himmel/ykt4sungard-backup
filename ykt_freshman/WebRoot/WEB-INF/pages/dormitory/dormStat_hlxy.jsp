								...
								<pg:pager url="./DormitoryAction.do" items="<%=dormStatCount%>" index="center" maxPageItems="<%=dormStatCount+1%>" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
									...
									<c:if test="${dormStat.location!='ALLLOC'}">
										<tr align="center" valign="middle" bgcolor="#FFFFFF">
											...
											<td align="center" valign="middle">
												<a href='DormitoryAction.do?method=showRoomStat&getrole=2&Area=<bean:write name="dormStat" property="areaId"/>&Location=<bean:write name="dormStat" property="locationId"/>&Dorm=<bean:write name="dormStat" property="dormitoryId"/>&cw=<bean:write name="dormStat" property="totalNumber"/>&yzrs=<bean:write name="dormStat" property="studentInCount"/>&kxcw=<bean:write name="dormStat" property="nonCount"/>'><bean:write name="dormStat" property="dormitory" /></a>
											</td>
											<td align="center" valign="middle">
												<bean:write name="dormStat" property="totalNumber" />
