	...
	<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
				<td height="30" align="right" valign="middle">				
					<input name="goback" type="button" class="button_nor" value="<bean:message bundle="dormitorymanage"  key="dormStat.sure"/>" onclick="location.href='DormitoryAction.do?method=showDormStat&getrole=2'">
				</td>
			</tr>
	</table>
</body>
