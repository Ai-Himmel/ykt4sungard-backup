...
function onSearch(){
	...
	if((document.all.location.value=="")&&(document.all.dormitory.value=="")&&(document.all.roomNumber.value=="")){
		document.forms[0].action='DormitoryAdjustAction.do?method=searchPeopleAdjust';
		return true;
	}
	document.forms[0].action='DormitoryAdjustAction.do?method=searchPeopleAdjust';
	return true;		
	...
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td align="center" valign="top">
				<html:form action="DormitoryAdjustAction.do?method=savePeopleAlert">
					<tr>
						<td>
...
<script language="JavaScript">	 
	...
	if(request.getAttribute("unbindStudentList")!=null){	
		...
		for(k=0;k<unbindStudentList.size();k++){
			StudentWithAllInfo unbindStu= (StudentWithAllInfo)unbindStudentList.get(k);
