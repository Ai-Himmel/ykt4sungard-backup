...
function onSearch(){
	...
	if((document.all.locationB.value=="")&&(document.all.dormitoryB.value=="")&&(document.all.roomNumberB.value=="")){
		document.forms[0].action='DormitoryAdjustAction.do?method=searchfdyAdjust&getrole=2';
		return true;
	}
	document.forms[0].action='DormitoryAdjustAction.do?method=searchfdyAdjust&getrole=2';
	return true;		
...
function onSearch1(){	
	...
	if((document.all.locationA.value=="")&&(document.all.dormitoryA.value=="")&&(document.all.roomNumberA.value=="")){
		document.forms[0].action='DormitoryAdjustAction.do?method=searchfdyAdjust&getrole=2';
		return true;
	}
	document.forms[0].action='DormitoryAdjustAction.do?method=searchfdyAdjust&getrole=2';
	...
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium">本班宿舍间调整</font></strong>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" valign="top">
				<html:form action="DormitoryAdjustAction.do?method=savefdyAlert&&getrole=2">
					<tr>
						<td>
								...
								<table width=99% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
									<tbody>
										...
										<tr align="center" valign=middle>
											...
											<td align="left" valign="middle">
												<html:text property="roomNumberA" styleClass="input_box" style="width:120" />
											</td>
										</tr>
										<tr align="center" valign=middle>
								...
								<table width=99% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
									...
									<tr align="center" valign=middle>
										...
										<tr align="center" valign=middle>
											...
											<td align="left" valign="middle">
												<html:text property="roomNumberB" styleClass="input_box" style="width:120" />
											</td>
										</tr>
										<tr align="center" valign=middle>
											<td height="24" colspan="2" align="right" valign="middle" class="medium">
...
<script language="JavaScript">	
	...
	if(request.getAttribute("bindStudentListA")!=null){	
		...
		for(k=0;k<bindStudentListA.size();k++){
			...
			String district = bindStu.get("district").toString();									
			String dormitoryId = bindStu.get("dormitoryId").toString();
			String accomodation = bindStu.get("accomodation").toString();
	%>
		unbindStudents[<%=k%>]= new Array("<%=stuId%>","<%=stuNo%> <%=stuName%>[<%=gender%>][<%=district%>]","<%=gender%>","<%=accomodation%>","<%=dormitoryId%>");
