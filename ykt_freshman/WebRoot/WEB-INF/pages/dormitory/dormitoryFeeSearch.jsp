	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="30" align="center" valign="middle" class="tdborder02">
				<strong><font class="medium">学生住宿费查询</font></strong>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" valign="top">
				<html:form method="post" action="DormitorySearchAction.do?method=searchFeeDetail">
			...
			%>
						...
						<tbody>
							...
							<tr align="center" valign=middle>
								...
								<td align="left" valign="middle" class="tableHeader3">
									<html:select styleClass="select01" property="nation">
										<html:option value="">-----------------------</html:option>
										<html:options collection="nationList" property="dictValue" labelProperty="dictCaption" />
									</html:select>
								</td>
								<td width="10%" align="right" valign="middle" class="tableHeader2">
							...
							<pg:pager url="./DormitorySearchAction.do" items="<%=dormitoryCount%>" index="center" maxPageItems="100" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
								...
								<logic:iterate name="dormitorys" id="dormitorys" indexId="i">
									...
									<tr align="center" valign=middle>
										...
										<c:if test="${i%2 == 0}">	
										        <td align="center" valign="middle" bgcolor="#FFFFFF">
													<bean:write name="dormitorys" property="fee" />
													&nbsp;
												</td>	
												<td align="center" valign="middle" bgcolor="#FFFFFF">
