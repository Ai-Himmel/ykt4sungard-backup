...
function baocun(){
	if(document.all.name.value==""){
		...
		if(document.all.memo.value.length>180){
			...
			dormAppBillForm.action = "<c:url value="/dormAppBillAction.do"/>?method=saveGzdormappSingleInfo";
...
function dosearch2(){
	...
	dormAppBillForm.action="<c:url value="/dormAppBillAction.do"/>?method=getStudentInfoByEnterenceNo&enterenceNo="+enterenceNo+"&tag=1";
	dormAppBillForm.submit();
}
	 function my_onload(){	 	
    ...
    <table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=submenu1>
        <tbody>
          ...
          <tr align="center" valign=center>
            ...
            <html:text property="enterenceNo" styleClass="input_box" maxlength="20" readonly="true"/>
            </td>
            ...
            <input type="text" value="<%=((Map)request.getAttribute("gzStu")).get("stuNo") %>" Class="input_box" style="background:#ECE6E6" readonly="true"/>
            </td>
          </tr>
          ...
          <tr align="center" valign=center>
            ...
            <td align="left" valign="middle" class="tableHeader3" >
            <input type="text" value="<%=((Map)request.getAttribute("gzStu")).get("stuName") %>" Class="input_box" style="background:#ECE6E6" readonly="true"/>
            </td>
            <td width="17%" height="30" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font class="medium">性别</font></td>
            <td align="left" valign="middle" class="tableHeader3" >
            <input type="text" name="name" value="<%=((Map)request.getAttribute("gzStu")).get("gender") %>" class="input_box" style="background:#ECE6E6" readonly="true"/>
            </td>
          </tr>
          <tr align="center" valign=center>
            <td width="17%" height="30" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font class="medium">班级</font></td>
            <td align="left" valign="middle" class="tableHeader3" colspan="3">
            <input type="text" value="<%=((Map)request.getAttribute("gzStu")).get("className") %>" class="input_box" style="background:#ECE6E6" readonly="true"/>
            </td>
          </tr>
          </c:if>
          <c:if test="${gzStu==null}">
          <tr align="center" valign=center>
            ...
            <td width="17%" height="30" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font class="medium">性别</font></td>
            <td align="left" valign="middle" class="tableHeader3" >
            <input type="text" value="" class="input_box" style="background:#ECE6E6" readonly="true"/>
            </td>
          </tr>
          <tr align="center" valign=center>
            <td width="17%" height="30" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font class="medium">班级</font></td>
...
<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff id=submenu1><tbody>
          ...
          <tr align="center" valign=center>
            ...
            <td align="left" valign="middle" class="tableHeader3" >
            <html:text property="curAddress" styleClass="input_box" maxlength="60" size="80" style="width:580"/>&nbsp;&nbsp;&nbsp;<font color="red">例如:浦东新区德平路345弄68号301</font>
            </td>
          </tr>
          <tr align="center" valign=center>
