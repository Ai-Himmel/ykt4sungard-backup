...
public class FromprovinceDict extends baseDictonary {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(FromprovinceDict.class);
	...
	public String getKey() {
		return DictionaryContants.FROMPROVINCE;
	}
	...
	public boolean loadDiction(Map dict) {
		...
		try {
			_serial = dict;
			List list = baseDAO
					.findEntity("from Dictionary a where a.id.dictNo=10");
