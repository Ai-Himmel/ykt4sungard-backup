...
public class MajorinDict extends baseDictonary {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(MajorinDict.class);
	...
	public String getKey() {
		return DictionaryContants.MAJORIN;
	}
	...
	public boolean loadDiction(Map dict) {
		...
		try {
			_serial = dict;
			List list = baseDAO
					.findEntity("from Dictionary a where a.id.dictNo=11");
