...
public class NationalityDict extends baseDictonary {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(NationalityDict.class);
	...
	public String getKey() {
		return DictionaryContants.NATIONALITY;
	}
	...
	public boolean loadDiction(Map dict) {
		...
		try {
			_serial = dict;
			List list = baseDAO
					.findEntity("from Dictionary a where a.id.dictNo=12");
