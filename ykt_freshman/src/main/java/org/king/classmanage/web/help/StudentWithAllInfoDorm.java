...
public class StudentWithAllInfoDorm extends Studentmodel {
	...
	public StudentWithAllInfoDorm(String college, String classId, String assistant,String location,
			...
			String dormId,String area,String idType,String cultureMode,String studentChar,Integer checkornot,Integer schoolornot,String district) {
//        <!-- 证件类型 -->
