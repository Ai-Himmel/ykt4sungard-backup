...
/**
 * AbstractStudentSharedb generated by MyEclipse - Hibernate Tools
 */

public abstract class AbstractStudentSharedb extends org.king.framework.domain.BaseObject implements java.io.Serializable {
	...
	public boolean equals(Object object) {
		if (!(object instanceof AbstractStudentSharedb)) {
			return false;
		}
		AbstractStudentSharedb rhs = (AbstractStudentSharedb) object;
		return new EqualsBuilder().append(this.gender, rhs.gender).append(
				this.midSchName, rhs.midSchName).append(this.fromProvince,
				rhs.fromProvince).append(this.curGrade, rhs.curGrade).append(
				this.majorin, rhs.majorin).append(this.polityBg, rhs.polityBg)
				.append(this.nationality, rhs.nationality).append(
						this.enterenceNo, rhs.enterenceNo).append(
						this.midSchCode, rhs.midSchCode).append(
						this.department, rhs.department).append(this.examNo,
						rhs.examNo).append(this.homeTelephone,
						rhs.homeTelephone).append(this.idCard, rhs.idCard)
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(1518023535, -886691545).append(this.gender)
				.append(this.midSchName).append(this.fromProvince).append(
						this.curGrade).append(this.majorin).append(
						this.polityBg).append(this.nationality).append(
						this.enterenceNo).append(this.midSchCode).append(
						this.department).append(this.examNo).append(
						this.homeTelephone).append(this.idCard).append(
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				.append("gender", this.gender).append("midSchName",
						this.midSchName).append("fromProvince",
						this.fromProvince).append("curGrade", this.curGrade)
				.append("majorin", this.majorin).append("polityBg",
						this.polityBg).append("nationality", this.nationality)
				.append("enterenceNo", this.enterenceNo).append("midSchCode",
						this.midSchCode).append("department", this.department)
				.append("examNo", this.examNo).append("homeTelephone",
						this.homeTelephone).append("idCard", this.idCard)
				.append("stuName", this.stuName).append("studentNo",
						this.studentNo).append("nation", this.nation).append(
						"studentType", this.studentType).append("enrollYear",
						this.enrollYear).append("specIntrst", this.specIntrst)
