...
<ec:table items="result" 
		title='<%= shopName+GetProperty.getProperties("oneshopaccount.title",getServletContext())+dateRange%>' 
		filterable="false"
	...
	<ec:row highlightRow="true">
		...
		<ec:column property="mngamt"  headerStyle="text-align:center"
			...
			filterable="false" 
			sortable="false" 
			title='<%= GetProperty.getProperties("oneshopaccount.mngamt",getServletContext())%>' />
		<ec:column property="totalamt"  headerStyle="text-align:center"
			...
			filterable="false" 
			sortable="false" 
			title='<%= GetProperty.getProperties("oneshopaccount.totalamt",getServletContext())%>' />
	</ec:row>
...
<cewolf:combinedchart
	id="combinedChart"
	layout="vertical"
	title='<%= shopName+GetProperty.getProperties("oneshopaccount.title",getServletContext())%>'
	type="combinedxy"
	>
