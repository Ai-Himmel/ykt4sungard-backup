...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1000" height="600" valign="top">
	    <table width="1000" height="600" border="0" cellpadding="0" cellspacing="0">
		  <tr> 
		    <td width="197" height="100%" valign="top">
		    	<iframe name="subnavframe" height="100%" width="197" frameborder="0" src="<%= ContextUtil.getCtxPath(request)%><%= tilesSubnav%>"></iframe>
		    </td>
		    <td align="left" valign="top"> 
				<iframe name="dataframe" height="100%" width="800" frameborder="0" src="<%= ContextUtil.getCtxPath(request)%><%= tilesContent%>"></iframe> </td>
		  </tr>
		</table>
	</td>
  </tr>
