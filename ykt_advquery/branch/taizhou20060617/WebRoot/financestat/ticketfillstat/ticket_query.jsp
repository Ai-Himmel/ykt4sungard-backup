  ...
  <tr>
	...
	<tr>
	  <td align="right" nowrap="nowrap"><bean:message key="query.begindate" /></td>
		<td nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" />
		  <a href="#"><img
      ...
      <TR>
        <td align="right" nowrap="nowrap"><bean:message key="query.savingtype" /></td>
      ...
      <tr>
        ...
        <td width="25%" height="25" align="left" nowrap><select name="depno" style="width=155">
        			<OPTION>-</OPTION>
					<%
