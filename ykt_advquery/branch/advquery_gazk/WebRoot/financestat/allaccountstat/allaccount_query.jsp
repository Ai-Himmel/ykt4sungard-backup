...
<%String remark = configs.getString("allaccountcont"); %>
<%String querytype41="0";
		if (null!=session.getAttribute("querytype41")){
		querytype41 = session.getAttribute("querytype41").toString();
	}
	String queryType = ParamUtil.getString(request, "querytype", querytype41);%>
<%String beginDate41d = session.getAttribute("begindate41d").toString();%>
<%String endDate41d = session.getAttribute("enddate41d").toString();%>
<%String beginDate41m = session.getAttribute("begindate41m").toString();%>
<%String endDate41m = session.getAttribute("enddate41m").toString();%>
<%String beginDate41w = session.getAttribute("begindate41w").toString();%>
<%String endDate41w = session.getAttribute("enddate41w").toString();%>
<form action="<%= ContextUtil.getCtxPath(request)%>/financestat/allaccountstat/allaccountstat_queryresult.do"
	name=allaccountform method=post >
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate41d%>" /></td>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate41d%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate41m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.endmonth" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate41m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<table width="98%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td width="8%" nowrap="nowrap"><bean:message key="query.begindate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate41w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0"  id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.enddate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate41w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0"  id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<script>
	function setQueryType(typevalue) {
		...
		self.location = '<%= ContextUtil.getCtxPath(request)%>/financestat/allaccountstat/allaccount_query.jsp?querytype=' + typevalue;
	}
</script>
