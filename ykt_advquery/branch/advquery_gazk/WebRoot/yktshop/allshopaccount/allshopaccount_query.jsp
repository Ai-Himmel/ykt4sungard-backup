...
<%String remark = configs.getString("allshopaccountcont"); %>
<%String querytype33="0";
		if (null!=session.getAttribute("querytype33")){
		querytype33 = session.getAttribute("querytype33").toString();
	}
	String queryType = ParamUtil.getString(request, "querytype", querytype33);%>
<%String beginDate33d = session.getAttribute("begindate33d").toString();%>
<%String endDate33d = session.getAttribute("enddate33d").toString();%>
<%String beginDate33m = session.getAttribute("begindate33m").toString();%>
<%String endDate33m = session.getAttribute("enddate33m").toString();%>
<%String beginDate33w = session.getAttribute("begindate33w").toString();%>
<%String endDate33w = session.getAttribute("enddate33w").toString();%>
<form action="<%= ContextUtil.getCtxPath(request)%>/yktshop/allshopaccount/allshopaccountstat_queryresult.do"
	name=allshopaccountform method=post >
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate33d%>" /></td>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate33d%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate33m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.endmonth" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate"  readonly="readonly" value="<%=endDate33m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<table width="98%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td width="8%" nowrap="nowrap"><bean:message key="query.begindate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate33w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.enddate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate33w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<script>
	function setQueryType(typevalue) {
		document.allshopaccountform.querytype.value = typevalue;
		self.location = '<%= ContextUtil.getCtxPath(request)%>/yktshop/allshopaccount/allshopaccount_query.jsp?querytype=' + typevalue;
	}
</script>
