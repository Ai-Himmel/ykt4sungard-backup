...
<html:form action="/usermanage/add_result" method="POST">	
    ...
    <table width="100%"  align=center border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        ...
        <html:text property="userid" maxlength="40" style="width:200px" /></td>
      ...
      <tr>            
        ...
        <td width="60%" valign="baseline" class="text_or_12">
        <html:text property="username" style="width:200px" maxlength="20" /></td>
    ...
    <table width="100%"  align=center  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        ...
        <td width="60%" valign="baseline" class="text_or_12">
        <html:password property="password" style="width:200px" maxlength="30" /></td>
        <td width="29%" class="portlet-msg-error" align=left><html:errors
						property="password" />
    ...
    <table width="100%"  align=center  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        ...
        <td width="60%" valign="baseline" class="text_or_12">
        <html:password property="confirmpassword" style="width:200px" maxlength="30" /></td>
        <td width="29%" class="portlet-msg-error" align=left><html:errors
