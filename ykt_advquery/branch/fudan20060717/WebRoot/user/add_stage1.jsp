...
<html:form action="/usermanage/add_result" method="POST">	
    ...
    <table width="100%"  align=center border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        <td width="11%" align=right valign="baseline" class="text_or_12"><bean:message key="eadvquery.userid" />:&nbsp;
          </td>
      ...
      <tr>            
        <td width="11%" align=right valign="baseline" class="text_or_12"><bean:message key="eadvquery.username" />: &nbsp;
          </td>
        <td width="60%" valign="baseline" class="text_or_12">
    ...
    <table width="100%"  align=center  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        <td width="11%" align=right valign="baseline" class="text_or_12"><bean:message key="eadvquery.password" />: &nbsp;
          </td>
        <td width="60%" valign="baseline" class="text_or_12">
    ...
    <table width="100%"  align=center  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        <td width="11%" align=right valign="baseline" class="text_or_12"><bean:message key="eadvquery.confirmpassword" />: &nbsp;
          </td>
        <td width="60%" valign="baseline" class="text_or_12">
    ...
    <table width="100%"  align=center  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>            
        <td width="11%" align=right valign="baseline" class="text_or_12"><bean:message key="eadvquery.isshopowner" />: &nbsp;
          </td>
        <td width="60%" valign="baseline" class="text_or_12">
