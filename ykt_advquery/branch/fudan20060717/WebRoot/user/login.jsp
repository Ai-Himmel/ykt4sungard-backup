...
<table width="997" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="22%" align="right" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="80" align="right" valign="bottom"><img src="<%=ContextUtil.getCtxPath(request)%>/commons/images/xinxiban.gif" width="48" height="59"></td>
        </tr>
      	</table>
    </td>
    <td align="center" valign="middle"> 
      ...
      <p class="bottom"><bean:message key="system.copyright" /></p></td>
    <td width="18%">&nbsp; </td>
  </tr>
</table>
</body>
