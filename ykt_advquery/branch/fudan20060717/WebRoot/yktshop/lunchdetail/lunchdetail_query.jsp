...
<%String feetype = session.getAttribute("feetype")==null?"":session.getAttribute("feetype").toString();%>
<%
...
<table width="100%" border="0" align="center" cellpadding="0"
	cellspacing="0">
	<tr>
<form action="<%= ContextUtil.getCtxPath(request)%>/yktshop/lunchdetail/lunchdetail_queryresult.do"
	name=lunchdetailform method=post >
	<td>
	<input type=hidden name="querytype" value="0">
	<input type=hidden name=operCode value='<%= userName%>'>
	<input type="hidden" name="statType" value="bymonth" />
...
<script>
	function setQueryType(typevalue) {
		document.lunchdetailform.querytype.value = typevalue;
		self.location = '<%= ContextUtil.getCtxPath(request)%>/yktshop/lunchdetail/lunchdetail_query.jsp?querytype=' + typevalue;
	}
</script>
