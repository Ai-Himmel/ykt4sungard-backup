...
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME) values('6', '扩展需求');
...
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('3.7', '商户结算统计', '/shopreportcont.do');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('3.8', '就餐人员查询', '/lunchdetail.do');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('3.9', '就餐人员分析', '/lunchanalyse.do');
...
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.1', '图书馆总访问量统计', '#');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.2', '各图书馆访问量比例', '#');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.3', '体锻次数统计', '#');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.4', '光华楼门禁访问量统计', '#');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.5', '校车使用次数统计', '#');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.6', '机房访问次数统计', '#');