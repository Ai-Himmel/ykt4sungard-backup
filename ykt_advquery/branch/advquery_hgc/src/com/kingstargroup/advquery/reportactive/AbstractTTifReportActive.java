 ...
 * by MyEclipse Hibernate tool integration.
 */
public abstract class AbstractTTifReportActive 
    implements Serializable
{
    ...
    private TTifReportActiveKey id;
     ...
     */
    public AbstractTTifReportActive()
    {
    }
     ...
     * @param id
     */
    public AbstractTTifReportActive(TTifReportActiveKey id)
    {
        this.setId(id);
    }
     ...
     */
    public TTifReportActiveKey getId()
    {
        return this.id;
    }
     ...
     * @param id
     */
    public void setId(TTifReportActiveKey id)
    {
        this.hashValue = 0;
        this.id = id;
    }
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof TTifReportActive))
            return false;
        TTifReportActive that = (TTifReportActive) rhs;
