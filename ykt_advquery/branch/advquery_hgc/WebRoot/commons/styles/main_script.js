...
SS_ENV.OptionsDivStyle = ''
  ...
  + ' z-index:10;'
  + ' position:absolute;'
  + ' border:1px solid '+ SS_ENV.CR.Border+';'
...
function SS_createTitleDiv ()
{
  this.TitleDiv = SS_createElement(""
    ...
    + "    height="+this.height
    + "    bgcolor=#ffffff"
    + "    style='table-layout:fixed;padding:0 0 0 2; border:1 solid "+SS_ENV.CR.Border+";'"
    + "    onmouseover='SS_VAR.SelectList["+this.ssID+"].adjustOptionsDiv()'"
    + "  >"
    + "  <tr>"
    + "    <td style='padding-top:3;padding-left:5'><nobr style='text-oveflow:hidden;"+SS_ENV.OptionNobrStyle+"'></nobr></td>"
  ...
  this.TitleTable.cells(0).childNodes(0).innerText = this.options[this.selectedIndex].innerText;
  this.TitleTable.cells(1).innerHTML = "<img src='"+SS_ENV.ImgPrefix+"/sel_icon03.gif' border=0 align=absmiddle>";
  this.TitleTable.cells(2).innerHTML = "<img src='"+SS_ENV.ImgPrefix+"/sel_icon03.gif' border=0 align=absmiddle>";
...
function SS_createOptionsDiv ()
{
  this.OptionsDiv = SS_createElement(""
    ...
    + ">"
    + "  <table border=0 cellpadding=0 cellspacing=0 width=100% style='table-layout:fixed;padding:2 0 0 5;'>"
    + "  </table>"
    + "</div>"
  );
