...
<html>
  ...
  <body>
  <html:form  action="/registerQuery.do">
       ...
       <table width="94%" border="0" align="center" cellpadding="0"  cellspacing="0">
	      ...
	      <tr>
	       ...
	       <tr>
		      ...
		      <td nowrap="nowrap"><bean:message key="spec.feeType"/>
			     <html:select property="feeType" value="${register.feeType}" style="width:140px;"> 
			      <option value=""/></option>
	    ...
	    <table width="94%" border="0" align="center" cellpadding="0"  cellspacing="0">
	       <tr>
			  ...
			  <bean:message key="register.iscome" />
		       <html:select property="isCome" value="${register.isCome}" style="width:85px;">
		         <option value=""/></option>
		         <html:optionsCollection name="comeList" value="code"  label="name"/>
