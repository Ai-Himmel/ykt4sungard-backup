...
<%String querytype48="0";
		if (null!=session.getAttribute("querytype48")){
		querytype48 = session.getAttribute("querytype48").toString();
	}
	String queryType = ParamUtil.getString(request, "querytype", querytype48);%>
<%String beginDate48d = session.getAttribute("begindate48d").toString();%>
<%String endDate48d = session.getAttribute("enddate48d").toString();%>
<%String beginDate48m = session.getAttribute("begindate48m").toString();%>
<%String endDate48m = session.getAttribute("enddate48m").toString();%>
<%String beginDate48w = session.getAttribute("begindate48w").toString();%>
<%String endDate48w = session.getAttribute("enddate48w").toString();%>

<table width="100%" border="0" align="center" cellpadding="0"
	cellspacing="0">
	<tr>
<form action="<%= ContextUtil.getCtxPath(request)%>/finance/possaving/possaving_queryresult.do"
	name=possavingform method=post >
	<td>
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate48d%>" /></td>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate48d%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate48m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.endmonth" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate48m%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<table width="98%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td width="7%" nowrap="nowrap"><bean:message key="query.begindate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="begindate" readonly="readonly" value="<%=beginDate48w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_begindate" /></a></td>
				<td width="8%" nowrap="nowrap"><bean:message key="query.enddate" /></td>
				<td width="20%" nowrap="nowrap"><input type="text" name="enddate" readonly="readonly" value="<%=endDate48w%>" /></td>
				<td width="20%" nowrap="nowrap"><a href="#"><img
					src="<%= ContextUtil.getCtxPath(request)%>/commons/images/search.jpg" width="33" height="22"
					border="0" id="f_trigger_enddate" /></a></td>
					<script language="JavaScript">
...
<script>
	function setQueryType(typevalue) {
		document.possavingform.querytype.value = typevalue;
		self.location = '<%= ContextUtil.getCtxPath(request)%>/financestat/possaving/possaving_query.jsp?querytype=' + typevalue;
	}
</script>
