...
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('4.91', '消费信息统计分析', '/consumeanalyse.do');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('4.92', '认证信息统计分析', '/entranceanalyse.do');
insert into ykt_query.T_LEADQUERY_FUNCLIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('4.93', '消费信息查询', '/consumequery.do');
