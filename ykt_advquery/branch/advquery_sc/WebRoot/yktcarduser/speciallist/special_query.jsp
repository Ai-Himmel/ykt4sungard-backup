	...
	<tr>
		...
		<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td nowrap="nowrap">
				<input style="width=65" type="text" name="bavgRange" onkeypress="return checkNumber(event);" value="<%=bavgRange%>">
				-->
				<input style="width=65" type="text" name="eavgRange" onkeypress="return checkNumber(event);" value="<%=eavgRange%>">
				</td>
			</tr>
