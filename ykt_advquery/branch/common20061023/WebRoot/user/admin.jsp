    ...
    <td><table width="763" border="0" align="center" cellpadding="0" cellspacing="0" class="data">
        <tr>
          <td width="23" height="21" class="title"><input name="ids_allbox" type="checkbox"
			...
			></td>
          <td align=center width="448" class="title"><bean:message key="eadvquery.userid" /></td>
          <td align=center width="303" class="title"><bean:message key="eadvquery.username" /></td>
        </tr>
              <%java.util.Iterator it = UserUtil.listUsers().iterator();      				
					while(it.hasNext()) {
