...
<script language="javascript">
  location.href="http://ids.usst.edu.cn/amserver/UI/Login?goto=http://ecard.usst.edu.cn/advquery/usermanage/login.do&gotoOnFail=http://ids.usst.edu.cn/amserver/UI/Login";
</script>
<html>
<head>
