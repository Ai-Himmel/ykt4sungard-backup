              ...
              <tr> 
                <td height="32" align="left" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="18%">
                        <!-- < a href="<%= ContextUtil.getCtxPath(request)%>/usermanage/changepwd.do" target="dataframe" class="topmenu_link"><bean:message
							key="system.edidpwd" /></a> 
                        | <a href="<%= ContextUtil.getCtxPath(request)%>/usermanage/logout.do" target="_parent" class="topmenu_link"><bean:message key="system.unreg" /></a>
                        -->
