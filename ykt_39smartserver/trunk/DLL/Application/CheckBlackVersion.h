...
public:
	...
	long ProcessData(TSSmartDocEx *pDocEx,TSSmartTask * const pTask, TSCmdBuffer *pBuffer);
	long ProcessData1(TSSmartDocEx *pDocEx, TSSmartTask *pTask, TSCmdBuffer *pBuffer);
	long ProcessDataJSB(TSSmartDocEx *pDocEx, TSSmartTask *pTask, TSCmdBuffer *pBuffer);
	long ProcessDataTick(TSSmartDocEx *pDoc, TSSmartTask *pTask, TSCmdBuffer *pBuffer);
	long ProcessDataJSBTask(TSSmartDocEx *pDocEx, TSSmartTask *pTask, TSCmdBuffer *pBuffer);
