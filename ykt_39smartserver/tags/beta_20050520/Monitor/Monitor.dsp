...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"..\Bin\Monitor.exe" /libpath:"..\lib"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\Include" /I "..\Interface\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"..\Bin\Monitor.exe" /pdbtype:sept /libpath:"..\lib" /libpath:"..\Interface\lib"
...
SOURCE=.\res\enable2.ico
# End Source File
# Begin Source File

SOURCE=.\res\enable5.ico
# End Source File
# Begin Source File
