...
void TSmartRegister::ReadParameter()
{
	...
	m_nCollData_Tick=GetPrivateProfileInt("INTERFACE", "CollDATA_TICK", 10000, strServerINI);
	m_nNoTask_Tick=GetPrivateProfileInt("INTERFACE", "NOTASK_TICK", 5000, strServerINI);
}
