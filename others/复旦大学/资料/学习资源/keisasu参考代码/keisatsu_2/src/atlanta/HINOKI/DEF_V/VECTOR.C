...
void INT_ERI1(void);				/* RS232C割込み		*//* Add By O.Kimoto 1998/09/24 */
void INT_RXI1(void);				/* RS232C割込み		*//* Add By O.Kimoto 1998/09/24 */
void INT_TXI1(void);				/* RS232C割込み		*//* Add By O.Kimoto 1998/09/24 */
void INT_TEI1(void);				/* RS232C割込み		*//* Add By O.Kimoto 1998/09/24 */
...
const void(* const INT_VectorTableExtROM[])(void) = {
	...
	&INT_ERI1,		/* 132	内蔵周辺モジュール SCI1:ERI1		*//* Change INT_UNDEFINE to INT_ERI1 By O.Kimoto 1998/09/24 */
	&INT_RXI1,		/* 133	内蔵周辺モジュール SCI1:RXI1		*//* Change INT_UNDEFINE to INT_RXI1 By O.Kimoto 1998/09/24 */
	&INT_TXI1,		/* 134	内蔵周辺モジュール SCI1:TXI1		*//* Change INT_UNDEFINE to INT_TXI1 By O.Kimoto 1998/09/24 */
	&INT_TEI1,		/* 135	内蔵周辺モジュール SCI1:TEI1		*//* Change INT_UNDEFINE to INT_TEI1 By O.Kimoto 1998/09/24 */
