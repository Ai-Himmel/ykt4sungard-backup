...
/*2*/	0
		...
		,
/*3*/	0
/*	#if (PRO_COST == ENABLE)		Del By M.Tachibana 1995/04/26 */
		|	COST					/*	料金管理セット			*/
/*	#endif							Del By M.Tachibana 1995/04/26 */
/*	#if (PRO_BATCH_TX == ENABLE)	Del By M.Tachibana 1995/04/26 */
		|	BATCH_TX				/*	一括送信セット			*/
/*	#endif							Del By M.Tachibana 1995/04/26 */
		|	RCR						/*	受領証					*/
/*	#if (PRO_FAT_MEMORY == ENABLE)	Del By M.Tachibana 1995/04/26 */
		|	NONE_PAPER_RX			/*	代行受信				*/
/*	#endif							Del By M.Tachibana 1995/04/26 */
		|	REMOTE_RX				/*	転送受信				*/
...
/*4*/	0
		...
		,
/*5*/	0
		|	REMOTE_TAKEOUT			/*	リモートＦＡＸ取出し	*/	/* or not -> or By M.Tachibana 1995/04/26 */
		&	~BRANCH_RX				/*	ブランチ転送			*/	/* or -> and By M.Tachibana 1995/04/26 */
		&	~POCKET_BELL			/*	ポケベル呼出			*/	/* or -> and By M.Tachibana 1995/04/26 */
		&	~MONITOR_ON_TO_DIS		/*	DIS受信までモニタON		*/	/* or -> and not By M.Tachibana 1995/04/26 */
		|	NOT_USED				/*	未使用					*/
		|	NOT_USED				/*	未使用					*/
		|	NOT_USED				/*	未使用					*/
		|	NOT_USED				/*	未使用					*/
...
/*16*/	3							/*	親展受信保持期間の初期値*/
		,
/*17*/	0
		|	INIT_PHONE_TYPE_10PPS	/*	回線設定の初期値		*/
		|	INIT_WORDING_NUMBER_0	/*	ワーディングの初期値	*/
		|	WORDING_NUMBER_MAX_3 	/*	マルチワーディング数	*/	/* 2 -> 3 By M.Tachibana 1995/04/26 */
		|	NOT_USED				/*	未使用					*/
		|	NOT_USED				/*	未使用					*/
