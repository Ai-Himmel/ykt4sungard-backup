...
/*1*/	0
		...
		&	~BELL_COUNT				/*	ベル回数セット			*/	/* |→&  BY M.HARADA '95.07.04 */
		|	CONNECTING_2TEL			/*	子電話接続セット		*/
		|	REMOTE_DIAG				/*	リモート診断セット		*/
		&	~REDIAL_NUMBER			/*	再ダイヤル回数セット	*/	/* |→&  BY M.HARADA '95.07.04 */
		&	~REDIALINTERVAL			/*	再ダイヤル間隔セット	*/	/* |→&  BY M.HARADA '95.07.04 */
...
/*3*/	0
		...
		|	ANSFAX_READY			/*	留守/FAX待機			*/	/* ~  BY M.HARADA '95.07.04 */
#endif
		&	~HOLD_KEY_ENABLE		/*	保留キー				*/	/* |→&  BY M.HARADA '95.07.04 */
		,
/*4*/	0
