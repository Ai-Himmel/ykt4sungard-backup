...
/************************************************************************
	...
	author		:[野瀬敏弘]
************************************************************************/
void FLA_InitializeInternalDevice(void)
{
#if (0)
/*1998.12.22 K.Kawata*/
defined (SAKAKI)
...
/************************************************************************
	...
	author		:[川崎真史]
************************************************************************/
void FLA_INI_Start10msTimer(void)
{
	/*------------------------------------------------------------------*/
	/* ＴＣＲの設定             										*/
...
/************************************************************************
	...
	author		:[橘正樹]
************************************************************************/
void FLA_INI_Stop10msTimer(void)
{
...
/************************************************************************
	...
	author		:[野瀬敏弘]
************************************************************************/
void FLA_InitializeSystem(void)
{
...
#if defined(HINOKI)	/* HINOKI2 Debug....by O.Kimoto 2002/02/26 */
	/* G/A, ソフトリセット */
