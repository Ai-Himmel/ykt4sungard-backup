...
/*11*/	2							/*	リダイヤル回数最小値	*/
		,
/*12*/	15							/*	リダイヤル回数最大値	*/ /* 5->30->15 1997/10/09 Y.Matsukuma */
		,
/*13*/	3							/*	リダイヤル間隔最小値	*/
		,
/*14*/	5							/*	リダイヤル間隔最大値	*/
...
/*15*/
 ...
 #if (PRO_DIALUP_INTERNET_FAX == ENABLE)	/* 1998/05/26 by K.Okada ｲﾝﾀｰﾈｯﾄFAXのNCUはF-150ﾀｲﾌﾟを改良したもの */
		14									/* USAでF-150ﾀｲﾌﾟのNCUを使うことが無さそうなので、NCUﾀｲﾌﾟで条件を */
 #else										/* 切っていない */
		9							/* 	トーンアッテネータの初期値 */
 #endif
#endif
