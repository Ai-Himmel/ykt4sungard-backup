...
void InitializeInternalDevice(void)
{
	...
	*/
	...
	if (SYB_MaintenanceSwitch[MNT_SW_E6] & SENSOR_AD_DETECT) {	/* 1998/08/19 H.Yoshikwa */
	/*----------------------------------------------------------------*/
	...
	/*----------------------------------------------------------------*/
		...
		(*(UWORD *)0xffff8410) = 0x001b;
		(*(UWORD *)0xffff8412) = 0x0000;
		(*(UWORD *)0xffff8410) |= 0x0020;
  	}
...
#if defined (SAKAKI)	/* 高速SRAM(CS2)の３ウエイトにします テスト用 1998/09/16 H.Yoshikawa */
	switch (SYB_MaintenanceSwitch[MNT_SW_E7] & CS2_WAIT_ALL) {
	case CS2_WAIT_0:
		SH__WCR1 = (WCR1_CS3_3WAIT + WCR1_CS2_NO_WAIT + WCR1_CS1_2WAIT + WCR1_CS0_2WAIT);
		break;
	case CS2_WAIT_1:
		...
		break;
	case CS2_WAIT_2:
		SH__WCR1 = (WCR1_CS3_3WAIT + WCR1_CS2_2WAIT + WCR1_CS1_2WAIT + WCR1_CS0_2WAIT);
		break;
	case CS2_WAIT_3:
	default:
		SH__WCR1 = (WCR1_CS3_3WAIT + WCR1_CS2_3WAIT + WCR1_CS1_2WAIT + WCR1_CS0_2WAIT);
		break;
	}
#endif
