...
type
  TfaqhSmlTradeSerial = class(TfaqhSimpleQueryTemp)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  faqhSmlTradeSerial: TfaqhSmlTradeSerial;
...
procedure TfaqhSmlTradeSerial.Init;
begin
  inherited;
...
procedure TfaqhSmlTradeSerial.btnQueryClick(Sender: TObject);
begin
...
procedure TfaqhSmlTradeSerial.btnReadCardClick(Sender: TObject);
var
  cardNo:string;
begin
  edtCardNo.Text:='0';
...
initialization
  TUIStdClassFactory.Create('小钱包流水查询',TfaqhSmlTradeSerial);
