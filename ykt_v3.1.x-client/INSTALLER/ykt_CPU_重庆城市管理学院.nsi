...
;Configuration
  ...
  OutFile "exec/ykt_CPU_重庆城市管理${VER_BUILD}_${NOW}.exe"
  XPStyle on
...
Section "应用程序" SecClient
  ...
  ;特有的bpl	
	...
	File ..\bin\module\CPUWaterUI_cqcsgl.bpl
	File ..\bin\module\CPUCardUI_cqcsgl.bpl
	...
	SetOutPath "$INSTDIR\configs"
	SetOverwrite on
  	File ..\configs\menus_CPU_cqcsgl.mn
...
Section
	...
	WriteINIStr "..\configs\SetPara.ini" "menu" "menu" "menus_CPU_cqcsgl.mn"
	WriteINIStr "..\configs\SetPara.ini" "bj" "bjopen" "0"
	WriteINIStr "..\bin\kscard.ini" "INTERFACE" "LIBENC" "ks_enc_szroad.dll"
SectionEnd
