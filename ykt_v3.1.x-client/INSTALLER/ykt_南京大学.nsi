...
;Configuration
  ...
  !define SHORT_NAME "校园一卡通管理中心"
  !define PRO_VER_NUM "南京大学v3.1"
  ...
  !define COMPANY_SITE "http://www.sungard.com/china"
  ...
  OutFile "exec/ykt_南京大学${VER_BUILD}_${NOW}.exe"
  XPStyle on
...
Section "应用程序" SecClient
  ...
  ;特有的bpl	
	SetOutPath "$INSTDIR\bin\module"
	SetOverwrite on
	File ..\bin\module\CardLibraryUI.bpl
	File ..\bin\module\CardUI.bpl
	File ..\bin\module\publicCardUI.bpl
	File ..\bin\module\WaterTransUI.bpl
	File ..\bin\module\BusPosManageUI.bpl
	
	SetOutPath "$INSTDIR\bin"
	SetOverwrite on
	File ..\bin\KSClient50d.exe
	File ..\bin\SysFileMan50c.exe
	File ..\bin\cardmanager.exe
	SetOverwrite on
	File ..\bin\*.ini
	File ..\bin\*.conf
	File ..\bin\*.msg
...
Section
	...
	WriteINIStr "..\configs\SetPara.ini" "menu" "menu" "menus_njdx.mn"
	WriteINIStr "..\configs\SetPara.ini" "bj" "bjopen" "1"
	WriteINIStr "..\configs\SetPara.ini" "progupdate" "iftip" "0"
	WriteINIStr "..\configs\SetPara.ini" "progupdate" "httppath" "http://172.22.1.7:8080/smartcardweb/pages/images/version"
	WriteINIStr "..\configs\SmartCardClient.ini" "Packages" "24" ""
	Delete "$INSTDIR\bin\CPUCardUI.bpl"
SectionEnd
