...
;Configuration
  ...
  OutFile "exec/ykt_内蒙古财经${VER_BUILD}_${NOW}.exe"
  XPStyle on
...
Section "应用程序" SecClient
  ...
  ;特有的bpl	
	...
	File ..\bin\module\pubCardUI_nmg.bpl
	File ..\bin\module\WaterTransUI_nmg.bpl
...
Section
	...
	WriteINIStr "..\configs\SetPara.ini" "menu" "menu" "menus.mn"
