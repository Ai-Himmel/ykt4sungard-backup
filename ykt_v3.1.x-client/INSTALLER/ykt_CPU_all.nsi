...
;Configuration
  ...
  !define TRANS_NAME "IP地址转换"
  !define PRO_VER_NUM "cpu_v3.1"
  ...
  !define TRANS_FILE "SysFileMan50c.exe"
...
Section "应用程序" SecClient
  ...
  ;特有的bpl	
	...
	SetOverwrite on
	File ..\bin\module\CPUCardLibUI.bpl
	;File ..\bin\module\CPUCardUI.bpl
	File ..\bin\module\CPUWaterUI.bpl
	File ..\bin\module\CPUPubCardUI.bpl
...
Section -SecConf
  ...
  SetDetailsPrint listonly
	...
	CreateShortCut "$SMPROGRAMS\${MUI_PRODUCT}\${TRANS_NAME}.lnk" "$INSTDIR\bin\${TRANS_FILE}" "" "$INSTDIR\bin\${TRANS_FILE}"
...
Section
	...
	WriteINIStr "..\configs\SetPara.ini" "menu" "menu" "menus_CPU_all.mn"
