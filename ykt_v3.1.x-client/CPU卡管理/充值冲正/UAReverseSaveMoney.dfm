inherited faqhReverseSaveMoney: TfaqhReverseSaveMoney
  Width = 702
  Height = 489
  ...
  object WVRReserveSaveMoney: TWVRequest
    WorkView = WVReserveSaveMoney
    ID = '充值冲正'
    Bindings = <
      item
  ...
  object WVReserveSaveMoney: TWorkView
    WorkFields = <
      item
        Name = '返回信息'
        Caption = '返回信息'
