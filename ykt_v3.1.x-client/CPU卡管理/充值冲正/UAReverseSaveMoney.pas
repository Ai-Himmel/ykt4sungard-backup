...
begin
  ...
  try
    ...
    WVReserveSaveMoney.FieldByName('卡号').Data.SetInteger(StrToInt(cm.getCardNo));
    ...
    WVReserveSaveMoney.FieldByName('充值次数').Data.SetInteger(dptCnt);
    WVReserveSaveMoney.FieldByName('卡交易次数').Data.SetInteger(payCnt);
    ...
    tradeDate := WVReserveSaveMoney.fieldbyname('业务日期').Data.AsString;
    tradeTime := WVReserveSaveMoney.fieldbyname('业务时间').Data.AsString;
