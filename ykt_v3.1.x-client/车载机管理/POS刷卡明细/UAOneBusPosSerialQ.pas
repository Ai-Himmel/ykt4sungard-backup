...
type
  TfaqhOneBusPosSerialQ = class(TfaqhSimpleQueryTemp)
    Panel1: TPanel;
    Label2: TLabel;
    Label3: TLabel;
    WVEdit2: TWVEdit;
...
var
  faqhOneBusPosSerialQ: TfaqhOneBusPosSerialQ;
...
procedure TfaqhOneBusPosSerialQ.Init;
var
  sDate:string;
begin
  inherited;
...
procedure TfaqhOneBusPosSerialQ.btnQueryClick(Sender: TObject);
begin
...
initialization
  TUIStdClassFactory.Create('单POS刷卡流水',TfaqhOneBusPosSerialQ);
