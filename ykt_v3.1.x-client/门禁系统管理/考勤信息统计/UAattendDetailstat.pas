...
type
  TfaqhattendDetailstat = class(TfaqhSimpleQueryTemp)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  faqhattendDetailstat: TfaqhattendDetailstat;
...
procedure TfaqhattendDetailstat.Init;
var
  sDate:string;
begin
  inherited;
...
procedure TfaqhattendDetailstat.WorkViewFieldsMonitors0ValueChanged(
...
procedure TfaqhattendDetailstat.btnQueryClick(Sender: TObject);
begin
...
initialization
  TUIStdClassFactory.Create('考勤信息统计',TfaqhattendDetailstat);
