...
type
  TfaqhSetBusiStructInfo = class(TfaSMSetTreeParamsTemp)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Label10: TLabel;
...
var
  faqhSetBusiStructInfo: TfaqhSetBusiStructInfo;
...
procedure TfaqhSetBusiStructInfo.CreatebusinessTree;
begin
...
procedure TfaqhSetBusiStructInfo.Init;
begin
  inherited;
  treeSign := 0;
end;

procedure TfaqhSetBusiStructInfo.btnAddClick(Sender: TObject);
var
  endBusi:Integer;
begin
...
function TfaqhSetBusiStructInfo.SaveCheckBussiness:String;
begin
  Result:='';
...
procedure TfaqhSetBusiStructInfo.btnOKClick(Sender: TObject);
var
  TmpMsg:String;
begin
  {
...
procedure TfaqhSetBusiStructInfo.btnDeleteClick(Sender: TObject);
begin
...
procedure TfaqhSetBusiStructInfo.btnQueryClick(Sender: TObject);
var
  ss:string;
begin
...
procedure TfaqhSetBusiStructInfo.btnChangeClick(Sender: TObject);
begin
  if TreeView.Items.Count=0 then Exit;
  if TreeView.Selected = nil then
  begin
...
procedure TfaqhSetBusiStructInfo.btnCancelClick(Sender: TObject);
begin
  Inherited;
  WorkView.FieldByName('查询.商户标识').Data.SetInteger(0);
  WorkView.FieldByName('操作标志').Data.SetString('R');
...
procedure TfaqhSetBusiStructInfo.TreeViewDblClick(Sender: TObject);
begin
  btnChangeClick(btnChange);
end;

procedure TfaqhSetBusiStructInfo.TreeViewMouseDown(Sender: TObject;
...
procedure TfaqhSetBusiStructInfo.findTree(ss: string);
var
  i:Integer;
begin
  TreeView.SetFocus;
...
procedure TfaqhSetBusiStructInfo.GridCellClick(Column: TColumn);
var
  ss : string;
begin
  try
...
procedure TfaqhSetBusiStructInfo.cbbBusiTypeChange(Sender: TObject);
var
  busiType:string;
begin
...
procedure TfaqhSetBusiStructInfo.cbbCheckSelfChange(Sender: TObject);
var
  checkSelf:string;
begin
...
initialization
  TUIStdClassFactory.Create('商户组织结构设置',TfaqhSetBusiStructInfo);
