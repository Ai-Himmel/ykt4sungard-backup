...
uses
  ...
  Contnrs, {KSMenus} KSMenuAdmin, KSFrameWorks, ActnList,IniFiles,
  ...
  RzSplit, AAFont, AACtrls, jpeg,UtCardDll,CardDll;
...
{$ENDIF}
  ...
  try
    try
      ...
      bjopen := myfile.ReadInteger('bj','bjopen',-1);
      bjcomport := myfile.ReadInteger('bj','comport',-1);
