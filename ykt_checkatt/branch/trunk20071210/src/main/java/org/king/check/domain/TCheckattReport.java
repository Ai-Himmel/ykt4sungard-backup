...
/**
 * TCheckattReport entity.
 * 
 * @author MyEclipse Persistence Tools
 */
public class TCheckattReport extends AbstractTCheckattReport implements Comparable,
	...
	public int compareTo(Object object) {
		TCheckattReport myClass = (TCheckattReport) object;
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1362265819, 223044403).toHashCode();
	}
