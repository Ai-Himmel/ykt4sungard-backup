...
public class SecurityAction extends BaseAction {
	...
	public ActionForward login(ActionMapping mapping, ActionForm form,
        ...
        //统一身份判断
	    String curUser = SecurityAction.getUser(request);
		...
		if(curUser!=null &&!"".equals(curUser)){
			...
			account = accountService.findAccountByName(curUser);
		...
		//正常登陆流程
			...
			if(userName ==null || "".equals(userName) ||password==null ||"".equals(password)){
				errors.add("User login", new ActionMessage("errors.userpasswordisnull"));
