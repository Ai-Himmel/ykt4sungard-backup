...
public class DutyTimeServiceImpl implements DutyTimeService {
	...
	public Map searchForNewFormat(Map filter) throws Exception {
		...
		String title = "<td width='95' align='center'   bgcolor='#A8D1E6'>部门</td>  <td><table border='1'  cellpadding='1'"
			...
			if (!departList.isEmpty()) {
				...
				while (departIte.hasNext()) {
					...
					if (!clerkList.isEmpty()) {
						...
						String preDutyStrs = "<tr><td width='95' align='center' bgcolor='#A8D1E6' >"
						...
						while (clerkIte.hasNext()) {
							...
							dutyInfo += "<tr>";
							dutyInfo += "<td width='95' align='center'  class='tdHeader1'>" + clerkName + "</td>";

							if (token) {
								title += "<td width='95' align='center' class='tdHeader1' rowspan='2'>&nbsp;&nbsp;&nbsp;&nbsp;姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名&nbsp;&nbsp;&nbsp;&nbsp;</td>";
							}
