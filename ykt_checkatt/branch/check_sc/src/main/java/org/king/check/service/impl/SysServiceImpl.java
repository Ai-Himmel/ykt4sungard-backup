...
public class SysServiceImpl implements SysService {
	 ...
	 * 
	 */
	public  List getAllDate(String begDate,String endDate){
		if ((begDate==null)||("".endsWith(begDate))||(endDate==null)||("".endsWith(endDate))){
			return null;
		}else{
			List returnList = new ArrayList();
			Calendar c1 = Calendar.getInstance();
			
			c1.setTime(DateUtilExtend.getStrToDate3(begDate));
			Calendar c2 = Calendar.getInstance();
			c2.setTime(DateUtilExtend.getStrToDate3(endDate));
			
			while(c1.getTimeInMillis()<=c2.getTimeInMillis()){
				Map workTime =new  HashMap();
				workTime.put("date",DateUtilExtend.formatDateByFormat(c1.getTime(),"yyyyMMdd"));
	...
	public static void main(String[] args){
	     new SysServiceImpl().getAllDate("20091220","20100105");
	}
	...
	public void importReportToExcelFinance(String realPath,String deptId,String statDate,String endDate,List reportList,String operId) throws Exception{
		 HSSFWorkbook wb = new HSSFWorkbook();
			...
			HSSFCell cell1 = row1.createCell((short) (4));		 
		
		
		   
		    makeExcelTitleFinance(statDate,endDate,recordReport,style,deptId);
		   // makeExcelTitleNoToken(statMonth,recordReport,style,deptId,true);
		    ...
		    while (reportIter.hasNext()){
				...
				recordReport.setColumnWidth((short)(short)(4),(short)7000);
		    ...
		    //生成Excel制表信息
		    makeExcelBottomFinance(recordReport,operId,cellRow);
		    
		   
		    String loadFile = "";
		    if ("".equals(deptId)){
		    	loadFile = realPath+"/downloadfile/"+statDate+"--"+endDate+"checkRecordReport.xls";
		    	// loadFile = realPath+"\\downloadfile\\"+statDate+"--"+endDate+"checkRecordReport.xls";
		    }else{
		    	loadFile = realPath+"/downloadfile/"+deptId+statDate+"--"+endDate+"checkRecordReport.xls";
		    	//loadFile = realPath+"\\downloadfile\\"+deptId+statDate+"--"+endDate+"checkRecordReport.xls";
		    }
	 ...
	 * Excel表头设置
	 */
	private void makeExcelTitleFinance(String startDate,String endDate,HSSFSheet recordReport,HSSFCellStyle style,String deptId){
		recordReport.setColumnWidth((short)0,(short)7000);
		recordReport.setColumnWidth((short)1,(short)3800);
		recordReport.setColumnWidth((short)2,(short)3800);
		recordReport.setColumnWidth((short)3,(short)3800);
		...
		//设置表格宽度
		recordReport.setColumnWidth((short)4,(short)7000);	
	//	recordReport.setColumnWidth((short)(short)(5),(short)1200);
		
		//合并表格
		recordReport.addMergedRegion(new Region(0,(short)0,1,(short)0));
		recordReport.addMergedRegion(new Region(0,(short)1,1,(short)1));
		recordReport.addMergedRegion(new Region(0,(short)2,1,(short)2));
		recordReport.addMergedRegion(new Region(0,(short)3,1,(short)3));
		recordReport.addMergedRegion(new Region(0,(short)4,1,(short)(4)));
		/*recordReport.addMergedRegion(new Region(0,(short)(4),2,(short)0));
		recordReport.addMergedRegion(new Region(0,(short)(5),2,(short)0));
		recordReport.addMergedRegion(new Region(0,(short)(6),2,(short)0));
		recordReport.addMergedRegion(new Region(0,(short)(7),2,(short)0));
		recordReport.addMergedRegion(new Region(0,(short)(8),2,(short)0));*/
		...
		cell66.setCellType(HSSFCell.CELL_TYPE_STRING);
		cell66.setCellValue(new HSSFRichTextString(getDeptName(deptId)+startDate+"--"+endDate+"月份明细考勤记录"));
		cell66.setCellStyle(style);
		*/
		
		HSSFRow row77 = recordReport.createRow(0);
		HSSFCell cell77 = row77.createCell((short) (4));		 
		cell77.setCellValue(new HSSFRichTextString("有效考勤次数("+startDate+"至"+endDate+")"));
		cell77.setCellStyle(style);
		recordReport.createRow(1).createCell((short) (4)).setCellStyle(style);
		recordReport.createRow(2).createCell((short) (4)).setCellStyle(style);
	...
	private void makeExcelBottomFinance(HSSFSheet recordReport,String operId,int cellRow){
	...
	public void downLoadFileFinance(HttpServletRequest request, HttpServletResponse response)
		...
		String downLoadFileName = downDeptId+startDate+"--"+endDate+"checkRecordReport.xls";
