...
INSERT INTO YKT_CK.ICO_MENU (ID,PID,MENU_NAME,URL,TITLE,TARGET,ICON,ICONOPEN,OPENED,SORT_FLAG) VALUES 
    ('0001','00','用户管理','accountManager.do?method=searchAccount','','main','','',' ',30);
INSERT INTO YKT_CK.ICO_MENU (ID,PID,MENU_NAME,URL,TITLE,TARGET,ICON,ICONOPEN,OPENED,SORT_FLAG) VALUES 
...
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
	('1103','11','班次信息设置','checkType.do?method=search','','main',Null,Null,Null,2);
*/
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
...
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
	('1410','14','考勤流水维护','workInfo.do?method=goSetCardSerial','','main',Null,Null,Null,10);
...
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
	('1503','15','生成考勤报表(人事用) ','checkStatic.do?method=goMakeCheckReportFinance','','main',Null,Null,Null,5);
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
