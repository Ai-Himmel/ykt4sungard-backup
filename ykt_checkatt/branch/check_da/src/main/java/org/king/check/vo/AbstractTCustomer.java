...
public abstract class AbstractTCustomer  implements
	...
	private BigDecimal holdcardcnt;
	...
	/** minimal constructor */
	public AbstractTCustomer(BigDecimal custid) {
		this.custid = custid;
	}

	/** full constructor */
	public AbstractTCustomer(BigDecimal custid, String stuempno,
			BigDecimal custtype, BigDecimal feetype, String status,
			String custname, String areacode, String deptcode,
			...
			BigDecimal openflag, BigDecimal holdcardcnt, String useflag,
			String eaccflag, String lastsaved, String classname) {
		this.custid = custid;
	...
	public BigDecimal getHoldcardcnt() {
		return this.holdcardcnt;
	}

	public void setHoldcardcnt(BigDecimal holdcardcnt) {
		this.holdcardcnt = holdcardcnt;
	}
