...
public abstract class AbstractTCustomer  implements
	...
	/** minimal constructor */
	public AbstractTCustomer(Integer custid) {
		this.custid = custid;
	}
	public AbstractTCustomer(Integer custid , String stuempno) {
		this.custid = custid;
	...
	/** full constructor */
	public AbstractTCustomer(Integer custid, String stuempno,
			Integer custtype, Integer feetype, String status,
			...
			Integer openflag, Integer holdcardcnt, String useflag,
