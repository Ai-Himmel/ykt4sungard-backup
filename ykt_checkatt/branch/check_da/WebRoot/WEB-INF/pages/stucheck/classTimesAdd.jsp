...
<html:html>
	...
	<html:form  action="/classTimes.do?method=saveClasssTimes" method="post" >
				...
				<table width=100% border=1 align="center" cellpadding=1 cellspacing=0 bordercolor="#FFFFFF" id="submenu1">
					<tbody>
						...
						<tr>
							...
							<td width="78%" align="left"  bgcolor="#E7F1F5">
								<html:text property="classNum"  maxlength="10" /><html:errors property="classNum" />														
							</td>
