...
<html>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 考勤计划维护 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<jodd:form bean="request">
				<html:form action="coursePlan.do?method=courseplanSearch" method="post">
                    <table width="100%">
                        <tr>
                            <td width="25%">
                                &nbsp;院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系
		...
		<tr>
				<td height="40" align="left" valign="middle" class="tdborder02">
					...
					<input name="Submit" type="button" class="submitButton" value=" 删 除 " onclick="javascript:batch_del(document.forms.ec,'课程 计划','<c:url value="/coursePlan.do?method=deleCourseplan" />');">
				</td>
			</tr>
		</table>	
		<div id="lineDiv" class="hrLine">
		...
		<div id="tableDiv">
			<ec:table items="courseplanList" var="plan" sortable="false"  rowsDisplayed="50" retrieveRowsCallback="org.extremecomponents.table.callback.LimitCallback" filterRowsCallback="org.extremecomponents.table.callback.LimitCallback" sortRowsCallback="org.extremecomponents.table.callback.LimitCallback"
			    action="coursePlan.do?method=courseplanSearch" locale="zh_CN" filterable="false">
				...
				<ec:row>
				    <ec:column property="checkbox" title="选择" sortable="false" viewsAllowed="html" width="4%">
							<input type="checkbox" name="itemlist" value="${plan.Id}" style="border:0px" />
					</ec:column>
					<ec:column property="areaName"  title="校区" width="8%"/>
					<ec:column property="build" title="楼宇" width="7%"/>
					<ec:column property="roomName" title="教室" width="7%"/>
					<ec:column property="stuempNo" title="教师工号" width="7%" filterable="false" sortable="false"  escapeAutoFormat="true"/>
					<ec:column property="custName" title="教师姓名" width="7%"/>
					<ec:column property="courseName" title="课程名" width="8%"/>
                    <ec:column property="className" title="班级" width="16%"/>
					...
					<ec:column property="update" title="修改" width="5%" sortable="false" viewsAllowed="html">
						<a  href="javascript:updateCourseplan('coursePlan.do?method=updateCourseplan_step1&planId=${plan.Id}');">修改</a>
					</ec:column>
