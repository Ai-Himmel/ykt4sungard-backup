...
<html>
    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
        ...
        <div id="filterDiv" style="text-align: left;">
				<html:form action="classtermcheckreport.do?method=getClassOther" method="post" >
                    <table width="100%">
                        <tr>
                            <td width="30%">
                                &nbsp;学&nbsp;&nbsp;工&nbsp;&nbsp;号：
        ...
        <div id="tableDiv">
            <ec:table items="list" var="classdetail" rowsDisplayed="50" action="classtermcheckreport.do?method=getClassOther">
                <ec:exportXls fileName="class.xls" tooltip="导出 Excel" />
                <ec:row>
                    <ec:column property="courseName" title="课程" width="20%" />
                    <ec:column property="deptName" title="班级" width="34%" />
