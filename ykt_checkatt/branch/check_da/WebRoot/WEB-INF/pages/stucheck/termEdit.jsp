...
<html:html>
	...
	<body>
	<%  
	   String termId = request.getAttribute("termId").toString();
	
	 %>
	<html:form  action="/term.do?method=updateTerm" method="post" >
					...
					<tbody>
						<tr align="center" valign="center">
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
							    ...
							    <html:text property="termName" styleClass="input_box" maxlength="30" readonly="true" />
						...
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								...
								<html:text property="beginDate" readonly="true" styleClass="input_box" maxlength="10" onblur="count(addConf.add_permitLateTime)" />
						...
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<html:text property="endDate" readonly="true" styleClass="input_box" maxlength="10" onblur="count(addConf.add_permitLateTime)"/>
					...
					<script type="text/javascript">
	                   ...
	                   new calendar("endDate", "calEnd", "%Y%m%d");
						...
						<tr>
							...
							<td>
								&nbsp;&nbsp;
								<input name="Submit22" type="button" class="submitButton" value=" 确  定 " onclick="if(validate()==false) return false;forms[0].submit();">
