...
<script type="text/javascript">
    function refreshOperLimit(){
        var url = "refreshOperLimit.do?method=refreshOperLimit";
...
-->
<frameset framespacing="0" border="0" frameborder="0" rows="86,*,25" onload="refreshOperLimit();">
