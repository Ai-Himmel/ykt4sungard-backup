								...
								<logic:iterate name="accounts" id="account" indexId="i">
									<pg:item>
										<tr>
											...
											<td>
												<a href="accountManager.do?method=loadAccount4Edit&id=<bean:write  name="account" property="id" />&offset=<%= offset %>&opType=edit"> <bean:write name="account" property="custname" /> </a>
											</td>	
											<td>
