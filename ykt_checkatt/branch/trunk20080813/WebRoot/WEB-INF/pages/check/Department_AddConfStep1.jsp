				...
				<table class="border" width=100% cellSpacing=0 cellPadding=2 align="center">
					...
					<tr>
						...
						<td class="right">
							...
							<input class="input_box" maxlength=20 style="width:100" name="new_startDate" readonly="readonly" value="<c:out value='${beginDate}'/>">
							...
							&nbsp; 结束日期 &nbsp;
							<input name="new_endDate" class="input_box" maxlength=20 style="width:100" readonly="readonly" value="<c:out value='${endDate}'/>">
