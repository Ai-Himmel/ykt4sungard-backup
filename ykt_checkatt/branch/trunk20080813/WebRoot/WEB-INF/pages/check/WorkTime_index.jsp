...
<html>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="40" align="left" valign="middle" class="tdborder02">
					...
					&nbsp;&nbsp;
					<input name="Submit" type="button" class="submitButton" value=" 删 除 " onclick="javascript:batch_del(document.forms.ec,'工作时间','<c:url value="workTime.do?method=delete" />');">
	...
	alert('<%=msg%>');
	window.location.href="workTime.do?method=search";
	</script>
	<%}%>