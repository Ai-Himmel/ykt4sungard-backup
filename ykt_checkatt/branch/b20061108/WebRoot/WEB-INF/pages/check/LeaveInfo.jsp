		...
		<div id="filterDiv" style="text-align: left;">
			<jodd:form bean="request">
				<form action="leaveInfo.do?method=searchLeaveInfo" method="post" name="leave" onsubmit="return validate();">
					开始日期
					<input style="width:100" class="input_box" maxlength=20 name="leave_startDate" readonly="true" value="<%=request.getParameter("leave_startDate")==null?"":request.getParameter("leave_startDate")%>">
					...
					结束日期
					<input style="width:100" name="leave_endDate" class="input_box" maxlength=20 readonly="true" value="<%=request.getParameter("leave_endDate")==null?"":request.getParameter("leave_endDate")%>">
