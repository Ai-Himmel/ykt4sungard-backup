...
<div id="filterDiv" style="text-align: left;">
  <form name="irreRegister" action="irregularRest.do?method=searchClerk" method="post" >
...
<form name="register" action="irregularRest.do?method=searchClerk" method="post" >
	<div id="tableDiv">
         <ec:table items="clerkList" var="clerk" rowsDisplayed="5" action="irregularRest.do?method=searchClerk"  form="register">
...
<form name="putin" method="post" action='irregularRest.do?method=register'>
<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
		...
		<tr> <td>&nbsp;</td>
      <td height="40" align="right" valign="middle" class="tdborder02"> <input name="Submit" type="button" class="button_nor" value="确 定" onclick="if(check()==false) return false;registerirre(document.forms.register,'考勤人员','<c:url value="irregularRest.do?method=register" />',document.forms.putin);"> 
      </td>
    </tr>
          </tbody>
        </table>
