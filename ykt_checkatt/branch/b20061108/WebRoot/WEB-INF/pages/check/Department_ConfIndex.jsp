...
<html>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 部门排班信息 </font> </strong>
		</div>
		<tr>
			&nbsp;
		</tr>
		...
		<div id="filterDiv" style="text-align: left;">
			<form action="department.do?method=search" method="post" name="deptConf" onsubmit="return validate();">
				<jodd:form bean="request">
					...
					&nbsp;&nbsp;&nbsp;
					<input type="button" value="添加排班计划" onclick="window.location.href='department.do?method=addConfStep1';" />
				</jodd:form>
			</form>
		</div>
		<div id=lineDiv class="hrLine">
		...
		<div id="tableDiv">
			<ec:table items="dpConfList" var="dptconf" rowsDisplayed="15" action="department.do?method=search">
				...
				<ec:row>
					...
					<ec:column property="DEPT_NAME" title="部门" width="100" />
					...
					<a href="department.do?method=getDeptConfDetail&pre_deptId=${dptconf.DEPT_ID}&pre_beginDate=${dptconf.BEGINDATE}" >详细信息</a>
					</ec:column>
