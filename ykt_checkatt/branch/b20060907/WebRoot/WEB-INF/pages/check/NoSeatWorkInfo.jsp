...
<input class="input_box"  maxlength=20 name="startDate" readonly="true" value="<%=request.getParameter("startDate")==null?"":request.getParameter("startDate")%>">
&nbsp;
...
&nbsp;
<input name="endDate" class="input_box"  maxlength=20  readonly="true" value="<%=request.getParameter("endDate")==null?"":request.getParameter("endDate")%>">
