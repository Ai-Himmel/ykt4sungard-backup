...
<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
		  ...
		  <tr align="center" valign=center>
              ...
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >部门</td>
              <td align="left" valign="middle" class="tableHeader3" ><c:out value='${leaveinfo.department.name}' /></td>
			  <input type="hidden" name="new_leaveInfoId" value="<c:out value='${leaveinfo.leaveinfoid}' />"
            </tr>
            ...
            name="new_description" type="textarea1" class="textarea1"  maxlength=20 value="<c:out value='${new_description}' />"></td>
