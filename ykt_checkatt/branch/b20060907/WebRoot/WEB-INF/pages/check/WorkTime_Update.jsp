...
<table width=100% border=1 align=center 
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
			...
			<input type="hidden" value='<c:out value="${workTimeComf.worktimeconfid}" />' name="add_worktimeconfid"/>
			  ...
			  <input 
            name="add_confName" class="input_box"  maxlength=20 value='<c:out value="${workTimeComf.confname}" />' ><font color=#ff0000>*</font></td>
			</tr>
			...
			<tr>
			  ...
			  <%=(String)request.getAttribute("add_ondutytime"+num+"_hour")==null?"请选择":(String)request.getAttribute("add_ondutytime"+num+"_hour")%>
			  </option>
			  <% for(int i=0;i<24;i++) {%>
		 ...
		 <%=(String)request.getAttribute("add_ondutytime"+num+"_min")==null?"请选择":(String)request.getAttribute("add_ondutytime"+num+"_min")%>
			  </option>
			  <% for(int i=1;i<60;i++) {%>
			  <option value='<%=i<10?"0"+Integer.toString(i):Integer.toString(i)%>'><%=i<10?"0"+Integer.toString(i):Integer.toString(i)%></option>
			  <%}%>
            ...
            <tr>
			 ...
			 <%=(String)request.getAttribute("add_offdutytime"+num+"_hour")==null?"请选择":(String)request.getAttribute("add_offdutytime"+num+"_hour")%>
			  </option>
			  <% for(int i=0;i<24;i++) {%>
			  <option value='<%=i<10?"0"+Integer.toString(i):Integer.toString(i)%>'><%=i<10?"0"+Integer.toString(i):Integer.toString(i)%></option>
			  <%}%>
			  ...
			  <%=(String)request.getAttribute("add_offdutytime"+num+"_min")==null?"请选择":(String)request.getAttribute("add_offdutytime"+num+"_min")%></option>
			  <% for(int i=1;i<60;i++) {%>
			  <option value='<%=i<10?"0"+Integer.toString(i):Integer.toString(i)%>'><%=i<10?"0"+Integer.toString(i):Integer.toString(i)%></option>
			  <%}%>
			  </select>分
