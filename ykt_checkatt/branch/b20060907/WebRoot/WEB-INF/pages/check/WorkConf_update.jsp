      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
			...
			<input type="hidden" name="add_workConfId" value="<c:out value='${workConf.workconfid}' />"/>
			  ...
			  <input 
            name="add_confName" class="input_box"  maxlength=20 value="<c:out value='${workConf.confname}' />"><font color=#ff0000>*</font></td>
			</tr>
			<tr>
            ...
            name="add_permitLateTime" class="input_box"  maxlength=5 onblur="count(addConf.add_permitLateTime)" value="<c:out value='${workConf.permitlatetime}' />"><font color=#ff0000>*</font>分钟</td>
            </tr>
            <tr>
              <td width="22%" align="center" valign="middle" bgcolor="#D1DAE9" >
			  <span class="medium STYLE5">
			...
			onblur="count(addConf.add_permitEarly)"
			value="<c:out value='${workConf.preearly}' />"
			...
			value="<c:out value='${workConf.ondutyad}' />"
			...
			value="<c:out value='${workConf.offdutyovertime}' />"
