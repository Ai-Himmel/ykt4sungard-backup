...
<tr> 
      <td height="40" align="left" valign="middle" class="tdborder02"> <input name="Submit" type="button" class="button_nor" value="添加" onclick="window.location.href='workConf.do?method=addWorkConf_step1';" > &nbsp; <input name="Submit" type="button" class="button_nor" value="查看全部" onclick="window.location.href='workConf.do?method=search';"> 
      </td>
    </tr>
<div id=lineDiv class="hrLine">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<div id="tableDiv" style="display :<c:out value='${show}' default='none'/>">
			<ec:table items="workConfList" var="workConf" rowsDisplayed="5" action="workConf.do?method=search">
				...
				<ec:column property="checkbox" title="选择" sortable="false" viewsAllowed="html" width="30" style="text-align: center">
					...
					<ec:column property="confname" title="考勤参数名称" width="80" />
					<ec:column property="permitlatetime" title="允许迟到" width="60" />
					<ec:column property="preearly" title="允许早退" width="80" />
					<ec:column property="ondutyad" title="上班提前打卡不超过" width="120" />
					<ec:column property="offdutyovertime" title="下班滞后打卡不超过" width="120" />
