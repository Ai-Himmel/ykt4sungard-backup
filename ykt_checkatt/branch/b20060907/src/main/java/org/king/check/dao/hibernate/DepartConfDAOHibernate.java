...
public class DepartConfDAOHibernate implements DepartConfDAO{
    ...
    private static final Log log = LogFactory.getLog(DepartConfDAOHibernate.class);
    ...
    public List find(String query) {
	  ...
	  public Departconf get(Serializable id) {
				...
				return (Departconf)baseDAO.getEntity(Departconf.class,id);
	  }
	
	  public List getAll() {
	      log.debug("getting DepartConf all");
	      String allHql = "from DepartConf";
