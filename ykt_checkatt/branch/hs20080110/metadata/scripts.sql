...
insert into YKT_CK.ICO_MENU(ID, PID, MENU_NAME, URL, TITLE, TARGET, ICON, ICONOPEN, OPENED, SORT_FLAG)values
	...
	('1409','14','请假审批取消','leaveReportCheck.do?method=goleaveReportCheckCancelQuery','','main',Null,Null,Null,7),
	('1407','14','生成考勤信息','workInfo.do?method=goCreateWorkInfo','','main',Null,Null,Null,8),
	...
	('1504','15','个人考勤信息查询','personalCheckDetail.do?method=goOnesCheckDetail','','main',Null,Null,Null,4),
	('1505','15','个人出勤情况报表 ','checkStatic.do?method=goPersonCheckStatic','','main',Null,Null,Null,8),
