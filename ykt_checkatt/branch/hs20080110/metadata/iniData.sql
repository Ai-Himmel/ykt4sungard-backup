...
insert into YKT_CUR.T_PIF_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) values(1200,'1','考勤类别','教职工');
insert into YKT_CUR.T_PIF_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) values(1200,'2','考勤类别','专职教师');
insert into YKT_CUR.T_PIF_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) values(1200,'3','考勤类别','职工');
insert into YKT_CUR.T_PIF_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) values(1200,'4','考勤类别','其他');
...
insert into ykt_ck.department(dept_id,dept_name,dept_parentid) values('0','上海海事大学',null)
