...
<html>
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 计时考勤明细表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<html:form action="checkInfo.do?method=viewClockCheckInfoDetail" method="post">
		...
		<div id="tableDiv">
			<ec:table items="result" var="checkInfo" rowsDisplayed="50" action="checkInfo.do?method=viewClockCheckInfoDetail">
				...
				<ec:row>
					...
					<ec:column property="CHECKINTIME" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="进入时间" width="10%" />
					<ec:column property="CHECKOUTTIME" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="离开时间" width="10%" />
					<ec:column property="DURATION" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="持续时间" width="10%" cell="org.king.check.util.DurationCell"/>
					<ec:column property="CHECKDATE" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="考勤日期" width="10%" />
