...
<html>
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 非计时考勤明细表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<html:form action="checkInfo.do?method=viewCheckInfoDetail" method="post">
		...
		<div id="tableDiv">
			<ec:table items="result" var="checkInfo" rowsDisplayed="50" action="checkInfo.do?method=viewCheckInfoDetail">
