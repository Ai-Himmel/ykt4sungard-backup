...
<html>
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 非计时考勤汇总表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<html:form action="checkInfo.do?method=viewCheckInfoTotal" method="post">
		...
		<div id="tableDiv">
			<ec:table items="result" var="checkInfo" rowsDisplayed="50" action="checkInfo.do?method=viewCheckInfoTotal">
				...
				<ec:row>
					...
					<ec:column property="DELAYNUM" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="进入次数" width="10%" />
					<ec:column property="EARLYNUM" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="离开次数" width="10%" />
