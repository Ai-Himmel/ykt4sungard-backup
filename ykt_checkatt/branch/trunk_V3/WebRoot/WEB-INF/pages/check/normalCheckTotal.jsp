...
<html>
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 考勤汇总表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<html:form action="checkInfo.do?method=viewCheckTotal" method="post">
		...
		<div id="tableDiv">
			<ec:table items="result" var="checkInfo" rowsDisplayed="50" action="checkInfo.do?method=viewCheckTotal">
