...
<html>
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 计时考勤汇总表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<html:form action="checkInfo.do?method=viewClockCheckInfoTotal" method="post">
		...
		<div id="tableDiv">
			<ec:table items="result" var="checkInfo" rowsDisplayed="50" action="checkInfo.do?method=viewClockCheckInfoTotal">
				...
				<ec:row>
					...
					<ec:column property="CHECKNUM" headerStyle="text-align:left" style="text-align:left" filterable="false" 
						sortable="true" title="考勤次数" width="10%" />
