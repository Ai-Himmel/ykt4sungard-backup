...
function validate()
{
	...
	<body>
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 坐班考勤明细报表查询 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<form action="checkStatic.do?method=getCheckDetail" method="post" name="noSeat" onsubmit="return validate();">
				<jodd:form bean="request">
					...
					&nbsp;&nbsp;
                       学工号:&nbsp;
					<input class="text" type="text" name="dutyInfo_stuNo" size="20" style="width:80">
					&nbsp;&nbsp;
					开始日期
		...
		<div id="tableDiv">
			<ec:table items="checkDetail" var="clerk" rowsDisplayed="15" action="checkStatic.do?method=getCheckDetail">
