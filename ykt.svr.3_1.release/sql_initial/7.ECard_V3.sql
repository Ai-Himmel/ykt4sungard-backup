...
insert into YKT_PORTAL.Account_ (accountId, companyId, userId, userName, createDate, modifiedDate, parentAccountId, name, legalName, legalId, legalType, sicCode, tickerSymbol, industry, type_, size_) values (7, 1, 5, '', sysdate, sysdate, 0, '一卡通综合信息平台', 'Sungard, Inc.', '', '', '', '', '', '', '');
...
begin
  sys.dbms_job.submit(job => :job,
                      what => 'YKT_PORTAL.ANALYSIZE_SPECIALSTU_STATDATA;',
