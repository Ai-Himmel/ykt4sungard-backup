--初始化数据库脚本--
--delete from YKT_CUR.T_DICTIONARY where dict_no=78 or dict_no=79 or dict_no=80 
--or dict_no=83;
--与会人员性质--
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(78,'1','与会人员性质','出席');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(78,'2','与会人员性质','列席');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(78,'3','与会人员性质','特邀');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(78,'4','与会人员性质','其它');

--会议状态数据字典--
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(80,'0','会议状态','正常');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(80,'1','会议状态','修改');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(80,'9','会议状态','取消');

--签到状态数据字典--
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'00','签到标志','未签到');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'11','签到标志','持卡签到');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'12','签到标志','无卡签到');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'13','签到标志','代替签到');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'21','签到标志','持卡签到（迟到）');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'22','签到标志','无卡签到（迟到）');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'23','签到标志','代替签到（迟到）');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(79,'30','签到标志','请假');

--同步数据字典--
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(83,'dbname','数据库配置','ykt');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(83,'ip','数据库配置','10.108.0.222');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(83,'port','数据库配置','50002');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(83,'pwd','数据库配置','db2inst4');
--INSERT INTO YKT_CUR.T_DICTIONARY(DICT_NO, DICT_VALUE, DICT_NAME, DICT_CAPTION) VALUES(83,'username','数据库配置','db2inst4');
...
insert into ykt_conf.T_FUNC_LIST(FUNC_CODE, FUNC_NAME, FUNC_URL) values('6.2','与会人员情况统计','/anal/totalnewquery.do');
commit;