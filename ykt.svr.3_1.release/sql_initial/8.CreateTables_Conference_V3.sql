...
grant create any index to YKT_CONF;
grant create any table to YKT_CONF;
grant create any view to YKT_CONF;
grant drop any table to YKT_CONF;
grant drop any trigger to YKT_CONF;
grant drop any view to YKT_CONF;

GRANT CONNECT TO YKT_CONF;
...
-- Create sequence 
create sequence YKT_CONF.HIBERNATE_SEQUENCE
minvalue 1
