...
/* Created on:     2011-01-18 14:34:06                          */
/*==============================================================*/
...
COMMENT ON COLUMN YKT_CUR.T_ACCOUNT.TERMID IS
'交易终端号';

COMMENT ON COLUMN YKT_CUR.T_ACCOUNT.TRANSTIME IS
'交易时间';
...
/* Index: IDX_CARDNO                                            */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_CARDNO ON YKT_CUR.T_ACCOUNT (
   CARDNO ASC
);
...
COMMENT ON COLUMN YKT_CUR.T_BANK.USEFLAG IS
'是否启用';

COMMENT ON COLUMN YKT_CUR.T_BANK.CHKACCLAG IS
'是否对账';
...
COMMENT ON COLUMN YKT_CUR.T_BANK.CHKTYPE IS
'一卡通核对项';

COMMENT ON COLUMN YKT_CUR.T_BANK.CHKBEGINDATE IS
'对账开始日期';

COMMENT ON COLUMN YKT_CUR.T_BANK.LASTCHKDATE IS
'上次对账日期';

COMMENT ON COLUMN YKT_CUR.T_BANK.CHKBEGINTIME IS
'对账开始时间';

COMMENT ON COLUMN YKT_CUR.T_BANK.CVTEXECFILE IS
'转换执行文件';

COMMENT ON COLUMN YKT_CUR.T_BANK.CHKEXECFILE IS
'对账执行文件';

COMMENT ON COLUMN YKT_CUR.T_BANK.AUTORESOLVE IS
'对账不符自动处理';
comment on column YKT_CUR.t_bank.GETBANKFILE  is '1:主动获取银行对账文件';
...
CREATE TABLE    YKT_CUR.T_BANKCHKBILL
    (
        ...
        BANKCARDNO VARCHAR2(30) NOT NULL,
        BANKSN VARCHAR2(30) NOT NULL,
        CARDNO INTEGER NOT NULL,
        LOCALSN VARCHAR2(30),
        TRANSCODE INTEGER,
        SUMMARY VARCHAR2(60),
...
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.TRANSDATE
IS
    '交易日期';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.BANKCARDNO
IS
    '银行卡号';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.BANKSN
IS
    '银行端流水号';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.CARDNO
IS
    '交易卡号';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.LOCALSN
IS
    '本地流水号';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.TRANSCODE
IS
    '交易码';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.SUMMARY
IS
    '摘要';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.BANKAMT
IS
    '银行端交易金额';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.LOCALAMT
IS
    '本地交易金额';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.DIFFAMT
IS
    '差额';
COMMENT ON COLUMN YKT_CUR.T_BANKCHKBILL.CHKFLAG
IS
    '0-未补帐1-已补帐';

CREATE TABLE    YKT_CUR.T_BANKCHKDATE
    (
        CHKDATE VARCHAR2(8) NOT NULL,
        CHKFLAG NUMBER(1),
        CONSTRAINT PK_T_BANKCHKDATE PRIMARY KEY (CHKDATE)
    );
COMMENT ON COLUMN T_BANKCHKDATE.CHKDATE
IS
    '交易日期';
COMMENT ON COLUMN T_BANKCHKDATE.CHKFLAG
IS
    '核对标志';
...
COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.STUEMPNO IS
'学工号';
...
COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.CHKFLAG IS
'对账标志';
...
CREATE TABLE YKT_CUR.T_BUSDTL  (
   ...
   ERRCODE              INTEGER,
   ERRMSG               VARCHAR(240),
   CONSTRAINT PK_T_BUSDTL PRIMARY KEY (TRANSDATE, DEVPHYID, DEVSEQNO)
)
PCTFREE 10
INITRANS 1
STORAGE
...
COMMENT ON COLUMN YKT_CUR.T_BUSDTL.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.TRANSTIME IS
'交易时间';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.DEVPHYID IS
'设备物理ID';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.DEVSEQNO IS
'设备流水号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CARDNO IS
'交易卡号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CARDCNT IS
'卡交易次数';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CARDBEFBAL IS
'交易前卡余额';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.AMOUNT IS
'发生额-包含管理费';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CARDAFTBAL IS
'交易后卡余额';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.TRANSMARK IS
'交易标记';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.DATATYPE IS
'数据类型';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.SHOPID IS
'商户号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.STUEMPNO IS
'学号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CUSTID IS
'客户号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.CUSTNAME IS
'客户姓名';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.DEPTCODE IS
'部门代码';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.FEETYPE IS
'收费类别';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.BATCHNO IS
'导入批次号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.COLDATE IS
'采集日期';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.COLTIME IS
'采集时间';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.ACCDATE IS
'记账日期';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.ACCTIME IS
'记账时间';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.TERMID IS
'终端号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.TERMSEQNO IS
'终端流水号';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.STATUS IS
'状态';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.ERRCODE IS
'错误码';

COMMENT ON COLUMN YKT_CUR.T_BUSDTL.ERRMSG IS
'错误信息';

/*==============================================================*/
/* Index: IDX_BUSDTL_STATUS                                     */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_BUSDTL_STATUS ON YKT_CUR.T_BUSDTL (
   STATUS ASC
);
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_BUSDTL_SHOPID ON YKT_CUR.T_BUSDTL (
   SHOPID ASC
);
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_BUSDTL_CUSTID ON YKT_CUR.T_BUSDTL (
   CUSTID ASC
);
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_BUSDTL_STUEMPNO ON YKT_CUR.T_BUSDTL (
   STUEMPNO ASC
);
...
/* Table: T_BUSFEETYPE                                          */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_BUSFEETYPE  (
   BUSFEETYPE           INTEGER                         NOT NULL,
   BUSFEENAME           VARCHAR(60)                     NOT NULL,
   CONSTRAINT PK_T_BUSFEETYPE PRIMARY KEY (BUSFEETYPE)
)
PCTFREE 10
INITRANS 1
STORAGE
...
COMMENT ON COLUMN YKT_CUR.T_BUSFEETYPE.BUSFEETYPE IS
'收费类别';

COMMENT ON COLUMN YKT_CUR.T_BUSFEETYPE.BUSFEENAME IS
'收费名称';
...
/* Table: T_CFGSHOPPAY                                          */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_CFGSHOPPAY  (
   SHOPID               INTEGER                         NOT NULL,
   FEETYPE              INTEGER                         NOT NULL,
   FLAG                 INTEGER,
   PAYAMT               NUMBER(15,2),
   CONSTRAINT PK_T_CFGSHOPPAY PRIMARY KEY (SHOPID, FEETYPE)
)
PCTFREE 10
INITRANS 1
STORAGE
...
COMMENT ON COLUMN YKT_CUR.T_CFGSHOPPAY.SHOPID IS
'商户号';

COMMENT ON COLUMN YKT_CUR.T_CFGSHOPPAY.FEETYPE IS
'收费类别';

COMMENT ON COLUMN YKT_CUR.T_CFGSHOPPAY.FLAG IS
'标志';

COMMENT ON COLUMN YKT_CUR.T_CFGSHOPPAY.PAYAMT IS
'扣费金额';
...
'资金类型 1-现金2-支票3-经费本4-个人帐户存款5-银行存款';
...
CREATE TABLE YKT_CUR.T_CUSTOMERTMP  (
   ...
   INDATE               VARCHAR(8),
   OUTDATE              VARCHAR(8),
   UPDFLAG              NUMBER(1)                      DEFAULT 0 NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_DPSOPER.BATCHNO IS
'充值批次号';

COMMENT ON COLUMN YKT_CUR.T_DPSOPER.AUTHCODE IS
'授权码';

COMMENT ON COLUMN YKT_CUR.T_DPSOPER.DEVPHYID IS
'设备物理ID';
...
/* Table: T_DPSOPERCARD                                         */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_DPSOPERCARD  (
   OPERCODE             VARCHAR(8)                      NOT NULL,
   CARDNO               INTEGER                         NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_DPSOPERCARD.OPERCODE IS
'操作员号';

COMMENT ON COLUMN YKT_CUR.T_DPSOPERCARD.CARDNO IS
'卡号';

COMMENT ON COLUMN YKT_CUR.T_DPSOPERCARD.DISABLEFLAG IS
'0-正常1-禁用';

COMMENT ON COLUMN YKT_CUR.T_DPSOPERCARD.OPENOPER IS
'绑定操作员';

COMMENT ON COLUMN YKT_CUR.T_DPSOPERCARD.LASTSAVED IS
'最后保存时间';
...
'备注';
COMMENT ON COLUMN YKT_CUR.T_FEETYPE.BOARDFEERATE IS
...
COMMENT ON COLUMN YKT_CUR.T_REFNO.REQREFNO IS
'请求方参考号';
...
COMMENT ON COLUMN YKT_CUR.T_RPTSHOPRAKEOFF.PERSONCNT IS
'人次';
...
CREATE TABLE YKT_CUR.T_RPTTERMLEDGER  (
   ...
   DRAMT                NUMBER(15,2)                    NOT NULL,
   CRAMT                NUMBER(15,2)                    NOT NULL,
   CONSTRAINT PK_T_RPTTERMLEDGER PRIMARY KEY (ACCDATE, TERMID, SUBJNO, ACCNO, TRANSTYPE, SUMMARY)
)
TABLESPACE TS_YKT_CUR;
...
/*==============================================================*/
CREATE TABLE YKT_CUR.T_STATCUSTTRANS  (
   SETTLEDATE           NUMBER(8)                       NOT NULL,
   CUSTID               INTEGER                         NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_STATCUSTTRANS.SETTLEDATE IS
'结算日期';

COMMENT ON COLUMN YKT_CUR.T_STATCUSTTRANS.CUSTID IS
'客户号';

COMMENT ON COLUMN YKT_CUR.T_STATCUSTTRANS.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_STATCUSTTRANS.TRANSCNT IS
'刷卡次数';

COMMENT ON COLUMN YKT_CUR.T_STATCUSTTRANS.TRANSAMT IS
'刷卡金额';

/*==============================================================*/
/* Index: IDX_STATCUSTTRANS_TRANSDATE                           */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_STATCUSTTRANS_TRANSDATE ON YKT_CUR.T_STATCUSTTRANS (
   TRANSDATE ASC
);
...
/*==============================================================*/
CREATE TABLE YKT_CUR.T_STATTERMTIME  (
   SETTLEDATE           NUMBER(8)                       NOT NULL,
   TERMID               INTEGER                         NOT NULL,
   TRANSDATE            NUMBER(8)                       NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.SETTLEDATE IS
'结算日期';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.TERMID IS
'终端编号';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.TIMEID IS
'时间ID';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.FEECNT IS
'收费次数';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.FREECNT IS
'记次次数';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.TOTALCNT IS
'总次数';

COMMENT ON COLUMN YKT_CUR.T_STATTERMTIME.TOTALAMT IS
'总金额';
...
COMMENT ON COLUMN YKT_CUR.T_SUBSIDY.SUBSIDYMODE IS
'补助模式';
...
COMMENT ON COLUMN YKT_CUR.T_SUBSIDY.CHECKFLAG IS
'审核标志';
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_SUBSIDY_STATUS ON YKT_CUR.T_SUBSIDY (
   STATUS ASC
);
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_TRANSDTL_TRANSCODE ON YKT_CUR.T_TRANSDTL (
   TRANSCODE ASC
);

/*==============================================================*/
/* Index: IDX_TRANSDTL_TRANSDATE                                */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_TRANSDTL_TRANSDATE ON YKT_CUR.T_TRANSDTL (
   TRANSDATE ASC
);
...
/* Table: T_TRANSPACK                                           */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_TRANSPACK  (
   PACKETID             VARCHAR(20)                     NOT NULL,
   REQID                VARCHAR(20)                     NOT NULL,
   REQSNO               INTEGER                         NOT NULL,
   FUNCNO               INTEGER,
   TRANSDATE            VARCHAR(8)                      NOT NULL,
   TRANSTIME            VARCHAR(6)                      NOT NULL,
   ...
   TERMID               INTEGER,
   TERMSEQNO            INTEGER,
   LASTUPDTIME          VARCHAR(30)                     NOT NULL,
   CONSTRAINT PK_T_TRANSPACK PRIMARY KEY (PACKETID, REQID)
)
PCTFREE 10
INITRANS 1
STORAGE
...
COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.PACKETID IS
'请求包ID:请求方发送的日期时间（YYYYMMDDHHMMSS）+（请求方流水号后3位）';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.REQID IS
'请求方ID:POS机使用设备物理ID，操作员使用操作员代码';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.REQSNO IS
'请求流水号:POS机就使用POS的流水号';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.FUNCNO IS
'功能号';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.TRANSDATE IS
'主机日期';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.TRANSTIME IS
'主机时间';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.REVFLAG IS
'冲正标志:0表示正常记录1表示冲正记录';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.RETRYCNT IS
'重试次数';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.STATUS IS
'处理状态:N未处理S成功R否决F失败D过期C撤销B退票V拒绝';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.ERRCODE IS
'错误码';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.ERRMSG IS
'错误消息';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.DATALEN IS
'请求包长度';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.REQDATA IS
'请求数据包';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.ACCDATE IS
'记账日期';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.TERMID IS
'终端号';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.TERMSEQNO IS
'终端流水号';

COMMENT ON COLUMN YKT_CUR.T_TRANSPACK.LASTUPDTIME IS
'最后更新时间';

/*==============================================================*/
/* Index: IDX_TRANSPACK_STATUS                                  */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_TRANSPACK_STATUS ON YKT_CUR.T_TRANSPACK (
   STATUS ASC
);
...
/* Table: T_WATERFEECFG                                         */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_WATERFEECFG  (
...
COMMENT ON COLUMN YKT_CUR.T_WATERFEECFG.FEEID IS
'费率ID';

COMMENT ON COLUMN YKT_CUR.T_WATERFEECFG.FEENAME IS
'费率名称';

COMMENT ON COLUMN YKT_CUR.T_WATERFEECFG.PURSENO IS
'钱包号';

COMMENT ON COLUMN YKT_CUR.T_WATERFEECFG.FEEMODE IS
'费率模式';

COMMENT ON COLUMN YKT_CUR.T_WATERFEECFG.FEETYPECNT IS
'卡权限类别数量';

/*==============================================================*/
/* Table: T_WATERFEETYPE                                        */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_WATERFEETYPE  (
   FEEID                INTEGER                         NOT NULL,
   FEETYPE              INTEGER                         NOT NULL,
   FEECNT               INTEGER,
   STARTTIME1           INTEGER,
...
COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEEID IS
'费率ID';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEETYPE IS
'收费类别';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEECNT IS
'费率数量';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.STARTTIME1 IS
'计费开始时间1';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEETIME1 IS
'计费时间1';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEEAMT1 IS
'计费金额1';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.STARTTIME2 IS
'计费开始时间2';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEETIME2 IS
'计费时间2';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEEAMT2 IS
'计费金额2';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.STARTTIME3 IS
'计费开始时间3';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEETIME3 IS
'计费时间3';

COMMENT ON COLUMN YKT_CUR.T_WATERFEETYPE.FEEAMT3 IS
'计费金额3';
...
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.ECARD_ID
IS
    '一卡通充值流水号';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.REQUEST_TIME
IS
    '充值请求发起的时间 YYYY-MM-DD HH:mm:ss';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.ECARD_NUM
IS
    '一卡通号码';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.USERNAME
IS
    '被充值用户id';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.FULLNAME
IS
    '被充值用户真实姓名';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.AMOUNT
IS
    '充值金额，单位：元';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.ECARD_MACHINE_ID
IS
    '充值设备终端编号';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.ECARD_IP
IS
    '一卡通服务器IP地址';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.INPAYAMOUNT_ID
IS
    '充值记录号';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.REPLY_TIME
IS
    '返回时间 YYYY-MM-DD HH:mm:ss';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.ACK_TIME
IS
    '确认时间 YYYY-MM-DD HH:mm:ss';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.STATUS
IS
    '状态（1 请求充值,2 充值成功,3充值失败  4 请求数据不完整 5 对账补充值成功 6 对账补充值失败 7 对账成功）';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.UPDATE_TIME
IS
    '最后更新时间';
COMMENT ON COLUMN YKT_CUR.T_THIRDPAY_JJLINK.CHECK_NUM
IS
    '对账次数';
    
-- 20110520 新开普的卡定义中缺少的字段存于此表，模拟卡上数据，以支持现有业务流程
CREATE TABLE YKT_CUR.T_NEWCAPEC_CARD
(
...
-- 圈存写卡失败分析结果表
create table YKT_CUR.t_err_writecard (
ACCDATE varchar2(8), 
ACCTIME varchar2(6), 
TERMID integer, 
TERMSEQNO integer, 
...
-- 短信通知队列表
CREATE TABLE YKT_CUR.T_MSGLISTMOBILE
    (
        MSGID NUMBER NOT NULL,  
        MOBILENO CHAR(11),
        REQURL VARCHAR2(1000),
        CONTENT VARCHAR2(1000),
        STATUS NUMBER,
		CONSTRAINT PK_T_MSGLISTMOBILE_MSGID PRIMARY KEY (MSGID)
    );
	
comment on table YKT_CUR.T_MSGLISTMOBILE is '短信通知消息队列表';	
COMMENT ON COLUMN YKT_CUR.T_MSGLISTMOBILE.MSGID IS '消息ID';
COMMENT ON COLUMN YKT_CUR.T_MSGLISTMOBILE.MOBILENO IS '手机号';
COMMENT ON COLUMN YKT_CUR.T_MSGLISTMOBILE.REQURL IS '短信发送请求URL';
COMMENT ON COLUMN YKT_CUR.T_MSGLISTMOBILE.CONTENT IS '短信内容';
COMMENT ON COLUMN YKT_CUR.T_MSGLISTMOBILE.STATUS IS '发送状态，1表示待发送，2表示发送失败,9表示发送成功';
