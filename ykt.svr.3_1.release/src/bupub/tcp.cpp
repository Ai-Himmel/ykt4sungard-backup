...
int CTcpSocket::GetLastError(char *szMsgBuf, int MsgBLen) {
    ...
    if (MsgBLen>0 && szMsgBuf!=NULL) {
        ...
        case 5  :
            ...
            break;
        case 6  :
            sprintf(msg,"%d:No such device or addr",errcode);
            break;
        case 7  :
        ...
        case 57 :
            ...
            break;
        case 58 :
            sprintf(msg,"errno=%d:Destination addr required",errcode);
            break;
        case 59 :
        ...
        case 67 :
            ...
            break;
        case 68 :
            sprintf(msg,"errno=%d:Can't assign requested addr",errcode);
            break;
            /* operational errors */
        case 69 :
