...
int F930003(TRUSERID *handle,int iRequest,ST_PACK *in_pack,int *pRetCode,char *szMsg) {
    int ret = 0;
    int cnt=0;
    int msgid=0;
    char sCardState[5]="";
    ...
    AddXmlItemStr(tMsgList.reqdata, XML_KEY_NOTVALIDITY, in_pack->sserial1);
