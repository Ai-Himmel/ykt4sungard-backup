...
#define SYSPARA_SUBSIDYAUDIT        18      //下发补助是否需要审核,0-不要；1-需要
...
#define SYSPARA_SUBSIDYMODE         24      //下发补助模式,0-下发到卡账户1-下发到待领补助
...
#define SYSPARA_MAXCHARGEFEE        28      //单笔充值最大金额
#define SYSPARA_WATERMAXAMT         30      //水控消费最大金额
#define SYSPARA_LOCKDEVNO           31      //后付费锁卡时记录终端号类型
#define SYSPARA_EPAY_OVERDRAFT      201     //电子钱包是否允许透支
#define SYSPARA_CARDBITMAP_USED     202     //是否判断卡位图入账


#define SYSPARA_RSA_2100      2100     //rsa.cpp使用，不知道含义
#define SYSPARA_RSA_2101      2101     //rsa.cpp使用，不知道含义
#define SYSPARA_RSA_2102      2102     //rsa.cpp使用，不知道含义
