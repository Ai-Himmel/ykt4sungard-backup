...
int DB_t_bankcarddtl_read_by_refno(char *v_refno,T_t_bankcarddtl *pt_bankcarddtl);
int DB_t_bankcarddtl_update_by_refno(char *v_refno,T_t_bankcarddtl *pt_bankcarddtl);
int DB_t_bankcarddtl_del_by_refno(char *v_refno);
int DB_t_bankcarddtl_read_lock_by_c0_and_refno(char *v_refno,T_t_bankcarddtl *pt_bankcarddtl);
