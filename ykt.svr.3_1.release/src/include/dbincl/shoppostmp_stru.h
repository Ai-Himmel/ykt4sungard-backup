...
int DB_t_shoppostmp_read_by_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_shoppostmp *pt_shoppostmp);
int DB_t_shoppostmp_update_by_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_shoppostmp *pt_shoppostmp);
int DB_t_shoppostmp_del_by_batchno(char *v_batchno);
int DB_t_shoppostmp_del_by_batchno_and_seqno(char *v_batchno,int v_seqno);
int DB_t_shoppostmp_read_lock_by_c0_and_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_shoppostmp *pt_shoppostmp);
int DB_t_shoppostmp_update_lock_by_c0(T_t_shoppostmp *pt_shoppostmp);
int DB_t_shoppostmp_free_lock_by_c0();
int DB_t_shoppostmp_open_select_by_c1_and_batchno(char *v_batchno);
