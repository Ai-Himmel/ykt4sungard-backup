...
int DB_t_paypara_read_by_paycode_and_paraname(int v_paycode,char *v_paraname,T_t_paypara *pt_paypara);
int DB_t_paypara_update_by_paycode_and_paraname(int v_paycode,char *v_paraname,T_t_paypara *pt_paypara);
int DB_t_paypara_del_by_paycode_and_paraname(int v_paycode,char *v_paraname);
...
int DB_t_paypara_open_select_by_c2_and_paraname(char *v_paraname);
