...
int DB_t_moduleauth_read_by_modulecode(char *v_modulecode,T_t_moduleauth *pt_moduleauth);
int DB_t_moduleauth_update_by_modulecode(char *v_modulecode,T_t_moduleauth *pt_moduleauth);
int DB_t_moduleauth_del_by_modulecode(char *v_modulecode);
int DB_t_moduleauth_read_lock_by_c0_and_modulecode(char *v_modulecode,T_t_moduleauth *pt_moduleauth);
