...
int DB_t_shopcard_read_by_shopid_and_status(int v_shopid,char *v_status,T_t_shopcard *pt_shopcard);
int DB_t_shopcard_read_by_cardphyid_and_status(char *v_cardphyid,char *v_status,T_t_shopcard *pt_shopcard);
