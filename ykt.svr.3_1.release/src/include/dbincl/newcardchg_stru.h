...
int DB_t_newcardchange_read_by_stuempno(char *v_stuempno,T_t_newcardchange *pt_newcardchange);
int DB_t_newcardchange_read_by_showcardno(char *v_showcardno,T_t_newcardchange *pt_newcardchange);
int DB_t_newcardchange_update_by_showcardno(char *v_showcardno,T_t_newcardchange *pt_newcardchange);
int DB_t_newcardchange_del_by_showcardno(char *v_showcardno);
int DB_t_newcardchange_del_by_batchno(char *v_batchno);
int DB_t_newcardchange_read_lock_by_c0_and_stuempno(char *v_stuempno,T_t_newcardchange *pt_newcardchange);
int DB_t_newcardchange_update_lock_by_c0(T_t_newcardchange *pt_newcardchange);
int DB_t_newcardchange_free_lock_by_c0();
int DB_t_newcardchange_read_lock_by_c1_and_showcardno(char *v_showcardno,T_t_newcardchange *pt_newcardchange);
