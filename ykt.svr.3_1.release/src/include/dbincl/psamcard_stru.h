...
int DB_t_psamcard_read_by_termno(char *v_termno,T_t_psamcard *pt_psamcard);
...
int DB_t_psamcard_read_lock_by_c1_and_termno(char *v_termno,T_t_psamcard *pt_psamcard);
