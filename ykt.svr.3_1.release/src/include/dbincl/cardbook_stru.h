...
int DB_t_cardbook_read_by_showcardno(char *v_showcardno,T_t_cardbook *pt_cardbook);
int DB_t_cardbook_update_by_showcardno(char *v_showcardno,T_t_cardbook *pt_cardbook);
int DB_t_cardbook_del_by_showcardno(char *v_showcardno);
int DB_t_cardbook_read_lock_by_c0_and_showcardno(char *v_showcardno,T_t_cardbook *pt_cardbook);
