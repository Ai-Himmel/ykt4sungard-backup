...
int DB_t_dpsoper_read_by_opercode(const char *v_opercode,T_t_dpsoper *pt_dpsoper);
int DB_t_dpsoper_update_by_opercode(char *v_opercode,T_t_dpsoper *pt_dpsoper);
int DB_t_dpsoper_del_by_opercode(const char *v_opercode);
int DB_t_dpsoper_read_lock_by_c0_and_opercode(const char *v_opercode,T_t_dpsoper *pt_dpsoper);
