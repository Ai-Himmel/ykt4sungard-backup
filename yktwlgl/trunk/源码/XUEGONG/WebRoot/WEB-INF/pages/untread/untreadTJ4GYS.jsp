...
function DoExport(){
   untreadTJSearchForm.action="<c:url value="/lf/untreadTJAction.do"/>?method=tj4Gys&doexl=1";
   untreadTJSearchForm.submit();
}
function DHTJ(){
    untreadTJSearchForm.action = "<c:url value="/lf/untreadTJAction.do"/>?method=tj4Gys";
	untreadTJSearchForm.submit();
}
function DoView(gysid,dlid,xlid,wlid){
		untreadTJSearchForm.action="equipmentAction.do?method=loadList4TJ&dlid="+dlid+"&xlid="+xlid+"&wlid="+wlid+"&gysid="+gysid;
    	untreadTJSearchForm.submit();
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" style="padding-left:10px">
							...
							<td height="25" align="left" valign="top">
									<table width="150" height="20" border="0" cellpadding="0" cellspacing="0">
										<tr><td width="10" bgcolor="#0066CA">&nbsp;</td>
											<td bgcolor="#0066CA" class="mediumwhite">按供应商统计</td>
        ...
        <tr align="center" valign="center">
          ...
          <td width="20%" class="tableHeader3" >
				 ...
				 <html:options collection="wllist" labelProperty="wlmc" property="id" />
										...
										<tr align="center" valign=center>
										    <td align="left" valign="middle" class="tableHeader2" >供应商</td>
      ...
      cellpadding=1 cellspacing=0 bordercolor=#3F738B bordercolordark=#ffffff id=maintable>
          <tbody>
            <tr align="center" valign=center>
            <td valign="middle" class="tableHeader" >供应厂商</td>
            ...
            <tr align="center" valign="middle" bgcolor="#F6F4F5">
              ...
              <a href="javascript:DoView('<bean:write name="tj" property="gysid" />','<bean:write name="tj" property="dlid" />','<bean:write name="tj" property="xlid" />','<bean:write name="tj" property="wlid"/>')"><bean:write name="tj" property="untreadNum" /></a>&nbsp;
              </td>
              <%if(request.getAttribute("ifLimit").equals("0")){%>
