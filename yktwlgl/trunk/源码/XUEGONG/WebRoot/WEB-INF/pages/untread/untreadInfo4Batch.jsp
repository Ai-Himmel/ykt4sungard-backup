...
function msg(message)
{
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		...
		<%
String[] cc=null;
 cc=(String[])request.getAttribute("untreadIdList");
for (int i=0;i<cc.length;i++){ 
	String dd=cc[i];
%>
<input type="hidden" name="untreadIds" value="<%=dd%>">
<%} %>
									...
									<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
										<tbody>												
											...
											<tr align="center" valign=center>
												<td height="26" valign="middle" class="tableHeader2" style="width:15%">
													经办人
												</td>
												<td align="left" valign="middle" class="tableHeader3" style="width:35%">
