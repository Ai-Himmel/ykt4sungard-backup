...
function back(){
    untreadBillForm.action = "<c:url value="/lf/untreadAction.do"/>?method=loadUntread4RegSearch";
	untreadBillForm.submit();
}
function doCheckForm(elements)
{
	...
	for(var i=0;i< len ;i++ )
	{
		...
		if(field.name=='untreadSource'){
				    if(field.value.length>200)
				    {
						msg(field.title+"请将退货原因的输入长度限制在200个字符以内！！");
						field.select();
						return false;
				    }
		}
		if(field.name=='memo'){
				    ...
				    {
						msg(field.title+"请将备注的输入长度限制在500个字符以内！！");
						field.select();
						return false;
				    }
		}
								...
								<td height="40" align="center" valign="top">
									<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
										<tbody>												
											...
											<tr>
												<td align="left" valign="middle"  class="tableHeader2" style="width:15%">登记人</td>
												<td align="left" valign="middle"  class="tableHeader3" style="width:35%"><bean:write name="untreadBillForm" property="rcdPName"/><html:hidden name="untreadBillForm" property="rcdUName"/>	</td>
												<td align="left" valign="middle"  class="tableHeader2" style="width:15%">登记日期</td>
												<td align="left" valign="middle"  class="tableHeader3" style="width:35%"><bean:write name="untreadBillForm" property="rcdDate"/><html:hidden name="untreadBillForm" property="rcdDate"/>	</td>
											</tr>
											<tr align="center" valign=center>
												<td align="left" valign="middle"  class="tableHeader2">
													<font color="red" style="font-weight:normal">*&nbsp;</font>经办人
												</td>
												<td align="left" valign="middle"  class="tableHeader3">
												<%
			                                         String userId=(String)session.getAttribute(org.king.web.util.Constants.LOGIN_NAME); %>
													<html:select property="rtnUName" styleClass="select01">
														<html:option value="<%=userId %>"><bean:write name="untreadBillForm" property="rcdPName"/></html:option>
												...
												<td align="left" valign="middle"  class="tableHeader3">
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td>
																<html:text property="untreadDate" styleClass="input_box" maxlength="50" readonly="true" />
															</td>
															<td width="25" align="right">
																<img id="untreadDate1" src="<c:url value="/pages/components/calendar/skins/aqua/cal.gif"/>" border="0"
																	alt="退货日期" style="cursor:pointer">
															</td>
														</tr>
													</table>
													<script type="text/javascript">
                										new calendar("untreadDate", "untreadDate1", "%Y-%m-%d");               
           											</script>
												</td>
											</tr>
											<tr align="center" valign=center>
												...
												<td width="87%" align="left" valign="middle"  class="tableHeader3" colspan=3>
													<html:textarea property="untreadSource" styleClass="" rows="3" cols="80" />
												</td>
											...
											<tr align="center" valign=center>
												...
												<td width="87%" align="left" valign="middle" class="tableHeader3" colspan=3>
													<html:textarea property="memo" styleClass="" rows="3" cols="100" />
												</td>
											</tr>
										</html:form>
										</tbody>
