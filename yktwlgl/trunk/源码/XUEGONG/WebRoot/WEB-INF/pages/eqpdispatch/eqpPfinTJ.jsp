...
<html>
	...
	<body leftmargin="0" topmargin="0">
		<br>
		<html:form action="/gyf/eqpdispatchAction.do?method=tongji4EqpPfin" method="post">

			<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td align="left" valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<input type="hidden" name="thisAction" value="<c:url value="/gyf/eqpdispatchAction.do"/>?method=tongji4EqpPfin">
							<tr>
											...
											<tbody>
												...
												<logic:iterate name="tongjilist" id="tl" type="java.util.Map" indexId="i">
													<tr align="center" valign="middle" <%if(j%2!=0){%> bgcolor="#FFFFFF" <%}else{%> bgcolor="#F6F4F5" <%}%>>
														...
														<td align="center" valign="middle">
															<a
																href="javascript:DoView('1','<bean:write name="tl" property="pfReason"/>','<bean:write name="tl" property="roomid" />','<bean:write name="tl" property="lyid"/>','<bean:write name="tl" property="collegeArea" />','<bean:write name="tl" property="pfCategory" />')"><bean:write
...
function DoFind(){
   ...
   eqpdispatchForm.action="eqpdispatchAction.do?method=tongji4EqpPfin&doexl=0";
...
function DoExport(){
   ...
   eqpdispatchForm.action="eqpdispatchAction.do?method=tongji4EqpPfin&doexl=1";
   eqpdispatchForm.submit();
