				...
				<tr>
					<td align="left" valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tbody>
												...
												<logic:iterate name="eqplist" id="el" type="java.util.Map" indexId="i">
													<tr align="center" valign="middle">
														...
														<td width="35%" align="left" valign="middle" class="tableHeader3">
															...
															<input type="hidden" name="processId" value="<bean:write name="el" property="processid"/>" />
														</td>
														<td width="15%" align="right" valign="middle" style="background-color: #D1DAE9;font-weight:bold;font-family:宋体;font-size: 12px;text-align: right;">
															资产号
														</td>
													...
													<tr align="center" valign=center>
														...
														<td align="left" valign="middle" class="tableHeader3" colspan="3">
															<textarea name="memo" cols=80 rows=2 maxLength="300"><bean:write name="el" property="memo" /></textarea>
														</td>
													</tr>
													<tr>
														<td height="15" align="right" valign="middle" colspan="4">
															&nbsp;
														</td>
													</tr>
													<tr>
														<td height="40" align="left" valign="top" colspan="4">
															<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
																<tbody>
																	<tr align="center" valign=center>
																		...
																		<td align="left" valign="middle" class="tableHeader3">
																			<textarea name="checkMemo" cols=80 rows=2 maxLength="300"><bean:write name="el" property="checkMemo" /></textarea>
																		</td>
																	</tr>
																</tbody>
															</table>
											...
											<logic:present name="eqpbatchlist" scope="request">
												...
												<tr align="center" valign=center>
													...
													<td align="left" valign="middle" class="tableHeader3" colspan="3">
														<textarea name="bmemo" cols=80 rows=2 maxLength="300" onchange="BchangeMemo(this)"></textarea>
													</td>
												</tr>
												<tr>
													<td height="15" align="right" valign="middle" colspan="4">
														...
														<table width=100% border=1 align=center cellpadding=1 cellspacing=0 bordercolor=#FFFFFF id=submenu1>
															<tbody>
																<tr align="center" valign=center>
																	...
																	<td align="left" valign="middle" class="tableHeader3">
																		<textarea name="bcheckMemo" cols=80 rows=2 maxLength="300" onchange="BchangeCheckMemo(this)"></textarea>
																	</td>
																</tr>
															</tbody>
														</table>
												...
												<logic:iterate name="eqpbatchlist" id="ebl" type="java.util.Map" indexId="i">
													...
													<input type="hidden" name="processId_<bean:write name="ebl" property="processid"/>" value="<bean:write name="ebl" property="processid"/>" />
												</logic:iterate>
											</logic:present>
										</tbody>
									</table>
							...
							<tr>
								<td height="30" align="right" valign="middle">
									...
									<input name="bcheckok" type="button" class="button_nor" value="通 过" onClick="DoBatchCheck('20')">
									<input name="bchecknok" type="button" class="button_nor" value="不通过" onClick="DoBatchCheck('21')">
									<%}%>
						...
						<jodd:form bean="request">
							...
							<input type="hidden" name="search_shzt" />
						</jodd:form>
						</html:form>
	</body>
</html>
...
function DoInit(){
  ...
  var hascb=false;
   ...
   if(document.all.hncupdate.value!=''){
       ...
       alert("一个设备只能修改最新的派发申请，若派发申请在审核中或已审核通过，不能修改！");
   }
}
...
function DoBatchInit(){
   ...
   if(document.all.hnccols.value!='')
       alert(document.all.hnccols.value+" 派发申请已审核完毕，不能修改！");
   ...
   if(document.all.hnsameloc.value!='')
       alert(document.all.hnsameloc.value+" 已有其它设备放在该起始位置！");
   if(document.all.hncupdate.value!=''){
       alert("修改"+document.all.hncupdate.value+"条派发申请！若派发申请在审核中或已审核结束，不能修改！");      
   }
}
...
if(doCheckForm(eqpdispatchForm)){
	...
	eqpdispatchForm.action="eqpdispatchAction.do?method=updateCheck&idset="+idset+"&idcount="+idcount;
...
if(doCheckForm(eqpdispatchForm)){
	eqpdispatchForm.action="eqpdispatchAction.do?method=batchupdateCheck&idset="+idset+"&idcount="+idcount;
	eqpdispatchForm.submit();
}
...
function DoCheck(str){
   ...
   if(confirm("您确定要审核吗？")){
       eqpdispatchForm.action="eqpdispatchAction.do?method=applyCheck&checkState="+str+"&idset="+idset+"&idcount="+idcount;    
       eqpdispatchForm.submit();
   }
   else
      return;
...
function DoBatchCheck(str){

   if(confirm("您确定要审核吗？")){
       eqpdispatchForm.action="eqpdispatchAction.do?method=batchapplyCheck&checkState="+str+"&idset="+idset+"&idcount="+idcount;    
       eqpdispatchForm.submit();
   }
   else
      return;
...
function DoBack(){   
   eqpdispatchForm.action="eqpdispatchAction.do?method=search4CheckList";
   eqpdispatchForm.submit();
}
