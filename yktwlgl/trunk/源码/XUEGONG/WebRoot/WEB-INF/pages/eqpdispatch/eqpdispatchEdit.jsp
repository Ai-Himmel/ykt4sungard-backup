...
<%
   ...
   idcount=<%=idsCount%>;
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		...
		<html:form action="/gyf/eqpdispatchAction.do?method=update" method="post">
										...
										<tbody>
											...
											<logic:present name="eqplist" scope="request">
												<logic:iterate name="eqplist" id="el" type="java.util.Map" indexId="i">
													...
													<tr align="center" valign="middle">
														...
														<td align="left" valign="middle" class="tableHeader3">
															<select name="s_mgid" class="select01" onchange="changeManagerid(this)">
																<option value="" checked>
																	请选择
																</option>
																<logic:present name="mglist" scope="request">
											...
											<logic:present name="eqpbatchlist" scope="request">
												...
												<tr align="center" valign="middle">
													...
													<td align="left" valign="middle" class="tableHeader3">
														<select name="bs_mgid" class="select01" onchange="BchangeManagerid(this)">
															<option value="" checked>
																请选择
															</option>
															<logic:present name="mglist" scope="request">
...
function DoInit(){
  var pr,uc,pf,xq,bd,rm,mg,acp,cb,act,eqpstate;
     ...
     pf=document.eqpdispatchForm.elements["pfid"].value;
     ...
     mg=document.eqpdispatchForm.elements["mgid"].value;
   ...
   for(var i=0;i<document.eqpdispatchForm.elements["s_pfid"].length;i++){//派发对象
       if(document.eqpdispatchForm.elements["s_pfid"][i].value==pf)
            document.eqpdispatchForm.elements["s_pfid"][i].selected=true;
   }
  ...
  for(var i=0;i<document.eqpdispatchForm.elements["s_xqid"].length;i++){//校区
   ...
   for(var i=0;i<document.eqpdispatchForm.elements["s_mgid"].length;i++){//新管理员
       if(document.eqpdispatchForm.elements["s_mgid"][i].value==mg)
            document.eqpdispatchForm.elements["s_mgid"][i].selected=true;
   }
...
if(doCheckForm(eqpdispatchForm)){
	eqpdispatchForm.action="eqpdispatchAction.do?method=update&idset="+idset+"&idcount="+idcount;
...
if(doCheckForm(eqpdispatchForm)){
	eqpdispatchForm.action="eqpdispatchAction.do?method=batchupdate&idset="+idset+"&idcount="+idcount;
	eqpdispatchForm.submit();
}
