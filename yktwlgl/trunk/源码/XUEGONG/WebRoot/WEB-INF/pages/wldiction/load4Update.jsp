												...
												<logic:iterate name="dictionlist" id="el" type="java.util.Map" indexId="i">
													<tr align="center" valign="middle">
														...
														<td align="left" valign="middle" class="tableHeader3">
															...
															<input type="hidden" name="updatequerylb" value="<bean:write name="el" property="dictParentNo"/>" title="字典类别" isMust='1'>
														</td>
													</tr>
													<tr align="center" valign="middle">
														<td width="20%" align="right" valign="middle" style="background-color: #D1DAE9;font-weight:bold;font-family:宋体;font-size: 12px;text-align: right;">
														...
														<td align="left" valign="middle" class="tableHeader3">
															<input type="text" name="updatedictCaption" style="input_box" maxlength="20" value="<bean:write name="el" property="dictCaption"/>" title="字典项值" isMust='1'>
														</td>
													</tr>
												</logic:iterate>
											</logic:present>
