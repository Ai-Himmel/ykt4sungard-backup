...
function baocun(elements){
    if(doCheckForm(elements)!= false){
    	wlArrivalDtlBillForm.action = "<c:url value="/lf/wlArrivalDtlAction.do"/>?method=saveWlArrivalDtl&flag="+<%=flag%>;
		wlArrivalDtlBillForm.submit();
	}
}
function back(){
    wlArrivalDtlBillForm.action = "<c:url value="/lf/wlArrivalBillAction.do"/>?method=loadWlArrivalInfo4Reg";
	wlArrivalDtlBillForm.submit();
}
function dtlback(){
      ...
      cellpadding=1 cellspacing=0 bordercolor=#FFFFFF       id=submenu1>
          <tbody>
			...
			<tr align="center" valign=center>
              <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>物料名称</td>
              <td align="left" valign="middle" class="tableHeader3"><table><tr><td>
                ...
                <html:hidden property="wlid" styleClass="input_box"/>
				 ...
				 <html:options collection="wllist" labelProperty="wlmc" property="id" />
			  	...
			  	<input name="tempwlmc" style="input_box" maxlength="50" value="<%=request.getParameter("tempwlmc")==null||request.getParameter("tempwlmc").equals("null")?"":request.getParameter("tempwlmc")%>" readonly="readonly"/>

                </td><td><input name="addWlmc" type="button" value="查找" onClick="javascript:window.open('<c:url value="/gyf/deptWlmcAction.do"/>?method=search4List&formName=wlArrivalDtlBillForm&addNum=1','newwindow','height=600,width=800,top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=yes');">
              	</td></tr></table>
              </td>              
              <td align="right" valign="middle" class="tableHeader2" >物料小类</td>
            ...
            <input type="hidden" name="ifChanged" value="0">
            <tr>
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" >物料大类</td>
              ...
              <td align="right" valign="middle" class="tableHeader2" >物料规格</td>
              <td align="left" valign="middle" class="tableHeader3" >
              <html:text property="wlsption" styleClass="input_box"/></td>
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font color="red">*</font>物料型号</td>
              <td align="left" valign="middle" class="tableHeader3" >
              <html:text property="wlmodel" styleClass="input_box"/></td>
             </tr>
            <tr align="center" valign=center>
            <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font color="red">*</font>用途大类</td>
			  ...
			  <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>是否附件</td>
              <td align="left" valign="middle" class="tableHeader3" >
              	<html:select property="ifAppendix" styleClass="select01" onchange="changeIfAppendix(this)">
                	<html:option value="">请选择</html:option>
              ...
              <html:textarea property="usage" styleClass="" rows="3" cols="80"/></td>
              
              </tr>

            <tr align="center" valign=center>
              <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>采购经办人</td>
              <td align="left" valign="middle" class="tableHeader3" >
              ...
              <td align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="25" align="right" ><img id="selectprocureDate" src="<c:url value="/pages/components/calendar/skins/aqua/cal.gif"/>" border="0" alt="开始日期" style="cursor:pointer"></td>
                </tr>
              </table></td>
            </tr>
            <tr align="center" valign=center>
              <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>物料来源</td>
              <td align="left" valign="middle" class="tableHeader3" >
              ...
              <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>到货数量</td>
              <td align="left" valign="middle" class="tableHeader3" >
              ...
              <td align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="25" align="right" ><img id="selectarrivalDate" src="<c:url value="/pages/components/calendar/skins/aqua/cal.gif"/>" border="0" alt="开始日期" style="cursor:pointer"></td>
                </tr>
              </table></td>
            </tr>
            ...
            <tr align="center" valign=center>
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font color="red">*</font>生产厂家</td>
              <td align="left" valign="middle" class="tableHeader3" ><table><tr><td>
            ...
            <tr align="center" valign=center>              
              <td align="right" valign="middle" class="tableHeader2" ><font color="red">*</font>供应商</td>
              <td align="left" valign="middle" class="tableHeader3"><table><tr><td>
             ...
             <input name="tempProvider" style="input_box" maxlength="50" value="<%=request.getParameter("tempProvider")==null||request.getParameter("tempProvider").equals("null")?"":request.getParameter("tempProvider")%>" readonly="readonly"/>
			  ...
			  <td align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="25" align="right" ><img id="selectaccountDate" src="<c:url value="/pages/components/calendar/skins/aqua/cal.gif"/>" border="0" alt="开始日期" style="cursor:pointer"></td>
                </tr>
              </table></td>
            </tr>
            
                        <tr align="center" valign=center>
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font color="red">*</font>维修商</td>
              <td align="left" valign="middle" class="tableHeader3" ><table><tr><td>
			  ...
			  <td align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="25" align="right" ><img id="selectreceiptDate" src="<c:url value="/pages/components/calendar/skins/aqua/cal.gif"/>" border="0" alt="开始日期" style="cursor:pointer"></td>
                </tr>
              </table></td>
            </tr>
            
            <tr align="center" valign=center>	
              <td height="26" align="right" valign="middle" bgcolor="#FFFFFF" class="tableHeader2" ><font color="red">*</font>到货经办人</td>
              <td align="left" valign="middle" class="tableHeader3" >
              ...
              </td><td><html:hidden property="acpid" styleClass="input_box"/><html:hidden property="s_deptacpid" styleClass="input_box"/>
...
function DoInit(){
  var dl,xl,wl,dept,wxs,uc,ifap,j;
	 ...
	 var bgrlist = document.wlArrivalDtlBillForm.elements["s_acpid"];
	...
	var wxs = wxslist.options[wxslist.selectedIndex].value;
	var bgr = bgrlist.options[bgrlist.selectedIndex].value;
  ...
  var hasbgr=false;
   ...
   for(var j=0;j<document.wlArrivalDtlBillForm.elements["s_acpid"].length;j++){
      if(document.wlArrivalDtlBillForm.elements["s_acpid"][j].value==bgr){
...
function changePersonId(obj)
{
 document.all.arrPersonId1.value=obj.value;
}
