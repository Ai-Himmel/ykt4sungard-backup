...
function DoExport(){
   wlArrivalDtlSearchForm.action="<c:url value="/lf/wlArrivalDtlAction4Search.do"/>?method=tj4Gys&doexl=1";
...
function DoView(gysid,dlid,xlid,wlid){
		wlArrivalDtlSearchForm.action="wlArrivalDtlAction4Search.do?method=loadList4TJ&dlid="+dlid+"&xlid="+xlid+"&wlid="+wlid+"&gysid="+gysid;
    	wlArrivalDtlSearchForm.submit();
      ...
      cellpadding=1 cellspacing=0 bordercolor=#3F738B bordercolordark=#ffffff id=maintable>
          <tbody>
            ...
            <tr align="center" valign="middle" bgcolor="#F6F4F5">
              ...
              <a href="javascript:DoView('<bean:write name="tj" property="gysid" />','<bean:write name="tj" property="dlid" />','<bean:write name="tj" property="xlid" />','<bean:write name="tj" property="wlid"/>')"><bean:write name="tj" property="wlArrivalNum" /></a>&nbsp;
              </td>
              <%if(request.getAttribute("ifLimit").equals("0")){%>
...
var rn = document.all.liSize.value;
var rowspann=0;
