...
function submit(){
  ...
  if(document.all.itemlist.checked==true){
	...
	ec.action = "<c:url value = "/lf/wlArrivalDtlAction.do"/>?method=submitWlArrivalDtl&wlArrivalId=<%=request.getAttribute("wlArrivalId")%>&flag=main";
	ec.submit();
  }else{
				...
				<td align="left" valign="top">
					...
					<logic:present name="wlArrList" scope="request">
						...
						<logic:iterate name="wlArrList" id="wlArrival" type="java.util.Map">
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="arrivalNum"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="alledTNum"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="waitNum"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="unincertNum"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="ifaccount"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="ifreceiptavl"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="stateID"/>"/>
							<input type="hidden" id="<bean:write name="wlArrival" property="wlArrivalDtlId"/>" value="<bean:write name="wlArrival" property="mtlSource"/>"/>
