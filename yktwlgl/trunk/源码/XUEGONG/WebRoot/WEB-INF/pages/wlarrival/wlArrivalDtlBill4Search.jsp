          ...
          <tbody>
            ...
            <tr>
             <td width="13%" class="tableHeader2" >物料名称</td>
              ...
              <td width="13%" class="tableHeader2" >物料规格</td>
              <td width="20%" align="left" valign="middle" class="tableHeader3" >
            ...
            <tr align="center" valign=center>
              ...
              <td width="20%" align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><bean:write name="wlArrivalDtlBillForm" property="procureDate"/></td>
            ...
            <tr align="center" valign=center>
              ...
              <td width="20%" align="left" valign="middle" class="tableHeader3" ><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><bean:write name="wlArrivalDtlBillForm" property="arrivalDate"/></td>
                  <td width="25" align="right" ></td>
                </tr>
              </table></td>
            </tr>
            ...
            <tr align="center" valign=center>
              ...
              <td colspan="5" align="left" valign="middle" class="tableHeader4" >
