...
function baocun(elements){
    if(doCheckForm(elements)!= false){
    	wlArrivalDtlBillForm.action = "<c:url value="/lf/wlArrivalDtlAction.do"/>?method=saveWlArrivalDtl&tag=1";
...
function changeXl(sel){
   ...
   document.wlArrivalDtlBillForm.elements["xlid"].length=1; //清空原小类列表

   document.wlArrivalDtlBillForm.elements["wlid"].length=1; //清空原名称列表      
      ...
      for (i=0;i < datacount; i++)
      {
         ...
         if (dataset[i][2] == id)
          {   
             ...
             document.wlArrivalDtlBillForm.elements["xlid"].options[document.wlArrivalDtlBillForm.elements["xlid"].length]=new Option(dataset[i][1], dataset[i][0]);              
   ...
   xllist = document.wlArrivalDtlBillForm.elements["xlid"];
...
function changeWl(sel){
   ...
   if(id!=""){      
      for (i=0;i < datacount2; i++)
      {
         if (dataset2[i][3] == id)
          {   
             document.wlArrivalDtlBillForm.elements["wlid"].options[document.wlArrivalDtlBillForm.elements["wlid"].length]=new Option(dataset2[i][1], dataset2[i][0]); 
    ...
    wllist = document.wlArrivalDtlBillForm.elements["wlid"];
}
