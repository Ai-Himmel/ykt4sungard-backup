...
function back(){
 	wlArrivalDtlBillForm.action = "<c:url value="/lf/wlArrivalDtlAction4Search.do"/>?method=loadList4TJ";
		...
		<html:hidden property="wlArrivalDtlId" styleClass="input_box"/>
									<tbody>
										<tr align="center" valign=center>
											<td width="16%" align="left" valign="middle" class="tableHeader2">
												物料名称
											</td>
											<td width="24%" align="left" valign="middle" class="tableHeader3">
											<bean:write name="wlArrivalDtlBillForm" property="wlmc"/>
											</td>
											<td width="9%" align="left" valign="middle" class="tableHeader2">
												物料规格
											</td>
											<td width="13%" align="left" valign="middle" class="tableHeader3">
