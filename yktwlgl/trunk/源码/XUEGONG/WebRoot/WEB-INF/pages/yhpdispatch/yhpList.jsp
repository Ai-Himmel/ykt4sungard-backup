...
<html>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" onload="init()">
		<br>
		<html:form action="/gyf/yhpdispatchAction.do?method=load4add" method="post">
							...
							<jodd:form bean="request">
								<tr>
									<td height="20" align="center" valign="middle">
										<ec:table items="yhplist" var="yhpInfo" autoIncludeParameters="false" rowsDisplayed="10" action="yhpdispatchAction.do?method=load4add">
...
function init(){
  ...
  if(document.yhpdispatchForm.querymode.value=='1'){
      document.yhpdispatchForm.bquerymode.value="高级查询";
  ...
  else if(document.yhpdispatchForm.querymode.value=='2'){
      document.yhpdispatchForm.bquerymode.value="简单查询";
      tr1.style.display='';
      tr2.style.display='';
      tr3.style.display=''; 
      tr4.style.display='';
...
function changeBd(sel){
   ...
   if(id!="")
      for (i=0;i < datacount2; i++)
      {
         if (dataset2[i][2] == id)
          {   
             document.yhpdispatchForm.elements["search_louyu"].options[document.yhpdispatchForm.elements["search_louyu"].length]=new Option(dataset2[i][1], dataset2[i][0]);              
...
function DoDispatch(){
   ...
   document.forms.ec.action="yhpdispatchAction.do?method=load4dispatch";       
...
function ChangeQueryMode(btn){
    ...
    if(btn.value=='高级查询'){
       document.yhpdispatchForm.querymode.value="2";
       btn.value='简单查询';
       tr1.style.display='';
       tr2.style.display='';
       tr3.style.display='';   
       ...
       document.yhpdispatchForm.querymode.value="1";
       btn.value='高级查询';
       tr1.style.display='none';
       tr2.style.display='none';
       tr3.style.display='none'; 
...
function DoClear(){
    ...
    document.yhpdispatchForm.elements["search_bNo"].value="";
    document.yhpdispatchForm.elements["search_eNo"].value="";
    document.yhpdispatchForm.elements["search_hth"].value="";
    document.yhpdispatchForm.elements["search_sccj"].value="";
    document.yhpdispatchForm.elements["search_sccj"].options[0].selected=true;
    
    document.yhpdispatchForm.elements["search_ly"].value="";
    document.yhpdispatchForm.elements["search_ly"].options[0].selected=true;    
    document.yhpdispatchForm.elements["search_gys"].value="";
    document.yhpdispatchForm.elements["search_gys"].options[0].selected=true;     
    document.yhpdispatchForm.elements["search_dhh"].value="";
    document.yhpdispatchForm.elements["search_ytdl"].value="";
    document.yhpdispatchForm.elements["search_ytdl"].options[0].selected=true; 
    document.yhpdispatchForm.elements["search_yhpNumc"].value="";
    document.yhpdispatchForm.elements["search_yhpNumd"].value="";
    document.yhpdispatchForm.elements["search_curNumc"].value="";
    document.yhpdispatchForm.elements["search_curNumd"].value="";
    document.yhpdispatchForm.elements["search_dhrqc"].value="";
    document.yhpdispatchForm.elements["search_dhrqd"].value="";
    document.yhpdispatchForm.elements["search_cgrqc"].value="";
    document.yhpdispatchForm.elements["search_rzrqc"].value="";
    document.yhpdispatchForm.elements["search_dfprqc"].value="";
    document.yhpdispatchForm.elements["search_cgrqd"].value="";
    document.yhpdispatchForm.elements["search_rzrqd"].value="";
    document.yhpdispatchForm.elements["search_dfprqd"].value="";
    document.yhpdispatchForm.elements["search_djc"].value="";
    document.yhpdispatchForm.elements["search_djd"].value="";
    document.yhpdispatchForm.elements["search_fphm"].value="";
    document.yhpdispatchForm.elements["search_jfly"].value="";
    document.yhpdispatchForm.elements["search_cgjbr"].value="";
    document.yhpdispatchForm.elements["search_dhjbr"].value="";
    document.yhpdispatchForm.elements["search_pfdx"].value="";
    document.yhpdispatchForm.elements["search_pfdx"].options[0].selected=true;
    document.yhpdispatchForm.elements["search_xq"].value="";
    document.yhpdispatchForm.elements["search_xq"].options[0].selected=true;
    document.yhpdispatchForm.elements["search_louyu"].value="";
    document.yhpdispatchForm.elements["search_louyu"].options[0].selected=true;
