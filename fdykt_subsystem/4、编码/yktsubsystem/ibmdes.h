...
/*IBM DES WRITEN BY ANSI C DEFINATION*/
...
extern "C"
{
void  des_ky(const void *kval, void *key);
void  des_ec(const void *i_blk, void *o_blk, void *key);
void  des_dc(const void *i_blk, void *o_blk, void *key);

short DES_ENCRYPT(const void *InBuf, long InLen, void *OutBuf, const void *pKey);
short DES_DECRYPT(const void *InBuf, long InLen, void *OutBuf, const void *pKey);
short DES_MAC	 (const void *InBuf, long InLen, void *MacBuf, const void *pKey, unsigned char Option);
short DES_DEMAC	 (const void *InBuf, long InLen, void *MacBuf, const void *pKey, unsigned char Option);
};
