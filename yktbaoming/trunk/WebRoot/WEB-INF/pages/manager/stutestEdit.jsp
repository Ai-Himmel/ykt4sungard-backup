        ...
        <tbody>
         ...
         <input name="stubmId" type="hidden" value="<bean:write name="nl" property="id"/>">
							...
							<tr align="center" valign="middle">							
								...
								<td align="left" valign="middle" class="tableHeader3" >
								<input name="ifBm" type="hidden" value="<bean:write name="nl" property="ifBm"/>">
								  <logic:equal   name="nl" property="ifBm" value="1">
								     是
								  </logic:equal>
								  <logic:notEqual   name="nl" property="ifBm" value="1">
								     否
								  </logic:notEqual>	
							...
							<tr align="center" valign="middle">							
								...
								<td align="left" valign="middle" class="tableHeader3" >
								<input name="ifPay" type="hidden" value="<bean:write name="nl" property="ifPay"/>">
								  <logic:equal   name="nl" property="ifPay" value="1">
								     是
								  </logic:equal>
								  <logic:notEqual   name="nl" property="ifPay" value="1">
								     否
								  </logic:notEqual>						    
								</td>
							</tr>           
  ...
  <tr> 
   ...
   <tr> 
    <td height="40" align="left" valign="middle"> 
      <font size="2.5" color="red">注：如果已缴费修改考试科目,必须是同金额</font>
    </td>
  </tr>
</table>
...
function init(){
    ...
    if(document.all.hmsg.value=='1')
        ...
        alert("已存在相同记录，保存失败！");
    else if(document.all.hmsg.value=='feenoequals'){
         alert("两次考试金额不同，不能更改！");
    }    
    else if(document.all.hmsg.value=='23')
        alert("该考生已有此考试,请先将该考生原报考此考试信息删除");
}
...
function DoCheck(){
  ...
  document.studentForm.action="studentAction.do?method=update";
