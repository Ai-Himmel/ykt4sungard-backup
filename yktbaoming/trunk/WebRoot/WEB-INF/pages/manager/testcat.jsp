		...
		<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="30" align="center" valign="middle" class="tdborder02">
					<strong><font class="medium">考试类别添加</font></strong>
				</td>
			</tr>
			<tr>
						...
						<tbody>
							<tr align="center" valign="middle">							
								...
								<td align="left" valign="middle" class="tableHeader3" colspan="3">
									<input name="bmTestCat.testCatName" style="height:18px; width:480px; border:#000000 solid 1px; margin:0px; padding:0px; FONT-SIZE:12px" maxlength="30" value="">								    
								</td>
							</tr>
							<tr align="center" valign="middle">							
								<td width="15%" align="left" valign="middle" class="tableHeader2">
							...
							<tr id="feetr" align="center" valign="middle">	
								...
								<td align="left" valign="middle" class="tableHeader3" colspan="3">
									<input name="bmTestCat.fee" class="input_box" value="0" maxlength="6">								    
								</td>
							</tr>
						</tbody>
					</table>
...
function DoCheck(){
  ...
  document.testCatForm.action="testCategoryAction.do?method=add";
