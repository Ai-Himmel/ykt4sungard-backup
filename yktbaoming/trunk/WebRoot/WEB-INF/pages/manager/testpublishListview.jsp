...
<html:form action = "testPublishAction.do?method=search4Listview">
...
function DoFind(){
   ...
   document.testPublishForm.action="testPublishAction.do?method=search4Listview";
...
function DoView(str){
   ...
   document.testPublishForm.action="testPublishAction.do?method=stuview";
   document.testPublishForm.submit();
}
