...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" align="center" valign="middle" class="tdborder02"><strong><font class="medium">考试信息维护</font></strong></td>
  </tr>
  <tr> 
      ...
      cellpadding=1 cellspacing=0 bordercolor=#AA817F bordercolordark=#ffffff      id=submenu1>
          ...
          <thead>
            <tr align="center" valign=center>
              ...
              <td width="12%" valign="middle" class="tableHeader" >考试类别名称</td>              
              <td width="13%" valign="middle" class="tableHeader" >报名开始时间</td>
              <td width="13%" valign="middle" class="tableHeader" >报名结束时间</td>
              <td width="10%" valign="middle" class="tableHeader" >考试日期</td>
              <td width="12%" valign="middle" class="tableHeader" >考试开始时间</td>
              <td width="12%" valign="middle" class="tableHeader" >考试结束时间</td>
		  ...
		  <pg:pager url="./testAction.do" items="<%=listcount%>" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           ...
           <pg:param name="search_testcatname" />		   
            ...
            <logic:iterate name="testlist" id="nl" type="java.util.Map"  indexId="i">
            <pg:item>
              <input  type="hidden" name="operator" value="<bean:write name="nl" property="updator" />" >     
            ...
            <tr align="center" valign="middle">             
              ...
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="nl" property="bmBegin"/>&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="nl" property="bmEnd" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="nl" property="testDate" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="nl" property="testBeginTime" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#FFFFFF" ><bean:write name="nl" property="testEndTime" />&nbsp;</td>
            ...
            <tr align="center" valign="middle">             
              ...
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="nl" property="bmBegin"/>&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="nl" property="bmEnd" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="nl" property="testDate" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="nl" property="testBeginTime" />&nbsp;</td>
              <td align="center" valign="middle" bgcolor="#F6F4F5" ><bean:write name="nl" property="testEndTime" />&nbsp;</td>
		  ...
		  <!-- page offset end -->
            ...
            <logic:notPresent name="testlist" scope="request">                           
          <!--page offset start -->
		  <pg:pager url="./testAction.do" items="0" index="center" maxPageItems="50" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
           <%-- keep track of preference --%>
			<pg:param name="search_testcatname" />			
...
function DoFind(){
   ...
   document.testForm.action="testAction.do?method=search4List";
...
function DoAdd(){
   ...
   document.testForm.action="testAction.do?method=load4add";   
   document.testForm.submit();
}
...
function DoView(str){
   ...
   document.testForm.action="testAction.do?method=view";
   document.testForm.submit();
}
...
function DoDelete(){
   ...
   if(confirm("您确定要删除此考试吗？")){   
       document.testForm.action="testAction.do?method=delete";       
       document.testForm.submit();
   }
   else
       return;
...
function DoUpdate(){
   ...
   //查询是否是本人创建的考试，如果不是，不能修改
   
   document.testForm.action="testAction.do?method=load4update";
   document.testForm.submit();
