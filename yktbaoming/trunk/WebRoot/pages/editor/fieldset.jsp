...
<table align="center"><tr><td>栏目：<select id=a><option value=left>不应用<option value=left>左对齐<option value=center>中对齐<option value=right>右对齐</select>
标题：<select id=b><option value=left>不应用<option value=left>左对齐<option value=center>中对齐<option value=right>右对齐</select><br>
</td></tr><tr><td>边框颜色： <select id=c><option selected>选择边框颜色</option>
...
</td></tr><tr><td>背景颜色： <select id=d><option selected>选择背景颜色</option>
<option style="background-color:#F0F8FF;color: #F0F8FF" value="#F0F8FF">#F0F8FF</option>
<option style="background-color:#FAEBD7;color: #FAEBD7" value="#FAEBD7">#FAEBD7</option>
<option style="background-color:#00FFFF;color: #00FFFF" value="#00FFFF">#00FFFF</option>
<option style="background-color:#7FFFD4;color: #7FFFD4" value="#7FFFD4">#7FFFD4</option>
...
</td><td width=80 align="center"><input type=submit value='   确定   ' id=Ok><br><br><input type=button value='   取消   ' onclick="window.close();"></td></tr></table>
