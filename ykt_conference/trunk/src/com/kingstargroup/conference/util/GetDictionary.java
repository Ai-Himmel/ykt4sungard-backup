...
public class GetDictionary extends BasicUtil{
	 ...
	 * @since 1.0
	 */
	public static List getGroupNameList(){
		DictionaryDAO dao = DictionaryDAO.getInstance();
		List groupList = new ArrayList();
		try {
			groupList = dao.getGroupListByOper();
		} catch (HibernateException he) {
			he.printStackTrace();
		}finally{
			closeSession();
	 ...
	 * @since 1.0
	 */
	public static List getAttendeeGroupListByOper(){
		DictionaryDAO dao = DictionaryDAO.getInstance();
		List groupList = new ArrayList();
		try {
			groupList = dao.getAttendeeGroupListByOper();
		} catch (HibernateException he) {
			he.printStackTrace();
		}finally{
			closeSession();
