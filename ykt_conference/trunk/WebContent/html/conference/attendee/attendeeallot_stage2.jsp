      ...
      <td align="center" valign="top"><table width="800" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr align="center" valign="top">
            <td align="left" valign="middle"><bean:message key="attendee.allot.delegray"/>
              <input name=delegray2 class="input_box"  maxlength=50>
              	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="attendee.allot.custtype"/> 
              	<select name=custtype2 class="select01"  style="width:100">
                <%
                	Iterator iter = GetDictionary.getCustTypeList().iterator();
                	while (iter.hasNext()){
                		TPifDictionary custtype = (TPifDictionary)iter.next();
                %>
...
<script>
  	function setCmdValue(cmd) {      		
		...
		for (i=0;i<document.AttendeeAllotForm.querydestlist.options.length;i++){
			querylist=querylist+document.AttendeeAllotForm.querydestlist.options[i].value+",";
		}
		document.AttendeeAllotForm.queryliststring.value = querylist;
