...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
	<form name="AllotInformForm" action="<%=ContextUtil.getCtxPath(request)%>/attendeeinform/list.do" method=post >
    <tr> 
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td height="25" align="left" valign="middle" background="<%= ContextUtil.getCtxPath(request)%>/html/commons/images/image_lines.jpg"><span class="mediumwhite">
      	<strong>&nbsp;&nbsp;&nbsp;<span class="mediumwhite"><strong></strong>
      		</span><bean:message key="attendee.statusquery"/></strong></span></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align="center" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF"  bordercolordark="#F2F2F2">
          <tr> 
            ...
            <td align="left" valign="middle" bgcolor="#E6ECF2"><select name=confid style="width:200" class="select01" >
            <%
            	List list = GetDictionary.getConfList();
            	if (null!=list){
            	...
            	while (iter.hasNext()){
            		...
            		if (conf.getConId().toString().equals(confid)){
            %>
                <option value="<%=conf.getConId()%>" selected="selected"><%=conf.getConName()%></option>
            <%}else{%>
            	<option value="<%=conf.getConId()%>"><%=conf.getConName()%></option>
            <%}}}%>
              </select></td>
          </tr>
          <tr> 
            <td height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium"><bean:message key="attendee.custno"/></td>
            <td align="left" valign="middle" bgcolor="#E6ECF2"><input 
            	name=custno  style="width:200" style="width:200" class="input_box" value="<%=custno%>"  maxlength=50>
            </td>
          </tr>
          <tr> 
            <td height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium"><bean:message key="attendee.custname"/></td>
            <td align="left" valign="middle" bgcolor="#E6ECF2"><input 
            	name=custname  style="width:200" value="<%=custname%>" class="input_box"  maxlength=50>
            </td>
          </tr>
          <tr> 
            <td height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium"><bean:message key="attendee.dept"/></td>
            <td align="left" valign="middle" bgcolor="#E6ECF2"><select name=dept style="width:200" class="select01" >
            <OPTION>-</OPTION>
            <%
          ...
          <tr> 
            ...
            <td align="left" valign="middle" bgcolor="#E6ECF2"><input 
            	name=duty  style="width:200" value="<%=duty%>" class="input_box"  maxlength=50>
            </td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr> 
      <td height="50" align="right" valign="middle" class="tdborder02">
      	<input name="Submit3" type="submit" class="button_nor" value="<bean:message key="button.query"/>" > 
