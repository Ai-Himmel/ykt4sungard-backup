...
<%
	List deptList = (List) getServletContext().getAttribute(WebKeys.DEPT_JS_TREE);//OperatorUtil.createDeptJSList("NA");
%>
...
<div>
	<script language="JavaScript">
		var dlTree = new Tree("dlTree", dlArray, dlIcons, "topmenu_link_12", "<%= deptLimitString%>");
