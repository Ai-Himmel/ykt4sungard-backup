...
<body   bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	...
	<form id="DeleteConferenceForm" name="DeleteConferenceForm" action="<%=ContextUtil.getCtxPath(request)%>/deleteconference.do" method=post >
	<tr> 
		<td>&nbsp;</td>
	</tr>
	<tr> 
		...
		<ec:table 
			...
			<ec:row highlightRow="true">		
				<ec:column property="conId" headerStyle="text-align:center"
					...
					<a href="<%= ContextUtil.getCtxPath(request)%>/conf/editconference.do?conid=${pres.conId}">${pres.conId}</a>
				</ec:column>
