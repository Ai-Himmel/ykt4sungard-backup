...
<form name="SignPreview" id="SignPreview" action="<%=ContextUtil.getCtxPath(request)%>/preview.do" method=post >
	...
	<tr> 
		...
		<span class="mediumwhite"><strong></strong></span>&nbsp;<span class="mediumwhite"><strong><%=pretip%></strong></span></td>
	</tr>
	<tr> 
    ...
    <tr> 
      <td height="40" align="right" valign="middle" class="tdborder02">
        <input name="Submit2" type="button" class="button_nor" value="<bean:message key="button.return"/>"
...
<script>
	function renderCancelPage() {
		self.location = '<%= ContextUtil.getCtxPath(request)%>/preview.do?confid=<%=ParamUtil.getString(request,"confid")%>&selecttype=totle&attendeesign=prev';
	}
</script>
