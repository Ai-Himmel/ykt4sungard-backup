 ...
 * by MyEclipse Hibernate tool integration.
 */
public abstract class AbstractTCifDeptfull 
    implements Serializable
{
    ...
    /**
     * Simple constructor of AbstractTCifDeptfull instances.
     */
    public AbstractTCifDeptfull()
    {
    }

    /**
     * Constructor of AbstractTCifDeptfull instances given a simple primary key.
     * @param deptCode
     */
    public AbstractTCifDeptfull(java.lang.String deptCode)
    {
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof TCifDeptfull))
            return false;
        TCifDeptfull that = (TCifDeptfull) rhs;
