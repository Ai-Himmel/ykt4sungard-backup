...
public class ParameterUtil extends BasicUtil{
	...
	public static boolean modifyAssemblyRoom(
		...
		try {			
			...
			assemblyroom.setContain(contain.longValue());
	 ...
	 * @author   王莹
	 */
	public static TConferenceType getConferenceType(Long id) {
		ConferenceTypeDAO dao = ConferenceTypeDAO.getInstance();
		try {
	 ...
	 * @author   王莹
	 */
	public static TGroup getAttGroupName(Long groupId) {
		AttGroupNameDAO dao = AttGroupNameDAO.getInstance();
		try {
	...
	public static boolean modifyAttGroupName(Long id, String operId, String groupName, String comments) {
		AttGroupNameDAO dao = AttGroupNameDAO.getInstance(); 
		Transaction t = beginTransaction();
		try {
