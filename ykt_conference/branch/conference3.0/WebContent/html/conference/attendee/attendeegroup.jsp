...
<form name="AttendeeGroupForm" action="<%=ContextUtil.getCtxPath(request)%>/attendeegroup.do" method=post >
    ...
    <tr> 
      <td align="left" valign="top" ><table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF"  bordercolordark="#F2F2F2">
          <tr>
            <td width="10%" height="25" align="right" valign="top" bgcolor="#A9CFE2" class="medium" rowspan="3" ><bean:message key="attendee.custno"/></td>
            <td width="25%" align="left" valign="middle" bgcolor="#E6ECF2" rowspan="3">
            <textarea rows="5" cols="20" name="custno" title="批量学工号输入,回车标识分割"></textarea>
            </td>
            <td width="10%" height="25" align="right" valign="top" bgcolor="#A9CFE2" class="medium" rowspan="3" ><bean:message key="attendee.custname"/></td>
          	<td width="25%" align="left" valign="middle" bgcolor="#E6ECF2" rowspan="3">
            <textarea rows="5" cols="20" name="custNames" title="批量姓名输入,回车标识分割"></textarea>
            </td>
            <td width="10%" align="right" valign="middle" bgcolor="#A9CFE2" class="medium"><bean:message key="attendee.custname"/></td>
		...
		<td align="center" valign="top">
          ...
          <tr align="center" valign="top"> 
            ...
            <aa:zone name="custlist">
              ...
              %>
                <option value="<%=row.get("cutId")%>"><%= StringUtil.nullConvertToString(row.get("stuempNo"))%>&nbsp;&nbsp;<%= row.get("cutName")%>&nbsp;&nbsp;
...
<script>
	function queryCmd(){
	   if(document.AttendeeGroupForm.custno.value==""&&document.AttendeeGroupForm.custname.value==""&&document.AttendeeGroupForm.dept.value==""&&document.AttendeeGroupForm.duty.value==""&&document.AttendeeGroupForm.custNames.value==""){
	       alert("请输入查询条件");
	       return false;	   
	   }
		document.AttendeeGroupForm.cmd.value = 'query';
