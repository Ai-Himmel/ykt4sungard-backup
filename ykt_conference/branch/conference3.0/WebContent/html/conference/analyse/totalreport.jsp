...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0" ondblclick="holeset();">
	<form action="<%=ContextUtil.getCtxPath(request)%>/totalreport.do"
		...
		<table width="900" height="100%" border="0" align="center" cellpadding="0"
			cellspacing="0">
				...
				<td align="left" valign="top" class="tdborder02">
		        	...
		        	%>
						<tr>
							...
							<td colspan="5" align="left" valign="middle" bgcolor="#E6ECF2">
								<b><%=ifconf?con.getConName():""%></b>
							</td>
							<td rowspan="14" valign="middle" bgcolor="#E6ECF2">
								<img src="<%=ContextUtil.getCtxPath(request)%>/attePieChart.do"/>
							</td>
						</tr>
						<tr>
							<td width="12%" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
						...
						<tr>
							...
							<td width="10%" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
		        		...
		        		int attend=0, sign=0;
		        		float percent=0;
		        		if(null != request.getSession().getAttribute("concount")) {
		        		count = (ArrayList) request.getSession().getAttribute("concount");        			
		        	...
		        	%>
						<tr>
							...
							<td width="10%" align="right" valign="middle" bgcolor="#A9CFE2" class="medium">
								<bean:message key="analyse.signper" />：
							</td>
							<td colspan="3" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(presented,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="12%" align="right" valign="middle" bgcolor="#A9CFE2"
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:all%>
							</td>
							<td width="10%" align="right" valign="middle" bgcolor="#A9CFE2" class="medium">
						...
						<tr>
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(dayoff,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(absent,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="12%" align="right" valign="middle" bgcolor="#A9CFE2"
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(checkin,all,2)%>
							</td>
						</tr>
						<tr>
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(nocardsign,all,2)%>
							</td>
						</tr>
						<tr>
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(replacer,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="12%" align="right" valign="middle" bgcolor="#A9CFE2"
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(checkinlate,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(nocardsignlate,all,2)%>
							</td>
						</tr>
						<tr>
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
							...
							<td width="6%" align="left" valign="middle" bgcolor="#E6ECF2">
								<%=all==0?0:StringUtil.getPercentage(replacerlate,all,2)%>
							</td>
						</tr>
					</table>
						...
						<tbody>
							<tr align="center" valign="middle" class="tableHeader">
								<td align="center" width="20%">
									<bean:message key="analyse.custdept" />
								</td>
								<td align="center" width="7%">
									<bean:message key="analyse.plan.present" />
								</td>
								<td align="center" width="7%">
									<bean:message key="analyse.presented" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.dayoff" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.absent" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.cardsign" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.nocardsign" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.replacesign" />
								</td>
								<td align="center" valign="middle" width="8%">
									<bean:message key="analyse.cardsignlate" />
								</td>
								<td align="center" valign="middle" width="8%">
									<bean:message key="analyse.nocardsignlate" />
								</td>
								<td align="center" valign="middle" width="8%">
									<bean:message key="analyse.replacesignlate" />
								</td>
								<td align="center" valign="middle" width="7%">
									<bean:message key="analyse.signper" />
								</td>
							</tr>
							<logic:present name="deptCountList" scope="request">
								<logic:iterate name="deptCountList" id="deptCount" indexId="i">								
									<tr align="center" valign="middle">
										<td align="left" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<bean:write name="deptCount" property="deptName" />
										</td>
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.planattendNum}">
													<bean:write name="deptCount" property="planattendNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('1','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="planattendNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.presentedNum}">
													<bean:write name="deptCount" property="presentedNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('2','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="presentedNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.dayoffNum}">
													<bean:write name="deptCount" property="dayoffNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('3','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="dayoffNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.absentNum}">
													<bean:write name="deptCount" property="absentNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('4','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="absentNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.checkinNum}">
													<bean:write name="deptCount" property="checkinNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('5','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="checkinNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.nocardsignNum}">
													<bean:write name="deptCount" property="nocardsignNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('6','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="nocardsignNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.replacerNum}">
													<bean:write name="deptCount" property="replacerNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('7','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="replacerNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.checkinlateNum}">
													<bean:write name="deptCount" property="checkinlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('8','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="checkinlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.nocardsignlateNum}">
													<bean:write name="deptCount" property="nocardsignlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('9','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="nocardsignlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==deptCount.replacerlateNum}">
													<bean:write name="deptCount" property="replacerlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithDept('10','<bean:write name="deptCount" property="deptCode" />');">
														<bean:write name="deptCount" property="replacerlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<bean:write name="deptCount" property="presentRate" />
										</td>
									</tr>
								</logic:iterate>
							</logic:present>
								...
								<aa:zone name="alist">
									<ec:table items="result" var="pres" filterable="false"
										...
										<ec:column property="stuempNo" headerStyle="text-align:center"
                                                width="70" style="text-align:left" filterable="false" sortable="false" escapeAutoFormat="true"
			...
			<tr>
				<td height="40" align="right" valign="middle" class="tdborder02">
					<input name="Submit" type="button" class="button_nor"
						...
						<input name="export" type="button" class="button_nor" value='<bean:message key="button.export"/>' onclick="javascript:exportReport();">
				</td>
			</tr>	
		</table>
	</form>
	<form action="<%=ContextUtil.getCtxPath(request)%>/exportReport.do?conId=<%= con.getConId()%>" name="exportForm" method="post">
	...
	function SetValueWithDept(tag,deptcode){
		var flag = tag;
		document.forms[0].action='<%=ContextUtil.getCtxPath(request)%>/totalreport.do?flag='+flag+'&deptcode='+deptcode;
		ajaxAnywhere.submitAJAX();	
	}
	function cancelPage() {
	...
	function exportReport(){
		var exportForm = document.forms[1];
		exportForm.submit();
	}
