...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	<form id="DeleteConferenceForm" name="DeleteConferenceForm"
		action="<%=ContextUtil.getCtxPath(request)%>/anal/totalquery.do?flag=print"
		method="post">
				...
				<td align="center" valign="top">
					<ec:table var="pres" items="result" filterable="false"
						...
						<ec:column property="conId" headerStyle="text-align:center"
								...
								<a href="<%=ContextUtil.getCtxPath(request)%>/totalreport.do?printflag=print&conId=${pres.conId}">${pres.conId}</a>
							</ec:column>
