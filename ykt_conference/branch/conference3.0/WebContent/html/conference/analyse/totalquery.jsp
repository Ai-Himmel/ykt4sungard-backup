			...
			<tr>
				<td align="center" valign="top">
					<ec:table var="pres" items="result" filterable="false"
						...
						<ec:column property="conId" headerStyle="text-align:left"
