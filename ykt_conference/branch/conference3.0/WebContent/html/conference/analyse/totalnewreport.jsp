...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
		...
		<table width="800" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="40" align="right" valign="middle">
					...
					&nbsp;&nbsp;&nbsp;
					<input name="exportAttendeeBtn" type="button" class="button_nor"
						value="<bean:message key="button.export"/>" onclick="javascript:exportAttendee();">
				</td>
			</tr>
			<tr>
	...
	<form id="exportForm" name="exportForm" action="<%=ContextUtil.getCtxPath(request)%>/exportAttendee.do" method="post">
		<input type="hidden" name="custno" value="<%=custno==null?"":custno %>"/>
		<input type="hidden" name="custname" value="<%=custname==null?"":custname %>"/>
		<input type="hidden" name="dept" value="<%=deptCode==null?"":deptCode %>"/>
		<input type="hidden" name="type" value="<%=type==null?"":type %>"/>
		<input type="hidden" name="begindate" value="<%=begindate==null?"":begindate %>"/>
	 ...
	 %>
		...
		if(result4!=null){
			for(int j=0;j<result4.size();j++){
				...
				String rate = StringUtil.getPercentage(Integer.valueOf(shouldcount),Integer.valueOf(allcount),2);
				String rate1 = StringUtil.getPercentage(Integer.valueOf(latecount),Integer.valueOf(allcount),2);
				%>
