				...
				<td height="25" align="left" valign="middle"
					...
					<span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<span
							class="mediumwhite"><strong></strong> </span> <bean:message
								key="conference.create" /> </strong> </span>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="2"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name=conname class="input_box" maxlength=35
									style="width=200"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<a title="<bean:message key="conference.open.exp" />"><input
										type="radio" name="open" checked="checked" value="0">
									<bean:message key="conference.open" />
								</a>
								<a title="<bean:message key="conference.notopen.exp" />"><input
										type="radio" name="open" value="1">
									<bean:message key="conference.notopen" />
								</a>
								<a title="<bean:message key="conference.noneedtoassign.people" />"><input
                                        type="radio" name="open" value="2">
                                    <bean:message key="conference.nomingdan" />
                                </a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<select name=assembly class="select01" style="width=200">
									<%
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<select name=type class="select01" style="width=200">
									<%
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="205">
											<input name=signtime readonly="readonly" class="input_box"
												style="width=200"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="205">
											<input name=begintime readonly="readonly" class="input_box"
												style="width=200"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="205">
											<input name=endtime readonly="readonly" class="input_box"
												style="width=200"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<select name=org class="select01" style="width=200">
									<%
										...
										String deptCode = "";
										if (null != GetterUtil.get((String) request.getSession().getAttribute("userdept"), "")) {
											deptCode = GetterUtil.get((String) request.getSession().getAttribute("userdept"), "");
										}
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<textarea name="explan" cols=50 rows=4></textarea>
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<textarea name="comments" cols=50 rows=4 maxlength="40"></textarea>
								<a class="portlet-msg-error"><html:errors
										property="comments" /> </a>
							</td>
						</tr>
