...
<%@page import="com.kingstargroup.conference.action.KSConfiguration"%>
          ...
          <td align="left" valign="top"><table width="232" border="0" cellspacing="0" cellpadding="0">
            ...
            name=password type="password" style="width:155;background-color: #ffffff; FONT-SIZE: 12px;  border: 1 solid #000000" maxlength=50></td>
              ...
              <tr>
                ...
                <td height="30">
                	<input name=authCode style="width:155;background-color: #ffffff; FONT-SIZE: 12px;  border: 1 solid #000000" maxlength=50>
                </td>
              </tr>
              <%} %>
              <tr> 
		        ...
		        <%
		        	if("0".equals(authType)){
		        %>
		        	<img border="0" hspace="0" src="<%= ContextUtil.getCtxPath(request)%>/captcha/challenge" vspace="0" width=153 height=50>
		        <%} %>	
