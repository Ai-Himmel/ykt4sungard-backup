...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
	<form id="Leave" name="Leave" action="<%=ContextUtil.getCtxPath(request)%>/leave.do" method=post >
    <tr> 
    ...
    <tr> 
      ...
      <span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<bean:message key="sign.leavemanage"/></strong></span></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align="left" valign="top" ><table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF"  bordercolordark="#F2F2F2">
          ...
          <tr> 
            ...
            <td align="left" valign="middle" bgcolor="#E6ECF2">
            	<input name=duty class="input_box" value="<%=duty%>" style="width: 150" maxlength=50>
            </td>
	...
	<tr> 
		...
		<ec:table 
				...
				rowsDisplayed="5"
				action="${pageContext.request.contextPath}/leave.do"
				form="Leave">
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
	<form id="LeaveForm" name="LeaveForm" action="<%=ContextUtil.getCtxPath(request)%>/leave.do" method=post >
	<%String custid="";%>
	<input type=hidden name=cmd value="sign">
	<input type=hidden name=confid value="<%=ParamUtil.getString(request,"confid")%>">
	<input type=hidden name=custid value="<%=custid%>">
    <tr> 
      <td height="30" align="left" valign="middle" class="medium"><font color="#000099"><strong><bean:message key="sign.leavereason"/></strong></font></td>
    </tr>
    <tr> 
      <td align="left" valign="top">
      	<input name=reason class="input_box" style="width: 600"  maxlength=30 >
      </td>
    </tr>
    <tr> 
      <td height="40" align="right" valign="middle" class="tdborder02">
        <input name="Submit2" type="submit" class="button_nor" value="<bean:message key="button.leave"/>"
        	onClick="javascript:setCmdValue('sign');"> &nbsp;&nbsp;&nbsp; 
        <input name="Submit2" type="button" class="button_nor" value="<bean:message key="button.cancle.leave"/>"  
