...
<html:form action="createattgroupname.do">
    ...
    <tr> 
      <td height="25" align="left" valign="middle" background="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/image_lines.jpg">
			<span class="mediumwhite"><strong>
				&nbsp;&nbsp;&nbsp;
				<bean:message key="attgroupname.create" />
			</strong></span>
      ...
      <td align="center" valign="top">
          ...
          <tr> 
            ...
            <td align="left" valign="middle" bgcolor="#E6ECF2">
            	<input name="groupName" class="input_box" maxlength="40" value="<%=ParamUtil.getString(request,"groupName")%>">
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <tr> 
            ...
            <td align="left" valign="middle" bgcolor="#E6ECF2">
            	<textarea name="comments" cols=50 rows=5 maxlength="40"><%=ParamUtil.getString(request,"comments")%></textarea>
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
