...
public class AnalyseDAO extends BasicDAO {
	...
	public List getAttendeeList(Integer conId, String sign) {
		...
		sqlStr.append("select ")
			...
			.append(" from (((t_attendee_list a")
			.append(" left join t_cif_customer c on a.cust_Id=c.cut_Id)")
			.append(" left join t_inform_list l on a.cust_Id=l.cust_Id and a.con_Id=l.con_id)")
			.append(" left join t_cif_dept d on c.classdept_No=d.dept_Code)")
			.append(" left join T_DUTY duty on c.stuemp_No=duty.stuemp_No")
			.append(" ")
