...
public class SynchDBUtils {
	...
	public SynchDBUtils(String dbtype, String ipAddr, String port,
	...
	private  boolean db2Check() {
		try {
			...
			String strsql = "select * from YKT_CONF.T_OPERATOR";
...
//	}
	...
	public boolean closeConnecttion(Connection conn){
		try {
			DbUtils.close(conn);
			return true;
...
//
//		MonitorDBUtils test = new MonitorDBUtils("db2", "10.49.188.243", "50000",
//				"ykttest", "db2inst1", "db2inst1");
//		MonitorDBUtils test = new MonitorDBUtils("oracle", "10.49.188.243", "1521",
//				"yktdb", "system", "kingstar");
//		test.oracleCheck();
//	}
	...
	public static boolean checkDBstatus(String db,String ip,String port,String dbname,String username,String password){
		...
		SynchDBUtils dbutil = new SynchDBUtils(db,ip,port,dbname,username,password);
		if("db2".equals(db)){
