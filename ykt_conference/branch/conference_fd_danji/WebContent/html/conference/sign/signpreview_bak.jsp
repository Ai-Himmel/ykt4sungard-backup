...
<head>
	...
	<META http-equiv=REFRESH content=10;URL=
		<%=ContextUtil.getCtxPath(request)%>/preview.do?confid=<%=ParamUtil.getString(request, "confid")%>
		&attendeesign=prev&selecttype=totle>
</head>
					...
					<table width="100%" height="42" border="0" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td width="35%" class="medium">
								<font color="#9B772B"><strong><%=conference.getConName()%>
								</strong> </font>
							</td>
				...
				<td align="center" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="300" height="25" align="center" valign="middle"
								class="medium">
								<a
										...
										<td align="left" valign="top">
											<table width="100%" height="100" border="0" cellpadding="0"
												...
												<tr>
													...
													<td height="337" align="center" valign="top"
														bgcolor="#DEF2FD">
							...
							<td align="center" valign="top" class="tdborder03">
								<table width="98%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr align="center" valign="middle">
										...
										<td class="medium">
											<%=StringUtil.nullConvertToString(row2.get("dutyName"))%>
										</td>
									</tr>
									<%
									}
																...
																<td align="center" valign="top" bgcolor="#F2F2F2">
																	<table width="98%" border="0" cellspacing="0"
																		...
																		<tr align="center" valign="middle">
																			...
																			<td class="medium">
																				<%=StringUtil.nullConvertToString(row3.get("dutyName"))%>
																			</td>
																		</tr>
																		<%
																		}
																...
																<td align="center" valign="top" bgcolor="#F2F2F2">
																	<table width="98%" border="0" cellspacing="0"
																		...
																		<tr align="center" valign="middle">
																			...
																			<td class="medium">
																				<bean:message key="rep.duty" />
																			</td>
																			<td class="medium">
																				<bean:message key="reped.duty" />
																			</td>
																		</tr>
																		<%
																		...
																		<tr align="center" valign="middle">
																			...
																			<td class="medium">
																				<%=StringUtil.nullConvertToString(row4.get("repDuty"))%>
																			</td>
																			<td class="medium">
																				<%=row4.get("cutName")%>
																			</td>
