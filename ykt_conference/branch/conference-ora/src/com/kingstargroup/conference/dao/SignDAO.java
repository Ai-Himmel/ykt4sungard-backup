	...
	public List getSignedNumByConfid(int confid) throws HibernateException {
		...
		if ("db2".equals(CONSTANT.DB_CONFIG)) {
			...
			.append(
					" from ykt_conf.T_ATTENDEE_LIST att where con_Id="
							+ confid).append(
					" and (attend_Sign='11' or attend_Sign='12' or attend_Sign='13' or attend_Sign='21' or attend_Sign='22' or attend_Sign='23') order by att.ATTEND_TIME desc");
