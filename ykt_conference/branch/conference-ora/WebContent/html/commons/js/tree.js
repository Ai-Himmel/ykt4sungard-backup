...
function Tree_create(openNodes) {
	if (this.nodes.length > 0) {
		...
		document.write("<a class=\"" + this.className + "\" href=\"javascript:" + this.treeId + ".clickcheckbox('box1');\" style=\"text-decoration: none;\">");
		if (isChecked(this.selectedItems, nodeValues[6])) {
			document.write("<img align=\"absmiddle\" border=\"0\" hspace=\"0\" id=\"boximage1\" src=\"" + this.icons[12] + "\">");
		} else {
			document.write("<img align=\"absmiddle\" border=\"0\" hspace=\"0\" id=\"boximage1\" src=\"" + this.icons[13] + "\">");
		}		
...
function Tree_addNode(parentNode, recursedNodes) {
	for (var i = parentNode; i < this.nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			document.write("<a class=\"" + this.className + "\" href=\"javascript:" + this.treeId + ".clickcheckbox('box" + nodeValues[0] + "');\" style=\"text-decoration: none;\">");
			//create image
			if (isChecked(this.selectedItems, nodeValues[6])) {
				document.write("<img align=\"absmiddle\" border=\"0\" hspace=\"0\" id=\"boximage" + nodeValues[0] + "\" src=\"" + this.icons[12] + "\">");
			} else {
				document.write("<img align=\"absmiddle\" border=\"0\" hspace=\"0\" id=\"boximage" + nodeValues[0] + "\" src=\"" + this.icons[13] + "\">");
			}
