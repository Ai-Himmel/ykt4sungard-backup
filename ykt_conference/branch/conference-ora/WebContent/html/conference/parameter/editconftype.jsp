...
<% 
	String conftypeid = request.getParameter("id");
	boolean back = false;
	if(null == conftypeid) {
		back = true;
		conftypeid = ParamUtil.getString(request,"typeid");
	}

	TConferenceType conftype = new TConferenceType();
	if (!"".equals(conftypeid) && (null != conftypeid)) {
		conftype = ParameterUtil.getConferenceType(Integer.valueOf(conftypeid));
	}	
%>
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">

<html:form action="modifyconftype.do">
	...
	<tr>
		<td height="25" align="left" valign="middle" background="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/image_lines.jpg">
			<span class="mediumwhite"><strong>
				&nbsp;&nbsp;&nbsp;
				<bean:message key="conftype.modify" />
			</strong></span>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF" bordercolordark="#F2F2F2">
				<tr>
					<td width="15%" height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium">
						...
						<input type="hidden" value="<%=conftypeid%>" name="typeid">
					</td>
					<td align="left" valign="middle" bgcolor="#E6ECF2">
						<input name="contypename" class="input_box" maxlength="30" value="<%=back?ParamUtil.getString(request,"contypename"):conftype.getTypeName()%>">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					...
					<td align="left" valign="middle" bgcolor="#E6ECF2">
		            	<textarea name="comments" cols=50 rows=5 maxlength="80"><%=back?ParamUtil.getString(request,"comments"):conftype.getComments()%></textarea>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
