...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	...
	<form name="AttendeeInformForm" id="AttendeeInformForm"
						...
						<tr align="center" valign="top">
							...
							<td width="35%">
								<font color="#FF0000"> <aa:zone name="hanQueryList">
										<select name="custdestlist" size="22" style="width: 250"
											multiple
							...
							<td width="35%">
								<font color="#FF0000"> <select name="groupdestlist"
										size="22" style="width: 250" multiple
