...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0" ondblclick="holeset();">
				...
				<td align="left" valign="top" class="tdborder02">
					<table width="100%" border=1 cellpadding=1 cellspacing=0 align="center"
						...
						<tbody>
							...
							<logic:present name="groupCountList" scope="request">
								<logic:iterate name="groupCountList" id="groupCount" indexId="i">								
									<tr align="center" valign="middle">
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<bean:write name="groupCount" property="groupName" />
										</td>
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.planattendNum}">
													<bean:write name="groupCount" property="planattendNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('1','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="planattendNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.presentedNum}">
													<bean:write name="groupCount" property="presentedNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('2','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="presentedNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.dayoffNum}">
													<bean:write name="groupCount" property="dayoffNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('3','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="dayoffNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.absentNum}">
													<bean:write name="groupCount" property="absentNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('4','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="absentNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.checkinNum}">
													<bean:write name="groupCount" property="checkinNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('5','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="checkinNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.nocardsignNum}">
													<bean:write name="groupCount" property="nocardsignNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('6','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="nocardsignNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.replacerNum}">
													<bean:write name="groupCount" property="replacerNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('7','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="replacerNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.checkinlateNum}">
													<bean:write name="groupCount" property="checkinlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('8','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="checkinlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.nocardsignlateNum}">
													<bean:write name="groupCount" property="nocardsignlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('9','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="nocardsignlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
										...
										<td align="center" valign="middle"
											bgcolor="#FFFFFF" class="medium">
											<core:choose>
												<core:when test="${'0'==groupCount.replacerlateNum}">
													<bean:write name="groupCount" property="replacerlateNum" />
												</core:when>
												<core:otherwise>
													<a href="javascript:SetValueWithGroup('10','<bean:write name="groupCount" property="groupId" />');">
														<bean:write name="groupCount" property="replacerlateNum" />
													</a>
												</core:otherwise>
											</core:choose>
	...
	function SetValueWithGroup(tag,groupId){
		var flag = tag;
		document.forms[0].action='<%=ContextUtil.getCtxPath(request)%>/totalreport.do?flag='+flag+'&groupId='+groupId;
		ajaxAnywhere.submitAJAX();	
	}
	function cancelPage() {
