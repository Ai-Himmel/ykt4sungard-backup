...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	...
	<form name="UserModifyPwdForm"
		action="<%=ContextUtil.getCtxPath(request)%>/modifypwd.do" method=post>
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="2"
						...
						<tr>
							<td height="25" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
								<bean:message key="conference.oldpwd" />
							</td>
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name=oldpwd type="password" class="input_box"
									style="width: 200" maxlength=12>
								<a class="portlet-msg-error"><html:errors property="oldpwd" />
								</a>
							</td>
						</tr>
						<tr>
							<td height="25" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
								<bean:message key="operator.newpwd" />
							</td>
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name=newpwd type="password" class="input_box"
									style="width: 200" maxlength=12>
								<a class="portlet-msg-error"><html:errors property="newpwd" />
								</a>
							</td>
						</tr>
						<tr>
							<td height="25" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
								<bean:message key="operator.renewpwd" />
							</td>
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name=renewpwd type="password" class="input_box"
									style="width: 200" maxlength=12>
