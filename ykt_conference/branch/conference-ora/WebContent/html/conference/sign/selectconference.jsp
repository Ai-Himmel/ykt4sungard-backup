		...
		<tr>
			<td height="25" align="left" valign="middle"
				...
				<span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<bean:message
							key="sign.preview.select" /> </strong> </span>
			</td>
		</tr>
		<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="25" align="center" valign="middle">
							<input type="radio" name="selecttype" value="totle"
								checked="checked">
						</td>
						<td width="150">
							<bean:message key="sign.preview.totle" />
						</td>
						<td width="25" align="center" valign="middle">
							<input type="radio" name="selecttype" value="justdelegray">
						</td>
						<td width="150">
							<bean:message key="sign.preview.delegray" />
						</td>
						<td>
							&nbsp;
						</td>
		...
		<tr>
			<td align="left" valign="top">
				<table width="100%" border="1" cellspacing="0" cellpadding="2"
					...
					<tr>
						<td width="10%" height="25" align="right" valign="middle"
							bgcolor="#A9CFE2" class="medium">
							<bean:message key="conference.name" />
						</td>
						<td width="90%" align="left" valign="middle" bgcolor="#E6ECF2">
