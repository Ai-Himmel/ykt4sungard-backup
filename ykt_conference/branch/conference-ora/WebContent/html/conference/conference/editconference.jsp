...
<%
	...
	String confname = conf.getConName()==null?"":conf.getConName();
	...
	String explain = conf.getConExplain()==null?"":conf.getConExplain();
	String comments = conf.getComments()==null?"":conf.getComments();
%>
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name=conname class="input_box" maxlength=35
									style="width=200" value="<%=confname%>">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr>
										<td width="205">
											<input name=begindate readonly="readonly" class="input_box"
												maxlength=50 style="width=200" value="<%=begindate%>">
										</td>
										<td width="25">
											<a href="#"><img
									...
									<tr>
										<td width="205">
											<input name=signtime class="input_box" readonly="readonly"
												style="width=200" value="<%=signtime%>">
										</td>
										<td width="25">
											<a href="#"><img
									...
									<tr>
										<td width="205">
											<input name=begintime class="input_box" readonly="readonly"
												style="width=200" value="<%=begintime%>">
										</td>
										<td width="25">
											<a href="#"><img
													src="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/clock.gif"
