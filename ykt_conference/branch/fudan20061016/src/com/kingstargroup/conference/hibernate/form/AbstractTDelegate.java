...
/**
 * AbstractTDelegate generated by MyEclipse - Hibernate Tools
 */
...
public abstract class AbstractTDelegate  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTDelegate(String dlgtName, String deptId, String open, String operId, String comment) {
    ...
    public Integer getDlgtId() {
        return this.dlgtId;
    }
    
    public void setDlgtId(Integer dlgtId) {
        this.dlgtId = dlgtId;
    }
