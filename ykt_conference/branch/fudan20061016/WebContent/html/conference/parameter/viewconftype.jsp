...
<% 
	String typename = request.getAttribute("contypename")==null?"":request.getAttribute("contypename").toString();
%>

<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">

<form id="DeleteConfTypeForm" name="DeleteConfTypeForm" action="<%=ContextUtil.getCtxPath(request)%>/queryconftype.do" method="post">
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF" bordercolordark="#F2F2F2">
				<tr>
					...
					<td width="35%" align="left" valign="middle" bgcolor="#E6ECF2">
						<input name="contypename" class="input_box" maxlength="30" value="<%=typename%>">
					</td>
					<td width="15%" height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium">
						&nbsp;
					</td>
...
<script type="text/javascript">
	...
	function setCmdValue(str) {
		if (window.confirm(str)){
			document.forms[0].action = '<%=ContextUtil.getCtxPath(request)%>/deleteconftype.do'
