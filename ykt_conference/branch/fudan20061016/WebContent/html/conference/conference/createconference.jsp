							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="25">
											<a href="#"><img
													src="<%=ContextUtil.getCtxPath(request)%>/html/themes/images/ecard/clock.gif"
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<select name=org class="select01" style="width=200">
									<%
										...
										String deptCode = "";
										if (null != GetterUtil.get((String) request.getSession()
												.getAttribute("userdept"), "")) {
											deptCode = GetterUtil.get((String) request.getSession()
											.getAttribute("userdept"), "");
										}
