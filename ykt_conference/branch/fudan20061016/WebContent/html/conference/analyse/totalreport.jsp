			...
			<tr>
				...
				<!--startprint-->
		        	...
		        	%>
		        		...
		        		noinformsign = ((Integer) count.get(11)).intValue();//未通知代替签到
		        		noinformsignlate = ((Integer) count.get(12)).intValue();//未通知代替签到迟到
		        		}
		        	%>
						<tr>
							<td width="15%" align="right" valign="middle" bgcolor="#A9CFE2"
						...
						<tr>
							...
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
								<a href="javascript:SetValue('11');"><bean:message
										key="analyse.noinformsign" /> </a>
							</td>
							<td width="15%" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
								<bean:message key="analyse.totalpeople" />
							...
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
								<bean:message key="analyse.ratio" />
								:
								<%=all==0?0:noinformsign *10000 /all /100.00f%>
								<%="%"%>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
								<a href="javascript:SetValue('12');"><bean:message
										key="analyse.noinformsignlate" /> </a>
							</td>
							<td width="15%" align="right" valign="middle" bgcolor="#A9CFE2"
								class="medium">
								<bean:message key="analyse.totalpeople" />
							...
							<td width="15%" align="left" valign="middle" bgcolor="#E6ECF2">
								<bean:message key="analyse.ratio" />
								:
								<%=all==0?0:noinformsignlate *10000 /all /100.00f%>
								<%="%"%>
							</td>
						</tr>
					</table>
