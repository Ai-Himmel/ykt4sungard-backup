...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="25" align="left" valign="middle" background="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/image_lines.jpg">
    	<span class="mediumwhite"><strong>
    		&nbsp;&nbsp;&nbsp;&nbsp;
    		<bean:message key="stat.attend.report"/>
    	</strong></span>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td align="left" valign="top" >
    	<form action="<%=ContextUtil.getCtxPath(request)%>/queryanalysestat.do" name="analyseForm" method="post">
    	<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF"  bordercolordark="#F2F2F2">
        	<tr> 
          		<td width="15%" height="25" align="right" valign="middle" bgcolor="#A9CFE2" class="medium">
          			<bean:message key="stat.attend.status"/>
          		</td>
          		<td colspan="2" align="left" valign="middle" bgcolor="#E6ECF2">
          			...
          			%>
              			<option value="0" <%=checklist?("0".equals(listid)?"selected":""):"selected"%>><bean:message key="stat.attend.list"/></option>
              			<option value="3" <%=checklist?("3".equals(listid)?"selected":""):""%>><bean:message key="stat.unattend.list"/></option>
            		</select>
            	</td>
        	</tr>
        	<tr> 
...
%>
<form action="<%=ContextUtil.getCtxPath(request)%>/queryanalysestat.do" name="analyse" method="post">
  <table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#FFFFFF"  bordercolordark="#F2F2F2">
  <tr> 
