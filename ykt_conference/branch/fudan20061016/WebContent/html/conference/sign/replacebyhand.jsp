...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	<html:form action="/replacebyhand.do" method="post"
		styleId="replacebyhandForm">
		<table width="800" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<aa:zone name="tipinfo">
					<td colspan="2">
						<font color="red"> <%=request.getAttribute("tipinfo") == null ? ""
					: request.getAttribute("tipinfo").toString()%>
						</font>
					</td>
				</aa:zone>
			</tr>
			<tr>
				<td height="25" align="left" valign="middle"
					...
					<span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<bean:message
								key="sign.uncheck" /> </strong> </span>
				</td>
				<td height="25" align="left" valign="middle"
					background="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/image_lines.jpg">
					&nbsp;
					<span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<bean:message
								key="sign.unknowcheck" /> </strong> </span>
				</td>
			</tr>
			<tr>
					...
					<table width="100%">
						<tr>
							<td>
								...
								<table width="100%" border="1" cellspacing="0" cellpadding="2"
									bordercolor="#FFFFFF" bordercolordark="#F2F2F2" height="83">
									<tr>
										...
										<td width="35%" align="left" valign="middle" bgcolor="#E6ECF2">
											<html:select property="confidA" styleClass="select01"
												onchange="javascript:synconf(this.options.selectedIndex);">
												<html:options collection="confList" labelProperty="conName"
													property="conId" />
											</html:select>
										</td>
									</tr>
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="custnoA" styleClass="input_box"
									...
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="custnameA" styleClass="input_box"
												maxlength="50"></html:text>
										</td>
									</tr>
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:select property="deptcodeA" styleClass="select01">
									...
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="dutyA" styleClass="input_box"
												maxlength="50"></html:text>
										</td>
									</tr>
									<tr>
										...
										<td align="right" valign="middle" bgcolor="#E6ECF2">
											<html:button property="submit1" styleClass="button_nor"
												onclick="javascript:asubmit();">
						...
						<tr>
							<td align="center" valign="top">
								<aa:zone name="alist">
									<ec:table var="presA" items="resultA" filterable="false"
										showPagination="false"
										imagePath="${pageContext.request.contextPath}/html/commons/ximages/*.gif"
										rowsDisplayed="5"
										action="${pageContext.request.contextPath}/replacebyhand.do?aaxmlrequest=false"
										form="replacebyhandForm">
							...
							getServletContext())%>'
												width="80">
												<input type="radio" name="custidA" value="${presA.cutId}">
												<a>${presA.stuempNo}</a>
											</ec:column>
				...
				<td width="400" valign="top">
					<table width="100%">
							...
							<td>
								<table width="100%" border="1" cellspacing="0" cellpadding="2"
									...
									<tr>
										...
										<td width="35%" align="left" valign="middle" bgcolor="#E6ECF2">
											<html:select property="confidB" styleClass="select01"
												disabled="true">
												<html:options collection="confList" labelProperty="conName"
													property="conId" />
											</html:select>
									...
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="custnoB" styleClass="input_box"
												maxlength="50"></html:text>
										</td>
									</tr>
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="custnameB" styleClass="input_box"
												maxlength="50"></html:text>
										</td>
									</tr>
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:select property="deptcodeB" styleClass="select01">
												<html:option value="-">-</html:option>
												<html:options collection="deptList" labelProperty="deptName"
													property="deptCode" />
											</html:select>
									...
									<tr>
										...
										<td align="left" valign="middle" bgcolor="#E6ECF2">
											<html:text property="dutyB" styleClass="input_box"
												maxlength="50"></html:text>
										</td>
									</tr>
									<tr>
										...
										<td align="right" valign="middle" bgcolor="#E6ECF2">
											<html:button property="submit2" styleClass="button_nor"
												onclick="javascript:bsubmit();">
												<bean:message key="button.query" />
											</html:button>
										</td>
									</tr>
						...
						<tr>
							<td align="center" valign="top">
								<aa:zone name="blist">
									<ec:table var="presB" items="resultB" filterable="false"
										showPagination="false"
										imagePath="${pageContext.request.contextPath}/html/commons/ximages/*.gif"
										rowsDisplayed="5"
										action="${pageContext.request.contextPath}/replacebyhand.do?aaxmlrequest=false"
							...
							getServletContext())%>'
												width="80">
												<input type="radio" name="custidB" value="${presB.cutId}">
												<a>${presB.stuempNo}</a>
											</ec:column>
											<ec:column property="cutName" headerStyle="text-align:center"
												width="80" style="text-align:left" filterable="false" sortable="false"
			...
			<tr>
				<td align="right" valign="middle" colspan="2" class="tdborder02">
					<html:button property="submit3" styleClass="button_nor"
						onclick="javascript:return signsubmit();">
						<bean:message key="button.replace.sign" />
					</html:button>
				
					<html:button property="submit3" styleClass="button_nor"
						onclick="javascript:return  sub();">
						<bean:message key="button.sign" />
					</html:button>
				</td>
			</tr>
		</table>
...
<script>
   ...
   function sub(){
      document.forms[0].action="<%=ContextUtil.getCtxPath(request)%>/replacebyhand.do?flag=hasCardNoInfo";
   	  ajaxAnywhere.submitAJAX();
    
   }
   function asubmit(){   	
   		document.forms[0].action="<%=ContextUtil.getCtxPath(request)%>/replacebyhand.do?flag=A";
   		ajaxAnywhere.submitAJAX();
   }
   function bsubmit(){   
      	document.forms[0].action="<%=ContextUtil.getCtxPath(request)%>/replacebyhand.do?flag=B";
   		ajaxAnywhere.submitAJAX();
   }
   
   function signsubmit(){
   		document.forms[0].action="<%=ContextUtil.getCtxPath(request)%>/replacebyhand.do?flag=all";
   		ajaxAnywhere.submitAJAX();
   }
   
   function synconf(id){
   	document.forms[0].confidB.options[id].selected=true;
   }
