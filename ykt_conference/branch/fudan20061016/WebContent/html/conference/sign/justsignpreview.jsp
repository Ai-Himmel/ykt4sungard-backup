...
<head>
	...
	<link
		...
		rel="stylesheet" type="text/css">
	<META http-equiv="REFRESH" content="5;URL=<%=ContextUtil.getCtxPath(request)%>/preview.do?confid=<%=ParamUtil.getString(request, "confid")%>&attendeesign=prev&selecttype=totle">
</head>
				...
				<td align="center" valign="middle">
					<table width="95%" border="0" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td width="100%" align="center" valign="middle" class="medium">
								<input type="hidden" name="timeout"
									value="<%=request.getAttribute("timeout") == null ? "9900"
					: request.getAttribute("timeout")%>">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<font color="#9B772B" size="5"><strong><%=conference.getConName()%>
								</strong> </font>
							</td>
...
function dochange(){
	alert(document.getElementById('top').style.display);
}
