...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	...
	<SCRIPT language="javascript">
	function  add(){
	 window.open('<%=ContextUtil.getCtxPath(request)%>/html/conference/sign/addnocardnoinfo.jsp','无卡无名单增加','top=450,left=600,height=400,width=600,scrollbars=no,resizable=no,status=no,toolbar=no,menubar=no,location=no'); 	
	}
