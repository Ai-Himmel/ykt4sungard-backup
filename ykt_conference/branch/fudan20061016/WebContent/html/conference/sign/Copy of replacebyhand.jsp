							...
							<td align="center" valign="top">
								<aa:zone name="alist">
									<table>
										...
										<logic:present name="resultA" scope="request">
											<logic:iterate name="resultA" id="presA" indexId="i">
												<tr align="center" valign="middle">
													<td height="24" align="center" valign="middle">
														<input type="radio" name="custidA"
															value="<bean:write name="presA" property="cutId" />">
													</td>
													<td align="center" valign="middle">
														<bean:write name="presA" property="stuempNo" />
													</td>
													<td align="center" valign="middle">
														<bean:write name="presA" property="cutName" />
														&nbsp;
													</td>
													<td align="center" valign="middle">
														<bean:write name="presA" property="deptName" />
														&nbsp;
													</td>
												</tr>
											</logic:iterate>
							...
							<td align="center" valign="top">
								<aa:zone name="blist">
									<table>
										...
										<logic:present name="resultB" scope="request">
											<logic:iterate name="resultB" id="presB" indexId="i">
												<tr align="center" valign="middle">
													<td height="24" align="center" valign="middle">
														<input type="radio" name="custidB"
															value="<bean:write name="presB" property="cutId" />">
													</td>
													<td align="center" valign="middle">
														<bean:write name="presB" property="stuempNo" />
													</td>
													<td align="center" valign="middle">
														<bean:write name="presB" property="cutName" />
														&nbsp;
													</td>
													<td align="center" valign="middle">
														<bean:write name="presB" property="deptName" />
														&nbsp;
													</td>
												</tr>
											</logic:iterate>
...
<script>
   ...
   function bsubmit(){   
   		document.all.flag.value="B";
   		ajaxAnywhere.submitAJAX();
   }
   
   function signsubmit(){
   		document.all.flag.value="all";
   		ajaxAnywhere.submitAJAX();
   }
