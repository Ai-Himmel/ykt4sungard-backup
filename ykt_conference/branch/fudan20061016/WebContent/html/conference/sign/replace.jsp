...
<body bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
	...
	<form id="Replace" name="Replace"
		action="<%=ContextUtil.getCtxPath(request)%>/replace.do" method=post>
			...
			<tr>
				<td height="25" align="left" valign="middle"
					...
					<span class="mediumwhite"><strong>&nbsp;&nbsp;&nbsp;<bean:message
								key="sign.replacesign" /> </strong> </span>
				</td>
			</tr>
			<tr>
	...
	<form id="ReplaceForm" name="ReplaceForm"
			action="<%=ContextUtil.getCtxPath(request)%>/replace.do" method=post>
	<table width="800" border="0" align="center" cellpadding="0"
		cellspacing="0">
			...
			<tr>
				<td height="30" align="left" valign="middle" class="medium">
					<font color="#000099"><strong><bean:message
								key="sign.replacer.info" /> </strong> </font>
				</td>
			</tr>
			<tr>
				<td align="left" valign="top">
					<table width="100%" border="1" cellspacing="0" cellpadding="2"
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name="repname" class="input_box" style="width: 150"
									maxlength=15>
							</td>
						</tr>
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name="repduty" class="input_box" style="width: 150"
									maxlength=20>
							</td>
						</tr>
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E6ECF2">
								<input name="repcomments" class="input_box" style="width: 400"
									maxlength=30>
							</td>
						</tr>
					</table>
...
function dosign(){
		if(document.ReplaceForm.custid.value==''){
			alert("请选择需要替代签到的人员！");
			return false;
		}
		if(document.ReplaceForm.repname.value==''){
			alert("请填写替代签到的人员！");
			return false;
		}
		document.ReplaceForm.action='<%=ContextUtil.getCtxPath(request)%>/replace.do?cmd=sign';
		document.ReplaceForm.submit();
	}
	
	function undosign(){
		if(document.ReplaceForm.custid.value==''){
			alert("请选择需要取消替代签到的人员！");
			return false;
		}
		document.ReplaceForm.action='<%=ContextUtil.getCtxPath(request)%>/replace.do?cmd=unsign';
		document.ReplaceForm.submit();
	}
</SCRIPT>
</body>
