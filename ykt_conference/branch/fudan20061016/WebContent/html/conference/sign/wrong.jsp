...
<body   bgcolor="#EFEFEF" leftmargin="0" topmargin="0">
    ...
    <tr> 
      <td align="center" valign="top"><table width="400" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="20%" align="center" valign="top"><img src="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/wrong.gif" width="60" height="60"></td>
	...
	<script>
	function cancelPage() {
      	self.location = '<%=ContextUtil.getCtxPath(request)%>/sign/attendeelist.do';
	}
	</script>
</body>
