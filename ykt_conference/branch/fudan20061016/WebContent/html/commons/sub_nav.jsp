...
<%
	...
	List childList = OperatorUtil.getUserChildFuncList((String) request
			.getSession().getAttribute("username"), parentId);
%>
<style media="print">
.noprint{display:none}
</style>

<body bgcolor="#F7F7F7" leftmargin="0" topmargin="0" class="noprint">
	<table id="leftmenu" width="138" border="0" cellspacing="0"
		cellpadding="0" >
		<tr>
		...
		<tr>
			<td align="center" valign="top">
				<img
					src="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/left_menutop.gif"
					width="138" height="5">
			</td>
		</tr>
		<tr>
			<td height="30" align="center" valign="middle" class="medium">
				<strong><%=GetDictionary.getFuncName(parentId)%> </strong>
			</td>
		</tr>
		<tr>
			<td align="center" valign="top">
				...
				%>
				<table width="132" height="32" border="0" cellpadding="0"
					cellspacing="0">
					<tr>
						<td align="center" valign="top">
							<img
								src="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/left_menu_touming.gif"
								width="10" height="10">
						</td>
					</tr>
					<tr>
							...
							<table width="132" height="32" border="0" cellpadding="0"
								...
								<tr>
									<td align="center" valign="middle"
										background="<%=ContextUtil.getCtxPath(request)%>/html/commons/images/left_menu.gif"
										class="medium">
										<a name="submenus"
											href="<%=ContextUtil.getCtxPath(request)%><%=func.getFuncUrl()%>"
											target="dataframe" class="topmenu_link"
											onclick="javascript:processtopmenu(this)"><%=func.getFuncName()%>
										</a>
										<input type=hidden name="hidden_submenus"
											value="<%=ContextUtil.getCtxPath(request)%><%=func.getFuncUrl()%>">
									</td>
								</tr>
							</table>
						</td>
