  ...
  <div id="container">
    <p><span class="yelText">您正使用即时到账交易:</span>付款后资金直接进入对账户</p>
      <div class="green_tb">
        ...
        <div class="flt rgtPadd imgtopPadd">
        	<img src="<c:url value="/theme/style/epay/images/succico.gif"/>"/>
        </div>
        <div class=" flt F14">
        	<p class="Font14">您已经成功付款<bean:write name="payForm" property="v_amount"/>元,账户余额<bean:write name="balance"/></p>
        ...
        <div class="frt"><img src="<c:url value="/theme/style/epay/images/sec.gif"/>" /></div>
        </div>
      </div>
    </div>
