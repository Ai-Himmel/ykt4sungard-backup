...
function check()
{
	...
	var v_add_offDutyLastTime=addConf.add_offDutyLastTime.value;		var v_add_add_checkTime = addConf.add_checkTime.value;
	if(v_add_confName==''||v_add_ondutyAdvancedTime==''||v_add_offDutyLastTime=='' || v_add_add_checkTime=='')
	{
		alert('有标记的项必须输入!');
		return false;
	}
