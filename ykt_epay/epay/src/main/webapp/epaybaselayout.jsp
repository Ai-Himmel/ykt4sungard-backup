...
<%@ include file="WEB-INF/pages/include/epaystyle.jsp"%>


<tiles:importAttribute name="title"/>
<title><bean:message name="title"/></title>
<script type="text/javascript" src="<c:url value='/theme/scripts/selectbox.js'/>" ></script>
<script type="text/javascript" src="<c:url value='/theme/scripts/global.js'/>" charset="gbk"></script>
</head>
