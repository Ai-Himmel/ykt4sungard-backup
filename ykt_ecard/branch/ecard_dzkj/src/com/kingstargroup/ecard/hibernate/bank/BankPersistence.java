 ...
 * @since 1.0
 */
public class BankPersistence extends BasicPersistence {

	public String getBankAccountFromDB(int custid, String bankcode) throws DBSystemException {
		String bankacc = "";
		Session s = null;
		try {
			s = getSession();
			TbankcardId tbankcardid = new TbankcardId(new Integer(custid), bankcode);
			Tbankcard tbankcard = (Tbankcard) s.get(Tbankcard.class,tbankcardid);
			if(tbankcard!=null){
	...
	public void updateBankAccountToDB(int custid, String bankcode,String bankcardno) throws DBSystemException {
		Session s = null;
		try {
			s = getSession();
			TbankcardId tbankcardid = new TbankcardId(new Integer(custid), bankcode);
	...
	public void removeBankAccountFromDB(int custid, String bankcode,String bankcardno) throws DBSystemException {
		Session s = null;
		try {
			s = getSession();
			TbankcardId tbankcardid = new TbankcardId(new Integer(custid), bankcode);
