...
public class EcardImageServlet extends HttpServlet {
		...
		try {
			...
			if (id == null) {				
				...
				if (cmd.equals("download")) {
					...
					_writePortrait(stuempNo, res, "application/octet-stream", header);
				} else {
	...
	private void _writePortrait(String stuempNo, HttpServletResponse res, String contentType, String header) throws PortalException {		
