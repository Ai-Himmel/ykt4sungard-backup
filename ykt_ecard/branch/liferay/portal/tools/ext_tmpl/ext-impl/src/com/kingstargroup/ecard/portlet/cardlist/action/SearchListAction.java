 ...
 * File name: SearchListAction.java<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class SearchListAction extends PortletAction {
	/* (non-Javadoc)
	...
	public ActionForward execute(
		...
		try {
			...
			req.setAttribute("result", EcardInformationServiceUtil.search(title, content, EcardConstants.INFORMATION_CARDLIST_TYPE, page,EcardConstants.LIST_MORE_SIZE));
			return mapping.findForward("portlet.ecardlist.search_result");
