 ...
 * File name: SearchRuleAction.java<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class SearchRuleAction extends PortletAction {
	/* (non-Javadoc)
	...
	public ActionForward execute(
		...
		int page = com.liferay.portal.kernel.util.ParamUtil.get(req, "page", 0);
		try {
			...
			req.setAttribute("result", EcardInformationServiceUtil.search(title, content, EcardConstants.INFORMATION_RULE_TYPE, page));
			return mapping.findForward("portlet.ecardrule.search_result");
