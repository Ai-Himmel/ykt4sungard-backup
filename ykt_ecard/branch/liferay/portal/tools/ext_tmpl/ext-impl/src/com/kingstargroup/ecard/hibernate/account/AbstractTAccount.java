...
public abstract class AbstractTAccount implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractTAccount(String accno, Long acctype, String accname,
			...
			Long subsidyno, Long lastsubsidyno, Double daycostamt,
			String lasttransdate, String lastaccdate, String opendate,
			String closedate, Double singlemaxamt) {
		this.accno = accno;
