 ...
 * File name: SearchMapAction.java<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class SearchMapAction extends PortletAction {
	/* (non-Javadoc)
	...
	public ActionForward execute(
		...
		try {
			...
			req.setAttribute("result", EcardInformationServiceUtil.search(title, content, EcardConstants.INFORMATION_DISTRIBUTION_TYPE, page));
			return mapping.findForward("portlet.distribution.search_result");
