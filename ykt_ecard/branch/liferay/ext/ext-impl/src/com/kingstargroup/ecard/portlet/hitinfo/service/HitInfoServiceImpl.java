...
public class HitInfoServiceImpl extends HitInfoServiceBase {
	 ...
	 *             Modify History:
	 */
	public ResultPage getHitInfos(int page) throws PortalException {
		return hitInfoPersistence.search("", page, EcardConstants.HIT_INFO_SIZE);
	}
	
	public ResultPage getHitInfos(int page, int size) throws PortalException {
		return hitInfoPersistence.search("", page, size);
	}
