 ...
 * @since 1.0
 */
public class ViewShopTotalReportAction extends PortletAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		datetime = com.kingstargroup.ecard.util.DateUtil.getOtherDate(datetime,
				"yyyy/MM/dd", -1);
		req.setAttribute("shoptotalreport_begindate", datetime);
		req.setAttribute("shoptotalreport_enddate", datetime);
