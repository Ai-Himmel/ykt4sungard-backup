 ...
 * File name: AddLostFoundAction<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class AddLostFoundAction extends PortletAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws Exception {
		try {
			...
			// String creater =
			// GetterUtil.get((String)req.getSession().getAttribute("j_username"),
			// StringPool.BLANK);

			if (isTokenValid(req)) {

				EcardInformationServiceUtil.add(title, content, "", String.valueOf(EcardConstants.INFORMATION_LOSTFOUND_TYPE), creater);
				resetToken(req);
			}
			...
			return mapping.findForward("portlet.lostfound.admin");
