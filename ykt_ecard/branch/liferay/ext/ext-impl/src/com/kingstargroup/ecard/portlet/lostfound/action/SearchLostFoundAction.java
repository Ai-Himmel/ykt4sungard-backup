 ...
 * File name: SearchLostFoundAction<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class SearchLostFoundAction extends PortletAction {
	/*
	 * (non-Javadoc)
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		try {
			...
			req.setAttribute("result", EcardInformationServiceUtil.search(title, content, EcardConstants.INFORMATION_LOSTFOUND_TYPE, page, EcardConstants.LIST_MORE_SIZE));
			return mapping.findForward("portlet.lostfound.search_result");
