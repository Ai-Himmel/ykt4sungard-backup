 ...
 * @since 1.0
 */
public class ViewShopDinnerTotalReportAction extends PortletAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		datetime = com.kingstargroup.ecard.util.DateUtil.getOtherDate(datetime,
				"yyyy/MM/dd", -1);
		req.setAttribute("shopdinnertotalreport_begindate", datetime);
		req.setAttribute("shopdinnertotalreport_enddate", datetime);
