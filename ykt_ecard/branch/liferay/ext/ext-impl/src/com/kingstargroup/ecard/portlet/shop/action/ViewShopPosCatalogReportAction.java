 ...
 * @since 1.0
 */
public class ViewShopPosCatalogReportAction extends PortletAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		datetime = com.kingstargroup.ecard.util.DateUtil.getOtherDate(datetime,
				"yyyy/MM/dd", -1);
		req.setAttribute("shopposcatalogreport_begindate", datetime);
		req.setAttribute("shopposcatalogreport_enddate", datetime);
