 ...
 * @since 1.0
 */
public class ViewShopCatalogReportAction extends PortletAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		datetime = com.kingstargroup.ecard.util.DateUtil.getOtherDate(datetime,
				"yyyy/MM/dd", -1);
		req.setAttribute("shopcatalogreport_begindate", datetime);
		req.setAttribute("shopcatalogreport_enddate", datetime);
