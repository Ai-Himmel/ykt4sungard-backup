 ...
 * File name: AddPostponeResultAction.java<br>
 * Description: <br>
 * Modify History: <br>
 ...
 * @since 1.0
 */
public class AddPostponeResultAction extends PortletAction {
	...
	public ActionForward execute(
		...
		throws Exception {
		try {
			String reason = com.liferay.portal.kernel.util.ParamUtil.get(req, "reason", "");
			String postponeTime = com.liferay.portal.kernel.util.StringUtil.replace(com.liferay.portal.kernel.util.ParamUtil.get(req, "postponeTime", ""), '/', "");
			...
			if (isTokenValid(req)) {
				PostponeServiceUtil.addPostpone(reason, stuempNo, postponeTime);
				resetToken(req);
			}			
