...
/**
 * Copyright (C), 2000-2005, Kingstar Co., Ltd. File name: DeleteLostFoundAction
 ...
 * @since 1.0
 */
public class DeleteLostFoundAction extends PortletAction {
	/*
	 * (non-Javadoc)
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws Exception {
		try {
			...
			EcardInformationServiceUtil.deleteInfomations(ids);
