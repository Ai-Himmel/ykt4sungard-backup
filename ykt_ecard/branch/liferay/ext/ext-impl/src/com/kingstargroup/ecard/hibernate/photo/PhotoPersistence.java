...
public class PhotoPersistence extends BasePersistence {
	public TPhoto getPhoto(String stuempno) throws DBSystemException {
		...
		try {
			...
			hsql
					.append(
							"select photo from com.kingstargroup.ecard.hibernate.photo.TPhoto photo,com.kingstargroup.ecard.hibernate.customer.TCustomer cust where")
					.append(" photo.custid=cust.custid and")
					.append(" cust.stuempno = ?");
