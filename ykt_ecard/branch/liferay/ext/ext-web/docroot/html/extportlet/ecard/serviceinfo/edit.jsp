...
<%@ include file="/html/extportlet/ecard/serviceinfo/permission.jsp" %>
    ...
    <table width="80%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- content table -->
        <%        	
			ResultPage result = EcardInformationServiceUtil.list(EcardConstants.INFORMATION_SERVICEINFO_TYPE);
		...
		%>
        <html:form action="/ext/ecardserviceedit_result" method="POST"
