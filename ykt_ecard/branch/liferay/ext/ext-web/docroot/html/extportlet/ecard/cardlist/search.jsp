...
<html:form action="/ext/ecardlistsearch_result" method="POST"
	...
	<tr>
		<td align="center">
			...
			<tr>
				<td></td>
				<td>
					<html:submit styleClass="portlet-form-button" property="search" value='<%= LanguageUtil.get(pageContext, "ecardlist.button.search") %>' /> 
				</td>
			</tr>
			<tr>
				<td colspan="2">
