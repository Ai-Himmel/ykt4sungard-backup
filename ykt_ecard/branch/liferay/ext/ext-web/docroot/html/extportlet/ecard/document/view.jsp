...
<table width="719" height="29" border="0" cellpadding="0"
	...
	<tr>
		<td>			
			<a class="txt_or"
					href="<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecarddocadmin" /></portlet:renderURL>">
				...
				<tr>
					<td>
						<img src="/html/extthemes/classic/images/ecard/jiantou.jpg"
							width="8" height="8">
						<a href="/ext/ecardfiledownload?id=<%=attachIds[0]%>"
...
<script>
function goto(page) {
	self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecarddocview" /></portlet:renderURL>&page=' + page;
}
</script>