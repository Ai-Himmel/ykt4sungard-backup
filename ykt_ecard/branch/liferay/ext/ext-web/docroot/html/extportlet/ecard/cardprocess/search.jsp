...
<html:form action="/ecardcardprocess/search_result" method="POST"
	...
	<tr>
		<td align="center">
			...
			<tr>
				<td>&nbsp;</td>
						<td align=left><font class="portlet-msg-error" style="font-size: 15px;"><html:errors
							property="search_title" /></font><br>
						<font class="portlet-msg-error" style="font-size: 15px;"><html:errors
							property="content" /></font></td>
			</tr>
			<tr>
				<td>
					<font class="portlet-font" style="font-size: 15px;"><b>
			...
			<tr>
				<td></td>
				<td>
					<html:submit styleClass="portlet-form-button" property="search" value='<%= LanguageUtil.get(pageContext, "ecardtutorial.button.search") %>' /> 
				</td>
			</tr>
			<tr>
				<td colspan="2">
