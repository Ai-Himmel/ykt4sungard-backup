...
<script language="JavaScript" src="/html/extjs/util.js"></script>
	...
	<table>
		<tr>
			...
			<td>
				...
				<html:form action="/enterprise_admin/shop_admin_save_shop" method="POST"
	...
	<script>
	   ...
	   function setCmdValue() {             
            var childs = document.all.ShopBindForm;
            var storelimit = '';
            ...
            document.ShopBindForm.storeLimitString.value = storelimit;
            document.ShopBindForm.cmd.value = cmd;
            document.ShopBindForm.submit();
        }
