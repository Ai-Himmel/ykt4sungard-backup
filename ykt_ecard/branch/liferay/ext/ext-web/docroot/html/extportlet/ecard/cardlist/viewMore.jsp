...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="2%">&nbsp;</td>
          <td width="72%" class="text_blue_12_c"><bean:message key="ecardlist.tab.cardlist" /></td>
        ...
        <!-- content table -->
          ...
          <table cellpadding="4" cellspacing="0" width="100%">
							...
							<img src="/html/extthemes/classic/images/ecard/jiantou.jpg" width="8" height="8">
			                  <a href="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardlistview" /></portlet:renderURL>&id=<%= info.getId()%>" class=blue_link_line>
			                  	<%= info.getInfoTitle()%>(<%= info.getCreateDate() ==null?"":format.format(info.getCreateDate())%>)</a>
			                  		</td>
			                  	</tr>
			                	<%}%>
			                	<tr>
...
<script>
function goto(page) {
	self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardlistview" /></portlet:renderURL>&page=' + page;
}
</script>