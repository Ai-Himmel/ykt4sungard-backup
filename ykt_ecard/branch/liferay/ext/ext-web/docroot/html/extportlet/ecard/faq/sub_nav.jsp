<%@ include file="/html/extportlet/ecard/faq/init.jsp" %>
	...
	<table width="243" height="20"  border="1" cellpadding="0" cellspacing="0">
	  <tr>
	    <td valign="top" >	    
	    <table width="100%" height="7"  border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td width="239" height="36" valign="bottom" >
    ...
    <table width="243" height="100"  border="1" cellpadding="0" cellspacing="0" >
      <tr>
      <c:choose>
