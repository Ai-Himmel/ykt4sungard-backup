...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td valign="top">
        <!-- content table -->
        <html:form action="/ext/ecardnewsadd_result" method="POST"
...
function renderAdminPage() {
	self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardnewsadmin" /></portlet:renderURL>';
}
</script>