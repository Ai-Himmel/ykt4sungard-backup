...
<%@ include file="/html/extportlet/ecard/msgboard/permission.jsp" %>
<%
...
ResultPage curpage = MsgBoardServiceUtil.list(search_title, search_content, 											
											pageNum, 
...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="2%">&nbsp;</td>
            <td width="72%" class="text_blue_12_c"><bean:message key="ecardmsgboard.tab.delete" /></td>
...
<table width="719"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td valign="top">
          <!-- content table -->
          <form name=InfoDelForm action="<portlet:actionURL><portlet:param name="struts_action" value="/ext/ecardmsgboarddelete" /></portlet:actionURL>" method="POST"
	onSubmit="javascript:submitForm(this); return false;">
       ...
       <c:if test="<%= SessionErrors.contains(request, EcardConstants.CHOOSE_DEL_CONTENT) %>">		
		...
		<tr>
			<td>				
					...
					<input type="button" name="reset" class="button_blank" value="<%=LanguageUtil.get(pageContext, "ecard.reset")%>">				
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
      ...
      <tr class="list_tr">
		...
		<td width=70% align=center>
			<a class=text_blue_12_c><bean:message key="ecardmsgboard.content.title" /></a>
		</td>
		<td width=15% align=center>
			<a class=text_blue_12_c><bean:message key="ecardmsgboard.content.posttime" /></a>
		</td>
		<td width=12% align=center>
			<a class=text_blue_12_c><bean:message key="ecardmsgboard.content.msger" /></a>
		</td>
      </tr>
	...
	<tr class="tr_<%= classId%>" style="font-size: x-small;">
		<td width=10>
		<input type="checkbox" name="ids" value="<%= String.valueOf(msg.getId())%>" 
