...
<%
	...
	if (stuempInfo==null){
		...
		cardno = stuempInfo.get("custid").toString();
		cardphyid = stuempInfo.get("cardphyid").toString();
		cardshowno = stuempInfo.get("showcardno").toString();
		stuempno = stuempInfo.get("stuempno").toString();
		status = stuempInfo.get("dictcaption").toString();	
	}
		...
		<tbody>
			<tr align="center" valign=center>
				...
				<td width="85%" align="left" valign="middle" bgcolor="#E7F1F5">
					<input readonly="true" name="cardno" class="input_box" maxlength=20 value='<%=cardno %>'>
				</td>
			</tr>
			<tr>
				...
				<td width="85%" align="left" valign="middle" bgcolor="#E7F1F5">
					<input readonly="true" name="cardphyid" class="input_box" maxlength=20 value='<%=cardphyid %>'>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" valign="middle" bgcolor="#D1DAE9">
				...
				<td width="85%" align="left" valign="middle" bgcolor="#E7F1F5">
					<input readonly="true" name="cardshowno" class="input_box" maxlength=20 value='<%=cardshowno %>'>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" valign="middle" bgcolor="#D1DAE9">
				...
				<td width="85%" align="left" valign="middle" bgcolor="#E7F1F5">
					<input readonly="true" name="stuempno" class="input_box" maxlength=20 value='<%=stuempno %>'>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" valign="middle" bgcolor="#D1DAE9">
				...
				<td width="85%" align="left" valign="middle" bgcolor="#E7F1F5">
					<input readonly="true" name="status" class="input_box" maxlength=20 value='<%=status %>'>
				</td>
			</tr>
			<tr>
				<td width="15%" align="right" valign="middle" bgcolor="#D1DAE9">
