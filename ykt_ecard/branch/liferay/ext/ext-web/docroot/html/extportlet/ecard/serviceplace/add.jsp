...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td valign="top">
			<!-- content table -->
			<!-- content table -->
			<html:form action="/ext/serviceplaceadd_result" method="POST"
...
function renderAdminPage() {
	self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/serviceplaceview" /></portlet:renderURL>';
}
</script>