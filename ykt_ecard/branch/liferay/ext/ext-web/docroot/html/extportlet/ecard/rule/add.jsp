...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td valign="top">
			<!-- content table -->
			<html:form action="/ext/ecardruleadd_result" method="POST"
...
<script>
	function renderAdminPage() {
		self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecardruleadmin" /></portlet:renderURL>';
	}
	</script>