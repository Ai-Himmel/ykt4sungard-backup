...
<%@ include file="/html/extportlet/ecard/cardprocess/permission.jsp"%>
<%
	...
	ResultPage curpage = EcardInformationServiceUtil.search(
			...
			EcardConstants.INFORMATION_CARDPROCESS_TYPE, pageNum,
	...
	<tr>
		...
		<td valign="top">
			...
			<form name=InfoDelForm
				action="<portlet:actionURL><portlet:param name="struts_action" value="/ext/ecardcardprocessdelete" /></portlet:actionURL>"
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<c:if
						...
						<tr>
							<td>
								<font class="portlet-msg-error" style="font-size: 15px;"> <bean:message
...
<form name=rendereditfm method=post
	action="<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecardcardprocessedit" /></portlet:renderURL>">
...
function renderAddPage() {
	self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecardcardprocessadd" /></portlet:renderURL>';
}
</script>