...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top">
        <!-- content table -->
        <html:form action="/ext/ecardfaqadd_result" method="POST"
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>            
            ...
            <td width="70%" valign="baseline" class="text_or_12">
            <select name="subType">
						<%List list = InfoTypeServiceUtil.getChildList(EcardConstants.INFORMATION_FAQ_TYPE).getList();
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <c:choose>
                 ...
                 <td width="20%" valign="top" align=left><font style="font-size: 11;">
	...
	function renderAdminPage() {
		self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardfaqadmin" /></portlet:renderURL>';
	}
	</script>