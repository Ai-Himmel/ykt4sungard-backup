              ...
              <tr>
                ...
                <td valign="top">
                  ...
                  <tr>
                    ...
                    <a class=blue_link_line href="javascript:setRenderEditForm('<%= msg.getId()%>', '<%= search_title%>' , '<%= search_content%>', '<%= passPage%>');">
                    <img src="/html/extthemes/classic/images/ecard/portlet/button.jpg" width="58" height="16" border="0"></a>
                    </c:if>
                  ...
                  <c:if test="<%= !msg.getStatus().equals(EcardConstants.MSG_NO_REPLY)%>">
		           <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="3%"><img src="/html/extthemes/classic/images/ecard/pic_an.jpg" width="20" height="24"></td>
	            ...
	            <table width="100%" height="8"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <%}%>
                  <!-- content table -->
 <form name=rendereditfm method=post action="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardmsgboardreply" /></portlet:renderURL>">
...
function goto(page) {
	...
	submitPortletForm(document.InfoSearchForm);
}
</script>