...
<%
	...
	ResultPage curpage = EcardInformationServiceUtil.search(
			...
			EcardConstants.INFORMATION_LOSTFOUND_TYPE, pageNum,
	...
	<tr>
		...
		<td valign="top" >
			...
			<form name=InfoDelForm
				action="<portlet:actionURL><portlet:param name="struts_action" value="/ext/lostfounddelete" /></portlet:actionURL>"
...
<form name=rendereditfm method=post
	action="<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/lostfoundedit" /></portlet:renderURL>">
...
function renderAddPage() {
	self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/lostfoundadd" /></portlet:renderURL>';
}
</script>