...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td valign="top">
        <!-- content table -->
        <html:form action="/ext/ecardmsgboardadd_result" method="POST"
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="29%" align=left><font style="font-size: 11;"><html:errors
							property="title" />
							</font></td>
          </tr>
        </table>
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <html:textarea property="content" style="width:510px" rows="20" /></td>
                          <td width="12%" valign="top" align=left><fontstyle="font-size: 11;"><html:errors
							property="content" />
							</font></td>
            </tr>
          </table>
