...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="2%">&nbsp;</td>
          <td width="72%" class="text_blue_12_c"><bean:message key="ecardlist.tab.addlist" /></td>
						...
						<script>
							...
							//save the editor's content to hidden field "content"
								...
								function setCmdType(cmd) {
									document.all.CardlistInputForm.cmd.value = cmd;
								}
						</script>
	...
	function renderAdminPage() {
		self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardlistadmin" /></portlet:renderURL>';
	}
	</script>