...
<jsp:include page="allshopaccount_query.jsp"></jsp:include>
			...
			<tr>
				<td>
					<display:table name="result" pagesize="10" class="isis"
						style="width:100%" requestURI="/ext/allshopaccount_queryresult"
						export="false">
