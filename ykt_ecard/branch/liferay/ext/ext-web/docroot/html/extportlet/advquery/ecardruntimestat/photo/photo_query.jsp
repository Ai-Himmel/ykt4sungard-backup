...
<c:if
	test="<%=SessionErrors.contains(request,
								EcardConstants.PHOTO_ERROR_EXIST)%>">
	<font class="portlet-msg-error"> <%=LanguageUtil.format(pageContext,
								EcardConstants.PHOTO_ERROR_EXIST, SessionErrors.get(
										request, EcardConstants.PHOTO_ERROR_EXIST))%>
	</font>
</c:if>
					...
					<tr>
						<td nowrap="nowrap">
							...
							<html:radio property="statType" value="bydate"
								onclick="javascript:setphotoformQueryType('bydate')"></html:radio>
							<bean:message key="query.bydate" />
							<html:radio property="statType" value="bymonth"
								onclick="javascript:setphotoformQueryType('bymonth')"></html:radio>
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													...
													onclick="WdatePicker({el:'photo_begindate'})" /> </a>
										</td>
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'photo_enddate'})"
/> </a>
										</td>
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'photo_begindate',dateFmt:'yyyy-MM'})" /> </a>
										</td>
										<td width="8%" nowrap="nowrap">
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'photo_enddate',dateFmt:'yyyy-MM'})" /> </a>
										</td>
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'photo_begindate'})"
 /> </a>
										</td>
										<td width="8%" nowrap="nowrap">
											<bean:message key="query.enddate" />
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'photo_enddate'})"/> </a>
										</td>
