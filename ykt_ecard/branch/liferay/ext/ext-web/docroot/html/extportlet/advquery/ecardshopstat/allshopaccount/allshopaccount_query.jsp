...
<c:if
	test="<%=SessionErrors.contains(request,
								EcardConstants.ALLSHOPACCOUNT_ERROR_EXIST)%>">
	<font class="portlet-msg-error"> <%=LanguageUtil.format(pageContext,
								EcardConstants.ALLSHOPACCOUNT_ERROR_EXIST, SessionErrors.get(
										request, EcardConstants.ALLSHOPACCOUNT_ERROR_EXIST))%> </font>
</c:if>

<html:form action="/ext/allshopaccount_queryresult" method="POST"
					...
					<tr>
						<td nowrap="nowrap" width="50%">
							...
							<html:radio property="statType" value="bydate"
								onclick="javascript:setallshopaccountformQueryType('bydate')"></html:radio>

							<bean:message key="query.bydate" />
							<html:radio property="statType" value="byweek"
								onclick="javascript:setallshopaccountformQueryType('byweek')"></html:radio>

							<bean:message key="query.byweek" />
							<html:radio property="statType" value="bymonth"
								onclick="javascript:setallshopaccountformQueryType('bymonth')"></html:radio>
								...
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allshopaccount_begindate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_begindate'})"
													/> </a>
										</td>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allshopaccount_enddate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_enddate'})"
													 /> </a>
										</td>
								...
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="34%" align="center">
											<button onclick="document.allshopaccountform.submit();">
												<bean:message key="btn.query" />
											</button>
											<button onclick="document.allshopaccountform.reset();">
							...
							<td height="40">
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allshopaccount_begindate"
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_begindate',dateFmt:'yyyy-MM'})"
													 /> </a>
										</td>
										<td width="8%" nowrap="nowrap">
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allshopaccount_enddate" readonly="true"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_enddate',dateFmt:'yyyy-MM'})"
													/> </a>
										</td>
							...
							<td height="40">
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allshopaccount_begindate" readonly="true"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_begindate'})"/> </a>
										</td>
										<td width="8%" nowrap="nowrap">
											<bean:message key="query.enddate" />
										</td>
										...
										<td width="20%" nowrap="nowrap">
											<a href="#"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allshopaccount_enddate'})"/> </a>
										</td>
	...
	<script>
    function setallshopaccountformQueryType(typevalue) {
        document.allshopaccountform.querytype.value = typevalue;
        document.allshopaccountform.submit();
    }
</script>
</html:form>
