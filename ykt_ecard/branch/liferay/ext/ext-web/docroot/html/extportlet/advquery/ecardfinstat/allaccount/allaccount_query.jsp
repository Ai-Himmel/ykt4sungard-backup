...
<c:if
	test="<%=SessionErrors.contains(request,
								EcardConstants.ALLACCOUNT_ERROR_EXIST)%>">
	<font class="portlet-msg-error"> <%=LanguageUtil.format(pageContext,
								EcardConstants.ALLACCOUNT_ERROR_EXIST, SessionErrors.get(
										request, EcardConstants.ALLACCOUNT_ERROR_EXIST))%> </font>
</c:if>
					...
					<tr>
						<td nowrap="nowrap" width="50%">
							...
							<html:radio property="statType" value="bydate"
								onclick="javascript:setallaccountformQueryType('bydate')"></html:radio>

							<bean:message key="query.bydate" />
							<html:radio property="statType" value="byweek"
								onclick="javascript:setallaccountformQueryType('byweek')"></html:radio>

							<bean:message key="query.byweek" />
							<html:radio property="statType" value="bymonth"
								onclick="javascript:setallaccountformQueryType('bymonth')"></html:radio>
								...
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allaccount_begindate" styleId="allaccount_begindate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="javascript:void(0);"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allaccount_begindate'})" /> </a>
										</td>
										<td width="8%" nowrap="nowrap">
											<bean:message key="query.enddate" />
										</td>
										<td width="20%" nowrap="nowrap">
											<html:text property="allaccount_enddate" styleId="allaccount_enddate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="javascript:void(0);"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allaccount_enddate'})"  /> </a>
										</td>
							...
							<td height="40">
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td width="20%" nowrap="nowrap">
											<html:text property="allaccount_begindate" readonly="true" styleId="allaccount_begindate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="javascript:void(0);"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allaccount_begindate',dateFmt:'yyyy-MM'})" /> </a>
										</td>
										<td width="8%" nowrap="nowrap">
											<bean:message key="query.endmonth" />
										</td>
										<td width="20%" nowrap="nowrap">
											<html:text property="allaccount_enddate" readonly="true" styleId="allaccount_enddate"></html:text>
										</td>
										<td width="20%" nowrap="nowrap">
											<a href="javascript:void(0);"><img
													src="/html/extthemes/classic/images/advquery/search.jpg"
													width="33" height="22" border="0"
													onclick="WdatePicker({el:'allaccount_enddate',dateFmt:'yyyy-MM'})" /> </a>
										</td>
