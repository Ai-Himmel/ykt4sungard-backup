...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <script>
function renderView() {
	self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ext/ecardlistview" /></portlet:renderURL>';
}
</script>