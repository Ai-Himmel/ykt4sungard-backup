<%@ include file="/html/extportlet/ecard/cardnews/init.jsp"%>
<%@ include file="/html/extportlet/ecard/cardnews/permission.jsp"%>
<%
	...
	ResultPage curpage = EcardInformationServiceUtil.search(
			...
			EcardConstants.INFORMATION_NEWS_TYPE, pageNum,
	...
	<tr>
		...
		<td valign="top" >
			...
			<form name=InfoDelForm
				action="<portlet:actionURL><portlet:param name="struts_action" value="/ext/ecardnewsdelete" /></portlet:actionURL>"
...
<form name=rendereditfm method=post
	action="<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecardnewsedit" /></portlet:renderURL>">
...
function renderAddPage() {
	self.location = '<portlet:renderURL windowState="<%=WindowState.MAXIMIZED.toString()%>" portletMode="<%=PortletMode.VIEW.toString()%>"><portlet:param name="struts_action" value="/ext/ecardnewsadd" /></portlet:renderURL>';
}
</script>