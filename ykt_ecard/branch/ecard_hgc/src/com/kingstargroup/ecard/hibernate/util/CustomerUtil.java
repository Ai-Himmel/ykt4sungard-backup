...
import com.kingstargroup.ecard.hibernate.termregister.TermRegPersistence;
...
public class CustomerUtil extends BasicUtil {
	...
	public static  List  getTermRegister(Integer   cutId){
		TermRegPersistence  persistence = (TermRegPersistence) getPersistence(TermRegPersistence.class.getName());
		Transaction t = beginTransaction();
		List list =new ArrayList();
		try{
		  list =	persistence.getTermByCutId(cutId.intValue());
