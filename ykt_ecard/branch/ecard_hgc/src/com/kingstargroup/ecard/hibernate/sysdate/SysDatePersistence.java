...
public class SysDatePersistence extends BasicPersistence {
	...
	public String getSysDate(int days) throws DBSystemException {
		...
		try {
			...
			if("db2".equals(KSConfiguration.getInstance().getProperty("constant.db.config", "db2"))){
			...
			}else if("oracle".equals(KSConfiguration.getInstance().getProperty("constant.db.config", "db2"))){
