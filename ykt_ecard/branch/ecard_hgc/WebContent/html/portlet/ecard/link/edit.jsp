...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td background="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/top_menu.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="2%">&nbsp;</td>
          <td width="72%" class="text_blue_12_c"><bean:message key="frindslink.modify" /></td>
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <%
			...
			FriendsLink info = FriendsLinkUtil.getLink(id); 
			Object obj = request.getAttribute("LinkEditForm");
			String linkName = info.getLinkName();
			String linkUrl = info.getLinkUrl();
			if (obj != null) {
				linkName = (String) ((DynaValidatorForm) obj).get("linkName");
				linkUrl = (String) ((DynaValidatorForm) obj).get("linkUrl");
			}
			
		%>
        <html:form action="/ecardlink/edit_result" method="POST"
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>            
            ...
            <html:text property="linkName" size="60" value="<%=linkName%>" /></td>
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="70%" valign="baseline" class="text_or_12">
					<html:text property="linkUrl" size="60" value="<%=linkUrl%>"/>
					</td>
    ...
    <form name=renderadminfm method=post action="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardlink/admin" /></portlet:renderURL>">
		<input type=hidden name="linkName" value="<%= ParamUtil.getString(request, "linkName")%>" >
		<input type=hidden name="linkUrl" value="<%= ParamUtil.getString(request, "linkUrl")%>" >
		<input type=hidden name="page" value="<%= ParamUtil.getString(request, "page")%>" >
	</form>