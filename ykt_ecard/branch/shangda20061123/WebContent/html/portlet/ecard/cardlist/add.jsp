...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- content table -->
        <html:form action="/ecardlist/add_result" method="POST"
						...
						<script>
							...
							//save the editor's content to hidden field "content"
								...
								function setCmdType(cmd) {
									CardlistInputForm.cmd.value = cmd;
								}
						</script>
	...
	function renderAdminPage() {
		self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardlist/admin" /></portlet:renderURL>';
	}
	</script>