...
<table cellpadding="4" cellspacing="0" width="100%" >
				...
				while(it.hasNext()) {
                  ...
                  <a class=brown_link_line href="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardlist/view" /></portlet:renderURL>&id=<%= info.getId()%>">
	...
	<tr>
	              <td align = right>
	              <a class=text_brown href="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardlist/view" /></portlet:renderURL>">
