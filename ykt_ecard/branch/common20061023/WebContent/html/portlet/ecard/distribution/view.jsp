                ...
                <!-- content table -->
                  ...
                  <table cellpadding="4" cellspacing="0" width="100%">
									...
									<img src="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/jiantou.jpg" width="8" height="8">
					                  <a href="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/distribution/view" /></portlet:renderURL>&id=<%= info.getId()%>" class=blue_link_line>
...
<script>
function goto(page) {
	self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/distribution/view" /></portlet:renderURL>&page=' + page;
}
</script>