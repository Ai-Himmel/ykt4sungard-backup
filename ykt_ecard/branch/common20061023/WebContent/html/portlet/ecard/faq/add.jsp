...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td background="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/top_menu.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="2%">&nbsp;</td>
          <td width="72%" class="text_blue_12_c"><bean:message key="ecardfaq.tab.addfaq" /></td>
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- content table -->
        <html:form action="/ecardfaq/add_result" method="POST"
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>            
            ...
            <td width="70%" valign="baseline" class="text_or_12">
            <select name="subType">
						<%List list = InfoTypeUtil.getChildList(EcardConstants.INFORMATION_FAQ_TYPE).getList();
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="10%" valign="top" class="text_or_12"><bean:message key="ecard.content" />: </td>
              <td width="70%" valign="baseline" class="text_or_12">
              <c:choose>
					<c:when test="<%= BrowserSniffer.is_rtf(request) %>">
                 ...
                 <td width="20%" valign="top" align=left><font class="portlet-msg-error" style="font-size: 11;">
	...
	function renderAdminPage() {
		self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardfaq/admin" /></portlet:renderURL>';
	}
	</script>