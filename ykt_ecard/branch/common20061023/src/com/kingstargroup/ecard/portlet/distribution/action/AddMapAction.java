 ...
 * Description: 添加文档的Struts Action实现
 * Modify History: 
 * 操作类型   操作人   操作时间     操作内容
 * ===================================
 ...
 * @since 1.0
 */
public class AddMapAction extends PortletAction {
	/* (non-Javadoc)
	...
	public ActionForward execute(
		...
		try {
			...
			if (isTokenValid(req)) {
				...
				InformationUtil.add(title, content, "", String.valueOf(EcardConstants.INFORMATION_DISTRIBUTION_TYPE), creater);
				resetToken(req);
			}
			...
			if (cmd.equals("saveandnext")) {
				...
				return mapping.findForward("portlet.distribution.add");
			}
