...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="2%">&nbsp;</td>
            <td width="72%" class="text_blue_12_c"><bean:message key="ecard.gatehisqueryresult" /></td>
...
<table width="719"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <!-- content table -->
          <html:form action="/ecardtransaction/gatehisquerydetail_result" method="POST"
      ...
      <tr class="list_tr">    
		<td align=center>
			<a class=text_blue_12_c><bean:message key="ecardtransaction.gatehistrade.tradeplace" /></a>
		</td>
		<td align=center>
			<a class=text_blue_12_c><bean:message key="ecardtransaction.gatehistrade.devicename" /></a>
		</td>
		<td align=center>
			<a class=text_blue_12_c><bean:message key="ecardtransaction.gatehistrade.tradetime" /></a>
		</td>
		<td align=center>
			<a class=text_blue_12_c><bean:message key="ecardtransaction.gatehistrade.errmsg" /></a>
		</td>
      </tr>
