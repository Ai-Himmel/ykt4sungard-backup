...
public class CardUtil extends BasicUtil {
	 ...
	 * Modify History:
	 */
	public static void processLostCard(String cutId, String cardId) throws PortalException {
...
//				mesList.setMesid(new Integer(cardPst.getKeyvalueByCode("T_TIF_MESLIST")));
				...
				mesList.setMaxSendCnt(new Integer(10));//magic number 10
			...
			tradeSerial.setCustomerId(Integer.valueOf(cutId));
