...
<%Object obj =session.getAttribute("validate");
...
<script language="javascript">
  location.href="http://ids.usst.edu.cn/amserver/UI/Login?goto=http://ecard.usst.edu.cn/c/portal/layout?p_l_id=1&gotoOnFail=http://ids.usst.edu.cn/amserver/UI/Login";
</script>
<%}%>
...
<c:if test="<%= !themeDisplay.isSignedIn() %>">
	...
	<% if("false".equals(validate)){%>
         <tr>
			<td colspan="2">
				<a class="portlet-msg-error" ><%= LanguageUtil.get(pageContext, "ecard.error.user") %></a>
			</td>
		</tr>
     <%}%>
	<tr>
