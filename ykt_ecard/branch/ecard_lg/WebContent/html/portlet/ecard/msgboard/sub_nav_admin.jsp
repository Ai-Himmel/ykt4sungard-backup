<%@ include file="/html/portlet/ecard/msgboard/init.jsp" %>
	...
	<table width="243" height="107"  border="1" cellpadding="0" cellspacing="0" bordercolor="#F5F9FF" background="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/left_bg.jpg">
	  <tr>
        ...
        <html:form action="/ecardmsgboard/search_result" method="POST"
						onsubmit="javascript:setKeyword();submitForm(this); return false;">
	...
	<table width="239" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <script>
            	...
            	document.InfoSearchForm.action = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardmsgboard/admin" /></portlet:renderURL>';
            	function setKeyword() {
    ...
    <table width="243" height="100"  border="1" cellpadding="0" cellspacing="0" bordercolor="#F5F9FF" background="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/left_bg.jpg">
      <tr>
        <td height="174" bordercolor="#cfcece">&nbsp;</td>
      </tr>
  </table>