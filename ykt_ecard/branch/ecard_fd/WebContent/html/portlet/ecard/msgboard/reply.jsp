...
<%
	...
	EcardMsgboard msg = MsgBoardUtil.getMsg(id);
...
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- content table -->
        <html:form action="/ecardmsgboard/reply_result" method="POST"
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <html:textarea property="replyContent" style="width:510px" rows="20" /></td>
                          <td width="15%" valign="top" align=left><font class="portlet-msg-error" style="font-size: 11;"><html:errors
    ...
    <form name=renderadminfm method=post action="<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>" portletMode="<%= PortletMode.VIEW.toString() %>"><portlet:param name="struts_action" value="/ecardmsgboard/search_result" /></portlet:renderURL>">
		<input type=hidden name="search_title" value="<%= ParamUtil.getString(request, "search_title")%>" >
		<input type=hidden name="search_content" value="<%= ParamUtil.getString(request, "search_content")%>" >
		<input type=hidden name="page" value="<%= ParamUtil.getString(request, "page")%>" >
	</form>