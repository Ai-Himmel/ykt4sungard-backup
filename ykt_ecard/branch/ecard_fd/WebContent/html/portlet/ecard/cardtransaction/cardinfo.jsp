...
<table cellpadding="8" cellspacing="0" width="100%">          
		...
		<table cellpadding="0" cellspacing="0" width="63%">
          ...
          <%}%>
          <div id=portraitDiv style=" LEFT: 231px; VISIBILITY: visible; WIDTH: 130px; POSITION: absolute; TOP: 169px; HEIGHT: 216px">
          <image src="/ecardimage" height=120 width=90><br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
