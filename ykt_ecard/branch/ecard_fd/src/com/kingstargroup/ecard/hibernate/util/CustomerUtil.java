...
public class CustomerUtil extends BasicUtil {
	...
	public static HashMap getRelatedCustomerInfo(String customerId, Integer cardId) throws PortalException {
		...
		infoMap.put("beginTime", DateFormatUtil.formatForCardPortlet(card.getBeginTime()));//卡开户日期
		infoMap.put("endTime", DateFormatUtil.formatForCardPortlet(card.getEndTime()));//卡截至日期
