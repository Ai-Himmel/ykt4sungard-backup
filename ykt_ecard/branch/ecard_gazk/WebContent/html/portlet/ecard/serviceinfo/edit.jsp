...
<%@ include file="/html/portlet/ecard/serviceinfo/permission.jsp" %>
<table width="719" height="29"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td background="<%= themeDisplay.getPathThemeRoot() %>/images/ecard/top_menu.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="2%">&nbsp;</td>
          <td width="72%" class="text_blue_12_c"><bean:message key="ecardservice.tab.edit" /></td>
    ...
    <table width="719"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- content table -->
        <%        	
			ResultPage result = InformationUtil.list(EcardConstants.INFORMATION_SERVICEINFO_TYPE);
		...
		%>
        <html:form action="/ecardservice/edit_result" method="POST"
