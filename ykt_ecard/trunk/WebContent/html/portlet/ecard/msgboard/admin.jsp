...
<%@ include file="/html/portlet/ecard/msgboard/permission.jsp" %>
<%
...
ResultPage curpage = MsgBoardUtil.list(search_title, search_content, 											
											pageNum, 
...
<table width="719"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <!-- content table -->
          <form name=InfoDelForm action="<portlet:actionURL><portlet:param name="struts_action" value="/ecardmsgboard/delete" /></portlet:actionURL>" method="POST"
       ...
       <c:if test="<%= SessionErrors.contains(request, EcardConstants.CHOOSE_DEL_CONTENT) %>">		
		...
		<tr>
			<td>				
					...
					<html:reset styleClass="button_blank" value='<%=LanguageUtil.get(pageContext, "ecard.reset")%>' />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
