...
begin
  ...
  Combo_academy.Sorted:=True;
  Combo_Spec.Sorted:=True;
  ProgressBar1.Position := 0;
  ADOQuery2.Close;
end;
...
begin
  ...
  begin
    ...
    CurrSql := 'SELECT YKT_CUR.T_CIF_PHOTO.CUT_TYPE, YKT_CUR.T_CIF_PHOTO.STUEMP_NO, ' +
      'YKT_CUR.T_CIF_PHOTO.STUEMP_NAME, YKT_CUR.T_CIF_DEPT.DEPT_CODE,YKT_CUR.T_CIF_PHOTO.S_CODE,YKT_CUR.T_CIF_DEPT.DEPT_NAME,' +
      ' YKT_CUR.T_CIF_PHOTO.PHOTO_NO, YKT_CUR.T_CIF_PHOTO.FILENAME FROM YKT_CUR.T_CIF_PHOTO , YKT_CUR.T_CIF_DEPT ' +
      ' where YKT_CUR.T_CIF_DEPT.DEPT_CODE=YKT_CUR.T_CIF_PHOTO.DEPT_CODE';
    if Memo1.Text <> '' then
      if TmpStr <> '' then
