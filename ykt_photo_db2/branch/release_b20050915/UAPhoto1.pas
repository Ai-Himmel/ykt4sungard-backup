...
begin
  ...
  Edit5.text := ADOQuery2.FieldByName(PersonKindName2).AsString;
  ...
  case stat of
    11: lblstat.Caption:='在读';
    12: lblstat.Caption:='离校';
    13: lblstat.Caption:='毕业';
    21: lblstat.Caption:='在职';
    22: lblstat.Caption:='退休';
    23: lblstat.Caption:='离职';
    24: lblstat.Caption:='死亡';
    25: lblstat.Caption:='离休';
