...
begin
  ...
  ADOQuery5.SQL.Add('select count(' + PersonNo + ') as totle ,count(' +
    SaveFileName + ')as num1,count(' + PersonKindNo2 + ')-count(' +
    SaveFileName + ') as num2 ,' + PersonKindNo2 + ' from ' +
    PhotoTableName + ' group by ' + PersonKindNo2);
  ...
  begin
    ...
    departCode1 := ADOQuery5.FieldByName(PersonKindNo2).AsString;
     //ShowMessage(ADOQuery5.FieldByName(PersonKindNo2).AsString);
