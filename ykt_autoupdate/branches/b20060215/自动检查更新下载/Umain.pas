...
begin
  try
    ...
    checktime:=update.ReadInteger('time','time',itime);
    {
...
begin
  ...
  begin
    lblTip.Caption:='找到要更新的软件，请先关闭一卡通前台，然后更新系统...';
...
procedure TfrmMain.TrayIcon1MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var
  Pt: TPoint;
begin
