...
DCLR_KSFUNC(int,SMT_ReadCutId,(unsigned long *cut_id));
...
DCLR_KSFUNC(int,ReadCardPwd,(unsigned char* cardpwd));
...
DCLR_KSFUNC(int,SMT_ReadDeadLineDate,(unsigned char ucDeadLineDate[3]));
DCLR_KSFUNC(int,SMT_ChangeDeadLineDate,(unsigned char ucDeadLineDate[3]));

DCLR_KSFUNC(int,SMT_ReadWaterPackInfo_XT,(WATER_PACK_INFO3* info));
DCLR_KSFUNC(int,SMT_TransWaterPacket_XT,(int main_money,WATER_PACK_INFO3* info));
DCLR_KSFUNC(int,SMT_WriteWaterPackInfo_XT,(WATER_PACK_INFO3* info));
DCLR_KSFUNC(int,XT2JD_Card,());

DCLR_KSFUNC(int,SMT_TransWaterPacket,(int main_money,WATER_PACK_INFO3* info));
DCLR_KSFUNC(int,SMT_ReadWaterPackInfo2,(WATER_PACK_INFO3* info));
DCLR_KSFUNC(int,JD2XT_Card,());
#endif