...
#define ERR_MODIFY_CARD				ERR_BASE + 15
#define ERR_READ_CARDINFO			ERR_BASE + 16
#define ERR_READ_CARDPHYID			ERR_BASE + 17
#define ERR_READ_CARDPWD			ERR_BASE + 18
#define ERR_READCUSTID				ERR_BASE + 19
...
public:
	...
	int ModifyCardInfo(int cardid, TPublishCard *pc);
	int ReadCardInformation(int cardid, TPublishCard *pc);
