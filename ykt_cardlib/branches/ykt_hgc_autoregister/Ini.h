...
public:
	...
	int ReadInt(char *, char *, const char *);		//读一个整数, 带默认参数
	int ReadInt(char *, int );						//在指定的行读一整数
	int ReadInt(char *, int , const char *);		//在指定的行读一整数, 带默认参数
	char *ReadText(char *, char *);					//读一个字符串
	char *ReadText(char *, char *, const char *);	//读一个字符串, 带默认参数
	char *ReadText(char *, int);					//在指定的行读一字符串
	char *ReadText(char *, int, const char *);		//在指定的行读一字符串, 带默认参数
