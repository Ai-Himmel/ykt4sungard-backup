...
//	m_labelPar.SetTextColor(RGB(0,0,255));
	...
	hWnd = m_hWnd;
	::PostMessage(GetDlgItem(IDC_BUTTON_START)->m_hWnd, WM_LBUTTONDOWN, NULL, NULL);
	::PostMessage(GetDlgItem(IDC_BUTTON_START)->m_hWnd, WM_LBUTTONUP, NULL, NULL);
