...
int __stdcall SMT_ReadCardStateInfo(unsigned char ucShowCardNo[5], int nDealCardNo[1],
									unsigned char ucDeadLineDate[3], unsigned char ucCardRightType[1]);             // (使用到)                                                                    
...
//////////////////////////////////////////////////////////////////////////
// 泰州一套操作卡的函数
int __stdcall ChangePassWord(unsigned char * newpwd);
...
int __stdcall ComInit(char *_ComType,int _Syn);
int __stdcall COMClose();
