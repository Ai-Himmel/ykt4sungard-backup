...
protected:
	...
	afx_msg void OnReadTerminalNo();
	afx_msg void OnReadDeviceType();
	afx_msg void OnReadTime();
	afx_msg void OnSetShower();
	afx_msg void OnSetShower2();
	afx_msg void OnSetShower3();
	afx_msg void OnSetShower4();
	afx_msg void OnBtnSet();
	afx_msg void OnBtnLoadkey();
	afx_msg void OnSetShower5();
	afx_msg void OnSetShower6();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
