...
LoadDll::LoadDll() : m_str_file_path(""), m_str_get_dllname(""), m_h_ks_dll(NULL)
{
}
...
int LoadDll::GetInitFile(const char *purpose_file_buf)
{
	char path_buf[512] = "";
...
void LoadDll::UnLoadKingStarDll()
{
	if (m_h_ks_dll)
	{
