...
#define KS_ERR_WRTIEPUBSECTOR			1050
#define KS_ERR_MONEYNOTENOUGH			1060
...
}g_Err_Def[] = 
{
	...
	{KS_ERR_MONEYNOTENOUGH,"金额不足,无法扣款"},
	{KS_ERR_EXIT, "无此类错误信息"}
};
...
DCLR_DLLFUNC(int,ModifyPubSector,(int sector, unsigned char login_key[7]));
DCLR_DLLFUNC(int,SetCardMainKey,(BYTE main_key[8]));
DCLR_DLLFUNC(int,PublishCard,(TPublishCard *pc));
DCLR_DLLFUNC(int,InitNewCard,(int * err_code,const char* showcardno ,LPProcessCallBack lpCallBack));
