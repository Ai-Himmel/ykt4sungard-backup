...
// 	if (_sector > 15)
// 	{
// 		ret = dc_load_key(icdev, _mode, _sector - 16, Buffer);	
// 	}
// 	else
// 	{
// 		ret = dc_load_key(icdev, _mode, _sector, Buffer);       // 多半PaDselect传入0
// 	}
...
// 	{
// 		ret = dc_authentication(icdev, _mode, _sector);         // 重新修改的
// 	}
// 	else
//  	{
//  		ret = dc_authentication_2(icdev, _mode, _sector - 16, _sector * 4);
//  	//	ret = rf_authentication(icdev, _mode, _sector - 16);
// 	}
	if (ret != 0)
	{
