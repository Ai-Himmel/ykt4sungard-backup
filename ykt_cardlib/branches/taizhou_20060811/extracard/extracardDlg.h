...
protected:
	...
	afx_msg void OnBtnWritepassword();
	afx_msg void OnBtnReadpassword();
	afx_msg void OnBtnInitclearcard2();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
...
DCLR_DLLFUNC(int,SMT_ReadWaterPackBackUp,(int *WaterPackBackUp));
...
DCLR_DLLFUNC(int,SMT_WritePersonalPassword,(unsigned char PersonalPsd[3])); 
