...
; Author 汤成 
; Date : 2005-4-28
; $Id: back_card.nsi 3 2005-06-17 03:34:33Z cash $
...
;Configuration
  ...
  !define MUI_PRODUCT "复旦大学校园一卡通卡处理程序"
  !define SHORT_NAME "发行一卡通"
  ...
  !define EXE_FILE "cardmanager.exe"
  ...
  InstallDir "$PROGRAMFILES\KINGSTAR\cardman"
