...
private:
	...
	void ClearLogMsg();
	void SetInitCtrlDisable(BOOL b);
	void UpdateSectInfo();
	void LoadInitSectConfig();
// Construction
public:
...
public:
	...
	afx_msg void OnBnClickedJdAdd();
	afx_msg void OnBnClickedBtnJd2xt();
	afx_msg void OnBnClickedBtnXt2jd();
	afx_msg void OnBnClickedBtnAddxt();
	afx_msg void OnBnClickedBtnXtamount();
