...
typedef void (CALLBACK *LPGZ_SetWaterCardType)(int t);
typedef void (CALLBACK *LPGZ_SetInitSect)(int sect,int need);
//////////////////////////////////////////////////////////////////////////
...
extern LPGZ_SetWaterCardType GZ_SetWaterCardType;
extern LPGZ_SetInitSect GZ_SetInitSect;
