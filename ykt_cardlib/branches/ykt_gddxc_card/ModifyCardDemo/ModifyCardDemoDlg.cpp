...
BEGIN_MESSAGE_MAP(CModifyCardDemoDlg, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BTN_ELEC_PWD, OnBnClickedBtnElecPwd)
	ON_BN_CLICKED(IDC_BTN_ELEC_PWD2, OnBnClickedBtnElecPwd2)
END_MESSAGE_MAP()
...
void CModifyCardDemoDlg::OnBnClickedBtnElecPwd()
{
	card_fun->EncryptElecPwd();	
}

void CModifyCardDemoDlg::OnBnClickedBtnElecPwd2()
{

	card_fun->DecryptElecPwd();
}
