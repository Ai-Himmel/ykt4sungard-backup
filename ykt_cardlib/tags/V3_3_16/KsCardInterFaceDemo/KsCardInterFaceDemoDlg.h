...
class CKsCardInterFaceDemoDlg : public CDialog
{
// Construction
public:
	CKsCardInterFaceDemoDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CKsCardInterFaceDemoDlg)
	enum { IDD = IDD_TESTDEMO_DIALOG };
	CEdit	m_edit_Balance;
	//}}AFX_DATA

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CKsCardInterFaceDemoDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CKsCardInterFaceDemoDlg)
...
//	afx_msg void OnBnClickedCheckdeposit();
	...
	afx_msg void OnBnClickedBtnRechange();
