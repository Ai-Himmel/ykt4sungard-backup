...
typedef enum {FT_INT8=1,FT_INT16,FT_INT24,FT_INT32,FT_BCD,FT_BCD_LPAD20,FT_BCD_LAPDZERO,FT_ANSI,FT_UCS2,
// 低位在前的字数
	FT_LT_INT16,FT_LT_INT24,FT_LT_INT32,FT_HEX_DATE,FT_HEX_TIME,FT_HEX_STR} FIELD_TYPE;

typedef enum {FRR_NULL=0,FRR_FREE,FRR_MAC,FRR_EXTAUTH_MAC,FRR_ENCRYPT,FRR_ENCRYPT_MAC,
	FRR_REC_FREE,FRR_REC_MAC} FILE_RIGHT_READ;
