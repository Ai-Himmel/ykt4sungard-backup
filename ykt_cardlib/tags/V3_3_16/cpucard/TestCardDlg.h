...
//	afx_msg void OnBnClickedBtnRequestcard2();
	afx_msg void OnBnClickedButton1();
	afx_msg void OnBnClickedBtnTest();
	afx_msg void OnBnClickedBtnInitpostpaid();
	afx_msg void OnBnClickedBtnGetprove4dps();
	afx_msg void OnBnClickedBtnHalt();
	afx_msg void OnBnClickedBtnSetm1key();
	afx_msg void OnBnClickedBtnCheckwritecard();
};
