...
int __stdcall ks_water_publishcard(int watertype,ks_water_pack_t *pack)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_publishcard(watertype,pack);
}
int __stdcall ks_water_recyclecard(int watertype)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_recyclecard(watertype);
}
int __stdcall ks_water_readmoney(int watertype,ks_water_pack_t *pack)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_readmoney(watertype,pack);
}
int __stdcall ks_water_writemoney(int watertype,ks_water_pack_t *pack)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_writemoney(watertype,pack);
}	
...
int __stdcall ks_water_publishparamcard(int watertype,ks_water_param_t *param)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_publishparamcard(watertype,param);
}
...
int __stdcall ks_water_publish_legacycard(int watertype,FEE_RATE_CARD_INFO *fee_rate)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_publish_legacycard(watertype,fee_rate);
}
int __stdcall ks_water_read_legacycard(int watertype,FEE_RATE_CARD_INFO *fee_rate)
{
	...
	ks_cardtype_base *c;
	GET_CARDTYPE(c);
	return c->water_read_legacycard(watertype,fee_rate);
}
