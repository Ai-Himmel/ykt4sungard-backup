...
public:
	...
	afx_msg void OnBnClickedPoldwater();
	afx_msg void OnBnClickedRoldwater();
	afx_msg void OnBnClickedWroldwater();
	afx_msg void OnBnClickedRdoldwater();
	afx_msg void OnBnClickedButton8();
	afx_msg void OnBnClickedButton9();
	afx_msg void OnBnClickedwaterdumpdata();
	afx_msg void OnBnClickedsetmfkey();
	afx_msg void OnBnClickedButton2();
	CComboBox m_watetype;
};
