...
class KsCardDaemonDlg : public wxFrame 
{
	...
	protected:
		...
		virtual void KsCardDaemonDlgOnClose( wxCloseEvent& event ) { event.Skip(); }
		virtual void KsCardDaemonDlgOnIconize( wxIconizeEvent& event ) { event.Skip(); }
		virtual void KsCardDaemonDlgOnSize( wxSizeEvent& event ) { event.Skip(); }
