...
short DES_ENCRYPT(const void *InBuf, long InLen, void *OutBuf, void *pKey);
short DES_DECRYPT(const void *InBuf, long InLen, void *OutBuf, void *pKey);
short DES_MAC	 (const void *InBuf, long InLen, void *MacBuf, void *pKey, unsigned char Option);
short DES_DEMAC	 (const void *InBuf, long InLen, void *MacBuf, void *pKey, unsigned char Option);
};
