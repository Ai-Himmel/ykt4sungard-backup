...
extern int		DRTP_PORT;	
 ...
 /////////////////////////// 内部交易代码  ///////////////////////////////
#define TRADE_INNER_CHKPWD		240000	//密码校验
#define TRADE_INNER_QUERYBANK		240007	//查询银行卡
#define TRADE_INNER_TRANS			240001	//自助转帐
#define TRADE_INNER_AUTOTRANS		240002	//批量转帐
#define TRADE_INNER_ELEC			242001 //电子钱包转账
#define	TRADE_INNER_YCT				242002 //羊城通转账
#define	TRADE_INNER_TRANS_REVERSE	240003 //银行卡转账功能冲正
...
#define TRADE_INNER_DEVBEATE	240108  //圈存机心跳
 #define TRADE_INNER_UPDATECOMSUMELIMIT 846320 //修改消费限额
