...
#define		BANK_TRADE_CODE_SIGN_IN		5			//交易签到
...
#define	THIRD_PART_INI_FILE 	"./third_part_bank.ini"		//third part bank ini文件
#define TIME_OUT1				500							// time sleep 500 millisecond 
...
static ISO8583 Tbl8583[128] = 
{ 
	/* FLD 1 */ {0,"BIT MAP,EXTENDED ", 16, 0, 0, 2, NULL,0}, 
	...
	/* FLD 52 */ {0,"PIN DATA  ", 16, 0, 0, 0, NULL,0}, 
...
typedef struct ISO8583_FULL_PACKET
{
	void *packet_head;		// 包头
	void *packet;			// 包体
}ISO8583_FULL_PACKET;
...
{
	int bank_id;										// 银行ID号
	ISO8583_FULL_PACKET *iso8583_full_packet;			// iso8583包
	int reserve_id;										// 保留字段
}bank;
/////////////////////////////与新大陆约定的错误码///////////////////////////////////
