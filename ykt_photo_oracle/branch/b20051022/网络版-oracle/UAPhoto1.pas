...
procedure TPhotoSystem.N13Click(Sender: TObject);
begin
  // 人员添加
  if dm.judgelimit(dm.soper,mdl_PersonAdd)=false then
  begin
    showmessage('你没有添加人员的权限，请找管理人员开通该权限！');
    exit;
  end;
  //PersonWrite(dm.ConnectPhoto);
  FrmPersonWrite := TFrmPersonWrite.Create(nil);
