...
type
  TfaqhVouAccount = class(TfaqhSimpleQueryTemp)
    Panel1: TPanel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
...
var
  faqhVouAccount: TfaqhVouAccount;
...
procedure TfaqhVouAccount.Init;
begin
  inherited;
...
procedure TfaqhVouAccount.btnQueryClick(Sender: TObject);
var
  tempData:TDataSet;
  tmpItem: TListItem;
begin
...
function TfaqhVouAccount.enterAccount(operSign: string;btn:TBitBtn): Integer;
var
  i:Integer;
  Id:Integer;
begin
...
procedure TfaqhVouAccount.btnCheckClick(Sender: TObject);
begin
  if selectSign<>0 then
  begin
...
procedure TfaqhVouAccount.btnCancelCheckClick(Sender: TObject);
begin
...
procedure TfaqhVouAccount.btnEnterClick(Sender: TObject);
begin
...
procedure TfaqhVouAccount.chkSelectClick(Sender: TObject);
var
  i: integer;
begin
...
function TfaqhVouAccount.selectSign: Integer;
var
  i:Integer;
begin
  Result := -1;
...
initialization
  TUIStdClassFactory.Create('凭证批量入账',TfaqhVouAccount);
