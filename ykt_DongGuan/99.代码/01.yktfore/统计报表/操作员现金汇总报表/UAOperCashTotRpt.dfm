inherited faqhOperCashTotRpt: TfaqhOperCashTotRpt
  Width = 949
  Height = 489
  ...
  object zqry1: TZQuery
    ...
    SQL.Strings = (
        ...
        'select t1.BRANCHNO,t1.BRANCHNAME,t1.OPERCODE,t1.OPERNAME,t1.TRAN' +
        'SCNT,t1.SUMMARY,'
      't1.INAMT,t1.OUTAMT,(t1.INAMT-t1.OUTAMT)as BALANCE,t2.subjname'
      
        'from t_rptopercash t1 left join t_subject t2 on t1.subjno=t2.sub' +
        'jno'
      'order by OPERCODE,t1.subjno asc')
    Params = <>
    Left = 411
    Top = 89
  end
