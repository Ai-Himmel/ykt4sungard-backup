...
uses
  ...
  function  irptAtmRptSql(tmpData:TDataSet):string;
  function  irptTermReFillRptSql(tmpData:TDataSet):string;
  function  irptExpendRptSql(tmpData:TDataSet):string;
  function  irptPkgFileRptSql(tmpData:TDataSet):string;
  ...
  function  irptPubCardRptSql(tmpData:TDataSet):string;
...
var
  ...
  strDate:string;
begin
  strDate := tmpData.fieldbyname('sdate3').AsString;
  sqlStr := 'insert into T_RPTOPERCASH(LINENO,ACCDATE,BRANCHNO,BRANCHNAME,OPERCODE,';
  sqlStr := sqlStr +'OPERNAME,SUBJNO,TRANSTYPE,BEGINTIME,ENDTIME,SUMMARY,TRANSCNT,INAMT,OUTAMT) values(';
  sqlStr := sqlStr +tmpData.fieldbyname('lserial1').AsString+',';//
  if strDate='' then
    sqlStr := sqlStr +#39+'20991201' +#39+','
  else
    sqlStr := sqlStr +#39+strDate +#39+',';
  sqlStr := sqlStr + '0'+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('vsvarstr2').AsString+#39+',';
  sqlStr := sqlStr +#39+ '' +#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('sall_name').AsString+#39+',';
...
begin
  ...
  sqlStr := sqlStr +#39+ '99991231'+#39+',';
  sqlStr := sqlStr + '0'+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('scust_auth2').AsString+#39+',';
  sqlStr := sqlStr +#39+ '' +#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('sname').AsString+#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('sstock_code').AsString+#39+',';
  sqlStr := sqlStr + '0' +',';
  sqlStr := sqlStr +#39+ '0'+#39+',';
  sqlStr := sqlStr +#39+ '0'+#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('semail').AsString+#39+',';
...
begin
  ...
  sqlStr := sqlStr +'OPERNAME,SUBJNO,TRANSTYPE,BEGINTIME,ENDTIME,SUMMARY,TRANSCNT,INAMT,OUTAMT) values(';
  sqlStr := sqlStr +tmpData.fieldbyname('lserial1').AsString+',';//
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('scust_no').AsString+#39+',';   
  sqlStr := sqlStr + tmpData.fieldbyname('lvol1').AsString+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('vsvarstr0').AsString+#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('scust_auth2').AsString +#39+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('sname').AsString+#39+',';
...
begin
  ...
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('sstock_code').AsString+#39+',';
  sqlStr := sqlStr + tmpData.fieldbyname('lserial1').AsString+',';
  sqlStr := sqlStr + tmpData.fieldbyname('scust_auth').AsString+',';
  sqlStr := sqlStr +#39+ tmpData.fieldbyname('vsvarstr0').AsString+#39+',';
  sqlStr := sqlStr + '0'+',';
  sqlStr := sqlStr + '0'+',';
  sqlStr := sqlStr +#39+tmpData.fieldbyname('sname').AsString+#39+',';
