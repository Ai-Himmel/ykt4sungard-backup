...
type
  ...
  function KSG_DownLoadPhotoFile(handle:KSG_File_Handle):Integer;stdcall;
  //function KSG_DownLoad_File(handle:KSG_File_Handle):Integer;stdcall;
	...
	function KSG_Downloadphoto_File(src_file,dest_file:string):Integer;
  function KSG_Download_File_Ext(src_file,dest_file:string):Integer;
...
implementation
  ...
  function KSG_DownLoadPhotoFile;stdcall;external FILETRANS_DLL;
  //function KSG_DownLoad_File;stdcall;external FILETRANS_DLL;
...
begin
	...
	Result := KSG_DownLoadPhotoFile(handle);
