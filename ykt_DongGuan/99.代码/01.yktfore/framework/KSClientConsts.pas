...
resourcestring
  ...
  SRootMetaMenuCaption = 'e卡通管理系统';
  //////////////////////////////////////////////////
  //SRootMetaMenuCaption = '集中交易系统'; (IN TRADER)
  //////////////////////////////////////////////////
  SInputPassword = '请输入密码';
  SPassword = '密码';
  yktVersion = 'ykt_3.0.029'; //固定长度为11位，不能改变,包含手机卡
...
var
  ...
  scNetNo:string;     //网点号
  scNetName:string;   //网点名称
  


  pasmSeat:Integer;   //默认pasm卡座
  psamTermId:string;  //psam卡终端号


  BusiID : string;    //读卡器所属商户号
  POSID:string;       //读卡器编号
