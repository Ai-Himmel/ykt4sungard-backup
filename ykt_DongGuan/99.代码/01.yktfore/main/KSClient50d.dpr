...
uses
  ...
  KSRECVPUSH in '..\Ãÿ ‚\KSRECVPUSH.PAS',
  UPushRevThread in '..\Ãÿ ‚\UPushRevThread.pas',
  KSComCmdDefs in '..\FRAMEWORK\KSComCmdDefs.pas' {ComCmdDefinition: TDataModule},
  KCDataPack in '..\Ãÿ ‚\KCDataPack.pas',
  ...
  UDownLoadProg in 'UDownLoadProg.pas' {FrmDownloadProg};
