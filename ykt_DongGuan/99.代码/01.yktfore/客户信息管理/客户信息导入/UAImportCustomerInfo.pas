...
type
  ...
  private
    ...
    FFCardNo		  :string;		//卡号
    FFIssueDept		:string;		//发卡部门
    FFExpMonths		:string;		//申请有效期限(月)
    FFCustName		:string;		//客户名称
    FFIdType		  :string;		//证件类型
    FFIdNo			  :string;		//证件号码
    FFBirthDay		:string;		//出生日期
    FFHeight		  :string;		//身高
    FFTel			    :string;		//电话
    FFMobile		  :string;		//手机
    FFEmail			  :string;		//电子信箱
    FFUnitName		:string;		//单位名称
    FFMarital		  :string;		//婚姻状态
    FFEducation		:string;		//文化程度
    FFPolitical		:string;		//政治面貌
    FFIncome		  :string;		//经济来源
    FFCountry		  :string;		//国籍
    FFNation		  :string;		//民族
    FFNative		  :string;		//籍贯
    FFDomicileType:string;		//户口所在地类型
    FFDomicile		:string;		//户口所在地
    FFLiveReason	:string;		//居住是由
    FFLiveAddr		:string;		//居住地址
    FFLiveDate		:string;		//居住日期
    FFArriveDate	:string;		//到达日期
  ...
  public
    ...
    property CardNo		    :string read FFCardNo		  write FFCardNo
    property IssueDept		:string read FFIssueDept	  write FFIssueDept
    property ExpMonths		:string read FFExpMonths	  write FFExpMonths
    property CustName		:string read FFCustName		  write FFCustName
    property IdType		    :string read FFIdType		  write FFIdType
    property IdNo			:string read FFIdNo			  write FFIdNo
    property BirthDay		:string read FFBirthDay		  write FFBirthDay
    property Height		    :string read FFHeight		  write FFHeight
    property Tel			:string read FFTel			  write FFTel
    property Mobile		    :string read FFMobile		  write FFMobile
    property Email			:string read FFEmail		  write FFEmail
    property UnitName		:string read FFUnitName		  write FFUnitName
    property Marital		:string read FFMarital		  write FFMarital
    property Education		:string read FFEducation	  write FFEducation
    property Political		:string read FFPolitical	  write FFPolitical
    property Income		    :string read FFIncome		  write FFIncome
    property Country		:string read FFCountry		  write FFCountry
    property Nation		    :string read FFNation		  write FFNation
    property Native		    :string read FFNative		  write FFNative
    property DomicileType	:string read FFDomicileType	  write FFDomicileType
    property Domicile		:string read FFDomicile		  write FFDomicile
    property LiveReason	    :string read FFLiveReason	  write FFLiveReason
    property LiveAddr		:string read FFLiveAddr		  write FFLiveAddr
    property LiveDate		:string read FFLiveDate		  write FFLiveDate
    property ArriveDate	    :string read FFArriveDate	  write FFArriveDate
  end;
...
type
  TfaqhImportCustomerInfo = class(TfaqhSimpleQueryTemp)
    ...
    btnCheck: TBitBtn;
    cbbPOLITICAL: TWVComboBox;
    cbbSex: TWVComboBox;
    cbbIdType: TWVComboBox;
    cbbEducation: TWVComboBox;
    cbbMarital: TWVComboBox;
    cbbCountry: TWVComboBox;
    cbbNation: TWVComboBox;
    cbbDOMICILETYPE: TWVComboBox;
    cbbInCome: TWVComboBox;
    cbbLiveReason: TWVComboBox;
    cbbIssueDept: TWVComboBox;
