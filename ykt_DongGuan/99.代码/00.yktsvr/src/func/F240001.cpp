...
int F240001(TRUSERID *handle,int iRequest,ST_PACK *rPack,int *pRetCode,char *szMsg)
{
	...
	*/
	...
	//流水的出卡值以及流水状态
	ats.trans.termseqno=rPack->lvol7;
	ret=DB_t_transdtl_read_lock_by_c0_and_accdate_and_termid_and_termseqno(ats.trans.accdate,trans.termid,ats.trans.termseqno, &transdtl);
	if(ret)
	{
...
//	}
	...
	des2src(out_pack->sdate0,ats.trans.accdate);
