...
int DB_t_bankcard_read_by_custid_and_bankcardno(int v_custid,const char *v_bankcardno,T_t_bankcard *pt_bankcard);
int DB_t_bankcard_del_by_custid_and_bankcardno(int v_custid,const char *v_bankcardno);
