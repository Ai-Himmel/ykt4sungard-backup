...
int DB_t_bankcardtmp_read_by_recordno(const char *v_recordno,T_t_bankcardtmp *pt_bankcardtmp);
int DB_t_bankcardtmp_update_by_recordno(char *v_recordno,T_t_bankcardtmp *pt_bankcardtmp);
int DB_t_bankcardtmp_del_by_recordno(const char *v_recordno);
int DB_t_bankcardtmp_del_by_batchno(const char *v_batchno);
int DB_t_bankcardtmp_read_lock_by_c0_and_recordno(const char *v_recordno,T_t_bankcardtmp *pt_bankcardtmp);
