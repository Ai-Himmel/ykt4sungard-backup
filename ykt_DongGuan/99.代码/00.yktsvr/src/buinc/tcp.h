...
#endif
*/
/* ****** Add by WENJIAN at 2007-07-21 BEGIN *******/

#if defined(SUNOS) 
#define INADDR_NONE         0xFFFFFFFF 
#endif 
/* ****** Add by WENJIAN at 2007-07-21 END  *******/
...
private:
   ...
   bool m_bConnected;   // 2005-11-7 12:29:20 CHENYH 为了标注本端口是否连接成功
	bool CheckConnectSuccess(int timeout);
public:
	bool IsConnected();
   ...
   // 参数  : int timeout : 等待接收数据的超时时间，毫秒计
	...
	bool ConnectTcpEx(const char *host,short port,int timeout);
...
*******************************************************/
	...
	bool CreateNB(int addressfamily=AF_INET,int type=SOCK_STREAM);
