...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="/smartcardweb/mobiletrans.do" method="post"
			name="writeCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
						...
						<div id="content_middle">
							...
							<div id="content_input">
								<table width="80%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="40" class="样式14" align="center" colspan="2">
											是否确认充值？
										</td>
									</tr>
									<tr>
										<td width="320" height="60" class="样式13">
											手机号码
											<input type="hidden" name="cardId"
												value="<%=request.getAttribute("cardId") == null ? ""
					: request.getAttribute("cardId")%>" />
											<input type="hidden" name="cellphone"
												value="<%=request.getAttribute("cellphone") == null ? ""
					: request.getAttribute("cellphone")%>" />
					...
					.getAttribute("txCnt")%>" />
										...
										<td>
											<%=request.getAttribute("cellphone") == null ? ""
					: request.getAttribute("cellphone")%>
										</td>
									</tr>
									<tr>
					...
					: Double.parseDouble(request.getAttribute("cardBala")
							.toString()) / 100%>
											元
										</td>
									</tr>
