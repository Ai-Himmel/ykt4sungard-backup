...
<html>
	...
	<%
	List list = (List)request.getAttribute("subsidyList");
	if(list.size()==1){
		TTifSubsidyDTO subsidy = (TTifSubsidyDTO) list.get(0);
						...
						<div id="content_middle">
							...
							<div id="content_input">
								<table width="80%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="30" class="样式14" align="center" colspan="2">
											是否领取该项补助？
										</td>
									</tr>
									<tr>
...
<%
		...
		String tx_time ="";
		String expire_date = "";
		TTifSubsidyDTO subsidy = null;
		for(int i=0;i<list.size();i++){
			subsidy = (TTifSubsidyDTO) list.get(i);
			ttamount += subsidy.getAmount();
			tx_date = subsidy.getTxDate();
			tx_time = subsidy.getTxTime();
			expire_date = subsidy.getExpireDate();		
		}
