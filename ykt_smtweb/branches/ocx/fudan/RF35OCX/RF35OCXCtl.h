...
public:
	enum {		
		dispidMobileTransWriteCard = 14L,		dispidGetMainKey = 13L,		dispidReportCardWriteFailue = 12L,		dispidRewriteCardInfo = 11L,		dispidGetPacketInfo = 10L,		dispidReadCardPocket = 9L,		dispidGetRequestRetInfo = 8L,	dispidCardNo = 1L,
	dispidPortNo = 2L,
	dispidDoScan = 3L,
	dispidUndoLoss = 4L,
