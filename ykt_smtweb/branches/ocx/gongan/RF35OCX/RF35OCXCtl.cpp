...
BEGIN_DISPATCH_MAP(CRF35OCXCtrl, COleControl)
	...
	DISP_FUNCTION_ID(CRF35OCXCtrl, "WaterTransWriteCard", dispidWaterTransWriteCard, WaterTransWriteCard, VT_I2, VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR)
...
SHORT CRF35OCXCtrl::WaterTransWriteCard(LPCTSTR url, LPCTSTR cardno, LPCTSTR outcardamount, LPCTSTR params)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
