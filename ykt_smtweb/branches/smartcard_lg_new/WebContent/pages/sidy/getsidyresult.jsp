...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<%
			...
			String subsidyCount = (String) request.getAttribute("subsidyCount");
		%>
		<script language="JavaScript" type="text/JavaScript">
		function showmess(){
			document.body.style.overflow='hidden';
			var t_count = '<%=count%>';	
			var subsidyCount = '<%=subsidyCount%>';
			...
			if(t_count==0){
				msg.innerHTML = "<b>补助领取成功！</b><br><br>领取"+subsidyCount+"笔补助 共计："+t_amount+"元<br> <br>卡余额："+t_outCardAmount/100+"元<br> <br> 所有补助领取完毕！";
			}else{
