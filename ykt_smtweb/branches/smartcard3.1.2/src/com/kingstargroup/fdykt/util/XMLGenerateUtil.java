...
public class XMLGenerateUtil {
	...
	public static String MapXMLGenerate(String errorCode, String errorMessage,
			HashMap map) {
		...
		try {
			...
			if (map != null) {
				...
				while (iter.hasNext()) {
					...
					String onevalue = (String) map.get(onekey);
					head.addElement(onekey).addText(onevalue);
				}
			}
			root.addElement("content").addText("");
	...
	public static String XMLGenerate(String errorCode,
			String errorMessage, HashMap datamap,List listData) {
		...
		try {
			...
			if(datamap!=null){
			Set ketset = datamap.keySet();
			Iterator iter =  ketset.iterator() ;
			while (iter.hasNext()) {
				String type = (String) iter.next();
				head.addElement(type).addText((String)datamap.get(type));
	...
	public static String XMLGenerate(String errorCode,
			String errorMessage, String SidyAmount,String OutCardAmount,String SerialNo,String ParamKey,String cardphyid,String txCnt,String sidyno,String sdate3,String stime3,List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
		...
		try {
			...
			head.addElement("cardphyid").addText(cardphyid);
			head.addElement("txCnt").addText(txCnt);
			head.addElement("sidyno").addText(sidyno);
			head.addElement("sdate3").addText(sdate3);
			head.addElement("stime3").addText(stime3);
			Element content = root.addElement("content").addText("");
			Element record = null;
			if (listDate != null) {
	...
	public static String MoblileXMLGenerate(String errorCode,
			String errorMessage, String amount,String OutCardAmount,String SerialNo,String ParamKey,String cardphyid,List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
		...
		try {
			...
			// head.addElement("ErrorMessage",errorMessage);
			head.addElement("ErrorMessage").addText(errorMessage);
			head.addElement("amount").addText(amount);
			head.addElement("OutCardAmount").addText(OutCardAmount);
			head.addElement("SerialNo").addText(SerialNo);
			head.addElement("ParamKey").addText(ParamKey);
			head.addElement("cardphyid").addText(cardphyid);
	...
	public static String ElectXMLGenerate(String errorCode,
			String errorMessage, String amount,String OutCardAmount,String SerialNo,String cardphyid,List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
