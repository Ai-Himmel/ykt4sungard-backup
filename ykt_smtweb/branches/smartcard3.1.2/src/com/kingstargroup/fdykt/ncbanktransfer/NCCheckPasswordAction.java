...
public class NCCheckPasswordAction extends Action {
	/**
	...
	private ActionForward doLogin(ActionMapping mapping,
		...
		if(request.getParameter("onlinecheck")==null){
			...
			session.setAttribute("REQ_URL", request.getRequestURL()+"?cardphyid="+cardphyid+"&cardBala="+card_bala+"&dptCardCnt="+dptCardCnt+"&payCardCnt="+payCardCnt);
