			...
			<div id="middle">
				<div id="Layer1">
								...
								<table width="80%" border="0" align="center" cellpadding="0"
									cellspacing="0" class="box">
									   <tr>
                                        ...
                                        <td>
                                            <%=request.getAttribute("stuempname") == null ? ""
                    : request.getAttribute("stuempname")%>
                                            元
                                        </td>
                                    </tr>
									...
									<tr>
										<td width="320" height="50" class="样式13">
											...
											<input type="hidden" name="stuempno"
												value="<%=request.getAttribute("stuempno") == null ? "0"
					...
					.getAttribute("money")%>
									...
									<tr>
										<td height="150" align="center" class="show" id="errmsg"
											colspan="2">
											<html:errors />
											请确认放好卡! &nbsp;
										</td>
