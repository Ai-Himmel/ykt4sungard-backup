...
<html>
    <head>
        ...
        <link href="/smartcardweb/pages/css/css.css" rel="stylesheet"
            type="text/css" />
<%
		String money = request.getParameter("money") == null ? "" : request
				.getParameter("money").toString();	
        String outCardAmount = request.getParameter("outCardAmount") == null ? ""
				: request.getParameter("outCardAmount").toString();
		String outCardAmount1 = request.getParameter("outCardAmount1") == null ? ""
				: request.getParameter("outCardAmount1").toString();	
		%>
