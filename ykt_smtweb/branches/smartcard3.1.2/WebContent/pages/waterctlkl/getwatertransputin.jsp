...
<html>
		       	...
		       	var cardphyid ='<%=cardphyid%>';
					...
					if(ret == 0){
						...
						if(parseInt(document.all.money.value)*100<=parseInt(bala)){
						 var pret = putinForm.all.RFScanner.ReadWaterCtlPacket(1,cardphyid);
						if(0==pret){
								var waterBala = putinForm.all.RFScanner.GetWaterCtlPacketInfo("money");
								var cxCnt1 =  putinForm.all.RFScanner.GetWaterCtlPacketInfo("add_count");
	...
	<body scroll="no"> 
		<form action="/smartcardweb/waterputinkl.do" method="post"
			name="putinForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
