...
<html>
    <head>
        ...
        function showmess(){
            ...
            var money = writeCardForm.RFScanner.GetRequestRetInfo("Amount");
            var out_card_amount = writeCardForm.RFScanner.GetRequestRetInfo("OutCardAmount");
             var out_card_amount1 = writeCardForm.RFScanner.GetRequestRetInfo("OutCardAmount1");
            var msg = document.getElementById("msg");
           msg.innerHTML="水控转账成功，<br><br>转账金额 "+money+" 元，<br><br>一卡通卡余额 "+parseFloat(out_card_amount)/100+" 元，<br><br> 水控钱包卡余额 "+parseFloat(out_card_amount1)/100 +"元";
