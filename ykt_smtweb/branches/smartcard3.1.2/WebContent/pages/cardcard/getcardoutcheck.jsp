               ...
               if(cardphyid!=logincardphyid){
	              ...
	              if(rrt == 0){
	                ...
	                if(pktret==0){
	                    ...
	                    writeCardForm.all.cardphyno.value=cardphyid;                     
	                    writeCardForm.all.cardbalance.value=writeCardForm.all.RFScanner.GetPacketInfo("cardbal");                     
	                    writeCardForm.all.cardcnt.value=writeCardForm.all.RFScanner.GetPacketInfo("pay_card_cnt");      
                    ...
                    : request.getAttribute("outcardcnt")%>" />
									...
									<tr>
										<td height="180" align="center" class="show" id="errmsg"
											colspan="2">
											<html:errors />											
											请确认 <font style="font-size: 22px;"><b>转入卡</b></font> 信息后
											<br>
											<br>
