                ...
                <div id="mid_center1">
                    <ul>
                        <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/count.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_account")) { out.print(" display:none; "); }%>" 
                        ...
                        <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/detail.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_tradelog")) { out.print(" display:none; "); }%>"
                        ...
                        <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/jie.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_cancelLost")) { out.print(" display:none; "); }%>"
                        ...
                        <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/pass.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_changePassword")) { out.print(" display:none; "); }%>"
                ...
                <div id="mid_center2">
                    <ul>
                        <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/xexg1.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_cardLimit")) { out.print(" display:none; "); }%>"
                         ...
                         <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/gxkxx.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_updateCardinfo")) { out.print(" display:none; "); }%>"
                         ...
                         <li
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/jssq.gif); <% if (!ConfigMenu.getMenuStatus("compusBiz_cancelLock")) { out.print(" display:none; "); }%>"
                            onclick="javascript: window.location='/smartcardweb/cancellock.do';"></li>
                            
                        <li style=" <% if (ConfigMenu.getMenuStatus("compusBiz_cardLimit")) { out.print(" display:none; "); }%>">&nbsp;</li>
                        <li style=" <% if (ConfigMenu.getMenuStatus("compusBiz_updateCardinfo")) { out.print(" display:none; "); }%>">&nbsp;</li>
                        <li style=" <% if (ConfigMenu.getMenuStatus("compusBiz_cancelLock")) { out.print(" display:none; "); }%>">&nbsp;</li>
