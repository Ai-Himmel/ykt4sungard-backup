...
<html>
	<head>
		...
		<script language="javascript">			
	        function addnum(num)
	        {
			if(putinForm.all.money.value.length < 4){
		       	...
		       	var tradecode = '<%=tradecode%>';
					...
					if(ret == 0){
						...
						var watertype =2;
                          if("1191"==tradecode){
                                watertype=2;
                          }else if("1192"==tradecode){
                                 watertype=3;
                          }
						 var pret = putinForm.all.RFScanner.ReadWaterCtlPacket(watertype,cardphyid); 
						if(0==pret){
								var waterBala = putinForm.all.RFScanner.GetWaterCtlPacketInfo("money");
								var cxCnt1 =  putinForm.all.RFScanner.GetWaterCtlPacketInfo("addcount");
								...
								putinForm.all.txCnt1.value = cxCnt1;
								putinForm.all.tradecode.value=tradecode;
								putinForm.submit();
							}else{
								alert("水控钱包读卡失败");
								return false;
	...
	<body scroll="no"> 
		<form action="/smartcardweb/waterputinctlyjz.do" method="post"
			name="putinForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
								...
								<tr>
									...
									<tr>
										...
										<td width="314" align="left">
											<input name="money" type="text" class="样式11" readonly="readonly" maxlength="4" />
										</td>
									</tr>
									<tr>
										<td class="info" colspan="2" align="center" height="45">
											<font class="样式12"><a href="#" onclick="javascript: putinForm.all.money.value=5">5元</a>&nbsp;</font>
											<font class="样式12"><a href="#" onclick="javascript: putinForm.all.money.value=10">10元</a>&nbsp;</font>
											<font class="样式12"><a href="#" onclick="javascript: putinForm.all.money.value=15">15元</a>&nbsp;</font>
											<font class="样式12"><a href="#" onclick="javascript: putinForm.all.money.value=20">20元</a></font>
										</td>
									</tr>
									<tr>
							...
							<div id="login_buttom">
								<table>
									<tr>
										...
										<td>
											<a
												onclick="javascript: window.location='/smartcardweb/g_zzxx.do';"
												onmouseup="MM_swapImgRestore()"
