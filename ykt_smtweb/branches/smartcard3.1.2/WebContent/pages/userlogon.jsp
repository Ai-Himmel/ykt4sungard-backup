									...
									<table width="90%" border="0" align="right" cellpadding="0"
										...
										<%
												...
												for(int i=0;i<list.size();i++){
													TCardphytypeDTO cardtype = (TCardphytypeDTO)list.get(i);
													if(cardtype.getCardphytype()==10){
												%>
												<a onclick="javascript:logonSelect(10);"
													onmouseup="MM_swapImgRestore()"
													onmousedown="MM_swapImage('send','','/smartcardweb/pages/images/icka.gif',1)"><img
														src="/smartcardweb/pages/images/ick.gif" name="ick1"
														width="109" height="48" border="0" id="ick1" /> </a>
													
												<%		
													}else if(cardtype.getCardphytype()==20){
													%>
													<a onclick="javascript:logonSelect(20);"
													onmouseup="MM_swapImgRestore()"
													onmousedown="MM_swapImage('send','','/smartcardweb/pages/images/icka.gif',1)"><img
														src="/smartcardweb/pages/images/ick.gif" name="ick2"
														width="109" height="48" border="0" id="ick2" /> </a>
													<%											
													}else if(cardtype.getCardphytype()==30){
														
														%>
														<a onclick="javascript:logonSelect(30);"
													onmouseup="MM_swapImgRestore()"
													onmousedown="MM_swapImage('send','','/smartcardweb/pages/images/sjka.gif',1)"><img
														src="/smartcardweb/pages/images/sjk.gif" name="sjk"
														width="109" height="48" border="0" id="sjk" /> </a>
														<%	
													}
												}
											}
