...
<html>
	<head>
		...
		<%
			...
			String cardId = (String) request.getAttribute("cardphyid");
...
%>   
		...
		function showmess(){
			...
			if(t_count==0){
				msg.innerHTML = "<b>补助领取成功！</b><br> <br>补助金额："+t_amount/100+" 元<br> <br>卡余额："+t_outCardAmount/100+" 元<br> <br> 所有补助领取完毕！";
			}else{
				msg.innerHTML = "<b>补助领取成功！</b><br> <br>补助金额："+t_amount/100+" 元<br> <br>卡余额："+t_outCardAmount/100+" 元<br> <br> 您还有<b> "+t_count+" </b>条补助未能一次性领取！<br> <br>可能是卡金额超限或别的原因，请下次再领取！";
			}
				...
				<div id="Layer1">
					<div id="content">
						...
						<div align="center">
								...
								height="82" /><input type="hidden" name="cardno" value="<%=cardId%>" />
							</div>
