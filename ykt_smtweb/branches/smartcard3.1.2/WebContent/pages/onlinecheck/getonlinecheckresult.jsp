...
<html>
	<head>
		...
		<%
			String lvol8 = (String) request.getAttribute("lvol8");
			String damt0 = (String) request.getAttribute("damt0");
...
%>   
		...
		function showmess(){
			...
			msg.innerHTML = "<b>卡余额补写成功！</b><br> <br>补写金额："+t_damt0+" 元<br> <br>卡余额："+t_lvol8/100+" 元<br> <br>请返回继续您的操作！";
