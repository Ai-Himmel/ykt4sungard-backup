    ...
    <script language="javascript">
        ...
        function NoWriteCard(){
          ...
          var params = "sphone3="+sphone3+"&saddr="+saddr+"&cardBala="+cardBala+"&outCardAmount="+outCardAmount;
            var ret = 0;
            ret = writeCardForm.all.RFScanner.ReportWriteCardFailure(serverbase+"ncdealTransCardExp.do",params);
            if(ret == 0){
                window.location='/smartcardweb/pages/ncbanktransfer/cardwriteerror.jsp';
            }else{
                window.location='/smartcardweb/pages/ncbanktransfer/cardwriteerror.jsp';
            }
        }
