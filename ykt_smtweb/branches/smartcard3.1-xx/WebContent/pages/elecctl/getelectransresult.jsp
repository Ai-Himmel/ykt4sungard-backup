	...
	<head>
		...
		function writeCard(){
			...
			if(ret==0){
				...
				msg.innerHTML="电控转账失败!<br/><br/>失败原因：网络超时！请到卡务中心补写卡信息.";
			}else if(ret==-100){
				msg.innerHTML="电控转账失败!<br/><br/>失败原因：写卡失败，请重新操作！";
			}else if(ret==-3){
				msg.innerHTML="电控转账失败!<br/><br/>失败原因：请求无应答！请到卡务中心补写卡信息.";
			}else{
				msg.innerHTML="电控转账失败!<br/><br/>请到卡务中心补写卡信息.<br/><br/>失败原因："+writeCardForm.all.RFScanner.GetRequestRetInfo("errmsg");
			}
		}
