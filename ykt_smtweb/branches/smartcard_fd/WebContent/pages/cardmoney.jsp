...
<html>
	<head>
		...
		function  readCard()
	  {
	    ...
	    var rrt = cardmoneyForm.all.RFScanner.GetMainKey(serverbase+"getSysPara.do");
			if(rrt == 0){
				var ret = cardmoneyForm.all.RFScanner.ReadCardPocket(1,cardno,"");
				if(ret == 0){
					var bala = cardmoneyForm.all.RFScanner.GetPacketInfo("bala");
					errmsg.innerHTML=" 卡余额 "+ bala/100 + " 元 ";
				}else if(ret == 1){
					alert("请放置卡片...");
					return false;
				}else{
 ...
 <form action="/smartcardweb/cardmoney.do" method="post" name="cardmoneyForm" >
	  <div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					<div id="content">
						...
						<div id="content_middle">
							...
							<div id="content_input">
								<table width="50%" border="0" align="center" cellpadding="0"
									...
									<tr>
									 <td height="320" align="center" class="show" id="errmsg">
									    请放置一卡通后，确认！
									 </td>
