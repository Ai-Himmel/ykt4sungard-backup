...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dogetsubquery(){
			...
			//alert(ret);
			if(ret == 0){
				var doworkret = document.all.RFScanner.MySendRequest(serverbase+"checkresult.do","money="+ money);
				if(doworkret == 0){
				//转账成功
				
				}else if(doworkret == -1){
					//写卡失败
					window.location='/smartcardweb/pages/transfer/recardwrite.jsp';//如果重写还不成功，就要走冲正流程
