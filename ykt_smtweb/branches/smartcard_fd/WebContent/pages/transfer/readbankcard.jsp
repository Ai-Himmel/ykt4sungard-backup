...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        { 
         ...
         // ret = readCardForm.all.RFScanner.ReadBankCard(device_port,sn);
          var  ret=0; 
           if(ret==0){//读卡成功
	...
	<body scroll="no" >
		<form action="/smartcardweb/bankpassword.do" method="post" name="readCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					<div id="content">
						...
						<div id="content_middle">
							<div align="center">
								<img src="/smartcardweb/pages/images/syhk.gif" width="314"
								height="82" />
							</div>
										...
										<td align="center">
											<a onclick="javascript:readCard();"
												...
												onmousedown="MM_swapImage('send','','/smartcardweb/pages/images/senda.gif',1)"><img
													src="/smartcardweb/pages/images2/send.gif" name="send"
										...
										<td>
											<a
												...
												onmousedown="MM_swapImage('cancel','','/smartcardweb/pages/images/cancela.gif',1)"><img
													src="/smartcardweb/pages/images2/cancel.gif" name="cancel"
