...
//-->
	...
	%>
	<body scroll="no" onload="MM_preloadImages('<%=path%>/pages/images/backa.gif')" onkeydown="return (event.keyCode!=8)">
		<div id="mid_top"></div>
		<div id="middle">
			<div id="Layer1">
				<div id="content">
					...
					<div id="content_middle">
						<div align="center">
							<img src="<%=path%>/pages/images/title.gif" width="314"
								height="82" />
						</div>
						<div id="content_input">
							<table width="80%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td>
										<bean:write name="account" property="cardBalance"	format="0.00" />
										元
									</td>
								</tr>
								  <tr>
                                      <td height="30" class="样式13"> 是否公费医疗</td>
                                    <td>
                                   <logic:equal name="account" property="MED_FEETYPE" value="1">是</logic:equal>
                                   <logic:notEqual name="account" property="MED_FEETYPE" value="1">否</logic:notEqual>
                                   </td>
                                 </tr>
								<!--<tr>
									<td height="30" class="样式13">
						...
						<div id="content_buttom">
							<a onclick="javascript: window.location='<%=path%>/xykw.do';"
