...
<%@ include  file="/pages/init.jsp"%><script language="javascript" src="<%=path%>/pages/js/other.js"></script><html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function ReadCard(){
				...
				msg.innerHTML = "<b>补助号为:"+<%=sidyno%>+"一笔"+<%=amount%>+"元补助领取失败！<br><br> 失败原因："+message+"</b>";
		}
		</script>
	
	</head>
	<body scroll="no" onload="javascript:ReadCard();" onkeydown="return (event.keyCode!=8)">
							...
							<div id="content_buttom">
								<table>
									<tr>
										<td align="center">
											<a
												onclick="javascript: window.location='<%=path%>/zzyw.do';"
