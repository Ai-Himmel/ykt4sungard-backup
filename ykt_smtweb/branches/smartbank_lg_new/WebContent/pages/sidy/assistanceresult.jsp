...
<%@ include  file="/pages/init.jsp"%><script language="javascript" src="<%=path%>/pages/js/other.js"></script><html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/JavaScript">
			...
			function gotoNextPage(page){
             ...
             // window.location=url+"?cardno="+document.all.RFScanner.CardNo+"&page="page;
              document.pagequery.cardno.value=document.all.RFScanner.CardNo;
              document.pagequery.page.value = page;
			  document.pagequery.submit();
              }else {
               // window.location="<%=path%>/zzyw.do";
             }
		  }
	...
	<body scroll="no"  onkeydown="return (event.keyCode!=8)"
		...
		<form name="pagequery" action="<%=path%>/queryassistancepage.do"
			method="post">
