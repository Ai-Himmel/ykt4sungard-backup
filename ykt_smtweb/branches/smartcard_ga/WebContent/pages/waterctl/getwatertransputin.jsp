						...
						<div id="login_middle">
							...
							<div id="login_input">
								<table width="800" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td   colspan="2" align="left" class="样式9">
											目前转入水控帐户的资金一旦转帐成功暂无法转回，水控剩余金额可于退卡时退回。<br/>
											每次水控转帐金额限额50元。洗澡费用每2秒钟0.01元，不能透支。</br> 
											水控为计时收费，不用热水就马上将卡从控水器上取下以免继续扣款。
										</td>
									</tr>
								</table>
							</div>
