...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function addnum(num)
        {
			if(logonForm.nowinput.value=="1" && logonForm.manId.value.length < 18){
				if(logonForm.locknum.value=="1"){
					logonForm.manId.value+=num;
				}else{
					logonForm.manId.value+=num.toUpperCase();
				}
		...
		if(logonForm.nowinput.value=="1")
			logonForm.manId.value=logonForm.manId.value.substring(0,logonForm.manId.value.length-1);
							...
							<tr>
								<td height="250" align="center" valign="top">
									...
									<table width="100%" border="0" align="right" cellpadding="0"
										...
										<tr>
											<td align="right" >
												<img src="/smartcardweb/pages/images/sfz.gif" width="80"
													height="31" align="absmiddle" />
											</td>
											<td align="right" width="100" >
												<input type="text" name="manId" class="样式11" size="18"
													maxlength="18"
										...
										<tr>
											<td align="right">
												<img src="/smartcardweb/pages/images/ps.gif" width="80"
