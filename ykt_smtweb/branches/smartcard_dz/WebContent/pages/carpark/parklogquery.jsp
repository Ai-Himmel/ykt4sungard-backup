...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function addnum(num)
        {
		if(parklogForm.nowinput.value=="1" && parklogForm.begin.value.length < 8 ){
			parklogForm.begin.value+=num;
		}
		else if(parklogForm.nowinput.value=="2" && parklogForm.end.value.length < 8 ){
			parklogForm.end.value+=num;
		}
        }
        function cancelnum()
        {
		if(parklogForm.nowinput.value=="1")
			parklogForm.begin.value=parklogForm.begin.value.substring(0,parklogForm.begin.value.length-1);
		else if(parklogForm.nowinput.value=="2")
			parklogForm.end.value=parklogForm.end.value.substring(0,parklogForm.end.value.length-1);
        ...
        {
              if(parklogForm.nowinput.value=="1")
                 parklogForm.end.focus();
              else if(parklogForm.nowinput.value=="2")
                 parklogForm.begin.focus();
        }
        function setDate()
        {
            var dDate = new Date();
            ...
            if(day<10) day="0" +day;
            parklogForm.end.value=year+""+month+""+day;
            ...
            if(month<10) month="0"+month;
            if(day<10) day="0" +day;
            parklogForm.begin.value=year+""+month+""+day;
	...
	<body scroll="no" onload="javascript:setDate();">
		<form action="/smartcardweb/queryparklog.do" method="post"
			name="parklogForm">
						...
						<div id="login_middle">
									...
									<tr>
										...
										<td width="214">
											<input type="text" name="begin" size="20" maxlength="8" class="info"
												onfocus="javascript:parklogForm.nowinput.value='1'"/>
										</td>
									</tr>
									<tr>
										<td align="right">
										...
										<td>
											<input name="end" type="text"
												onfocus="javascript:parklogForm.nowinput.value='2'" class="info"
												size="20" maxlength="8"/>
										</td>
									</tr>
									<tr>
							...
							<div id="login_buttom">
								<table align="center">
									<tr>
										<td align="center">
											<a onclick="javascript:parklogForm.submit();" onmouseup="MM_swapImgRestore()"
