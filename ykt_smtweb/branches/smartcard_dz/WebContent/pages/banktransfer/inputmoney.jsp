        ...
        <script language="javascript">          
            ...
            if(putinForm.all.nowinput.value=="1")
             ...
             function readCard(){
                ...
                if(parseInt(putinForm.all.money.value)==0){
                    alert("转账金额不能为0！");
                    putinForm.all.money.focus();
                    return false;
                }
    			...
    			if(rrt == 0){
	    			...
	    			if(ret == 0){
	    				var cardbal = putinForm.all.RFScanner.GetPacketInfo("bala");
						var payCardCnt =  putinForm.all.RFScanner.GetPacketInfo("total_cnt");
