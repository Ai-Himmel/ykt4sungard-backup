...
public class LiberatComeCardAction extends Action {

	private static final Logger logger = Logger
			.getLogger(LiberatComeCardAction.class);
	...
	private ActionForward liberatcard(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//	logger.info("=========custno=========="+Integer.parseInt(custno));
				bcc.SetIntFieldByName(xpackhandle, 0, "lvol2".getBytes(),Integer.parseInt("2"));//标志
