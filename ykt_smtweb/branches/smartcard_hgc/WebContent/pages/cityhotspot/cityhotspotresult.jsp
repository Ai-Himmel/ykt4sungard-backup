...
<html>
	<head>
		...
		function writeCard(){
			...
			var parms = "money="+t_money+"&serialNo="+serial_no+"&cardId="+card_id;
			writeCardForm.all.RFScanner.PortNo=device_port;
			var ret = writeCardForm.all.RFScanner.ElectTransWriteCard(url,card_id,out_card_amount,<%=txCnt%>,parms);//这里不需要room,后台可能更改。
