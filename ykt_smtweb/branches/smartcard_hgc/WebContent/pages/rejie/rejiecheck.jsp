...
<html>
	...
	<body scroll="no">
		<form action="/smartcardweb/rejieCheck.do" method="post"
			name="writeCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					...
					: request.getAttribute("outCardAmount")%>" />
											<input type="hidden" name="chargeID"
												value="<%=request.getAttribute("chargeID") == null ? "" : request
					.getAttribute("chargeID")%>" />
					...
					.getAttribute("txCnt")%>" />
									  ...
									  <td>
											<%=request.getAttribute("chargeID") == null ? "" : request
					.getAttribute("chargeID")%>
										</td>
										</tr>
									<tr>
					...
					: String.valueOf(Double.parseDouble(request.getAttribute(
							"cardBala").toString()) / 100)%>
									...
									<tr>
										...
										<td>
											<%=request.getAttribute("ip") == null ? "" : request
					.getAttribute("ip")%>
										</td>
									</tr>
									<tr>
										...
										<td>
											<%=request.getAttribute("stuName") == null ? "" : request
