...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function writeCard(){
			...
			if(ret==0){
				msg.innerHTML="电控转账成功，转账金额 "+t_money+" 元，卡余额 "+parseFloat(out_card_amount)/100+" 元";
			}else if(ret==2){
				msg.innerHTML="电控转账失败，失败原因：网络超时！";
			}else if(ret==-2){
				msg.innerHTML="电控转账失败，失败原因：写卡失败！";
			}else if(ret==-3){
				msg.innerHTML="电控转账失败，失败原因：请求无应答！";
			}else{
				msg.innerHTML="电控转账失败，失败原因："+writeCardForm.all.RFScanner.GetRequestRetInfo("errmsg");
			}
		}
