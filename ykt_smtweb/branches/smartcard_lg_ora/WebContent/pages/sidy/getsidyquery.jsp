...
<html>
	<head>
		...
		function dogetsubquery(){
			...
			if(ret == 0){
				var sidyno = writeCardForm.all.RFScanner.ReadCardSidyNo(cardId,"");
				if(sidyno>=0){
					var doworkret = writeCardForm.all.RFScanner.MySendRequest(serverbase+"getSidy.do","cardId="+cardId+"&sidyno="+sidyno);
					if(doworkret == 0){
						//领取成功
						writeCardForm.all.cardId.value=cardId;
						writeCardForm.all.sidyno.value=sidyno;
				...
				<div id="Layer1">
						...
						<div id="content_middle">
							...
							<div id="content_input">
								<table width="80%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="32" class="样式14" align="right" colspan="2">
											您还有&nbsp;
									...
									<tr>
										<td width="320" height="29" class="样式13">
											客户号
										</td>
										<td>
											<%=request.getAttribute("cut_id") == null ? ""
					: request.getAttribute("cut_id")%>
										</td>
									</tr>
									<tr>
										<td width="320" height="29" class="样式13">
					...
					: request.getAttribute("cut_name")%>
									...
									<tr>
										...
										<td>
											<bean:write name="subsidy" property="subsidyNo" />
											&nbsp;
										</td>
									</tr>
									<tr>
