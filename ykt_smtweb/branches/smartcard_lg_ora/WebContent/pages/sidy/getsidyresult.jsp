...
<html>
	<head>
		...
		<%
			...
			String sidyno = (String) request.getAttribute("sidyno");
		%>
		<script language="JavaScript" type="text/JavaScript">
		function showmess(){
			document.body.style.overflow='hidden';
			var t_count = '<%=count%>';	
			var t_amount = writeCardForm.all.RFScanner.GetRequestRetInfo("amount");
			var t_outCardAmount = writeCardForm.all.RFScanner.GetRequestRetInfo("outcardamount");
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td height="80">
											...
											<input type="hidden" name="sidyno" value="<%=sidyno%>" />
										</td>
									</tr>
								</table>
							</div>
