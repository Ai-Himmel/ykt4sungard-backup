...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function ReWriteCard(){		
			...
			var cardId = writeCardForm.all.RFScanner.GetRequestRetInfo("cardno");	
			var sidyno = writeCardForm.all.RFScanner.GetRequestRetInfo("sidyno");	
			ret = writeCardForm.all.RFScanner.RewriteSidy();
			if(ret ==0){				
		...
		function NoWriteCard(){
			...
			var device_port = <%=read_card_device_port%>;
			var serial_no = writeCardForm.all.RFScanner.GetRequestRetInfo("serialno");
			var ret = 0;
			ret = writeCardForm.all.RFScanner.ReportCardWriteFailue(serverbase+"dealSidyErr.do",serial_no);
			if(ret == 0){
