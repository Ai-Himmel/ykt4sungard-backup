...
<html>
	<head>
		...
		function ReadCard(){		
			...
			var out_card_amount = readCardForm.all.RFScanner.GetRequestRetInfo("outcardamount");
			var t_money = readCardForm.all.RFScanner.GetRequestRetInfo("amount");	
			var out_card_amount1 = readCardForm.all.RFScanner.GetWaterCtlPackInfo("balanceout")
