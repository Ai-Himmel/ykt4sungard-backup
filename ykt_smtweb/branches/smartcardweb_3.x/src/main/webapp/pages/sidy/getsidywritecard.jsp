...
<html>
	<head>
		...
		<script language="JavaScript" type="text/JavaScript">
		 function dogetsubquery(){
            ...
            if(ret == 0){
                var doworkret = document.all.RFScanner.MySendRequest(serverbase+"getSidy.do","cardphyid="+CardPhyId);
                if(doworkret == 0){
                //领取成功	                     
                ...
                window.location='/smartcardweb/pages/sidy/getsidyfailue1.jsp';
            }
	...
	<body scroll="no" onload="javascript:dogetsubquery();">
