...
<html>
	<head>
		...
		<%
			...
			String oldsidyno = (String) request.getAttribute("sidyno");
        ...
        function dogetsubquery(){
            ...
            if(ret == 0){
                ...
                if(sidyno>=0){
                    var doworkret = document.all.RFScanner.MySendRequest(serverbase+"getSidy.do","cardphyid="+CardPhyId+"&sidyno="+sidyno);
                    if(doworkret == 0){
                    //领取成功
                     document.forms[0].cardphyid.value=CardPhyId;
                     var newsidyno = document.all.RFScanner.GetRequestRetInfo("sidyno");
                     document.forms[0].sidyno.value=newsidyno;
...
.样式14 {
	...
	<%
		Integer tpage = (Integer) request.getAttribute("page");
		int p = tpage.intValue();
	%>
	...
	<body scroll="no">
		...
		<form name="pagequery" action="/smartcardweb/getsidyquery.do"
			method="post">
			<input name="page" type="hidden" value="1" />
			<input type="hidden" name="cardphyid" value="<%=cardphyid%>"/>
            <input type="hidden" name="sidyno" value="<%=oldsidyno%>"/>
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					<div id="content">
							...
							<div id="content_input">
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tr align="center">
										...
										<td align="center" class="样式13" width="25%">
											摘要信息
										</td>
									...
									<logic:iterate id="ttifsidy" name="ttifsidys" offset="0">
										<%
											TTifSubsidyDTO ts = (TTifSubsidyDTO) ttifsidy;
													String tx_date = ts.getPutdate() == null ? "" : ts
															.getPutdate();
										...
										<tr align="center">
											...
											<td height="20">
												<div align="center" class="样式12">
													<bean:write name="ttifsidy" property="custid" />
													&nbsp;
												</div>
											</td>
											...
											<td height="20">
												<div align="center" class="样式12">
													<bean:write name="ttifsidy" property="summary" />
													&nbsp;
												</div>
											</td>
										</tr>
