		...
		<form action="/smartcardweb/electrans.do" method="post"
			...
			<div id="middle">
				<div id="Layer1">
					...
					.getAttribute("room")%>" />
											<input type="hidden" name="elecIndex" value="<%=request.getAttribute("elecIndex") == null ? "" : request.getAttribute("elecIndex")%>" />
										</td>
										<td>
					...
					.getAttribute("room")%>
									...
									<tr>
										...
										<td>
											<%=request.getAttribute("money") == null ? "" : request.getAttribute("money")%>
											元
										</td>
									</tr>
									<tr>
										...
										<td>
											<%=request.getAttribute("cardBala") == null ? "": String.valueOf(Double.parseDouble(request.getAttribute("cardBala").toString()) / 100)%>元
										</td>
									</tr>
									<%
										if(StringUtils.isNotBlank(request.getAttribute("info") == null ? "" : request.getAttribute("info").toString())){
									%>
									<tr>
										<td height="50" class="样式13">
											房间信息
