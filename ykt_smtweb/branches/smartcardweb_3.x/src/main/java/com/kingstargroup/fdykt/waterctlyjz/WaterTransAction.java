...
public class WaterTransAction extends Action {
	...
	private ActionForward dotrans(ActionMapping mapping, ActionForm form,
		...
		String svrFunc = KSConfiguration.getInstance().getProperty(
				"mainfunction1", "6000");
		DB2SysParaDAO sysdao = new DB2SysParaDAO();
		String price1="10";
		String price2="10";
		String price3="10";
		String validatedate = DateUtil.getNewDateTime(sdate3, 90, "yyyyMMdd");
		try {
			SysParaDTO sysparadto = sysdao.getSysPara(157);
			price1 = sysparadto.getParaval();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			//e.printStackTrace();
			System.out.print("没有设置水控费率 syspara(157)");
		}
		try {
			SysParaDTO sysparadto = sysdao.getSysPara(158);
			price2 = sysparadto.getParaval();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			//e.printStackTrace();
			System.out.print("没有设置水控费率 syspara(158)");
		}
		try {
			SysParaDTO sysparadto = sysdao.getSysPara(159);
			price3 = sysparadto.getParaval();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			//e.printStackTrace();
			System.out.print("没有设置水控费率 syspara(159)");
		}
