				...
				if (bccret) {
					...
					if (0 == RetCode[0]) {
						if (0 < RecordCount[0]) {
							...
							BigDecimal s = new BigDecimal(Double.toString(OutCardAmount[0]));
							BigDecimal c = new BigDecimal("100");
							BigDecimal one = new BigDecimal("1");
							BigDecimal f = s.divide(one, 2, BigDecimal.ROUND_HALF_UP);
							String cout_card_amount = String.valueOf(f.multiply(c).doubleValue());
							
//							String cout_card_amount = String.valueOf(OutCardAmount[0] * 100);
