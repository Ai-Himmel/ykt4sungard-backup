...
public class DealWaterTransErrorAction extends Action {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(DealWaterTransErrorAction.class);
	...
	private ActionForward dealWaterTransErr(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		...
		int func = KSConfiguration.getInstance().getPropertyAsInt("logicfunc_rewritecard", 847304);// 后台业务功能号
