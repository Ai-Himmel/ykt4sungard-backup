...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function ReWriteCard(){		
			...
			ret = writeCardForm.all.RFScanner.ReWriteWaterPacket(cardId);
			if(ret ==0){
				window.location='/smartcardweb/pages/waterctl/cardwritesuccess.jsp';
			}else{
				NoWriteCard();
			}
		}
		function NoWriteCard(){
			...
			var device_port = <%=read_card_device_port%>;
			var serial_no1 = writeCardForm.all.RFScanner.GetRequestRetInfo("serialno1");
			var ret = 0;
			ret = writeCardForm.all.RFScanner.ReportCardWriteFailue(serverbase+"dealWaterTransErr.do",serial_no1);
			if(ret == 0){
