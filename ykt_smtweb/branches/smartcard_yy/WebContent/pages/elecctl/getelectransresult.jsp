...
<html>
	<head>
		...
		function writeCard(){
			...
			var parms = "money="+t_money+"&serialNo="+serial_no+"&room="+myroom+"&cardId="+card_id;
			writeCardForm.all.RFScanner.PortNo=<%=read_card_device_port%>;
			...
			if(ret==0){
				...
				msg.innerHTML="已经转账，后台正在处理，请30分钟后查询房间金额！";
			}else if(ret==-2){
				msg.innerHTML="电控转账失败!<br/><br/>失败原因：写卡失败！";
			}else if(ret==-3){
				msg.innerHTML="已经转账，后台正在处理，请30分钟后查询房间金额！";
			}else{
				msg.innerHTML="电控转账失败!<br/><br/>";
			}
		}
