...
public class ElecTransAction extends Action {
	/**
	...
	private ActionForward dotrans(ActionMapping mapping, ActionForm form,
		...
		if (null == cardId || null == money || null == serialNo
				|| "".equals(cardId) || "".equals(money) || "".equals(serialNo)||"".equals(room)) {
		...
		int func = KSConfiguration.getInstance().getPropertyAsInt(
				"logicfunc_elect_trans", 847317);// 后台业务功能号
		...
		try {
			...
			System.out.println("here have some problem！");
