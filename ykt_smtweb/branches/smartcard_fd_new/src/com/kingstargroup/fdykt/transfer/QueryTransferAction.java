...
public class QueryTransferAction extends Action {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(QueryTransferAction.class);
	...
	private ActionForward doTradeSerial(ActionMapping mapping, ActionForm form, HttpServletRequest request) {
	   ...
	   // int  week = Integer.parseInt(request.getParameter("week").toString());
		...
		String end = "";
 		...
 		tradeserials = tradeserialdao.getTSByCardId(cardId,240001, begin, end,
					page.intValue());

			/*Integer all = new Integer(tradeserialdao.getCountByCardId(cardId,240001,
					begin, end));*/
