				...
				<div id="mid_center">
					<ul>
					  ...
					  <li
					    ...
					    <li
							onmouseout="this.style.background='url(<%=path%>/pages/images/dsdj.gif)'"
							onmouseup="this.style.background='url(<%=path%>/pages/images/dsdj.gif)'"
							onmousedown="this.style.background='url(<%=path%>/pages/images/dsdja.gif)'"
							style="cursor: hand; background: url(<%=path%>/pages/images/dsdj.gif)"
							onclick="dsdj()"></li>	
