...
<%@ include  file="/pages/init.jsp"%><script language="javascript" src="<%=path%>/pages/js/other.js"></script><html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body scroll="no" onkeydown="return (event.keyCode!=8)">
		<form action="<%=path%>/cancelresult.do" method="post"
			name="cancelLossForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					<div id="content">
						...
						<div id="content_middle">
							<div align="center">
								<img src="<%=path%>/pages/images/jiegua.gif" width="314" height="82" />
							</div>
							...
							<div id="content_buttom">
								<table>
									<tr>
										<td align="center">
											<a onclick="readCard('<%=path%>/cancelresult.do')"
												onmouseup="MM_swapImgRestore()"
												onmousedown="MM_swapImage('send','','<%=path%>/pages/images/senda.gif',1)"><img
													src="<%=path%>/pages/images/send.gif" name="send" width="109" height="48"
													border="0" id="send" /> </a>
										</td>
										<td>
											<a
												...
												onmousedown="MM_swapImage('back','','<%=path%>/pages/images/backa.gif',1)"><img
													src="<%=path%>/pages/images/back.gif" name="back" width="109" height="48"
													border="0" id="back" /> </a>
										</td>
									</tr>
								</table>
