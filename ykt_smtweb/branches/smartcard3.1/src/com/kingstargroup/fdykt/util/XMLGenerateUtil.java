...
public class XMLGenerateUtil {
	...
	public static String XMLGenerate(String errorCode,
			String errorMessage, String SidyAmount,String OutCardAmount,String SerialNo,String ParamKey,String CardId,String txCnt,String sidyno,String sdate3,String stime3,List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
