...
public class DealWaterTransCardExceptionAction extends Action {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(DealWaterTransCardExceptionAction.class);
	...
	private ActionForward dealWaterTransErr(ActionMapping mapping,
		...
		String packetno = request.getParameter("packetno")==""?"1":request.getParameter("packetno");
				...
				if (bccret) {
					...
					if (0 == RetCode[0]) {
						...
						String xmlout = XMLGenerateUtil
								.XMLGenerate("0000", "写卡异常处理成功", null, null);
						XMLGenerateUtil.XMLSendOut(request, response, xmlout);
						return null;
