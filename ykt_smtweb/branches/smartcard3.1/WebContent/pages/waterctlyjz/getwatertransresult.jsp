...
<html>
	<head>
		...
		function writeCard(){
			...
			var sdate3 = '<%=sdate3%>';
            var stime3 = '<%=stime3%>';
			var url = serverbase+"getWaterTransctlyjz.do";			
			...
			var watertype = 2;
             ...
             var parms = "cardphyid="+cardphyid+"&cardBala="+cardBala+"&waterBala="+waterBala+"&money="+money+"&txCnt="+txCnt+"&txCnt1="+txCnt1+"&tradecode="+tradecode+"&sphone3="+sphone3+"&saddr="+saddr+"&outCardAmount="+outCardAmount+"&outCardAmount1="+outCardAmount1+"&sdate3="+sdate3+"&stime3="+stime3;
			var ret = writeCardForm.all.RFScanner.WaterCtlTransWriteCard(url,cardphyid,watertype,parms);
			if(ret==0){
				...
				window.location='/smartcardweb/pages/waterctlyjz/recardwrite1.jsp';
			}else{
			     window.location='/smartcardweb/pages/waterctlyjz/recardwrite.jsp';
			}
		}
