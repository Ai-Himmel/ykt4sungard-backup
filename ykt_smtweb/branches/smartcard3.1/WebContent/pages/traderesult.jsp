					...
					<div id="content_middle">
						...
						<div id="content_input">
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr align="center">
									<td align="center" class="样式13" height="20" width="6%">
										序号
									</td>
									<td align="center" class="样式13" width="7%">
                                             卡号
                                    </td>
									<td align="center" class="样式13" width="14%">
										交易名称
									</td>
									...
									<td align="center" class="样式13" width="18%">
										日期时间
									</td>
									<td align="center" class="样式13" width="10%">
										交易金额
								...
								<logic:iterate id="tradeserial" name="tradeserials" offset="0">
									<%
											...
											String operate_Date = ts.getTransdate();
											String operate_Time = ts.getTranstime();
										    ...
										    String datetime = operate_Date +" "+operate_Time;
									...
									<tr align="center">
										...
										<td height="20" class="样式12">
                                            <bean:write name="tradeserial" property="cardno" />
                                        </td>
										<td height="20" class="样式12">
											<bean:write name="tradeserial" property="transname" />
										</td>
										<td height="20" class="样式12">
											<bean:write name="tradeserial" property="areaname" />
										</td>
										<td height="20" class="样式12">
										<%if(ts.getCardcnt()>0){ %>
										 <bean:write name="tradeserial" property="cardcnt"/>                                    
                                        <%}else{ %>
                                        --
                                        <%} %>
										...
										<td height="20" class="样式12">
										<%if(ts.getAmount()!=0){ %>
										<bean:write name="tradeserial" property="amount" format="###.##"/>    
										<%}else{ %>
                                        --
                                        <%} %>
										</td>
										<td height="20" class="样式12">
										<%if(ts.getCardaftbal()!=0){ %>
                                        <bean:write name="tradeserial" property="cardaftbal" format="###.##"/>    
                                        <%}else{ %>
                                        --
                                        <%} %>
