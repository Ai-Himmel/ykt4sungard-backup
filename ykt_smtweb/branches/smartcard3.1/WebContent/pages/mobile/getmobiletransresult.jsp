...
<html>
	<head>
		...
		function writeCard(){
			...
			var ret = writeCardForm.all.RFScanner.MobileTransWriteCard(url,card_id,out_card_amount,parms);
			if(ret==0){
				msg.innerHTML="手机充值成功！<br/><br/>手机充值金额 "+t_money+" 元，<br/><br/>一卡通卡余额 "+parseFloat(out_card_amount)/100+" 元。";
			}else if(ret==2){
				...
				msg.innerHTML="手机充值失败，失败原因："+writeCardForm.all.RFScanner.GetRequestRetInfo("errmsg");
			}
		}
