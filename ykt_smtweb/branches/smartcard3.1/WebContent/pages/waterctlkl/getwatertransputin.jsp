				...
				if(rrt == 0){
					...
					if(ret == 0){
						...
						if(parseInt(document.all.money.value)*100<=parseInt(bala)){
						 var pret = putinForm.all.RFScanner.ReadWaterPacket(cardphyid); 
						if(0==pret){
								var waterBala = putinForm.all.RFScanner.GetWaterPacketInfo("money");
								var cxCnt1 =  putinForm.all.RFScanner.GetWaterPacketInfo("add_count");
