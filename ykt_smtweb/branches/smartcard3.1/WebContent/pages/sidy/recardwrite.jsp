...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script language="javascript">
		...
		function ReWriteCard(){		
			...
			var CardPhyId = document.all.RFScanner.GetRequestRetInfo("cardno");		
			ret = document.all.RFScanner.RewriteSidy();
			if(ret ==0){		
		...
		function NoWriteCard(){
			...
			document.all.RFScanner.PortNo=device_port;
			var ret = 0;
			ret = document.all.RFScanner.ReportCardWriteFailue(serverbase+"dealSidyErr.do","0");
			if(ret == 0){
