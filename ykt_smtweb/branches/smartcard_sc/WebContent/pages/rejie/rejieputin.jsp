...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		String stuempno = request.getSession().getAttribute("stuempno") == null ? "" : request.getSession().getAttribute("stuempno").toString();
		%>
												...
												<div id="mis">
													<div>
														<ul>
															...
															<li id="lock"
																style="cursor:hand; background:url(/smartcardweb/pages/images/locka.gif)"
									...
									<table width="90%" border="0" align="right" cellpadding="0"
									    ...
									    <td >
											<input name="chargeID" type="text" class="样式11"
												onfocus="javascript:putinForm.nowinput.value='1'" size="15" value="<%=stuempno %>"/>
										</td>
