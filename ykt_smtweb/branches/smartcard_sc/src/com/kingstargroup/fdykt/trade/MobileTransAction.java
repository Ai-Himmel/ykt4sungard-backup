...
public class MobileTransAction extends Action {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger
			.getLogger(MobileTransAction.class);
	...
	private ActionForward dotrans(ActionMapping mapping, ActionForm form,
		...
		if (null == cardId || null == cellphone || null == money
				|| null == serialNo || "".equals(cardId)
				|| "".equals(cellphone) || "".equals(money)
				|| "".equals(serialNo)) {
		...
		int func = KSConfiguration.getInstance().getPropertyAsInt(
				"logicfunc_mobile_trans", 847317);// 后台业务功能号
