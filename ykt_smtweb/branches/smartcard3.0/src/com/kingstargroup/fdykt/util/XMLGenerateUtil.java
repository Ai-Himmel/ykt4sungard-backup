...
public class XMLGenerateUtil {
	...
	public static String XMLGenerate(String errorCode, String errorMessage,
			String SidyAmount, String OutCardAmount, String SerialNo,
			String ParamKey, String CardId, String txCnt, String sidyno,
			String sdate3, List listDate) {
	...
	public static String MoblileXMLGenerate(String errorCode,
			String errorMessage, String MobileAmount, String OutCardAmount,
			String SerialNo, String ParamKey, String CardId, List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
	...
	public static String ElectXMLGenerate(String errorCode,
			String errorMessage, String MobileAmount, String OutCardAmount,
			String SerialNo, String CardId, List listDate) {
		if (logger.isDebugEnabled()) {
			logger.debug("XMLGenerate(String, String, List) - start");
		}
