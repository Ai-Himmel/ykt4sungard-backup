											...
											<td>
												<div id="mis">
													<div>
														<ul>
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/a.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/b.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/c.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/d.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/e.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/f.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/g.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/h.gif)'"
															...
															<li
																onmouseup="this.style.background='url(/smartcardweb/pages/images/i.gif)'"
