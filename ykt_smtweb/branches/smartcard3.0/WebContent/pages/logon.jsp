    ...
    %>
        ...
        function readCard()
        {
         var serverbase = "http://"+"<%=webserverip%>"+":"+"<%=webserverport%>"+"/"+"<%=webserverapp%>"+"/";
          ...
          logonForm.all.RFScanner.PortNo=device_port;//¶Á¿¨Æ÷¶Ë¿ÚÉèÖÃ
           ...
           if(ret==0){//¶Á¿¨³É¹¦
            ...
            if(rrt == 0){
                var deadlinedate = logonForm.all.RFScanner.getDeadlineDate(serverbase+"getDeadlineDate.do",cardid,"");
                if(deadlinedate!=""){
                    logonForm.all.RFScanner.UpdateDeadlineDate(serverbase+"updateDeadlineDate.do",cardid,deadlinedate,"");
                }
            }
				...
				<div id="Layer1">
					<div id="login">
						...
						<div id="login_middle">
							...
							<div id="login_blank1" class="ÑùÊ½12">
								<html:errors />
								&nbsp;
							</div>
							<div id="login_buttom">
