...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function ReWriteCard(){
			...
			ret = writeCardForm.all.RFScanner.ReWriteWaterPacket();
			if(ret ==0){
        ...
        function reportCarderror2(){
            ...
            var sphone3 = writeCardForm.all.RFScanner.GetRequestRetInfo("sphone3");
            var saddr = writeCardForm.all.RFScanner.GetRequestRetInfo("saddr");
            var packetno = writeCardForm.all.RFScanner.GetRequestRetInfo("packetno");
            ...
            var outCardAmount1 = writeCardForm.all.RFScanner.GetRequestRetInfo("OutCardAmount1");
             var params = "sphone3="+sphone3+"&saddr="+saddr+"&cardBala="+waterBala+"&outCardAmount="+outCardAmount1+"&packetno="+packetno;
            var ret = 0;
            ret = writeCardForm.all.RFScanner.ReportWriteCardFailure(serverbase+"/dealWaterTransCardExp999.do",params);
            if(ret == 0){
                window.location='/smartcardweb/pages/waterctl999/cardwriteerror.jsp';
