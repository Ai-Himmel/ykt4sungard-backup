...
<html>
				...
				if(rrt == 0){
					...
					if(ret == 0){
						...
						var packet =2;
						 ...
						 var pret = putinForm.all.RFScanner.ReadSmallPacket(packet,cardId); 
							if(0==pret){    
								var waterBala = putinForm.all.RFScanner.GetSmallPacketInfo("nBalance");
								var cxCnt1 =  putinForm.all.RFScanner.GetSmallPacketInfo("nCnt");
	...
	<body scroll="no"> 
		<form action="/smartcardweb/waterputin999.do" method="post"
			name="putinForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
