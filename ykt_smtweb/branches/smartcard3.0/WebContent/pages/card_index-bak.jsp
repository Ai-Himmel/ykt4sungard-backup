			...
			<div id="Layer3">
				<div id="mid_center">
					<ul>
						...
						<!-- 
                        <li
                            onmouseup="this.style.background='url(/smartcardweb/pages/images/mb.gif)'"
                            onmousedown="this.style.background='url(/smartcardweb/pages/images/mba.gif)'"
                            style="cursor:hand; background:url(/smartcardweb/pages/images/mb.gif)"
                            onclick="javascript: window.location='/smartcardweb/mobilebusiness.do';"></li>
                        ...
                        <li
                            ...
                            style="cursor:hand; background:url(/smartcardweb/pages/images/sk.gif)"
                        ...
                        <li
                            ...
                            style="cursor:hand; background:url(/smartcardweb/pages/images/dk.gif)"
						...
						<li
                         ...
                         <li
                            ...
                            onmousedown="this.style.background='url(/smartcardweb/pages/images/ska.gif)'"
                            style="cursor:hand; background:url(/smartcardweb/pages/images/sk.gif)"
                            onclick="javascript: window.location='/smartcardweb/watershopchoose999.do';"></li>
                            ...
                            style="cursor: hand; background: url(/smartcardweb/pages/images/zysf.gif)"
