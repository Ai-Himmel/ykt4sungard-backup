...
<html>
	<head>
		...
		<%
            ...
            String outCardAmount = request.getAttribute("outCardAmount") == null ? "0"
		...
		function docancel(){
		  if(confirm("转出卡所扣款还未写入收款方卡，是否确认直接返回？")){
		...
		function doCardCharge(){		      
           ...
           if(rrt == 0){
            ...
            if(ret == 0){
                    var doworkret = writeCardForm.all.RFScanner.CardTransWriteCard(outCardAmount,outcardphyno,outcardcnt);
                    if(doworkret == 0){
                    //写卡成功
								...
								<table width="70%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="320" align="center" class="show" id="msg">
											<font style="font-size: 22px;"><b>转出卡</b></font> 金额已扣除,扣款金额为 <%=money%> 元
											<br>
											<br>
											点击 <font style="font-size: 22px;"><b>确定</b></font> 前，请将 <font style="font-size: 22px;"><b>收款方卡</b></font> 放置于读卡器上
											<br />
											<br>
											（点击 确定 后，请不要移动卡片！）  
