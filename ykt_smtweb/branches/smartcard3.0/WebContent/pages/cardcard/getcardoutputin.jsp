               ...
               if(cardid==logingcardid){
	               ...
	               if(rrt == 0){
	                 ...
	                 if(pktret==0){
	                     ...
	                     writeCardForm.all.outcardphyno.value=cardid;                     
	                     writeCardForm.all.outcardbalance.value=writeCardForm.all.RFScanner.GetPacketInfo("bala");                     
	                     writeCardForm.all.outcardcnt.value=writeCardForm.all.RFScanner.GetPacketInfo("total_cnt");      
								...
								<table width="70%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="320" align="center" class="show" id="msg">
											请将  <font style="font-size: 22px;"><b>收款方卡</b></font> 放置于读卡器上，点击 <font style="font-size: 22px;"><b>确定</b></font> 进行信息确认
											<br/>
											<br/>
											（点击 <font style="font-size: 22px;"><b>确定</b></font> 后请等待 ，不要移动卡片！）  
