...
<html>
	<head>
		...
		function writeCard(){
			...
			var parms = "cardId="+card_id+"&fee="+t_fee+"&serialNo="+serial_no+"&sdate3="+sdate+"&sname2="+sname+"&gid="+t_gid;
			...
			if(ret==0){
                ...
                msg.innerHTML="操作失败,失败原因："+writeCardForm.all.RFScanner.GetRequestRetInfo("errmsg");
			}
		}
