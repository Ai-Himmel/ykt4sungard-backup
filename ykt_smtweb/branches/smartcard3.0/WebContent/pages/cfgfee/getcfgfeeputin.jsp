             ...
             function readCard(){
              if(!document.all.send.disabled){
	                ...
	                var mret=putinForm.all.RFScanner.DoScan();
			           if(mret==0){//读卡成功			           
			            var cardid = putinForm.all.RFScanner.CardNo;
                                ...
                                <table width="560" border="0" cellpadding="0" cellspacing="0">        
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                                <input type="hidden" name="nowinput" onfocus="javascript:putinForm.nowinput.value='1'"/>
                                                <input name="fee" type="text" size="20"  class="info"  maxlength="4">
                                            <%
                                            }else{
                                               %>
                                               <input type="hidden" name="nowinput" onfocus="javascript:putinForm.nowinput.value='2'"/>
                                                <input name="fee" type="text" size="20"  class="info"  maxlength="4" readonly="readonly">
                                                 <%if(!"input".equals(type)){
                                    ...
                                    maxlength="6" onfocus="javascript:putinForm.nowinput.value='3'"/>
                                        </td>
                                    </tr>   
                                    <tr>
