...
<html>
	<head>
		...
		function writeCard(){
			...
			var ret = writeCardForm.all.RFScanner.CardChangeNewCard(serverbase+"newcardchange.do");
			if(ret==0){
				 window.location='/smartcardweb/pages/changecard/changecardsuccess.jsp';
			}else if(ret>=-11){
			     //未写卡
                window.location='/smartcardweb/pages/changecard/newcardrecardwrite.jsp';
			}else{
			     //已部分写卡
			    window.location='/smartcardweb/pages/changecard/newcardrecardwrite2.jsp'; 
			}
		}
