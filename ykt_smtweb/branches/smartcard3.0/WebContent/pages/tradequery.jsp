...
<html>
	<head>
        ...
        function addnum(num)
        {
		if(tradeSerialForm.all.nowinput.value=="1" && tradeSerialForm.all.begin.value.length < 8 ){
			tradeSerialForm.all.begin.value+=num;
		}
		else if(tradeSerialForm.all.nowinput.value=="2" && tradeSerialForm.all.end.value.length < 8 ){
			tradeSerialForm.all.end.value+=num;
		}
        }
        function cancelnum()
        {
		if(tradeSerialForm.all.nowinput.value=="1")
			tradeSerialForm.all.begin.value=tradeSerialForm.all.begin.value.substring(0,tradeSerialForm.all.begin.value.length-1);
		else if(tradeSerialForm.all.nowinput.value=="2")
			tradeSerialForm.all.end.value=tradeSerialForm.all.end.value.substring(0,tradeSerialForm.all.end.value.length-1);
        ...
        {
              if(tradeSerialForm.all.nowinput.value=="1")
                 tradeSerialForm.all.end.focus();
              else if(tradeSerialForm.all.nowinput.value=="2")
                 tradeSerialForm.all.begin.focus();
        }
        function setDate()
        {
            var dDate = new Date();
            ...
            if(day<10) day="0" +day;
            tradeSerialForm.all.end.value=year+""+month+""+day;
            ...
            if(month<10) month="0"+month;
            if(day<10) day="0" +day;
            tradeSerialForm.all.begin.value=year+""+month+""+day;
						...
						<div id="login_middle">
							...
							<div id="login_buttom">
								<table>
									<tr>
										<td align="center">
											<a onclick="javascript:serialquery();" onmouseup="MM_swapImgRestore()"
