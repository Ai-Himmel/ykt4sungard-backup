					...
					<ul>
						...
						<li
                            ...
                            -->
 							<!-- 大连海事专用返回 -->
 						<li
							onmouseout="this.style.background='url(/smartcardweb/pages/images/xszl.gif)'"
							onmouseup="this.style.background='url(/smartcardweb/pages/images/xszl.gif)'"
							onmousedown="this.style.background='url(/smartcardweb/pages/images/xszla.gif)'"
							style="cursor: pointer; background: url(/smartcardweb/pages/images/xszl.gif); <% if (!ConfigMenu.getMenuStatus("main_student")) { out.print(" display:none; "); }%>"
							onclick="javascript: window.location='/smartcardweb/shzhstudent.do';"></li>
					</ul>
				</div>
			</div>
		</div>
