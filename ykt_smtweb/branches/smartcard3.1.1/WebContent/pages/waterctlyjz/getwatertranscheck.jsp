...
.样式14 {
	...
	<body scroll="no">
		<form action="/smartcardweb/watertransctlyjz.do" method="post"
			name="writeCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
							...
							<div id="content_input">
								<table width="80%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<td>
											<%=request.getAttribute("sphone3") == null ? ""
					...
					: request.getAttribute("sphone3")%>" />
											<input type="hidden" name="saddr"
												value="<%=request.getAttribute("saddr") == null ? "" : request
					.getAttribute("saddr")%>" />
										</td>
										<td>
					...
					: String.valueOf(Double.parseDouble(request.getAttribute(
							"waterBala").toString()) / 100.00)%>
									...
									<tr>
										<td height="110px" align="center" class="show" id="errmsg"
											colspan="2">
											<html:errors />
											请确认放好卡! &nbsp;
										</td>
