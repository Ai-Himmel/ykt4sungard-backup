...
<html>
	<head>
		...
		String default_openacc_amount = KSConfiguration.getInstance().getProperty("default_openacc_amount","30"); 
		%>
	...
	<body scroll="no">
		<form action="/smartcardweb/netcomputeputinbindopenacc.do" method="post"
			name="putinForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
							...
							<div id="login_input">
								<table width="360" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td width="214">
											 <input name="money" type="text" class="样式11" size="20" value="<%=default_openacc_amount%>"
                                                maxlength="4" />
										</td>
									</tr>
									<tr>
