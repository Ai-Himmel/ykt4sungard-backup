...
<html>
	<head>
		...
		String netIndex = request.getAttribute("netIndex") == null ? "": request.getAttribute("netIndex").toString();
		%>
								...
								<table width="360" border="0" cellpadding="0" cellspacing="0">
									<tr>
									 ...
									 <tr>
                                        ...
                                        <td width="214" class="样式9">
                                        	<%=request.getAttribute("thirdinfo") == null ? "" : request.getAttribute("thirdinfo")%>                                        
									...
									<tr>
										<td width="206" align="right">
											...
											<input type="hidden" name="netIndex" value="<%=netIndex%>"/>
										</td>
										<td width="214">
