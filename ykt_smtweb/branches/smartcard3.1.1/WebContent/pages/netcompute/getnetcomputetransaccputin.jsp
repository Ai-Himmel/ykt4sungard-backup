...
.样式9 {
	...
	<body scroll="no"
		...
		<form action="/smartcardweb/netcomputeaccputin.do" method="post"
			name="logonForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
										...
										<tr>
											...
											<td>
												<input type="text" name="stuempno" class="样式11" size="15"
													maxlength="15" />
												<input type="hidden" name="cardphyid" value="<%=request.getAttribute("cardphyid") == null ? "" : request.getAttribute("cardphyid")%>"/>
