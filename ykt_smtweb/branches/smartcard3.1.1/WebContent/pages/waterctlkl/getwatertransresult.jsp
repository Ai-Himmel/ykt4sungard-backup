...
<html>
	<head>
		...
		function writeCard(){
			...
			var sdate3 = '<%=sdate3%>';
            var stime3 = '<%=stime3%>';
			var url = serverbase+"getWaterTranskl.do";			
			writeCardForm.all.RFScanner.PortNo=device_port;
             var parms = "cardphyid="+cardphyid+"&cardBala="+cardBala+"&waterBala="+waterBala+"&money="+money+"&txCnt="+txCnt+"&txCnt1="+txCnt1+"&sphone3="+sphone3+"&saddr="+saddr+"&outCardAmount="+outCardAmount+"&outCardAmount1="+outCardAmount1+"&sdate3="+sdate3+"&stime3="+stime3;
			var ret = writeCardForm.all.RFScanner.WaterTransWriteCard(url,cardphyid,parms);
			if(ret==0){
				...
				window.location='/smartcardweb/pages/waterctlkl/recardwrite1.jsp';
			     ...
			     window.location='/smartcardweb/pages/waterctlkl/recardwrite.jsp';
			}
		}
