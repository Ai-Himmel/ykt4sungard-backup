...
<html>
              ...
              if(!document.all.send.disabled){
                ...
                if(rrt == 0){
                    ...
                    if(ret == 0){
                        ...
                        var tx_cnt =  putinForm.all.RFScanner.GetPacketInfo("total_cnt");
                        if(parseInt(putinForm.all.money.value)*100<=0){
                            alert("转账金额需大于0");
                            return false;
                        }
                        if(parseInt(putinForm.all.money.value)*100<=parseInt(bala)){
                            ...
                            putinForm.all.txCnt.value = tx_cnt;
    ...
    <body scroll="no">
        <form action="/smartcardweb/nettransamoutputin.do" method="post"
            name="putinForm">
            <div id="mid_top"></div>
            <div id="middle">
                <div id="Layer1">
                                ...
                                <table width="560" border="0" cellpadding="0" cellspacing="0">
                                 ...
                                 <tr>
                                        <td width="314" align="right">
                                            <img src="/smartcardweb/pages/images/zhm.gif"
                                                width="142" height="24" align="absmiddle"/>
                                                  <input type="hidden" name="nowinput" value="1" />
                                            <input type="hidden" name="stuempno" value="<%=request.getAttribute("stuempno") == null ? "" : request.getAttribute("stuempno")%>"/>
                                            <input type="hidden" name="cardId" />
                                            <input type="hidden" name="cardBala" />
                                            <input type="hidden" name="txCnt" />
                                             <input type="hidden" name="stuempname" value="<%=request.getAttribute("stuempname") == null ? "" : request.getAttribute("stuempname")%>"/>
                                        </td>
                                        <td width="314">
                                        
                                            <%=request.getAttribute("stuempname") == null ? "" : request.getAttribute("stuempname")%>
                                     ...
                                     <tr>
                                        <td align="right">
                                           <img src="/smartcardweb/pages/images/zhzt.gif"
                                                width="142" height="24" align="absmiddle"/>
                                        </td>
                                        <td>
                                           <%=request.getAttribute("state") == null ? "" : request.getAttribute("state")%>
                                           [<%=request.getAttribute("curBalance") == null ? "" : request.getAttribute("curBalance")%>元]
                                        </td>
                                    </tr>                              
                                                                  
                                    <tr>
                                        <td align="right">
                                            <img src="/smartcardweb/pages/images/czje.gif"
                                                width="142" height="24" align="absmiddle"/>
                                        </td>
                                        <td>
