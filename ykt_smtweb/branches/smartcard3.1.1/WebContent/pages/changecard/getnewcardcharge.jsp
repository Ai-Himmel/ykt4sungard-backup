...
<html>
	<head>
		...
		function docancel(){
		  if(confirm("卡信息还未写入正式卡，是否确认直接返回？")){
            var showcardno =  writeCardForm.all.RFScanner.GetChangeCardinfo("showcardno");
            writeCardForm.action='/smartcardweb/updatechangecardstatus.do';
	...
	<body scroll="no">
		<form action="/smartcardweb/newcardnext.do" method="post" name="writeCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					<div id="content">
