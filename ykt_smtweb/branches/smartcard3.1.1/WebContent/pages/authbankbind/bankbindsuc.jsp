...
<html>
    <head>
        ...
        <link href="/smartcardweb/pages/css/css.css" rel="stylesheet"
            type="text/css" />
         <%
			String bankcardno = request.getAttribute("bankcardno") == null ? ""
					: request.getAttribute("bankcardno").toString();
		%>
        ...
        function showmess(){
            ...
            msg.innerHTML = "<b>圈存绑定成功！</b><br> <br>绑定银行卡号："+bankcardno+"<br>";
                            ...
                            <div id="content_buttom">
                                <table>
                                    <tr>
                                        <td>
                                            <a
                                                onclick="javascript: window.location='/smartcardweb/g_yhkw.do';"
