...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<META HTTP-EQUIV="refresh" CONTENT="60;url=/smartcardweb/main.do">
								...
								<table width="70%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="320" align="center" class="样式13" id="msg">
											电子钱包转卡账户转账失败：
											<br/><html:errors/>
											<br/><%=request.getAttribute("errmsg") == null ? "": request.getAttribute("errmsg")%>
										</td>
									</tr>
