							...
							<div id="login_input">
								<table width="500" border="0" cellpadding="0" cellspacing="0">
									...
									<tr style="<% if (transflag.equals("0")) { out.print(" display:none; "); }%>">
										...
										<td width="214">
											<input type="password" name="epaypwd" class="样式11" onfocus="javascript:putinForm.nowinput.value='2'" size="20" maxlength="10">
										</td>
									</tr>
									...
									<tr style="<% if (transflag.equals("0")) { out.print(" display:none; "); }%>">
										<td align="center" colspan="3" valign="bottom" class="样式9">
											电子钱包账户与卡账户转账
										</td>
									</tr>
									<tr style="<% if (!transflag.equals("0")) { out.print(" display:none; "); }%>">
