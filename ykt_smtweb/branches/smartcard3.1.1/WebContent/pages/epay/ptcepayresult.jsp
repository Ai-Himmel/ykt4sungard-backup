...
<html>
	<head>
		...
		function writeCard(){
			...
			var sphone3 = '<%=sphone3%>';
			var saddr = '<%=saddr%>';
			var url = serverbase+"epaysuccess.do";
			var parms = "cardphyid="+cardphyid+"&money="+t_money+"&sphone3="+sphone3+"&saddr="+saddr;
			var ret = writeCardForm.all.RFScanner.CommonTransWriteCard(url,cardphyid,dptCnt,out_card_amount,t_money,sdate3,stime3,ipServer,drtpPort,svrFunc,parms);
			if(ret==0||ret==1||ret==2||ret==-1||ret==-3){
				msg.innerHTML="电子钱包转卡账户转账成功!<br/><br/>转账金额 "+t_money+" 元.<br/><br/>卡余额 "+parseFloat(out_card_amount)/100+" 元";
			}else{
