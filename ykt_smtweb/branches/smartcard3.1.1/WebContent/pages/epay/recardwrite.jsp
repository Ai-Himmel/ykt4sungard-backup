...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        String saddr = request.getAttribute("saddr") == null ? "" : request.getAttribute("saddr").toString();	
        String sphone3 = request.getAttribute("sphone3") == null ? "" : request.getAttribute("sphone3").toString();
    ...
    <script language="javascript">
        ...
        function ReWriteCard(){     
            ...
            if(ret ==0){        
             window.location='/smartcardweb/pages/epay/transfersuccess.jsp';  
            }else{
			 NoWriteCard();
			}
        }
        ...
        function NoWriteCard(){
            ...
            window.location='/smartcardweb/pages/epay/cardwriteerror.jsp';
        }
