...
<html>
	...
	<%
		...
		String begin = "2011年07月26日";
		String end = "2011年07月26日";
	%>
	<body scroll="no"
		...
		<div id="mid_top">
			<div class="menu">
				<ul style="width:420px;">
					<li id="li1">
						<a href="javascript:easytabs('1','/smartcardweb/student/grxx.do');" id="tablink1" class="tab1">个人信息</a>
					</li>
					<li id="li2" class="tabactive">
						<a href="javascript:easytabs('2','/smartcardweb/student/jcxx.do');" id="tablink2" class="tab2 tabactive">奖学金信息</a>
					</li>
					<li id="li3">
					...
					<div id="content_middle">
						...
						<div id="content_input">
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr align="center">
									<td align="center" class="样式13" height="20" width="20%">
										奖学金编号
									</td>
