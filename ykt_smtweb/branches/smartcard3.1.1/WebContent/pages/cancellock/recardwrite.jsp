...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function ReWriteCard(){
			...
			ret = writeCardForm.all.RFScanner.ReUnlockWriteCard();
			if(ret ==0){
				window.location='/smartcardweb/pages/cancellock/cardwritesuccess.jsp';
			}else if(ret ==-10){//写卡失败
				window.location='/smartcardweb/pages/cancellock/cardwriteerror.jsp';
			}else if(ret ==-20){//中途拔卡
			    window.location='/smartcardweb/pages/cancellock/cardwriteerror2.jsp';
			}else{
			    window.location='/smartcardweb/pages/cancellock/cardwriteerror4.jsp';  
			}
		}
	</script>
		<style type="text/css">
