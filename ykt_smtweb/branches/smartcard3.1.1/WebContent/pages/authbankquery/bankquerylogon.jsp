					...
					<div id="login">
						...
						<div id="login_middle">
							...
							<div id="login_input" style="margin-top: 10px">
								<font size="5" color="#1940CF"><strong>«Î∑≈»Îø®</strong></font><font size="5">&nbsp;&nbsp;&nbsp;&nbsp;√‹&nbsp;&nbsp;¬Î£∫</font>
								<input name="password" type="password" class="info" size="20"
									maxlength="6" onfocus="javascript:logonForm.nowinput.value='1'"/><font size="5">°æ–£‘∞ø®√‹¬Î°ø&nbsp;&nbsp;</font>
								<input type="hidden" name="cardphyid" />
							</div>
							<div id="login_input" style="margin-top: 10px">
								<font size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;»¶¥Ê√‹¬Î£∫</font>
								<input name="authcode" type="password" class="info" size="20"
									maxlength="6" onfocus="javascript:logonForm.nowinput.value='2'"/><font size="5">°æ“¯––ø®»¶¥Ê√‹¬Î°ø</font>
							</div>
