...
public class CardBusinessAction extends Action {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(CardBusinessAction.class);
	...
	private ActionForward checklogin(ActionMapping mapping, HttpServletRequest request) {
		...
		String reqcardno = request.getParameter("cardphyno");
