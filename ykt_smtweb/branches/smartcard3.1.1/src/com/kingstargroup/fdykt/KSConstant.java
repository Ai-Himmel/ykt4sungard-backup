...
//	
//	static public final String DRTP_IP = "10.49.118.253";
//	
//	static public final int DRTP_PORT = 4000;
	/**
	 * 系统配置文件路径
	 */
	static public final String CONFIG_FILE = "ksconfig.properties";
	
//	static public final String CPACK_FILE = "/opt/cpack.dat";
	/**
	 * JNDI 资源名
	 */
	...
	static public final String CARDSTAT_NORMAL = "0000000000";
	static public final String CARDSTAT_LOST = "0100000000";
	static public final String CARDSTAT_WFAIL = "0001000000";
	...
	static public final int CARDSTAT_TYPE_BAD = 4;
	...
	static public final String NETACC_STAT_INI="0";
	static public final String NETACC_STAT_NORMAL="1";
	static public final String NETACC_STAT_LOCK="2";
	
	public static final String SHZH_DRIVER_CLASS = "shzh_driverClass";

    public static final String SHZH_JDBC_URL = "shzh_jdbcUrl";

    public static final String SHZH_USERNAME = "shzh_user";

    public static final String SHZH_PASSWORD = "shzh_password";
