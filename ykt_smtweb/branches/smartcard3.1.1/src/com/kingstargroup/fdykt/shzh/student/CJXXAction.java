 ...
 * 
 */
public class CJXXAction extends Action {
	private static final Logger logger = Logger.getLogger(CJXXAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			int pageCount = 10;
			int totalPage = 1;
			List<Map> result = SHZHDao.getXscj(xh);
			...
			request.setAttribute("errmsg", "查询学生成绩信息失败：" + e.getMessage());
