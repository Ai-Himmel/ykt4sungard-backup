...
//		reqip = "10.49.188.50";
		...
		String tri9_water_pay_code = KSConfiguration.getInstance().getProperty("999_water_pay_code", "1003");//支付代码
		...
		try {
			...
			if (0 != xpackhandle) {
				...
				bcc.SetIntFieldByName(xpackhandle, 0, "lcert_code".getBytes(),
						Integer.parseInt(tri9_water_pay_code));// 支付代码
				bcc.SetIntFieldByName(xpackhandle, 0, "lbank_acc_type".getBytes(),
						Integer.parseInt("4"));// 钱包号
