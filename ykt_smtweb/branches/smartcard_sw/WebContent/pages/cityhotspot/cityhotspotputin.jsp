...
<html>
	...
	<body scroll="no">
		<form action="/smartcardweb/cityhotspotPutin.do" method="post"
			name="putinForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
									...
									<tr>
										<td align="center">
											<a onclick="javascript: readCard();"
												...
												onmousedown="MM_swapImage

('send','','/smartcardweb/pages/images/senda.gif',1)"><img
...
('cancel','','/smartcardweb/pages/images/cancela.gif',1)"><img
													src="/smartcardweb/pages/images/cancel.gif" 
