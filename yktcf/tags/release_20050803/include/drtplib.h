...
BOOL DrtpPostMessage(int primary,int branchno,int function,char *message,
					 ...
					 int handle,int hook/*=0*/,int ackmode/*=0*/);
...
BOOL DrtpSendMessage(char *message,int messagelen,int *errcode,
					 ...
					 int handle/*=-1*/,int ackmode/*=0*/,int primary/*=-1*/,
					 int zip/*=2*/);
...
BOOL DrtpTransMessage(int branchno,int function,char *message,
					  int messagelen,int *errcode,char *errormessage,
					  TAG_DRTPHANDLE *drtphandle,int hook/*=0*/,int ackmode/*=0*/,int primary/*=-1*/);
...
handle:通讯平台连接句柄
*/
int DrtpQueryResult(char* message,int messagesize,int *messagelen,int *errcode,
					char *errormessage,int handle,int timeout/*=-1*/);
