 ...
 * 日期					2005-07-05
 * 备注
 * $Id: parseconf.c 55 2009-10-11 09:32:03Z tc $
 */
...
parse_uint_conf_ary[] =
{
	...
	{"drtptimeout",&g_drtp_timeout},
	/*
	{"desdrtpfuncno",&g_des_drtp_func_no},
	{"desdrtpport",&g_des_drtp_svr_port},
	{"desdrtpsvrid",&g_des_drtp_svr_id},
	{"des_main_func",&g_des_main_func},
	*/
	{NULL,NULL}
};
	...
	if(!splite_line(line,value,'='))
	{
		...
		while(p_bool_config->conf_name != NULL)
		{
			if(kcc_str_equals(p_bool_config->conf_name,line))
			{
				...
				{
					kcc_die(2,"bad bool value[%s]!",p_bool_config->conf_name);
				}
