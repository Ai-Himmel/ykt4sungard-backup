...
//返回-1表示失败
DRTPAPPDLL_API int App_Init(int QueueLen /*= 20 */, 
							int ErrorMode /*= 0 */, 
							void *lp /*= NULL*/);
...
//连接失败返回false;
DRTPAPPDLL_API bool App_Connect(int index , LPSTR ServerIp , short ServerPort ,
								WORD FunctionCount , void *func ,
								int EncryptMode /*= 0*/);
...
DRTPAPPDLL_API bool App_Transmit(APPHANDLE *handle , LPSTR Data , int len , 
								 int DestNo, WORD MainFunc /*= 0*/);
