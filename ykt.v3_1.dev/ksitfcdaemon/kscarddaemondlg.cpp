...
KsCardDaemonDlg::KsCardDaemonDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style ) {
    ...
    m_cfgpanel->SetMinSize( wxSize( -1,200 ) );
    ...
    m_edtListenPort = new wxTextCtrl( m_cfgpanel, wxID_ANY, wxT("10001"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    // Connect Events
    this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnClose ) );
    this->Connect( wxEVT_ICONIZE, wxIconizeEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnIconize ) );
    this->Connect( wxEVT_SIZE, wxSizeEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnSize ) );
...
KsCardDaemonDlg::~KsCardDaemonDlg() {
    // Disconnect Events
    this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnClose ) );
    this->Disconnect( wxEVT_ICONIZE, wxIconizeEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnIconize ) );
    this->Disconnect( wxEVT_SIZE, wxSizeEventHandler( KsCardDaemonDlg::KsCardDaemonDlgOnSize ) );
