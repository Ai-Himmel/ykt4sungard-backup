...
//	ON_BN_CLICKED(IDC_CheckDeposit, OnBnClickedCheckdeposit)
    ...
    ON_BN_CLICKED(IDC_BUTTON1, &CKsCardInterFaceDemoDlg::OnBnClickedButton1)
    ON_WM_TIMER()
    ON_BN_CLICKED(IDC_BUTTON2, &CKsCardInterFaceDemoDlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void CKsCardInterFaceDemoDlg::OnBnClickedButton1() {
    pay_count = 0;
    SetTimer(1,   1000,   NULL);//1秒刷新一次
}

void CKsCardInterFaceDemoDlg::OnTimer(UINT_PTR nIDEvent) {
    if(nIDEvent == 1) {
        pay_count ++;
...
void CKsCardInterFaceDemoDlg::OnBnClickedButton2() {
    pay_count = 0;
    KillTimer(1);
}
