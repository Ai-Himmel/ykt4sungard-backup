...
void YCT_InitIndexTable() {
    ...
    sCardTable.nIndexNo=CF_CARDNO ;
    strcpy(sCardTable.sIndexName,"交易卡号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_DEPTCODE;
    strcpy(sCardTable.sIndexName,"部门代码");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_BATCHNO;
    strcpy(sCardTable.sIndexName,"卡批次号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_BATCHSEQNO;
    strcpy(sCardTable.sIndexName,"卡批次序号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_SEX;
    strcpy(sCardTable.sIndexName,"性别");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_STARTDATE ;
    strcpy(sCardTable.sIndexName,"启用日期");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_NATIONAL ;
    strcpy(sCardTable.sIndexName,"民族代码");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDTYPE;
    strcpy(sCardTable.sIndexName,"卡类别");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDSTATUS ;
    strcpy(sCardTable.sIndexName,"卡状态标志");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_SINGLEMAXAMT;
    strcpy(sCardTable.sIndexName,"卡单次消费金额上限");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDPWD;
    strcpy(sCardTable.sIndexName,"卡密码");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDVERNO ;
    strcpy(sCardTable.sIndexName,"黑名单版本");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_EXPIREDATE;
    strcpy(sCardTable.sIndexName,"有效日期");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDBAL;
    strcpy(sCardTable.sIndexName,"卡余额");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_SUBSIDYBAL;
    strcpy(sCardTable.sIndexName,"补助钱包");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_TOTALAMT;
    strcpy(sCardTable.sIndexName,"总额");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_PAYCNT;
    strcpy(sCardTable.sIndexName,"交易次数");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_TODAY;
    strcpy(sCardTable.sIndexName,"本日");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_DAYSUMAMT;
    strcpy(sCardTable.sIndexName,"日累计消费额");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_MEALAMT;
    strcpy(sCardTable.sIndexName,"餐消费额累计");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_NAME;
    strcpy(sCardTable.sIndexName,"姓名");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_STUEMPNO;
    strcpy(sCardTable.sIndexName,"学工号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_IDNO;
    strcpy(sCardTable.sIndexName,"证件号码");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_LIBNO;
    strcpy(sCardTable.sIndexName,"图书证条码");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);

    sCardTable.nIndexNo=CF_SHOWCARDNO ;
    strcpy(sCardTable.sIndexName,"显示卡号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CUSTID;
    strcpy(sCardTable.sIndexName,"客户号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CUSTTYPE;
    strcpy(sCardTable.sIndexName,"客户类别");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_IDTYPE;
    strcpy(sCardTable.sIndexName,"证件类型");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_FEETYPE ;
    strcpy(sCardTable.sIndexName,"卡权限类别");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_SUBSIDYNO ;
    strcpy(sCardTable.sIndexName,"卡补助批次号");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_PUBLISHID;
    strcpy(sCardTable.sIndexName,"发行方标识");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_CARDSTRUCTVER;
    strcpy(sCardTable.sIndexName,"卡结构版本");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_TRANSDATE;
    strcpy(sCardTable.sIndexName,"卡最后交易日期");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_DPSCNT;
    strcpy(sCardTable.sIndexName,"卡充值次数");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_PAYCNT;
    strcpy(sCardTable.sIndexName,"卡消费次数");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    sCardTable.nIndexNo=CF_DAYMAXAMT;
    strcpy(sCardTable.sIndexName,"卡日累计消费金额上限");
    g_VsCardInfo.push_back(sCardTable);
    memset(&sCardTable,0,sizeof sCardTable);
    ...
    sCardTable.nIndexNo=CF_APPSERIALNO;strcpy(sCardTable.sIndexName,"应用序列号");			g_VsCardInfo.push_back(sCardTable);	memset(&sCardTable,0,sizeof sCardTable);
...
//		}
    ...
    this->SetDlgItemInt(ID_PAYMONEY,100);
...
//	nField=atol(cs.GetBuffer(0)+cs.GetLength()-3);
    ...
    if(ks_setfieldval(nField,(const char*)m_sFieldVal) != 0) {
...
void CTestCardDlg::OnBnClickedBtnCheckwritecard() {
    ...
    USERINFO checkinfo[] = {
        ...
        DEFINFO(CF_CARDNO,"12345"),
        DEFINFO(CF_DEPTCODE,"9"),
        DEFINFO(CF_BATCHNO,"101"),
        DEFINFO(CF_BATCHSEQNO,"2034"),
        DEFINFO(CF_SEX,"2"),
        DEFINFO(CF_STARTDATE,"20100101"),
        DEFINFO(CF_NATIONAL,"5"),
        DEFINFO(CF_CARDTYPE,"1"),
        DEFINFO(CF_CARDSTATUS,"0"),
        DEFINFO(CF_SINGLEMAXAMT,"100"),
        DEFINFO(CF_CARDPWD,"987654"),
        DEFINFO(CF_CARDVERNO,"123456"),
        DEFINFO(CF_EXPIREDATE,"20190202"),
        DEFINFO(CF_CARDBAL,"120000"),
        DEFINFO(CF_SUBSIDYBAL,"0"),
        DEFINFO(CF_TOTALAMT,"120000"),
        DEFINFO(CF_PAYCNT,"36"),
        DEFINFO(CF_TODAY,"15"),
        DEFINFO(CF_DAYSUMAMT,"5000"),
        DEFINFO(CF_MEALAMT,"100"),
        DEFINFO(CF_NAME,"柳下惠二"),
        DEFINFO(CF_STUEMPNO,"LOVE20100921"),
        DEFINFO(CF_IDNO,"12345678901234567X"),
        DEFINFO(CF_LIBNO,"0234567890123"),

        /*
        DEFINFO(CF_CARDNO,"123450"),
        DEFINFO(CF_DEPTCODE,"90"),
        DEFINFO(CF_BATCHNO,"201"),
        DEFINFO(CF_BATCHSEQNO,"203"),
        DEFINFO(CF_SEX,"1"),
        DEFINFO(CF_STARTDATE,"20200101"),
        DEFINFO(CF_NATIONAL,"50"),
        DEFINFO(CF_CARDTYPE,"1"),
        DEFINFO(CF_CARDSTATUS,"3"),
        DEFINFO(CF_SINGLEMAXAMT,"0"),
        DEFINFO(CF_CARDPWD,"605431"),
        DEFINFO(CF_CARDVERNO,"12346"),
        DEFINFO(CF_EXPIREDATE,"20290202"),
        DEFINFO(CF_CARDBAL,"130000"),
        DEFINFO(CF_SUBSIDYBAL,"494240"),
        DEFINFO(CF_TOTALAMT,"6710886"),
        DEFINFO(CF_PAYCNT,"2"),
        DEFINFO(CF_TODAY,"1"),
        DEFINFO(CF_DAYSUMAMT,"50000"),
        DEFINFO(CF_MEALAMT,"1000"),
        DEFINFO(CF_NAME,"柳下惠二"),
        DEFINFO(CF_STUEMPNO,"LOVE2010092"),
        DEFINFO(CF_IDNO,"12345678901234567X"),
        DEFINFO(CF_LIBNO,"0234567890123"),

        DEFINFO(CF_APPTYPE,"23"),
        DEFINFO(CF_FEETYPE,"33"),
        DEFINFO(CF_CUSTTYPE,"43"),
        DEFINFO(CF_CUSTID,"53333"),
        DEFINFO(CF_IDTYPE,"13"),
        DEFINFO(CF_DPSCNT,"503"),
        DEFINFO(CF_TRANSDATE,"20210102"),
        DEFINFO(CF_DAYMAXAMT,"5000"),
        DEFINFO(CF_PUBLISHID,"100"),
        DEFINFO(CF_SHOWCARDNO,"1230"),
        DEFINFO(CF_SUBSIDYNO,"80"),
        DEFINFO(CF_CARDSTRUCTVER,"30"),
        DEFINFO(CF_SCHOOLCODE,"500"),*/
    };
    /*
    ...
    */
    ...
    for(i = 0; i < sizeof(checkinfo)/sizeof(checkinfo[0]); ++i) {
        ...
        if(strcmp(val,checkinfo[i].fieldval)) {
            sprintf(temp,"** 属性[%s][%d], 写入值[%s]  读出值[%s]\n",checkinfo[i].fieldName,checkinfo[i].fieldID
