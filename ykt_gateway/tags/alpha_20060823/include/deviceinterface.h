 ...
 */
#define _KSG_GET_FACTORY_INTERFACE_OBJECT(id,clazz,obj) { \
	AbstractDeviceInterfaceFactory* _f1; \
	KSG_GET_FACTORY_INTERFACE(id,_f1); \
	obj = reinterpret_cast<clazz*>(_CALL_FACTORY_CREATE(_f1,clazz)); }
...
#define KSG_GET_DEVICE_OBJECT(dev,dtype,devobj) { \
