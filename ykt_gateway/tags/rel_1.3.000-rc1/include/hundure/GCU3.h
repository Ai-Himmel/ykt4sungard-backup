...
extern "C" {
	...
	GCU3_API int __stdcall hsGCUDeleteUserRecord(HANDLE hComm,int iGCUID,int iCompressed,char *cCardNo,int * iReturnCode,unsigned int iTimeout);
	GCU3_API int __stdcall hsGCUQueryUserRecord(HANDLE hComm,int iGCUID,int iCompressed,char *cCardNo,unsigned char * cCardFormatData,
