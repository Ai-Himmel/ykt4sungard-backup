...
#define RET_SERVER_NOANSWER             -11      //在规定时间内LPORT或直连设备未响应
...
#define RET_TASKISVAILD                -1003    //任务无效
...
//*      RET_NG:  初始化失败
//*=================================================================================
typedef long (* lpfnGetDocStatus)(TSSmartDoc *pDoc, TSCmdBuffer *pBuffer);
...
struct TSSmartFunction
{
	...
	lpfnGetDocStatus			fnGetDocStatus;
};
