...
namespace HDDEV
{
	...
	public:
		...
		HDRecordFileReader(const std::string& filepath,int device_id=0)
			:_filepath(filepath),_file_handler(ACE_INVALID_HANDLE),_device_id(device_id),bColHisSeri(false)
		{}
		~HDRecordFileReader();
		int ReadFile();
