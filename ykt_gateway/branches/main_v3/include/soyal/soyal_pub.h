...
namespace SOYALDEV
{
	...
	int SetGroupSet(ACE_HANDLE handler,int ctrlid,DownCard_info info);			// 下面门组
	...
	int SetTimeZone(ACE_HANDLE handler,int ctrlid,int zoneidx,int zonelink,int zonelevel,TimeGroup timegroup);	// 设置时间段
