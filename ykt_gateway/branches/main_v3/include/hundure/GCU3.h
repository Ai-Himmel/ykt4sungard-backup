...
extern "C" {
	...
	GCU3_API int __stdcall hsGCUDeleteUserRecord(HANDLE hComm,int iGCUID,int iCompressed,int iCardlen,const char *cCardNo,int * iReturnCode,unsigned int iTimeout);
