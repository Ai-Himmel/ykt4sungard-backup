...
#define KSG_VERSION_MAGIC	"sungard kingstar gateway common v3 version"
...
#endif
		// 闻剑说都是明文
		config->_maintainKey = data->scert_no;			// 维护密钥
		config->_tradeKey = data->scert_no2;			// 消费密钥
