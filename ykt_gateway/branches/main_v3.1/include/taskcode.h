...
//<! 下传补助文件
#define TK_DL_SUBSIDY_FILE  930077
//<! 下传餐次
#define TK_DL_CONCODE		950042
//<! 批量下载名单
#define TK_BATCH_DL_BLKCARD 950003
//<! 控制开关门
#define TK_CTRL_DOOR_OPEN	950004

//<! 远程控制水阀			
#define TK_CTRL_PEN_STOCK	950044

//<! 电大下载管理卡			
#define TK_DL_MANAGE_CARD	950045

//<! 电大下载考勤参数
#define TK_DL_KQ_PARAM		950046

//<! 水控费率下载
#define TK_DL_WATERFEE		950047
...
//水控机指令
#define XML_KEY_PENSTOCKCMD		"PENSTOCKCMD"
...
#define E_999_SUBISIDY				   0xFB //补贴
#define E_999_CANCEL                   0xFE	//冲正交易
#define E_999_FAILED				   0xFF	//交易不成功

//CPU卡
#define  HD_TRANSFLAG_OK				0x00	//正常
#define  HD_TRANSFLAG_REV				0x01	//冲正
#define  HD_TRANSFLAG_LOCK				0x02	//锁卡
#define  HD_TRANSFLAG_CANCEL			0x08	//取消

//联机模式 RT==RecordType
#define RT_HD_ONLINE_CONSUME			0	//发送消费报文
#define RT_HD_ONLINE_RUSH				1	//发送冲正报文
#define RT_HD_ONLINE_BLACK				2	//黑名单
#define RT_HD_ONLINE_OTHER				3	//发送未定义报文
#define RT_HD_ONLINE_OFFCANCEL			7	//联机模式下出现网络故障进行脱机消费出现中途拔卡交易
#define RT_HD_ONLINE_CANCEL				8	//出现重新刷卡时,操作员按取消键
#define RT_HD_ONLINE_LOCKCARD			0x01	//黑卡消费锁卡
//脱机模
#define RT_HD_OFFLINE_LOCKCARD			0x91    //脱机消费黑卡消费流水
#define RT_HD_OFFLINE_CONSUME			0x41	//联机消费成功**(脱机消费记录已实时上送记录)
#define RT_HD_OFFLINE_ASHCONSUME		0x61	//联机消费灰记录(脱机消费灰记录已实时上送记录)
#define RT_HD_OFFLINE_CONSUME2			0xd1	//脱机消费成功记录**(脱机消费记录未实时上送记录)
#define RT_HD_OFFLINE_ASHCONSUME2		0xf1	//脱机消费灰记录**(脱机灰消费记录未实时上送记录)
#define RT_HD_OFFLINE_REVERSALCONSUME	0x51	//联机消费冲正成功**

#define CM_NOFIXAMT						0		//非定值消费
#define CM_FIXAMT						1		//定值消费

#define POSDATATYPE_POSONLINE			0   //联机流水
#define POSDATATYPE_POSREALTIME			1   //实时脱机流水
#define POSDATATYPE_POSAUTOSEND			2   //上传脱机流水(自动)
#define POSDATATYPE_COLLPOS				3   //补采脱机POS流水
#define POSDATATYPE_COLLCARD			4	//补采CPU卡内流水
