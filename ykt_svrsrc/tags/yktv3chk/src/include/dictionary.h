...
#define CARDVERTYPE_CARDUNLOSS  	4		//卡解挂
#define CARDVERTYPE_CARDFROZE   	5		//冻结卡
#define CARDVERTYPE_CARDUNFROZE 	6		//解冻卡
#define CARDVERTYPE_CARDINSTEADOLD 	7		//换卡旧卡
#define CARDVERTYPE_CARDINSTEADNEW 	8		//换卡新卡

#define PAYTYPE_CASH				1		//现金
#define PAYTYPE_BILL				2		//支票
#define PAYTYPE_OUTLAY				3		//经费本	
#define PAYTYPE_ACC					4		//个人账户
//#define PAYTYPE_ACC					5		//商户账户

#define TRANSCODE_CARDOPEN			1010
#define TRANSCODE_CARDOPEN_RESERVED	1011
#define TRANSCODE_CARDDEPOSIT		1020
#define TRANSCODE_CARDDEPOSIT_RESERVED	1021
...
#define DTLSTATUS_FAIL			'2'
#define DTLSTATUS_SUCCESS		'3'
#define DTLSTATUS_CANCEL		'4'
#define DTLSTATUS_INVALID		'5'

#define CARDUSETYPE_OPENCARD	'1'			//开卡
#define CARDUSETYPE_CLOSECARD	'2'			//销卡
#define CARDUSETYPE_REUSE		'3'			//回收
#define CARDUSETYPE_DISABLECARD	'3'			//作废
#define CARDUSETYPE_BADCARD		'4'			//坏卡回收
#define CARDUSETYPE_RETURNCARD	'5'			//退卡
...
/*
	卡信息相关宏定义
*/
#define PURSE_NO_ONE 1					//钱一钱包号
#define PURSE_NO_TWO 2					//第二钱包号
#define PURSE_NO_THREE 3				//第三个钱包
#define PURSE_NO_FOUR	4				//第四个钱包
...
#define SUBJECT_ESAVING				"203"				//电子帐户存款
