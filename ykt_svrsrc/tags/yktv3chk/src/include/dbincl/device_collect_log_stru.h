...
int DB_t_tif_device_collect_log_read_by_id_and_deviceid(int v_id,int v_deviceid,T_t_tif_device_collect_log *pt_tif_device_collect_log);
int DB_t_tif_device_collect_log_read_lock_by_cur_and_id_and_deviceid(int v_id,int v_deviceid,T_t_tif_device_collect_log *pt_tif_device_collect_log);
