...
int DB_t_authcard_read_by_opercode_and_status(char *v_opercode,char *v_status,T_t_authcard *pt_authcard);
int DB_t_authcard_read_by_cardphyid_and_status(char *v_cardphyid,char *v_status,T_t_authcard *pt_authcard);
