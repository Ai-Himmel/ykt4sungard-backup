...
int DB_t_cif_shop_pos_log_open_select_by_c0_and_update_date_and_deviceid(char *v_update_date,int v_deviceid);
...
int DB_t_cif_shop_pos_log_open_select_by_c1_and_update_date_and_deviceid(char *v_update_date,int v_deviceid);
...
int DB_t_cif_shop_pos_log_open_select_by_c2_and_update_date_and_deviceid_and_fee_code(char *v_update_date,int v_deviceid,int v_fee_code);
