...
int DB_t_door_device_holiday_read_by_device_id_and_holidayname(char *v_device_id,char *v_holidayname,T_t_door_device_holiday *pt_door_device_holiday);
int DB_t_door_device_holiday_del_by_device_id_and_holidayname(char *v_device_id,char *v_holidayname);
