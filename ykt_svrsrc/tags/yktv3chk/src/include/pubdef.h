...
#define TRANSTYPE_FOREGIFT		1	//收押金
#define TRANSTYPE_CARDCOSTFEE   2	//收卡成本费
#define TRANSTYPE_POUNDAGE		3	//收手续费
#define TRANSTYPE_BOARD			4	//搭伙费
#define TRANSTYPE_SUBSIDY		5   //领取补助
#define TRANSTYPE_CARDSAVING	6	//持卡人存款
#define TRANSTYPE_CARDDRAW		7	//持卡人取款
#define TRANSTYPE_PAYMENT		8	//支付
#define TRANSTYPE_RETURNFOREGIFT		9	//退还押金
#define TRANSTYPE_DEDUCTFOREGIFT		10	//扣取押金
#define TRANSTYPE_RETURNBALANCE			11  //退帐户余额
...
#define KEYTYPE_CARDNO  		"T_CARD"					//卡号
#define KEYTYPE_OPERLDTL		"T_OPERDTL"					//操作员流水号
#define KEYTYPE_CARD_STRU		"T_PIF_CARDSTRUT"			//卡结构
#define KEYTYPE_CUSTOMER  		"T_CUSTOMER"				//客户号
#define KEYTYPE_SHOP  			"T_CIF_SHOP"					//商户号
#define KEYTYPE_SUBSYSTEM 	 	"T_PIF_SUBSYSTEM"			//子系统注册表
#define KEYTYPE_DEVICE  			"T_DEVICE"				//设备表
...
#define KEYTYPE_AREA	 		"T_AREA"					//区域表
...
#define KEYTYPE_CARD_TYPE			"CARDTYPE" 

#define KEYTYPE_SCHEDULEDTASK       "SCHEDULEDTASK"
