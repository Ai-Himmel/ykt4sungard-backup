...
#define TXCODE_CONSUME					847201 	//水控转账扣款
#define TXCODE_SAVING_WATER			847202	//水控钱包充值
#define TXCODE_WATER_REWRITE_CARD	849009	//水控补写卡
#define TXCODE_POWER_CONSUME			847206	//电控转账扣款
#define TXCODE_POWER_RUSH				847207	//电控转账交易冲正
...
#define XML_KEY_DORM_NO		"DORM"			//宿舍号
...
#define XML_KEY_OPERATEDATE2	"OPERDATE2" //交易日期2
#define XML_KEY_SERIALNO		"SERIAL_NO"		//交易流水号
#define XML_KEY_SERIALNO2		"SNO2"		//交易流水号2

#define XML_KEY_TRADECODE		"TRADE_CODE"	//交易码
#define XML_KEY_TRADECODE2	"TRCODE2"		//交易码2
...
#define CARDWFAIL_WATER		'W'	//水控转账
#define CARDWFAIL_POWER		'P'	//电控转账
