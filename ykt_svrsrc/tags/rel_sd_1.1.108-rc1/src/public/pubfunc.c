...
{
	long long lAmt1=D2I(D4U5(amt1*100,2));
	long long lAmt2=D2I(D4U5(amt2*100,2));
...
{
	char phycode[9] = "";
	des2src(phycode,phyid);
	unsigned long id = strtoul(phycode,NULL,16);
	return id;
}
