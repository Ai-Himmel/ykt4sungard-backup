...
*/
	...
	switch(type)
	{
		case TYPE_CASH:	//现金
			...
			break;
		case TYPE_BILL:	//支票
			tradeserial.serial_type = TXCODE_CARD_OPEN_VIP_BILL;
			IA.dArrInAmt[2]=tradeserial.trade_fee;
			break;
		case TYPE_FUNDBOOK:	//经费本
			tradeserial.serial_type = TXCODE_CARD_OPEN_VIP_FUNDBOOK;
			IA.dArrInAmt[3]=tradeserial.trade_fee;
			break;
		case TYPE_OTHER:	//其他
			tradeserial.serial_type = TXCODE_CARD_OPEN_VIP_OTHER;
