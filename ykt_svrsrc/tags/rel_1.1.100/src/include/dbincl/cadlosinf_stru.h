...
int DB_t_pif_cardlossinfo_read_by_card_id_and_state_id(int v_card_id,int v_state_id,T_t_pif_cardlossinfo *pt_pif_cardlossinfo);
int DB_t_pif_cardlossinfo_add(T_t_pif_cardlossinfo *pt_pif_cardlossinfo);
int DB_t_pif_cardlossinfo_read_lock_by_cur1_and_card_id_and_state_id(int v_card_id,int v_state_id,T_t_pif_cardlossinfo *pt_pif_cardlossinfo);
