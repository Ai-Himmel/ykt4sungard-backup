...
int DB_t_tif_tradeserial_open_with_hold_select_by_cur2();
int DB_t_tif_tradeserial_fetch_select_by_cur2(T_t_tif_tradeserial *pt_tif_tradeserial);
int DB_t_tif_tradeserial_close_select_by_cur2();
