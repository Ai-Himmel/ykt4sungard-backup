...
int DB_t_doordevcardlist_read_by_deviceid_and_custid(int v_deviceid,int v_custid,T_t_doordevcardlist *pt_doordevcardlist);
int DB_t_doordevcardlist_update_by_deviceid_and_custid(int v_deviceid,int v_custid,T_t_doordevcardlist *pt_doordevcardlist);
int DB_t_doordevcardlist_del_by_deviceid_and_custid(int v_deviceid,int v_custid);
int DB_t_doordevcardlist_read_lock_by_c0_and_deviceid_and_custid(int v_deviceid,int v_custid,T_t_doordevcardlist *pt_doordevcardlist);
