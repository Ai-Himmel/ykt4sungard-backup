...
int DB_t_dictionary_read_by_dicttype_and_dictval(int v_dicttype,char *v_dictval,T_t_dictionary *pt_dictionary);
int DB_t_dictionary_update_by_dicttype_and_dictval(int v_dicttype,char *v_dictval,T_t_dictionary *pt_dictionary);
int DB_t_dictionary_del_by_dicttype_and_dictval(int v_dicttype,char *v_dictval);
int DB_t_dictionary_read_lock_by_c0_and_dicttype_and_dictval(int v_dicttype,char *v_dictval,T_t_dictionary *pt_dictionary);
