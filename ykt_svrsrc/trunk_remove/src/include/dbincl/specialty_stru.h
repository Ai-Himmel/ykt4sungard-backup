...
int DB_t_specialty_read_by_specialtycode(char *v_specialtycode,T_t_specialty *pt_specialty);
int DB_t_specialty_update_by_specialtycode(char *v_specialtycode,T_t_specialty *pt_specialty);
int DB_t_specialty_del_by_specialtycode(char *v_specialtycode);
int DB_t_specialty_read_lock_by_c0_and_specialtycode(char *v_specialtycode,T_t_specialty *pt_specialty);
