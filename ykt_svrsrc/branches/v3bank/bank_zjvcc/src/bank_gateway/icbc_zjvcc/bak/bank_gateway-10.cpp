...
int doSetdata(KS_YKT_Clt &ykt_clt,char* type,Message &msg)
{
...
//int doBind(KS_YKT_Clt &ykt_clt,INFO_BIND &info_bind,Message &msg)
int doBind(KS_YKT_Clt &ykt_clt,Message &msg)
{		
	int ret=0;
	char errmsg[256]="";
	doSetdata(ykt_clt,"A",msg);
	...
	des2src(info_bind.IcCard, msg.userno);
