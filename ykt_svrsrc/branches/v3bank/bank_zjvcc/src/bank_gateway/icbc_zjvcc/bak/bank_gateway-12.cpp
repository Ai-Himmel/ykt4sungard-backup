...
int doSetdata(char* type,KS_YKT_Clt &ykt_clt,Message &msg)
{
...
int doSetErr(KS_YKT_Clt &ykt_clt,Message &msg,char errmsg[])
{
...
int doProcess(char* type,KS_YKT_Clt &ykt_clt,Message &msg)
{
	int ret=0;
	char errmsg[256]="";
