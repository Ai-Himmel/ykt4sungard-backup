...
#define E_DEPOSIT_SHOPNAME_N				130241			//商户名称为空
#define E_DEPOSIT_SHOPMANNAME_N			130242			//商户负责人为空
#define E_DEPOSIT_SHOPMANTYPE_N			130243			//商户负责人证件类型为空
#define E_DEPOSIT_SHOPMANID_N			130244			//商户负责人证件号码不对
...
#define E_NETCHARGE_COMM_TIME_OUT   100955         //网络收费通讯超时
#define E_NETCHARGE_DATABASE_CONNECT 100956       //网络收费数据库连接失败
#define E_NETCHARGE_NO_ACCOUNT 100957           //网络收费帐户不存在
#define E_NETCHARGE_NODATE 100958                 //网络收费不是期限用户
#define E_NETCHARGE_OUT_OF_MAXBALANCE 100959      //网络收费金额超出数字表示范围
#define E_NETCHARGE_ACCOUNT_ISEXIST 100960           //网络收费帐户已经存在
#define E_NETCHARGE_ACCOUNT_NOTOPEN 100961           //网络收费帐户未开通
#define E_NETCHARGE_DEPOSIT_SHORTAGE 100962           //网络收费预存款不足
#define E_NETCHARGE_MULTI_ACCOUNT 100963           //网络收费存在多条帐户
#define E_NETCHARGE_STOP_SERVICE 100964          //网络收费用户停机
#define E_NETCHARGE_ACC_PSWORD 100965         //网络收费账号或密码错误
/*************************************************************************
解款类交易错误码
*/
...
#define E_DB_W_U_DATA 109200 //无考勤记录
#define E_DB_W_N_DATA 109201 //读数据建立出错
#define E_DB_W_R_DATA 109202 //读数据遍历游标错误
#define E_TRANS_OTHER_COMM_ERROR 109203 //其他通讯错误

#define 	E_QUERY_NO_DATA  	109204 //查询无数据
#define 	E_QUERY_ERROR		109205 //查询错误
#endif
