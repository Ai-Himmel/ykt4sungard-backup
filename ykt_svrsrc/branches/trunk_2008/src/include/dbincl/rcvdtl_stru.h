...
int DB_t_tif_rcvdtl_read_lock_by_c1_and_serial_no_and_tx_date_and_tx_time_and_device_id_and_card_no_and_tx_code(int v_serial_no,char *v_tx_date,char *v_tx_time,char *v_device_id,int v_card_no,int v_tx_code,T_t_tif_rcvdtl *pt_tif_rcvdtl);
...
int DB_t_tif_rcvdtl_read_by_tx_date_and_card_no_and_device_id_and_serial_no(char *v_tx_date,int v_card_no,char *v_device_id,int v_serial_no,T_t_tif_rcvdtl *pt_tif_rcvdtl);
#endif
