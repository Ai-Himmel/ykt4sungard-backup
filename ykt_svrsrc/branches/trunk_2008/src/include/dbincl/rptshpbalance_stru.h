...
int DB_t_tif_report_shop_balance_read_by_shop_id_and_balance_date(int v_shop_id,char *v_balance_date,T_t_tif_report_shop_balance *pt_tif_report_shop_balance);
