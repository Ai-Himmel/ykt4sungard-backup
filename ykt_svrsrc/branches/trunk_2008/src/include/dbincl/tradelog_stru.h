...
int DB_t_tif_tradelog_open_select_by_c2_and_serino_and_seri_type_and_outorin(int v_serino,int v_seri_type,int v_outorin);
int DB_t_tif_tradelog_fetch_select_by_c2(T_t_tif_tradelog *pt_tif_tradelog);
int DB_t_tif_tradelog_close_select_by_c2();
#endif
