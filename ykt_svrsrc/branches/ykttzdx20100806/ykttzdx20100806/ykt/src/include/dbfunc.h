...
int DB_v_tif_shopdeptfee_water_open_select_by_c5();
int DB_v_tif_shopdeptfee_fetch_select_by_c5(T_t_tif_report_shop_balance *pv_tif_shopdeptfee);
int DB_v_tif_shopdeptfee_water_fetch_select_by_c5(T_t_tif_report_shop_balance_water *pv_tif_shopdeptfee);
int DB_v_tif_shopdeptfee_close_select_by_c5();
int DB_v_tif_shopdeptfee_water_close_select_by_c5();
