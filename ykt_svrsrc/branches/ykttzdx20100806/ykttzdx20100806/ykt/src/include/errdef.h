...
#define E_DB_WATER_INFO_I					110002			//水表信息表插入错误
#define E_DB_WATER_INFO_U					110003			//水表信息表更新错误
#define E_DB_WATER_INFO_R					110004			//水表信息表读取错误
#define E_DB_WATER_INFO_D					110005			//水表信息表删除错误
#define E_DB_WATER_INFO_N					110006			//水表信息表无相关记录
#define E_DB_WATER_INFO_E					110007			//水表信息表记录已存在
...
#define E_WATER_LIMIT_EXCEED				105001			//剩余水量超过限额
#define E_WATER_METER_NO_ERROR			105002			//水表号超过允许范围

#define E_POWER_CONN_SVR					105003			//连接电控中心失败
#define E_POWER_INTERNAL_ERR				105004			//系统故障请与系统管理员联系
#define E_POWER_TRANS_ERR					105005			//与电控服务器通讯故障,请稍后重试
#define E_POWER_RECV_ERR					105006			//电控交易返回数据不合法
#define E_INPUT_DORM_NO					105007			//输入的宿舍号有误
#define E_POWER_SVR_DUP					105008			//系统中有多个电控系统,无法唯一确定
...
#define E_POWER_CONN_DB				11000	//连接数据库失败
#define E_POWER_DORM_NO_EXISTS		10001	//无宿舍信息
#define E_POWER_DORM_READ				10002	//读取宿舍信息错误
#define E_POWER_DATA_ERR				10003	//数据错误
#define E_POWER_ENTER_ACCOUNT		10004	//入账失败
#define E_POWER_RUSH_ERR				10005	//冲正失败
...
#define E_SM_UPDATAERR_SCM_N 109168  //更新短信数据为空
#define E_SM_UPDATAERR_SCM_U 109169 //更新短信重发状态错误
#define E_SM_TREATMENT_SM_N   109170 //余额指令查询数据为空
#define E_SM_TREATMENT_SM_S   109171 //余额指令执行错误
#define E_SM_WRITETEMP_N  109172  //没有数据加入临时表
#define E_SM_WRITETEMP_U  109173 //添加临时表数据错误
#define E_SM_STUDENTNO_N 109174 //查询学生学号为空
#define E_SM_STUDENTNO_S 109175 //查询学生学校错误
#define E_SM_UPACMINFO_N  109176 //更新申请信息不存在
#define E_SM_UPACMINFO_U  109177 //更新申请信息错误
#define E_SM_UPCUSTEMINFO_N 109178 //更新客户定制信息表更新数据不存在
#define E_SM_UPCUSTEMINF0_U 109179 //跟新客户定制信息出错
#define E_SM_SENDMSG_N 109180 //发送信息不存在
#define E_SM_SENDMSG_U 109181 //添加发送消息失败
#define E_SM_CUSTEM_S 109182 //查询客户定制列表失败
#define E_SM_OPENCUSTEM_CURSORERR_N  109183//读取客户定制信息游标无数据
#define E_SM_OPENCUSTEM_CURSORERR_S 109184//读取客户定制信息游标无数据
#define E_SM_READTEMP_N 109185  //读取临时表信息为空
#define E_SM_READTEMP_U 109186  //读取临时表数据失败 
#define E_SM_READFUNCERR_S 109187  //查询客户定制信息表错误
#define E_SM_SZXE_U 109188 //设置余额失败
#define E_SM_SZXE_N 109189 //数据库无此记录
#define E_SM_STOPMS_N 109190 //无此用户
#define E_SM_STOPMS_U 109191 //冻结此用户的短信服务失败
#define E_SM_CSTATE_N 109192 //无此记录数据
#define E_SM_CSTATE_U 109193 //查询该用户的短信服务状态失败
#define E_SM_OUTXD_N 109194 //续订的数据
#define E_SM_OUTXD_U 109195 //查询数据失败
#define E_DB_SHOPDEPTFEE_WATER_R              109196	//水控明细视图读取错误
