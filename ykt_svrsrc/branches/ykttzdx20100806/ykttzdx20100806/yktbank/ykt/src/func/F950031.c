...
//	tRcvdtl.run_reason = rPack->lbank_acc_type2;				//启动原因
	...
	{
		// 有管理费
		tRcvdtl.in_bala = rPack->lvol9;
		tRcvdtl.amount = rPack->lvol8;
		// 加上管理费
		tRcvdtl.out_bala = rPack->lvo10 + rPack->lvol1;
	}
	...
	if(rPack->lvol1 > 0)
	{
		tRcvdtl.in_bala = tRcvdtl.out_bala;
		tRcvdtl.amount = rPack->lvol1;
		tRcvdtl.out_bala = rPack->lvol10;
		tRcvdtl.tx_code = 930032;
