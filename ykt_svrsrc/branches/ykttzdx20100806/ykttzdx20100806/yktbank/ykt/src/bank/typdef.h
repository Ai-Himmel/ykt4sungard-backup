...
typedef struct 
{
	...
	char          priActNum[23];     /*priamary account*/
	char          procCode[7];	/*3*/
	double        txnAmunt; 	/*4*/	/*total*//*总金额 分为单位 */
	double        txnAmunt1; 	/*5*/	/*本金*/
	double        txnAmunt2; 	/*6*/

	char          txnDatTim[11];    /*7*/ 	 /*交易时间日期*/
	char 		  companyid[9];		/*8*/        	/*公司代码*/
	unsigned long tracAudNum ;      /*11*/			/*流水号*/
	char          txnLocTim[7];     /*12*/			
	char          txnLocDat[5];     /*13*/
