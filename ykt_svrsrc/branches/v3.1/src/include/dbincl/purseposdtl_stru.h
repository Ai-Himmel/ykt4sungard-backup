...
int DB_t_purseposdtl_read_lock_by_c1_and_transdate_and_termid_and_devseqno_and_cardno(const char *v_transdate,int v_termid,int v_devseqno,int v_cardno,T_t_purseposdtl *pt_purseposdtl);
int DB_t_purseposdtl_update_lock_by_c1(T_t_purseposdtl *pt_purseposdtl);
int DB_t_purseposdtl_free_lock_by_c1();
#endif
