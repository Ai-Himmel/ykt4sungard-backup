...
int DB_t_paymentdtl_read_by_accdate_and_termid_and_termseqno(char *v_accdate,int v_termid,int v_termseqno,T_t_paymentdtl *pt_paymentdtl);
...
int DB_t_paymentdtl_del_by_accdate_and_termid_and_termseqno(char *v_accdate,int v_termid,int v_termseqno);
int DB_t_paymentdtl_read_lock_by_c0_and_accdate_and_termid_and_termseqno(char *v_accdate,int v_termid,int v_termseqno,T_t_paymentdtl *pt_paymentdtl);
int DB_t_paymentdtl_update_lock_by_c0(T_t_paymentdtl *pt_paymentdtl);
int DB_t_paymentdtl_free_lock_by_c0();
int DB_t_paymentdtl_open_select_by_c1_and_accdate_and_termid_and_termseqno(char *v_accdate,int v_termid,int v_termseqno);
