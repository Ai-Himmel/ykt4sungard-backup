...
int DB_t_doorholidaytime_del_by_holidayid_and_holidaydate(int v_holidayid,char *v_holidaydate);
int DB_t_doorholidaytime_read_lock_by_c0_and_holidayid_and_holidaydate(int v_holidayid,char *v_holidaydate,T_t_doorholidaytime *pt_doorholidaytime);
...
int DB_t_doorholidaytime_open_select_by_c1_and_holidayid_and_holidaydate(int v_holidayid,char *v_holidaydate);
