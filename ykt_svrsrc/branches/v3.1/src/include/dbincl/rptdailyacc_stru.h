...
int DB_t_rptdailyacc_read_by_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptdailyacc *pt_rptdailyacc);
int DB_t_rptdailyacc_update_by_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptdailyacc *pt_rptdailyacc);
int DB_t_rptdailyacc_del_by_accdate_and_accno(char *v_accdate,char *v_accno);
int DB_t_rptdailyacc_read_lock_by_c0_and_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptdailyacc *pt_rptdailyacc);
