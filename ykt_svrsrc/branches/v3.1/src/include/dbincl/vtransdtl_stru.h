...
int DB_v_transdtl_read_by_accdate_and_termid_and_devseqno(char *v_accdate,int v_termid,int v_devseqno,T_v_transdtl *pv_transdtl);
int DB_v_transdtl_read_by_accdate_and_devphyid_and_devseqno(char *v_accdate,char *v_devphyid,int v_devseqno,T_v_transdtl *pv_transdtl);
...
int DB_v_transdtl_read_lock_by_c1_and_accdate_and_termid_and_devseqno(char *v_accdate,int v_termid,int v_devseqno,T_v_transdtl *pv_transdtl);
