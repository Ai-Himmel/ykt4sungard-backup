...
int DB_t_cardaccdiff_read_by_cardno_and_startdate(int v_cardno,char *v_startdate,T_t_cardaccdiff *pt_cardaccdiff);
int DB_t_cardaccdiff_update_by_cardno_and_startdate(int v_cardno,char *v_startdate,T_t_cardaccdiff *pt_cardaccdiff);
int DB_t_cardaccdiff_del_by_cardno_and_startdate(int v_cardno,char *v_startdate);
int DB_t_cardaccdiff_read_lock_by_c0_and_cardno_and_startdate(int v_cardno,char *v_startdate,T_t_cardaccdiff *pt_cardaccdiff);
