...
int DB_t_subject_update_by_subjno(char *v_subjno,T_t_subject *pt_subject);
int DB_t_subject_del_by_subjno(char *v_subjno);
int DB_t_subject_read_lock_by_c1_and_subjno(char *v_subjno,T_t_subject *pt_subject);
