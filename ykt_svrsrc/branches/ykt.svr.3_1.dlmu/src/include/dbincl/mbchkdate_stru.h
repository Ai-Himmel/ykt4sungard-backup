...
int DB_t_mobilechkdate_read_by_chkdate(char *v_chkdate,T_t_mobilechkdate *pt_mobilechkdate);
int DB_t_mobilechkdate_update_by_chkdate(char *v_chkdate,T_t_mobilechkdate *pt_mobilechkdate);
int DB_t_mobilechkdate_del_by_chkdate(char *v_chkdate);
int DB_t_mobilechkdate_read_lock_by_c0_and_chkdate(char *v_chkdate,T_t_mobilechkdate *pt_mobilechkdate);
