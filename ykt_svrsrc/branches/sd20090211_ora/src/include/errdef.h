...
#define E_DB_TABCARDINFO_R	109203	//卡信息同步表读取错误
#define E_DB_OPTION_TYPE_N			109203	//操作类型为空
#define E_DB_OPTION_TYPE_E			109204	//操作类型错误
#define E_DB_TREATMENT_TYPE_N		109205	//处理类型为空
#define E_DB_TREATMENT_TYPE_E		109206	//处理类型错误
#define E_DB_HALFWAY_WATER_N			109207	//中途拔卡流水为空
#define E_DB_HALFWAY_WATER_E			109208	//查询中途拔卡流水错误
#define E_DB_HALFWAY_CURSOR_E		109209	//中途拔卡流水查询游标错误
#define E_DB_HALFWAY_CURSOR_OPEN_E	109210	//中途拔卡流水查询游标打开错误	
#define E_DB_HALFWAY_CURSOR_READ_E	109211	//中途拔卡流水查询游标读取错误	
#define E_DB_GETCARDNO_READ_N		109212	//查询卡号为空
#define E_DB_GETCARDNO_RAND_E		109213	//查询卡号错误
#define E_DB_QUERY_PANDN_WATER_N		109214	//上下笔流水为空
#define	E_DB_QUERY_PANDN_WATER_E		109215	//查询上下笔流水错误
#define E_DB_QUERY_PANDN_CURSOR_E	109216	//建立上下笔流水查询游标错误
#define E_DB_QUERY_PANDN_CURSOR_OPEN_E	109217	//查询上下笔流水开打游标错误
#define E_DB_QUERY_PANDN_CURSOR_READ_E	109218	//查询上下流水读数据错误
#define E_DB_QUERY_ERROR_WATER_OPERATE_N	109219	//查询错误流水状态为空
#define E_DB_QUERY_ERROR_WATER_OPERATE_E	109220	//查询错误流水状态错误
#define E_DB_QUERY_ERROR_WATER_STUEMP_N	109221	//查询错误流水学工号为空
#define E_DB_QUERY_ERROR_WATER_N		109222	//查询错误入账流水为空
#define	E_DB_QUERY_ERROR_WATER_E		109223	//查询错误入账流水SQL语句错误
#define E_DB_QUERY_ERROR_WATER_CURSOR_E		109224	//查询错误入账流水建立游标错误
#define E_DB_QUERY_ERROR_WATER_CURSOR_READ_E	109225	//查询错误入账流水读游标错误
#define E_DB_UPDATE_ERROR_WATER_STATE_E			109226	//更新错误入账流水错误
#define E_DB_UPDATE_ERROR_WATER_STATE_N		109227	//更新错误入账流水不存在
#endif
