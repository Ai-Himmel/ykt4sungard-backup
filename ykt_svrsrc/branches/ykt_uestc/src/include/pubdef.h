...
#define KEYTYPE_BANKCARDTMP      "T_BANKCARDTMP"                    //银行绑定表
#define KEYTYPE_BANKCARDDTL      "T_BANKCARDDTL"                    //银行绑定表
...
#define 	TRADE_TRANS			240001		//自助转帐v3
#define	TRADE_REVERSE		240002 		//银行卡转账功能冲正v3
#define    BANK_QUERYBALA		240003		// 查询银行卡余额v3
#endif
