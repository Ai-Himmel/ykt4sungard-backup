...
int DB_t_refno_read_by_dateserialno(char *v_dateserialno,T_t_refno *pt_refno);
...
int DB_t_refno_read_by_reqrefno_and_accdate(char *v_reqrefno,char *v_accdate,T_t_refno *pt_refno);
#endif
