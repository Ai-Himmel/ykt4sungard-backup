...
#define E_999_CARDBALANCEERR    390256	//卡金额错误
...
#define E_savdtl_R                         100889         //经费本查询错误
#define E_savdtl_N                         100890        //经费本查询无相关记录 
...
#define E_DB_DOOR_DOWNLOAD_R				130157			// 门禁下载表读取错误
#define E_DB_DOOR_DOWNLOAD_I				130158			// 门禁下载表插入错误
#define E_DB_DOOR_DOWNLOAD_D				130159			// 门禁下载表删除错误
#define E_DB_DOOR_DOWNLOAD_U				130160			// 门禁下载表更新错误
#define E_DB_DOOR_DOWNLOAD_N				130161			// 门禁下载表无相关记录
#define E_DB_DOOR_DOWNLOAD_E				130162			// 门禁下载表插入重复

#define E_DB_DOOR_CARD_R				130163			// 门禁卡表读取错误
#define E_DB_DOOR_CARD_I				130164			// 门禁卡表插入错误
#define E_DB_DOOR_CARD_D				130165			// 门禁卡表删除错误
#define E_DB_DOOR_CARD_U				130166			// 门禁卡表更新错误
#define E_DB_DOOR_CARD_N				130167			// 门禁卡表无相关记录

#define E_DB_DOOR_CARDADDR_N			130168			// 门禁卡地址表无相关记录
#define E_DB_DOOR_CARDADDR_R			130169			// 门禁卡地址表读取错误
#define E_DB_DOOR_CARDADDR_I			130170			// 门禁卡地址表插入错误
#define E_DB_DOOR_CARDADDR_D			130171			// 门禁卡地址表删除错误
#define E_DB_DOOR_CARDADDR_U			130172			// 门禁卡地址表更新错误
#define DOOR_CARDADDR_FULL			130173			// 门禁卡地址已经使用完
...
#define E_CUSTOMER_IN_USE				109206			//该客户已使用，不能删除
#define E_CARD_TYPE						109207			//卡类型错误，过渡临时卡不能批量发行
...
#define E_SYSPARAM_ERROR				200119			//系统参数配置有误
////////////////////////////////////////////////////////
/// 转账后台错误定义
...
#define	E_DB_MODIFYINFO_D	108310 			//修改学工号记录表删除错误
#define	E_DB_MODIFYINFO_E	108311 			//修改学工号记录表记录重复
#define	E_DB_MODIFYINFO_I	108312 			//修改学工号记录表插入错误
#define	E_DB_MODIFYINFO_N	108313 			//修改学工号记录表查询无符合条件记录
#define	E_DB_MODIFYINFO_R	108314 			//修改学工号记录表查询错误
#define	E_DB_MODIFYINFO_U	108315 			//修改学工号记录表修改错误
...
#define  E_TRANS_OTHER_COMM_ERROR 109187 //其他通讯错误
...
#define E_ENTERENCE_LOG_INSERT_E 109203 //车库出入日志信息插入失败
#define E_ENTERENCE_LOG_SEQUENCE_E 109204 //车库出入日志信息sequence获取失败
#define E_PROFESSOR_NOT_DATE 109205 //查询教授就餐统计数据为空
...
#define   E_INPUT_BEGDATE		500675	//输入开始日期不正确
#define   E_INPUT_ENDDATE		500676	//输入结束日期不正确
#define   E_INPUT_RECODENO         500677  //  请输入记录号
#define   E_INPUT_BATCHNO           500678  // 请输入批次号                
#define   E_INPUT_STUTEMPNO       500679   //请输入学/工号
#define   E_INPUT_QU                      500680 //无效的请求类型
#define   E_INPUT_KINDS                500681 //本系统银行卡绑定模式为本地绑定模式,不能使用联机绑定功能

#define  BANKCHECK_I_NOSTUEM  500700  //没有学工号
#define  BANKCHECK_I_NOCUST    500701  //客户号不存在
#define   E_TRANS_BANKCARDTMP   500702 //没有配置系统参数表流水表
#define   E_DB_TRADESERIAL_A   500703 //生成流水号错误
#define   GET_BALANCE_ERR     500704      //判断是否处于日终结算状态
#define   E_SPEFEE_R                 500705   //读取tSpeFee表错
#define   E_ACC_BANK                 500706   //银行转帐入账错误
#endif
