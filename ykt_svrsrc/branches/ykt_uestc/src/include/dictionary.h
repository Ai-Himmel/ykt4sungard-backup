...
//换卡旧卡
#define UNI_CARDINSTEADOLD 	8	
//卡解挂
#define UNI_CARDUNLOSS  	9		
...
//soyal 门禁时段级别
#define TIMESECT_ONWORK   1		//时段级别1，刷卡进门
#define TIMESECT_OFFWORK  2		// 时段级别2 ，刷卡加密码进门
...
#define BANKCODE            "00"
#define SYSPARA_BANKCARDONLINEBIND	3       //银行卡绑定模式 0-本地绑定,1银行联机绑定
