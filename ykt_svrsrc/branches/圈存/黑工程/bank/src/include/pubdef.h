...
#define	AUTH_MODE_BANKPWD		1	//转账输入银行卡密码
#define 	AUTH_MODE_SCHOOLPWD		2	//转账输入校园卡密码，判断对应关系
#define 	LOGIN_MODE_STUEMP_NO		1	//挂失登陆方式输入学工号
#define	LOGIN_MODE_CUT_NO			2	//挂失登陆方式输入客户号	
