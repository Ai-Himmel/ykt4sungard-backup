...
#define E_SERI_ALREADY_EXPIRE				110002			// 流水已经过期
#define E_DB_DEVSERIINFO_I					110003			// 设备流水信息表插入错误
#define E_DB_DEVSERIINFO_U					110004			// 设备流水信息表更新错误
#define E_DB_DEVSERIINFO_R					110005			// 设备流水信息表读取错误
#define E_DB_DEVSERIINFO_N					110006			// 设备流水信息表无记录
#define E_DEVICE_LOGOUT					110007			// 设备已经注销
...
#define E_DB_V_REPORT_DEVICE_WATER_I		100970			//商户设备水流量视图插入错误
#define E_DB_V_REPORT_DEVICE_WATER_U		100971			//商户设备水流量视图更新错误
#define E_DB_V_REPORT_DEVICE_WATER_R		100972			//商户设备水流量视图读取错误
#define E_DB_V_REPORT_DEVICE_WATER_D		100973			//商户设备水流量视图删除错误
#define E_DB_V_REPORT_DEVICE_WATER_N		100974			//商户设备水流量视图无相关记录
#define E_DB_V_REPORT_DEVICE_WATER_E		100975			//商户设备水流量视图记录已经存在

#define E_DB_T_REPORT_DEVICE_WATER_I		100976			//商户设备水流量表插入错误
#define E_DB_T_REPORT_DEVICE_WATER_U		100977			//商户设备水流量更新错误
#define E_DB_T_REPORT_DEVICE_WATER_R		100978			//商户设备水量表读取错误
#define E_DB_T_REPORT_DEVICE_WATER_D		100979			//商户设备水量表删除错误
#define E_DB_T_REPORT_DEVICE_WATER_N		100980			//商户设备水量表无相关记录
#define E_DB_T_REPORT_DEVICE_WATER_E		100981			//商户设备水量表记录已经存在
...
#define E_DB_PUSHTASK_R					130151			//计划任务表读取错误
#define E_DB_PUSHTASK_I					130152			//计划任务表插入错误
#define E_DB_PUSHTASK_U					130153			//计划任务表更新错误
#define E_DB_PUSHTASK_D					130154			//计划任务表删除错误
#define E_DB_PUSHTASK_E					130155			//计划任务表记录已存在
#define E_DB_PUSHTASK_N					130156			//计划任务表无相关记录


#define E_DB_DEPOSIT_SHOP_N			130245			//充值商户表无相关记录
#define E_DB_DEPOSIT_SHOP_R			130246			//充值商户表读取错误
#define E_DB_DEPOSIT_SHOP_I			130247			//充值商户表插入错误
#define E_DB_DEPOSIT_SHOP_U			130248			//充值商户表更新错误
#define E_DB_DEPOSIT_SHOP_D			130249			//充值商户表删除错误
#define E_DB_DEPOSIT_SHOP_E			130250			//充值商户表记录已存在
#define E_DB_DEPOSIT_SHOPPOS_N		130251			//充值商户设备表无相关记录
#define E_DB_DEPOSIT_SHOPPOS_R		130252			//充值商户设备表读取错误
#define E_DB_DEPOSIT_SHOPPOS_I		130253			//充值商户设备表插入错误
#define E_DB_DEPOSIT_SHOPPOS_U		130254			//充值商户设备表更新错误
#define E_DB_DEPOSIT_SHOPPOS_D		130255			//充值商户设备表删除错误
#define E_DB_DEPOSIT_SHOPPOS_E		130256			//充值操作员设备表记录已存在
#define E_DB_DEPOSIT_OPERPOS_N		130257			//充值操作员设备表无相关记录
#define E_DB_DEPOSIT_OPERPOS_R		130258			//充值操作员设备表读取错误
#define E_DB_DEPOSIT_OPERPOS_I		130259			//充值操作员设备表插入错误
#define E_DB_DEPOSIT_OPERPOS_U		130260			//充值操作员设备表更新错误
#define E_DB_DEPOSIT_OPERPOS_D		130261			//充值操作员设备表删除错误
#define E_DB_DEPOSIT_OPERPOS_E		130262			//充值操作员设备表记录已存在
#define E_DB_DEPOSIT_OPER_N			130263			//充值操作员表无相关记录
#define E_DB_DEPOSIT_OPER_R			130264			//充值操作员表读取错误
#define E_DB_DEPOSIT_OPER_I			130265			//充值操作员表插入错误
#define E_DB_DEPOSIT_OPER_U			130266			//充值操作员表更新错误
#define E_DB_DEPOSIT_OPER_D			130267			//充值操作员表删除错误
#define E_DB_DEPOSIT_OPER_E			130268			//充值操作员表记录已存在
#define E_DEPOSIT_OPER_STOP			130269			//该操作员已停用
#define E_OPER_NO_NEED_DEVICE		130270			//该操作员不需要限制使用设备
#define E_OPER_OVER_MAX_DEPOSIT_AMT	130271			//充值超过最大限额
#define E_SHOP_CLOSE				130272			//该商户已销户
#define E_CARD_EXPIRE 				130273			//卡已过有效使用日期
#define E_DB_SHOPRATE_N			130274			//商户搭伙费表无相关记录
#define E_DB_SHOPRATE_R			130275			//商户搭伙费表读取错误
#define E_DB_SHOPRATE_I			130276			//商户搭伙费表插入错误
#define E_DB_SHOPRATE_U			130277			//商户搭伙费表更新错误
#define E_DB_SHOPRATE_D			130278			//商户搭伙费表删除错误
#define E_DB_SHOPRATE_E			130279			//商户搭伙费表记录已存在
#
//////////////////////////////////////////////////////////
//
...
#define E_RESERVE_BALA_DIFF			110835			//账户保留金额有误
#define E_ACCOUNT_NOT_SUPPORT		110836			//不直接清算
/*************************************************************************
解款类交易错误码
*/
...
#define E_DEVICE_IS_DEPOSITSHOP			200119			//非充值商户操作员不能使用充值商户充值机
#define E_DEVICE_NOTIS_DEPOSITSHOP             200120			//充值商户操作员不能使用非充值商户充值机
#define E_DEVICE_USED_TO_NODEPOSITSHOPOPER 200121		//该充值机已经被非充值操作员使用
#define E_INPUT_NOSHOP_ID					200122			//输入商户号不能为空
#define E_ACCOUNT_OVERDRAFT				200123			//帐户已透支，请先充值
////////////////////////////////////////////////////////
/// 转账后台错误定义
#define  E_TRANS_COMP_OPENFILE          107101	//打开对账文件失败
#define  E_TRANS_COMP_GETRECORD         107102	//获取对账文件记录失败
...
#define E_FIXCARD_ALREADY		108300		//写卡失败记录已经被修复过	
#define E_FIXCARDLOG_R			108301		//修卡记录表读取错误
#define E_FIXCARDLOG_I			108302		//修卡记录表插入错误
#define E_SERI_NOT_LOST		108305		//查询相关时间段内无流水丢失
...
#define E_DB_EXTPOSDTL_D              110031	//流水数据表删除错误
#define E_DB_EXTPOSDTL_I              110032	//流水数据表插入错误
#define E_DB_EXTPOSDTL_N              110033	//流水数据表无相关记录
#define E_DB_EXTPOSDTL_R              110034	//流水数据表查询错误
#define E_DB_EXTPOSDTL_U              110035	//流水数据表更新错误

#define GET_SHPID_ERR                 110036	//获得商户号失败
#define SHOP_REED_ERRY                110037	//获得商户信息失败

// 网络收费对接错误码
#define E_NETCHARGE_SHOP_NOT_EXIST 		110201          //网络收费商户信息不存在
#define E_DB_NETCHARGE_SHOP_R     		110202          //网络收费商户信息读取错误
#define E_NETCHARGE_DATABASE_CONNECT 	110203       	//网络收费数据库连接失败
#define E_NETCHARGE_NO_ACCOUNT 			110204          //网络收费帐户不存在,请到营业厅办理
#define E_NETCHARGE_NODATE 				110205          //网络收费不是期限用户
#define E_NETCHARGE_OUT_OF_MAXBALANCE 	110206      	//网络收费金额超出数字表示范围
#define E_NETCHARGE_ACCOUNT_ISEXIST 	110207          //网络收费帐户已经存在
#define E_NETCHARGE_ACCOUNT_NOTOPEN 	110208          //网络收费帐户未开通
#define E_NETCHARGE_DEPOSIT_SHORTAGE 	110209          //网络收费预存款不足
#define E_NETCHARGE_MULTI_ACCOUNT 		110210          //网络收费存在多条帐户
#define E_NETCHARGE_STOP_SERVICE 		110211          //网络收费用户停机
#define E_NETCHARGE_COMM_TIME_OUT   	110212         	//网络收费通讯超时
#define E_NETCHARGE_USER_ID_NULL   		110213         	//网络收费用户名为空
#define E_NETCHARGE_UNKNOW   			110214         	//网络收费未知错误
#define E_NETCHARGE_INPUTMONEY   		110301         	//网络收费输入金额应该是40元的倍数
#define E_NETCHARGE_STOP_OUT_OF_DATE   	110302         	//网络收费超期停用
#define E_NETCHARGE_USER_NAME_NULL   	110303         	//网络收费用户姓名为空
#define E_NETCHARGE_ACC_PSWORD 			110304         //网络收费账号或密码错误

// 注册缴费系统错误码
#define E_DB_REGISTER_PAY_QUERY_P      		110215			//报到注册准备动态查询语句错误
#define E_DB_REGISTER_PAY_R					110216			//报到注册信息表查询出错
#define E_DB_REGISTER_PAY_N					110217			//报到注册信息表无相关记录
#define E_DB_REGISTER_PAY_U					110218			//报到注册信息表更新出错
#define E_DB_REGISTER_PAY_NOTUPDATE			110219			//未进行报到注册更新
#define E_DB_REGISTER_PAY_ALREADYUPDATE		110220			//报到注册系统已经更新
#define E_DB_REGISTER_PAY_NOTNEEDUPDATE		110221			//报到注册系统无需更新
#define E_DB_REGISTER_PAY_ALREADY			110222			//已经报到注册
#define E_DB_REGISTER_OUT_OF_DATE			110223			//超过报到日期
#define E_DB_REGISTER_I						110224			//报到信息插入错误
#define E_DB_REGISTER_INFO_R				110225			//缴费标识信息读取错误
#define E_DB_REGISTER_PAY_LOG_R  			110226			//缴费日志信息表读取错误
#define E_DB_REGISTER_PAY_LOG_N  			110227			//缴费日志信息表无相关记录
#define E_DB_REGISTER_PAY_LOG_I  			110228			//缴费日志信息表插入错误
#define  E_DB_REGISTER_FREEZIE_ADD_ERR			110244			 //冻结名单导入错误
#define E_DB_W_N_DATA 110229 //查询考勤流水数据出错
#define E_DB_W_R_DATA  110230  //查询考勤流水数据 为空!
#define E_DB_W_U_DATA  110231 //查询不到数据


#define E_DB_TRANSBANK_FILE_NOFOUND			110245			//对账文件路径错误
#define E_DB_TRANSBANK_FILE_OPENERR			110256			//对账文件路径错误
#define E_DB_READSEMESTER_N					110257			//学期不存在请配置
#define E_DB_READSEMESTER_E					110258			//读取学期数据错误



#define E_DB_REG_SCHOOLTERM_R					110232			//学期参数表读取错误
#define E_DB_REG_SCHOOLTERM_I					110233			//学期参数表插入错误
#define E_DB_REG_SCHOOLTERM_U					110234			//学期参数表更新错误
#define E_DB_REG_SCHOOLTERM_D					110235			//学期参数表删除错误
#define E_DB_REG_SCHOOLTERM_E					110236			//学期参数表记录已存在
#define E_DB_REG_SCHOOLTERM_N					110237			//学期参数表无相关记录

#define E_DB_REGISTRATION_R					110238			//报道记录表读取错误
#define E_DB_REGISTRATION_I					110239			//报道记录表插入错误
#define E_DB_REGISTRATION_U					110240			//报道记录表更新错误
#define E_DB_REGISTRATION_D					110241			//报道记录表删除错误
#define E_DB_REGISTRATION_E					110242			//报道记录表记录已存在
#define E_DB_REGISTRATION_N					110243			//报道记录表无相关记录

#define E_DB_RPT_TRANS_COMP_R					110244			//圈存转账对账表读取错误
#define E_DB_RPT_TRANS_COMP_I					110245			//圈存转账对账表插入错误
#define E_DB_RPT_TRANS_COMP_U					110246			//圈存转账对账表更新错误
#define E_DB_RPT_TRANS_COMP_D					110247			//圈存转账对账表删除错误
#define E_DB_RPT_TRANS_COMP_E					110248			//圈存转账对账表记录已存在
#define E_DB_RPT_TRANS_COMP_N					110249			//圈存转账对账表无相关记录

#define E_QUERY_NO_DATA						110837			//查询无相关数据
#define E_QUERY_ERROR							110838			//查询数据错误
