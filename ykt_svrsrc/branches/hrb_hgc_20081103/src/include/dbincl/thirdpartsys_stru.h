...
typedef struct 
{
		...
		char	bu_name[60+1];
		int	des_func_type;
		char	des_func_name[60+1];
}T_t_pif_third_part_system;
int DB_t_pif_third_part_system_add(T_t_pif_third_part_system *pt_pif_third_part_system);
int DB_t_pif_third_part_system_read_by_sub_system_id_and_des_func_type(int v_sub_system_id,int v_des_func_type,T_t_pif_third_part_system *pt_pif_third_part_system);
