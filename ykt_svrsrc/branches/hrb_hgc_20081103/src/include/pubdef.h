...
#define KEYTYPE_WRITEFAILED    "T_TIF_WRITEFAILED"        //写卡失败表
#define KEYTYPE_DEVICE_COLLECT "T_TIF_DEVICE_COLLECT_LOG" //设备采集标示表
...
#define KEYTYPE_DOOR_TIMESECT				"T_DOOR_TIME_SECT"  //门禁时间段
...
#define KEYTYPE_TIF_SUBSIDY_NO			"TIF_SUBSIDY_NO"	//补助批次号
#define KEYTYPE_T_ATTSERIAL				"T_ATTSERIAL"
#define KEYTYPE_ISBP_SERIALNO			"ISBP_SERIALNO" //ISBP报盘文件
#define KEYTYPE_TIF_PUSH_TASK			"T_TIF_PUSH_TASK" // 计划任务
...
#define TXCODE_DEPOSIT_SHOP_OPEN		843350 	//充值商户开户
#define TXCODE_DEPOSIT_SHOP_DEPOSIT	843351 	//充值商户存款
#define TXCODE_DEPOSIT_SHOP_CLOSE	843352	//充值商户销户
...
#define TXCODE_ONLINE_BANK				847233	 //网银转账

//海事考试报名
#define TXCODE_TURNOVER					847233	//考试报名
#define TXCODE_NET_CHARGE_EXT			847330	//网络收费

#define TXCODE_NETFEE_TRANS			847234  //城市热点网费转帐

#define TXCODE_NET_CHARGE                240112  //网络收费扣款 
//网络收费失败交易记录代码
#define NETCHARGE_CODE 1001 //记录网络收费转账失败标记

//第三方系统交易操作
#define THIRD_PARTE_QUERY_USERINFO	0	// 查询个人信息
#define THIRD_PARTE_TRANSFER		1	// 转账
#define THIRD_PARTE_QUERY_BALANCE	2	// 查询第三方系统余额
#define THIRD_PARTE_QUERY_SYSINFO	3	// 查询第三方系统信息
#define THIRD_PARTE_CHECK_DB		4	// 检查第三方系统数据库


#define TXCODE_ONLINE_SHOPDEPOSIT 	849003	//商户充值
...
#define	REGISTER_FULL					1			//完全缴费
#define	REGISTER_DELAY					2			//缓缴
#define	REGISTER_ARREARAGE 				3			//欠费
#define	REGISTER_SPECIALARREARAGE 		4			//特殊欠费

#define	REGISTER_ALREADY_UPDATE 		1			//已经做过更新
#define REGISTER_BEGIN_DATE				2702		//报到开始时间 
#define REGISTER_END_DATE				2703		//报到截止时间


// 收费类别
#define CUT_FEE_TYPE_BK					11			//本科生
#define CUT_FEE_TYPE_YJ					12			//研究生
#define CUT_FEE_TYPE_BS					13			//博士生
#define CUT_FEE_TYPE_ZB					14			//专升本
#define CUT_FEE_TYPE_TX					15			//离退休
#define CUT_FEE_TYPE_JG					17			//教职工
#define CUT_FEE_TYPE_TEMP				18			//临时人员收费类别

// 网络收费
#define NET_CHARGE_TRADE_MONEY			2701		//网络收费交易金额倍数 
