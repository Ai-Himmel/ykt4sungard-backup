...
#define E_NETCHARGE_NO_ACCOUNT 			110204          //网络收费帐户不存在
...
// 注册缴费系统错误码
#define E_DB_REGISTER_PAY_QUERY_P       110215			//注册缴费准备动态查询语句错误
#define E_DB_REGISTER_PAY_R				110216			//注册缴费信息表查询出错
#define E_DB_REGISTER_PAY_N				110217			//注册缴费信息表无相关记录
#define E_DB_REGISTER_PAY_U				110218			//注册缴费信息表更新出错
