...
L_RETU2:
	...
	if (1 == register_flag)
	{
		...
		if (REGISTER_ALREADY_UPDATE == register_pay.flag)
		{
			*pRetCode = E_DB_REGISTER_PAY_ALREADY;
			goto L_RETU;
		}
	}
	...
	SetCol(handle,0);
	SetCol(handle,F_DAMT0,F_LVOL1,F_LVOL6,F_LVOL7,F_LVOL5,F_SDATE0,F_LVOL0,F_SNAME,F_SNAME2,F_SCUST_AUTH,F_SSERIAL0,F_SCUST_AUTH2,F_SCUST_TYPE,F_SCUST_LIMIT,F_SCUST_NO,F_SBANK_ACC,F_VSMESS,0);
	...
	writelog(LOG_ERR,"write card flag=[%d], fee type=[%d]", out_pack->lvol6, out_pack->lvol5);
