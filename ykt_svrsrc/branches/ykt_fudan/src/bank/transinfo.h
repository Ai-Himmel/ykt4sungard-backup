...
#define TRADE_INNER_QUERY_MENDCARD_INFO 240108	//查询补写卡信息
#define TRADE_INNER_MEND_CARD 240109	//补写卡信息
#define TRADE_INNER_MEND_CARD_MAKE_SURE 240110 //补写卡确认
#define TRADE_INNER_QUERY_NETCHARGE_ACCINFO 240111 //查询机房网络收费帐户信息
#define TRADE_INNER_NETCHARGE_ACC_TRANS 240112 //网络收费帐户转账
#define TRADE_INNER_NETCHARGE_CHECK 240113 //网络收费检测
#define TRADE_INNER_REMAIN_BOARD_RECKON 240116 //多余搭伙费清算
