...
int F847125(TRUSERID *handle,int iRequest,ST_PACK *rPack,int *pRetCode,char *szMsg)
{
	...
	ret = UseShowCardNo(rPack->scust_limit,h_showcardid,CT_TEMP_NONAME);
	if(ret)
		return ret;
