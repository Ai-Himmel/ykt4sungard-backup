...
int DB_t_pif_card_read_by_physical_no_and_state_id(char *v_physical_no,char *v_state_id,T_t_pif_card *pt_pif_card);
int DB_t_pif_card_read_by_cosumer_id_and_state_id(int v_cosumer_id,char *v_state_id,T_t_pif_card *pt_pif_card);
