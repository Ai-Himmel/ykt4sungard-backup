...
int DB_t_door_device_cardlist_open_select_for_update_by_c0_and_cut_id(int v_cut_id);
int DB_t_door_device_cardlist_fetch_select_by_c0(T_t_door_device_cardlist *pt_door_device_cardlist);
int DB_t_door_device_cardlist_update_lock_by_c0(T_t_door_device_cardlist *pt_door_device_cardlist);
int DB_t_door_device_cardlist_close_select_by_c0();
#endif
