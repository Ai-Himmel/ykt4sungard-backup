...
#define GLOBE_MAXFUNDBOOK			3	//经费本年充值最大金额
...
#define GLOBE_HEAD_OF_TMPHUMAN_STUEMP_NO	14	//临时人员学号前缀
#define GLOBE_LENGTH_OF_TMPHUMAN_STUEMP_NO	15	//临时人员学号长度
#define GLOBE_ACC_BEGINMONTH	 16   //年结算开始的日期[mmdd]
