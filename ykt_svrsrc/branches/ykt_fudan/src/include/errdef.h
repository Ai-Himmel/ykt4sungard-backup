...
#define E_INPUT_SUBSIDY					100869			//补助批次号为空
...
#define E_DB_DOOR_GR_I					100883			//门禁组权限表插入错误
#define E_DB_DOOR_GR_U					100884			//门禁组权限表更新错误
#define E_DB_DOOR_GR_R					100885			//门禁组权限表读取错误
#define E_DB_DOOR_GR_D					100886			//门禁组权限表删除错误
#define E_DB_DOOR_GR_N					100887			//门禁组权限表无相关记录
#define E_DB_DOOR_GR_E					100888			//门禁组权限表记录已存在

#define E_DB_T_MEC_DAILY_REPORT_I		100889			//现代教育中心日解表插入错误
#define E_DB_T_MEC_DAILY_REPORT_U	100890			//现代教育中心日解表更新错误
#define E_DB_T_MEC_DAILY_REPORT_R		100891			//现代教育中心日解表读取错误
#define E_DB_T_MEC_DAILY_REPORT_D	100892			//现代教育中心日解表删除错误
#define E_DB_T_MEC_DAILY_REPORT_N	100893			//现代教育中心日解表无相关记录
#define E_DB_T_MEC_DAILY_REPORT_E		100894			//现代教育中心日解表记录已经存在

// 网络收费对接错误码
#define E_NETCHARGE_SHOP_NOT_EXIST 100900          //网络收费商户信息不存在
#define E_DB_NETCHARGE_SHOP_R     100901          //网络收费商户信息读取错误
#define E_NETCHARGE_DATABASE_CONNECT 100902       //网络收费数据库连接失败
#define E_NETCHARGE_NO_ACCOUNT 100903             //网络收费帐户不存在
#define E_NETCHARGE_NODATE 100904                 //网络收费不是期限用户
#define E_NETCHARGE_OUT_OF_MAXBALANCE 100905      //网络收费金额超出数字表示范围
#define E_NETCHARGE_ACCOUNT_ISEXIST 100906           //网络收费帐户已经存在
#define E_NETCHARGE_ACCOUNT_NOTOPEN 100907           //网络收费帐户未开通
#define E_NETCHARGE_DEPOSIT_SHORTAGE 100908           //网络收费预存款不足
#define E_NETCHARGE_MULTI_ACCOUNT 100909           //网络收费存在多条帐户
#define E_NETCHARGE_STOP_SERVICE 100910           //网络收费用户停机
#define E_NETCHARGE_COMM_TIME_OUT   100911         //网络收费通讯超时

#define E_ACCOUNT_OVERDRAFT				200120			//帐户已透支，请先充值
#define E_EXCEED_MAX_FUNDBOOK			200121			//经费本充值超过年限额
...
#define  E_TRANS_SCHCARD_WFAIL	108122	//上次写卡失败未处理，无法完成本次联机交易
#define  E_TRANS_COMM_TIME_OUT   108123  //BCC通讯超时
#define  E_TRANS_OTHER_COMM_ERROR 108124 //其他通讯错误
#define  E_DB_SUBSYSPARAMS_D               108125	//子系统参数表删除错误
#define  E_DB_SUBSYSPARAMS_I                108126	//子系统参数表插入错误
#define  E_DB_SUBSYSPARAMS_N               108127	//子系统参数表查询相关无记录
#define  E_DB_SUBSYSPARAMS_R               108128	//子系统参数表读取错误
#define  E_DB_SUBSYSPARAMS_E               108129	//子系统参数表已存在

#define  E_TRANS_UNKNOW_ERROR         	109000	//其他未知错误
#define  E_TRANS_ACCOUNT_NOT_RECKON    108130	    //此帐户不用清算
#define  E_TRANS_RECKON_BALA_ERR    108131	    //清算金额有误
#define  E_TRANS_BOARD_SHORTAGE    108132	        //搭伙费余额不足


#define E_STARTNO_GT_ENDNO		108232 //开始卡号大于截止卡号
#define E_STARTNO_RANGE         108233	//开始卡号范围错误
#define E_ENDNO_RANGE			108234  //截止卡号范围错误
#define E_RANGE_EXIST_SHOWCARDNO 108235 //在起始号和结束号之间存在已领入的卡号
#define E_GETCARDCNT_TOOMUCH     108236 //一次领入的卡数量不能超过10000张
#define E_RANGE_EXIST_USEDCARD 108237 //在起始号和结束号之间存在已使用的卡号
#define E_RANGE_EXIST_NOTGETCARD 108238 //在起始号和结束号之间存在未领入的卡号
#define E_EXIST_GETCARDRANGE 108239 //上交的卡片记录不存在
#define E_CARDUSESTATUS_USED     108240 //该卡已经使用
#define E_CARDUSESTATUS_DISABLE	 108241 //该卡已经作废
#define E_CARDUSESTATUS_GET		 108242 //该卡已领入
#define E_NOTEXIST_SHOWCARDNO	 108243 //该显示卡号不存在
#define E_DB_CARDBOOK_D        108244 //卡片登记表删除错误
#define E_DB_CARDBOOK_E        108245 //卡片登记表记录重复
#define E_DB_CARDBOOK_I        108246 //卡片登记表插入错误
#define E_DB_CARDBOOK_N        108247 //卡片登记表查询无符合条件记录
#define E_DB_CARDBOOK_R        108248 //卡片登记表查询错误
#define E_DB_CARDBOOK_U        108249 //卡片登记表修改错误
#define E_DB_CARDDTL_D        108250 //卡片使用明细表删除错误
#define E_DB_CARDDTL_E        108251 //卡片使用明细表记录重复
#define E_DB_CARDDTL_I        108252 //卡片使用明细表插入错误
#define E_DB_CARDDTL_N        108253 //卡片使用明细表查询无符合条件记录
#define E_DB_CARDDTL_R        108254 //卡片使用明细表查询错误
#define E_DB_CARDDTL_U        108255 //卡片使用明细表修改错误
#define E_SAME_PUTOPER_GETOPER  108256 //交接操作员与当前操作员不能相同
#define E_CARD_NOTBELONG_OPER 108257 //该卡不属于该操作员
#define E_CARDUSESTATUS_NODISABLED	 108258 //该卡号未作废
#define E_CARD_NOGET			 108259 //该卡未领入登记或登记的类型不对
#define E_CARDUSESTATUS_UNUSED     108260 //该卡未使用
#define E_CARD_BADRECORD	108261	//该卡损坏已经登记
#define E_CARDNO_NOTLOGOUT	108262		//该卡未注销
#define E_CARDNO_NOTCONTINUE	108263		//在起始号和结束号之间存在不连续的卡号
#define E_CARDTYPE_SHOWNO		108264		//卡类型和显示卡号不匹配
#define E_CARDTYPE			108265		//卡类型不支持
#define E_CARDTYPE_NORMAL	108267		//该类型的卡不能发正式卡
#define E_SHOWNO_ZERO	108268		//显示卡号全是0
#define E_READVIPCARD_N		108269		//没有发行VIP卡
#define E_READVIPCARD_E		108270		//统计VIP卡出错

#define E_FIXCARD_ALREADY		108300		//写卡失败记录已经被修复过	
#define E_FIXCARDLOG_R			108301		//修卡记录表读取错误
#define E_FIXCARDLOG_I			108302		//修卡记录表插入错误

#define	E_DB_MODIFYINFO_D	108303 //修改学工号记录表删除错误
#define	E_DB_MODIFYINFO_E	108304 //修改学工号记录表记录重复
#define	E_DB_MODIFYINFO_I	108305 //修改学工号记录表插入错误
#define	E_DB_MODIFYINFO_N	108306 //修改学工号记录表查询无符合条件记录
#define	E_DB_MODIFYINFO_R	108307 //修改学工号记录表查询错误
#define	E_DB_MODIFYINFO_U	108308 //修改学工号记录表修改错误

#define E_DB_STUROOMINFO_R 108309  //学生宿舍信息表读取错误
#define E_DB_STUROOMINFO_E 108310  //学生宿舍信息表读记录重复
#define E_DB_STUROOMINFO_I 108311  //学生宿舍信息表插入错误
#define E_DB_STUROOMINFO_D 108312  //学生宿舍信息表删除错误
#define E_DB_STUROOMINFO_U 108313  //学生宿舍信息表更新错误

#define E_DATE_RANGE_ERR	108314		// 日期范围太大
#endif
