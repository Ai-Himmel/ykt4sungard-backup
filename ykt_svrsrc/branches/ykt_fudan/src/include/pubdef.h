...
#define KEYTYPE_TD_SERI_NO			"T_THIRDPARTY_SERIAL"
#define KEYTYPE_NETCHRAGE_SHOP  			"T_CIF_NETCHRAGE_SHOP"				//网络收费商户表
#define KEYTYPE_TIF_SUBSIDY_NO			"TIF_SUBSIDY_NO"	//补助批次号
#define KEYTYPE_T_PIF_CARDDTL		"T_PIF_CARDDTL"				//卡片操作情况表
...
#define TXCODE_MOD_SUBSIDY				847133	//已发补助修改客户
...
#define TXTYPE_SHOP_RAKEOFF							59	//商户收取佣金
