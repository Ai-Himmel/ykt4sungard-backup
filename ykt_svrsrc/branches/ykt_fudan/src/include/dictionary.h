...
#define DEVITYPE_MOBILE_JSB		"0115"
...
/*
	...
	消息状态7: 连续返回数据集
*/
#define MESLISTSTATE_WAIT			1
#define MESLISTSTATE_START			2
#define MESLISTSTATE_SUCCEED		3
#define MESLISTSTATE_ERROR			4
