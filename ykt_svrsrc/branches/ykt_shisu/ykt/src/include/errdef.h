...
#define E_MOBILE_TRANS_ZERO 109188 //充值为0
#define E_MOBILE_TRANS_MAX 109189 //充值超过最大值

#define E_TO_SQL_ERR 109197 //缴费查询失败
#define E_TURN_OVER_N 109198 //无相关的缴费记录
#define E_TURN_OVER_U 109199 //缴费信息表更新错误
#define E_DB_SYS_STATISTICS_SQL_ERR 109200 //查询SQL脚本错误
#define E_DB_SYS_STATISTICS_NOTFOUND_DATA 109201 //查询数据为空
