...
ALTER TABLE YKT_CUR.T_CIF_SHOP ADD (B_ACT_ID  VARCHAR2(40 BYTE),B_ACT_NAME VARCHAR2(60 BYTE));
ALTER TABLE YKT_CUR.T_CIF_SHOP_LOG ADD (B_ACT_ID   VARCHAR2(40 BYTE),B_ACT_NAME VARCHAR2(60 BYTE));
