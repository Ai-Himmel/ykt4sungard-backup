APLIBS=-L$(HOME)/ykt/lib -ldrtplib -ldrtpapi -lbccclt -lkcrypto -lboost_thread -lbccpub -lpubdb
...
PREPROCESSOR_C=gcc34 -x c -E -P -DESQL=""
PREPROCESSOR_CXX=g++34 -x c -E -P -DESQL=""
