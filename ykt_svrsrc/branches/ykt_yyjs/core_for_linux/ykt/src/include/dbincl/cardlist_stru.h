...
int DB_t_door_device_cardlist_read_lock_by_cur_and_device_id_and_cust_id(int v_device_id,int v_cust_id,T_t_door_device_cardlist *pt_door_device_cardlist);
