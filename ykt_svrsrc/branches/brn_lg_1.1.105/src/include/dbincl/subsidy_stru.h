...
int DB_t_tif_subsidy_read_lock_by_c3_and_subsidy_no_and_cust_no_and_status(int v_subsidy_no,int v_cust_no,char *v_status,T_t_tif_subsidy *pt_tif_subsidy);
