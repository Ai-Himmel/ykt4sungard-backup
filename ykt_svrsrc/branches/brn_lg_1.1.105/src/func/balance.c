...
int CreateActiveReport_bakdate(char *bak_date)
{
	int ret=0;
	int cnt=0;
...
int CreateOperReport_bakdate(char *bak_date)
{
	T_v_tif_report_oper	v_oper;
	T_t_tif_report_oper		t_oper;
...
int CreateShopReport_bakdate(char *bak_date)
{
...
int CreateRichDebtReport_bakdate(char *bak_date)
{
