...
RE=W
CC= gcc
CCFLAGS= -D_DRTP_V4 -D_MT -Wall -O2 -finput-charset=gbk
...
.SUFFIXES: .o .c .cpp .sqc .sqC .ec .eC
...
rcv_acc:rcv_acc.o $(HOME)/ykt/lib/libbccpub.a $(HOME)/ykt/lib/libpubdb.a
	$(CC) $(CCFLAGS) $(INCLD) $(LIBS) -o $@ $@.o $(APLIBS) $(LIBSUDF)
	mv rcv_acc $(BINDIR)
...
TMP820601.ec:F820601.ec
	cp F820601.ec TMP820601.
...
synccut:$(SYNCCUT_SRC:=.o) $(HOME)/ykt/lib/libbccpub.a $(HOME)/ykt/lib/libpubdb.a
	$(CC) $(CCFLAGS) $(INCLD) $(LIBS) -o $@ $(SYNCCUT_SRC:=.o) $(APLIBS) $(LIBSUDF)
	mv $@ $(BINDIR)
	rm TMP820601.sqc
start:start.o
	$(CC) $(CCFLAGS) -o $@ $@.o
...
bala:bala.o balance.o $(HOME)/ykt/lib/libbccpub.a $(HOME)/ykt/lib/libpubdb.a
	$(CC) $(CCFLAGS) $(INCLD) $(LIBS) -o $@  $@.o balance.o  $(APLIBS) $(LIBSUDF)
	mv bala $(BINDIR)
