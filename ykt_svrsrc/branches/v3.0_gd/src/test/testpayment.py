...
class paymentTest (unittest.TestCase):
    ...
    def testGDCTTrans(self):
        ...
        # 正常交易
        v = {"lcert_code":3062,"lvol0":common.CARDNO,"lvol1":common.CARDCNT,"lvol2":0,
        "damt0":befbala,"damt1":tranbala,"scust_no":'1000','lvol3':1,'lvol4':common.TERMID,
        'sname':'','sphone':'13564319628'}
        ret = obj.callsvr(847316,v,10000)
        self.failUnless(ret==0,obj.errmsg)
        x = obj.getrecord(["lvol0","damt0","damt1","damt2","lvol5",'damt10','damt11','damt12','sname2'])
        print x
        v = {"lcert_code":3062,"lvol0":3797,"lvol1":24,"lvol2":0,
        "damt0":100.0,"damt1":1,"scust_no":'1000','lvol3':1,'lvol4':125,
        'sname':'','sphone':'13564319628','lvol6':x['lvol0'],'sphone3':x['sname2']}
        ret = obj.callsvr(847317,v)
        self.failUnless(ret==0,obj.errmsg)
...
def suite():
    ...
    #'testLossCardTrans','testFronzenCardTrans','testReaderTrans','testGDCTTrans']
    suites = ['testGDCTTrans']
