...
int UpdateTransdtlRevFlag(char *transdtlname,char *accdate,int termid,int termseqno);
//根据校区生成新客户号
...
// CPU 卡计算 MAC2
int calc_cpucard_mac(cpu_trade_t *trade,char *mac);
int GetCustBaseInfoByCustID(int custid,char *custname,char *stuempno,char *areacode);
