...
#define CARDBITMAPTYPE_RESET   '0'	 	//重置

#define TRADE_TRANS			240001	//自助转帐
#define	TRADE_REVERSE			240002 //银行卡转账功能冲正

// 对账类型
#define CHKTYPE_MANUAL 1 // 手工
#define CHKTYPE_AUTO 2 // 自动

//  对账标志
#define CHKFLAG_INIT 0 // 初始状态
#define CHKFLAG_CHECKING 1 // 正在对账
#define CHKFLAG_FINISH 2 // 对账成功
#define CHKFLAG_ACC 3 // 以手工平帐
