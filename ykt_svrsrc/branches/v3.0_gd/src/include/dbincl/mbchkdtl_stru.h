...
int DB_t_mobilechkdtl_read_by_refno(char *v_refno,T_t_mobilechkdtl *pt_mobilechkdtl);
int DB_t_mobilechkdtl_update_by_refno(char *v_refno,T_t_mobilechkdtl *pt_mobilechkdtl);
int DB_t_mobilechkdtl_del_by_refno(char *v_refno);
int DB_t_mobilechkdtl_read_lock_by_c0_and_refno(char *v_refno,T_t_mobilechkdtl *pt_mobilechkdtl);
