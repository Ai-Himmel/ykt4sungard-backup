...
int DB_t_cardver_read_by_cardverno(char *v_cardverno,T_t_cardver *pt_cardver);
int DB_t_cardver_update_by_cardverno(char *v_cardverno,T_t_cardver *pt_cardver);
int DB_t_cardver_del_by_cardverno(char *v_cardverno);
int DB_t_cardver_read_lock_by_c0_and_cardverno(char *v_cardverno,T_t_cardver *pt_cardver);
int DB_t_cardver_update_lock_by_c0(T_t_cardver *pt_cardver);
int DB_t_cardver_free_lock_by_c0();
int DB_t_cardver_open_select_by_c1_and_cardverno(char *v_cardverno);
