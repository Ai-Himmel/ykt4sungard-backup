...
int DB_t_dooroperright_read_by_opercode_and_deviceid(char *v_opercode,int v_deviceid,T_t_dooroperright *pt_dooroperright);
int DB_t_dooroperright_del_by_opercode(char *v_opercode);
int DB_t_dooroperright_del_by_deviceid(int v_deviceid);
int DB_t_dooroperright_del_by_opercode_and_deviceid(char *v_opercode,int v_deviceid);
int DB_t_dooroperright_open_select_by_c0_and_opercode(char *v_opercode);
