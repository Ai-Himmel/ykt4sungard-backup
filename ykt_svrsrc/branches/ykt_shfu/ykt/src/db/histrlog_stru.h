...
int DB_t_tif_tradelog_his_open_select_by_c0_and_bak_date_and_serino_and_outorin(char *v_bak_date,int v_serino,int v_outorin);
int DB_t_tif_tradelog_his_fetch_select_by_c0(T_t_tif_tradelog_his *pt_tif_tradelog_his);
int DB_t_tif_tradelog_his_close_select_by_c0();
#endif
