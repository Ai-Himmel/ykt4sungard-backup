...
int DB_t_pif_card_open_select_for_update_by_c5_and_cosumer_id(int v_cosumer_id);
int DB_t_pif_card_fetch_select_by_c5(T_t_pif_card *pt_pif_card);
int DB_t_pif_card_update_lock_by_c5(T_t_pif_card *pt_pif_card);
int DB_t_pif_card_close_select_by_c5();
#endif
