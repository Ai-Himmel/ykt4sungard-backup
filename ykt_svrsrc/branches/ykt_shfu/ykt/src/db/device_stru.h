...
int DB_t_pif_device_open_select_by_c5_and_devtype_and_phytype(char *v_devtype,int v_phytype);
int DB_t_pif_device_fetch_select_by_c5(T_t_pif_device *pt_pif_device);
int DB_t_pif_device_close_select_by_c5();
#endif
