...
#define SUBJECT_DEPOSITSHOPSAVING	 "209"		//充值商户存款
/*
	末级标志	1	是
	末级标志	2	非
*/
...
// 补助状态
// 未下发
#define SUBSIDY_STAT_NEW	'1'
// 未领取
#define SUBSIDY_STAT_NORMAL  '2'
// 已领取
#define SUBSIDY_STAT_FINISHED  '3'
...
结算对账文件类型
****************************************************/
#define ACCOUNTING_SHOP 1	// 商户结算
#define ACCOUNTING_OPERATOR 2 // 操作员结算

/*************************************************
 * 授权卡权限位
 * **********************************************/
#define AUTHCARD_PRV_POS		0x01 // 收费终端
#define AUTHCARD_PRV_CENTER		0x02 // 管理中心
#define AUTHCARD_PRV_ADDPOS		0x04 // 充值终端
#define AUTHCARD_PRV_DOOR		0x08 // 门禁终端
#define AUTHCARD_PRV_ID			0x16 // 认证终端
#define	AUTHCARD_PRV_AREA		0X32 // 区域控制
