...
#define E_DB_RCVDTLFILTER_D				100778		//消费来帐流水过滤表删除错误
#define E_DB_RCVDTLFILTER_E				100779		//消费来帐流水过滤表记录重复
#define E_DB_RCVDTLFILTER_N				100780		//消费来帐流水过滤表无相关记录
#define E_DB_RCVDTLFILTER_R				100781		//消费来帐流水过滤表读取错误
#define E_DB_RCVDTLFILTER_U				100782		//消费来帐流水过滤表更新错误
#define E_DB_RCVDTLFILTER_I				100783		//消费来帐流水过滤表插入错误
...
#define E_SERI_ALREADY_REPEAT				110003			// 流水已经重复
#define E_DAY_OFF_RANGE						110004			// 日期范围不能超过1个月
...
#define E_DB_BANKCOMP_N					130156			//银行对账表无相关记录
#define E_DB_BANKCOMP_R					130157			//银行对账表读取错误
#define E_DB_BANKCOMP_I					130158			//银行对账表插入错误
#define E_DB_BANKCOMP_U					130159			//银行对账表更新错误
#define E_DB_BANKCOMP_D					130160			//银行对账表删除错误
#define E_DB_BANKCOMP_E					130161			//银行对账表记录已存在
...
#define E_ACCOUNT_NOT_SUPPORT		110835			//结算类型不支持
#define E_RESERVE_BALA_DIFF			110836			//保留账户金额不正确
...
#define E_STUEMPANDNAME 109200 //学工号和姓名不符合
#define E_FIXCARD_ALREADY 109201 //卡已经修过
#define E_FIXCARDLOG_R 109202 //读取修卡表错误
#define E_FIXCARDLOG_I 109203 //插入修卡表错误
