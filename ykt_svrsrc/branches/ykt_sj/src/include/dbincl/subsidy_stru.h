...
int DB_t_tif_subsidy_open_select_for_update_by_c3_and_card_no_and_status(int v_card_no,char *v_status);
...
int DB_t_tif_subsidy_open_select_for_update_by_c4_and_batch_no_and_subsidy_no(char *v_batch_no,int v_subsidy_no);
int DB_t_tif_subsidy_fetch_select_by_c4(T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_update_lock_by_c4(T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_close_select_by_c4();
#endif
