...
#define SMLPACKETDTL_INCARDNO_EXIT   110038	//小钱包已经写卡成功
#define SMLPACKETDTL_I                110039	//小钱包流水表插入失败
#define SMLPACKETDTL_R               110040	//小钱包流水表读取失败
#define SMLPACKETDTL_U               110041	//小钱包流水表更新失败
