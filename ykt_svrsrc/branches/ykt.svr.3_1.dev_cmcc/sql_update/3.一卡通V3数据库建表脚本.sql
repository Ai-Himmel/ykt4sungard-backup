...
/*==============================================================*/
CREATE TABLE YKT_CUR.T_BRASTRANSDTL  (
   ...
   STATUS               NUMBER(1),
   REMARK               VARCHAR(240),
   CONSTRAINT PK_T_BRASTRANSDTL PRIMARY KEY (REFNO)
)
PCTFREE 10
INITRANS 1
STORAGE
...
COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.REFNO IS
'交易参考号';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.CARDNO IS
'卡号';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.CUSTNAME IS
'姓名';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.OPPACCNO IS
'对方账号';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.OPPACCNAME IS
'对方账户名';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.TRANSTIME IS
'交易时间';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.TRANSTYPE IS
'交易类型';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.SUMMARY IS
'摘要';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.TRANSAMT IS
'交易金额';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.STATUS IS
'处理结果0-成功1失败';

COMMENT ON COLUMN YKT_CUR.T_BRASTRANSDTL.REMARK IS
'备注';
...
/* Table: T_CARDBALANCE                                         */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_CARDBALANCE  (
   ACCNO                VARCHAR(10)                     NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.ACCNO IS
'账号';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.PURSETYPE IS
'钱包类型';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.CARDNO IS
'交易卡号';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.OLDCARDNO IS
'原卡号';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.TRANSDATE IS
'最后交易日期';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.TRANSTIME IS
'最后交易时间';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.DPSCNT IS
'充值次数';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.PAYCNT IS
'消费次数';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.BALANCE IS
'账户余额';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.CARDBAL IS
'卡余额';

COMMENT ON COLUMN YKT_CUR.T_CARDBALANCE.ACCUMDPSAMT IS
'累计充值金额';

/*==============================================================*/
/* Index: IDX_CARDBALANCE_CARDNO                                */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_CARDBALANCE_CARDNO ON YKT_CUR.T_CARDBALANCE (
   PURSETYPE ASC,
   CARDNO ASC
);
...
/* Table: T_PURSEPOSDTL                                         */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_PURSEPOSDTL  (
   TRANSDATE            VARCHAR(8)                      NOT NULL,
   TRANSTIME            VARCHAR(6),
   TERMID               INTEGER,
   DEVPHYID             VARCHAR(20)                     NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.TRANSTIME IS
'交易时间';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.TERMID IS
'终端号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.DEVPHYID IS
'设备物理ID';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.DEVSEQNO IS
'设备流水号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.CARDNO IS
'交易卡号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.PURSETYPE IS
'钱包类型';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.CARDCNT IS
'卡交易次数';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.CARDBEFBAL IS
'交易前卡余额';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.AMOUNT IS
'发生额-包含管理费';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.CARDAFTBAL IS
'交易后卡余额';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.TRANSMARK IS
'交易标记';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.DATATYPE IS
'数据类型';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.SHOPID IS
'商户卡号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.BATCHNO IS
'导入批次号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.SYSID IS
'子系统ID';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.COLDATE IS
'采集日期';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.COLTIME IS
'采集时间';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.ACCDATE IS
'记账日期';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.ACCTIME IS
'记账时间';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.TERMSEQNO IS
'终端流水号';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.STATUS IS
'状态-1初始状态2-入账失败3-成功4-异常流水';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.ERRCODE IS
'错误码';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.ERRMSG IS
'错误信息';

COMMENT ON COLUMN YKT_CUR.T_PURSEPOSDTL.DELFLAG IS
'删除标志';

/*==============================================================*/
/* Index: IDX_PURSEPOSDTL_STATUS                                */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_PURSEPOSDTL_STATUS ON YKT_CUR.T_PURSEPOSDTL (
   STATUS ASC
);
...
/*==============================================================*/
CREATE TABLE YKT_CUR.T_PURSETRANSDTL  (
   ACCDATE              VARCHAR(8)                      NOT NULL,
   ACCTIME              VARCHAR(6),
   TERMID               INTEGER                         NOT NULL,
   TERMSEQNO            INTEGER                         NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.ACCDATE IS
'记账日期';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.ACCTIME IS
'记账时间';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TERMID IS
'终端编号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TERMSEQNO IS
'终端流水号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.PURSETYPE IS
'钱包类型';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TRANSDATE IS
'交易日期';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TRANSTIME IS
'交易时间';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.REFNO IS
'交易参考号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TRANSCODE IS
'交易码';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CUSTID IS
'客户号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CUSTNAME IS
'客户名';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.STUEMPNO IS
'学工号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.SHOWCARDNO IS
'显示卡号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CARDNO IS
'卡号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.TRANSFLAG IS
'1充值标志2消费次数';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CARDCNT IS
'卡交易次数';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CARDBEFBAL IS
'交易前卡余额';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.CARDAFTBAL IS
'交易后卡余额';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.AMOUNT IS
'发生额';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.OPERCODE IS
'操作员号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.SYSID IS
'子系统编号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.DEVPHYID IS
'设备物理ID';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.DEVSEQNO IS
'设备流水号';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.COLDATE IS
'采集日期';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.COLTIME IS
'采集时间';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.STATUS IS
'记录状态1:未入账2-入账失败3-成功';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.ERRCODE IS
'错误码';

COMMENT ON COLUMN YKT_CUR.T_PURSETRANSDTL.REMARK IS
'备注';

/*==============================================================*/
/* Index: IDX_PURSETRANSDTL_CARDNO                              */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_PURSETRANSDTL_CARDNO ON YKT_CUR.T_PURSETRANSDTL (
   CARDNO ASC
)
TABLESPACE TS_YKT_HIS;
...
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_PURSETRANSDTL_CUSTID ON YKT_CUR.T_PURSETRANSDTL (
   CUSTID ASC
)
TABLESPACE TS_YKT_HIS;
...
/* Table: T_PURSETYPE                                           */
/*==============================================================*/
CREATE TABLE YKT_CUR.T_PURSETYPE  (
   PURSETYPE            NUMBER(1)                       NOT NULL,
...
COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.PURSETYPE IS
'钱包类型';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.PURSETYPENAME IS
'钱包类型名';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.PURSEMAXBAL IS
'最大存款金额';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.ONLINEFLAG IS
'联机标志';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.SHOPID IS
'商户号';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.REFUNDFLAG IS
'退款余额标志';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.PRIMARYFLAG IS
'主钱包标志';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.ENABLEFLAG IS
'启用标志';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.REMARK IS
'备注';

COMMENT ON COLUMN YKT_CUR.T_PURSETYPE.LASTSAVED IS
'最后保存时间';
...
/*==============================================================*/
/* Index: IDX_SUBSIDY_CARDNO                                    */
/*==============================================================*/
CREATE INDEX YKT_CUR.IDX_SUBSIDY_CARDNO ON YKT_CUR.T_SUBSIDY (
   CARDNO ASC
);
