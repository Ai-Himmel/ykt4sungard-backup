...
#define TXCODE_CARD_OPEN_BILL		471012	//发行正式卡(支票)
#define TXCODE_CARD_OPEN_FUNDBOOK	8471013 	//发行正式卡(经费本)
#define TXCODE_CARD_OPEN_TRAD			8471014 	//发行正式卡(财务收款)
...
#define TXCODE_CARD_OPEN_TMP_TRAD		8471244 	//发行记名临时卡(财务收款)
...
#define TXCODE_SAVING_TRAD			8471064	//财务收款
...
#define TXCODE_CARD_OPEN_VIP_TRAD	8471264 	//发行贵宾临时卡(财务收款)
...
//上外网费转帐
#define TXCODE_NETFEE_TRANS			847234
...
#define TXTYPE_SAVING_TRAD			4	//财务收款
#define TXTYPE_SAVING_OTHER			54	//其他充值

#define TXTYPE_DRAW_CASH			5	//现金支取
#define TXTYPE_DRAW_BILL			6	//支票支取
#define TXTYPE_DRAW_FUNDBOOK		7	//经费本支取
#define TXTYPE_DRAW_TRAD			73	//财务收款支取
#define TXTYPE_DRAW_OTHER			55	//其他支取
...
#define TXTYPE_SUBSIDY_PRE_TOLL_BOARD_TRAD		64 //补助预收搭伙费(财务收款)
