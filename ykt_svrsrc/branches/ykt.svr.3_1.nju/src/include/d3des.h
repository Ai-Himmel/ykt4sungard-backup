 ...
 * internal key register) one block of eight bytes at addr 'from'
 * into the block at addr 'to'.  They can be the same.
 */
 ...
 * internal key registerS) one block of eight bytes at addr 'from'
 * into the block at addr 'to'.  They can be the same.
 */
...
/*		    from[16]	      to[16]
 * Encrypts/Decrypts (according to the keyS currently loaded in the
 * internal key registerS) one block of SIXTEEN bytes at addr 'from'
 * into the block at addr 'to'.  They can be the same.
 */
