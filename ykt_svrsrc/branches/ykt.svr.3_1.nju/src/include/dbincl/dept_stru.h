...
int DB_t_dept_read_by_deptcode(char *v_deptcode,T_t_dept *pt_dept);
int DB_t_dept_update_by_deptcode(char *v_deptcode,T_t_dept *pt_dept);
int DB_t_dept_del_by_deptcode(char *v_deptcode);
int DB_t_dept_read_lock_by_c0_and_deptcode(char *v_deptcode,T_t_dept *pt_dept);
