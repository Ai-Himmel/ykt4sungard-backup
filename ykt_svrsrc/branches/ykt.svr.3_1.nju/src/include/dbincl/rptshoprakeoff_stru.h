...
int DB_t_rptshoprakeoff_read_by_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptshoprakeoff *pt_rptshoprakeoff);
int DB_t_rptshoprakeoff_update_by_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptshoprakeoff *pt_rptshoprakeoff);
int DB_t_rptshoprakeoff_del_by_accdate_and_accno(char *v_accdate,char *v_accno);
int DB_t_rptshoprakeoff_read_lock_by_c0_and_accdate_and_accno(char *v_accdate,char *v_accno,T_t_rptshoprakeoff *pt_rptshoprakeoff);
