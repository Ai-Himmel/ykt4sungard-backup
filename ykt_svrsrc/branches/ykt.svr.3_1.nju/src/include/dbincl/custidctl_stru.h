...
int DB_t_custidctl_read_by_areacode(char *v_areacode,T_t_custidctl *pt_custidctl);
int DB_t_custidctl_update_by_areacode(char *v_areacode,T_t_custidctl *pt_custidctl);
int DB_t_custidctl_del_by_areacode(char *v_areacode);
int DB_t_custidctl_read_lock_by_c0_and_areacode(char *v_areacode,T_t_custidctl *pt_custidctl);
