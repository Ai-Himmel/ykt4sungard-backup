...
int DB_t_syskey_del_by_keycode(char *v_keycode);
int DB_t_syskey_read_by_keycode(char *v_keycode,T_t_syskey *pt_syskey);
int DB_t_syskey_read_lock_by_cur_and_keycode(char *v_keycode,T_t_syskey *pt_syskey);
