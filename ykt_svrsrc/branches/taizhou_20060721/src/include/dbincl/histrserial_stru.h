...
int DB_t_tif_tradeserial_his_read_by_operate_date_and_serial_no(char *v_operate_date,int v_serial_no,T_t_tif_tradeserial_his *pt_tif_tradeserial_his);
int DB_t_tif_tradeserial_his_read_by_bak_date_and_serial_no(char *v_bak_date,int v_serial_no,T_t_tif_tradeserial_his *pt_tif_tradeserial_his);
#endif
