...
#define E_DB_NOTFOUND                   100224		//查询无相关记录
...
#define E_DYNAMIC_STMT_EXECUTE		100799			//执行动态语句失败
#define E_OPER_OVER_MAX_DEPOSIT_AMT	100800			//充值超过最大限额
...
#define E_CARDTYPE_SHOPCARD			100828			//该卡是商户卡,回收请使用商户卡回收功能
#define E_CARD_EXPIRE 					100829			//卡已过有效使用日期
#define E_SHOP_CLOSE					100830			//该商户已销户
#define E_DEPOSIT_OPER_STOP			100831			//该操作员已停用
#define E_OPER_NO_NEED_DEVICE			100832			//该操作员不需要限制使用设备
#define E_SYS_CALL						100833			//系统调用失败
...
#define E_SUBSYS_VERSION_ERR			110028			//前置机程序版本不正确
/////////////////////////////////////////////////////////////////////////////////
...
#define E_DB_DEPOSIT_SHOP_N			130145			//充值商户表无相关记录
#define E_DB_DEPOSIT_SHOP_R			130146			//充值商户表读取错误
#define E_DB_DEPOSIT_SHOP_I			130147			//充值商户表插入错误
#define E_DB_DEPOSIT_SHOP_U			130148			//充值商户表更新错误
#define E_DB_DEPOSIT_SHOP_D			130149			//充值商户表删除错误
#define E_DB_DEPOSIT_SHOP_E			130150			//充值商户表记录已存在
#define E_DB_DEPOSIT_SHOPPOS_N		130151			//充值商户设备表无相关记录
#define E_DB_DEPOSIT_SHOPPOS_R		130152			//充值商户设备表读取错误
#define E_DB_DEPOSIT_SHOPPOS_I		130153			//充值商户设备表插入错误
#define E_DB_DEPOSIT_SHOPPOS_U		130154			//充值商户设备表更新错误
#define E_DB_DEPOSIT_SHOPPOS_D		130155			//充值商户设备表删除错误
#define E_DB_DEPOSIT_SHOPPOS_E		130156			//充值操作员设备表记录已存在
#define E_DB_DEPOSIT_OPERPOS_N		130157			//充值操作员设备表无相关记录
#define E_DB_DEPOSIT_OPERPOS_R		130158			//充值操作员设备表读取错误
#define E_DB_DEPOSIT_OPERPOS_I		130159			//充值操作员设备表插入错误
#define E_DB_DEPOSIT_OPERPOS_U		130160			//充值操作员设备表更新错误
#define E_DB_DEPOSIT_OPERPOS_D		130161			//充值操作员设备表删除错误
#define E_DB_DEPOSIT_OPERPOS_E		130162			//充值操作员设备表记录已存在
#define E_DB_DEPOSIT_OPER_N			130163			//充值操作员表无相关记录
#define E_DB_DEPOSIT_OPER_R			130164			//充值操作员表读取错误
#define E_DB_DEPOSIT_OPER_I			130165			//充值操作员表插入错误
#define E_DB_DEPOSIT_OPER_U			130166			//充值操作员表更新错误
#define E_DB_DEPOSIT_OPER_D			130167			//充值操作员表删除错误
#define E_DB_DEPOSIT_OPER_E			130168			//充值操作员表记录已存在
...
#define E_DEVICE_IS_DEPOSITSHOP			200116			//非充值商户操作员不能使用充值商户充值机
#define E_DEVICE_NOTIS_DEPOSITSHOP             200117			//充值商户操作员不能使用非充值商户充值机
#define E_DEVICE_USED_TO_NODEPOSITSHOPOPER 200118		//该充值机已经被非充值操作员使用
#define E_INPUT_NOSHOP_ID					200119			//输入商户号不能为空
...
#define E_EACC_BALANCE_NOZERO		500239 //电子钱包账户余额不为空
#define E_EACC_DYNA_KEY			500240	//动态密钥验证错误
#define E_EACC_ORDERCODE			500241	// 订单号重复或冻结金额已经解冻
#define E_INPUTNULL_PWD			500242 //输入的密码为空
#define E_PWD_DECRYPT			500243 //解密失败
#define E_DIFF_IDTYPE           500244  //证件类型不符
#define E_DIFF_IDNO             500245  //证件号码不符
#define E_ACC_NOTEACC			500246 //账户不是电子账户
#define E_ACC_NOTSHOP			500247 //账户不是商户账户
#define E_ACC_BACKOFF			500248 //要冲正的支付交易未成功或交易已经冲正
#define E_ACC_FROZENOFF		500249 //要解冻的冻结交易未成功或已经解冻
#endif
