...
// 用户默认密码,长度为6个字符
#define DEFAULT_CUST_PWD	"888888"
...
#define CT_NORMAL			1		//正式卡
#define CT_TEMP_ANONYM	2		//不记名临时卡
#define CT_TEMP_NAME		3		//记名临时卡
#define CT_NORMAL_TEMP		4		//过渡临时卡
#define CT_VIP				5		//vip临时卡
#define CT_MERCH			10		//商户卡
/*
	帐户状态	1	注册
   	帐户状态	2	注销
   	帐户状态	3	冻结
...
#define SUBJECT_ESAVING			"210"				//电子帐户存款
