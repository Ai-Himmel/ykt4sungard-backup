...
int DB_t_tif_tradeserial_read_by_operate_date_and_serial_no_and_card_id(char *v_operate_date,int v_serial_no,int v_card_id,T_t_tif_tradeserial *pt_tif_tradeserial);
...
int DB_t_tif_tradeserial_open_select_by_cur3_and_serial_type_and_card_id(int v_serial_type,int v_card_id);
...
int DB_t_tif_tradeserial_read_lock_by_c4_and_operate_date_and_serial_no_and_card_id(char *v_operate_date,int v_serial_no,int v_card_id,T_t_tif_tradeserial *pt_tif_tradeserial);
int DB_t_tif_tradeserial_update_lock_by_c4(T_t_tif_tradeserial *pt_tif_tradeserial);
int DB_t_tif_tradeserial_free_lock_c4();
int DB_t_tif_tradeserial_read_lock_by_c5_and_operate_date_and_other_seri_no_and_devphy999_id(char *v_operate_date,int v_other_seri_no,char *v_devphy999_id,T_t_tif_tradeserial *pt_tif_tradeserial);
int DB_t_tif_tradeserial_update_lock_by_c5(T_t_tif_tradeserial *pt_tif_tradeserial);
int DB_t_tif_tradeserial_free_lock_c5();
#endif
