...
int DB_t_tif_subsidy_open_select_by_c3_and_batch_no_and_status(char *v_batch_no,char *v_status);
int DB_t_tif_subsidy_fetch_select_by_c3(T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_close_select_by_c3();
int DB_t_tif_subsidy_update_by_cust_no_and_subsidy_no(int v_cust_no,int v_subsidy_no,T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_read_lock_by_c4_and_subsidy_no_and_cust_no(int v_subsidy_no,int v_cust_no,T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_update_lock_by_c4(T_t_tif_subsidy *pt_tif_subsidy);
int DB_t_tif_subsidy_free_lock_by_c4();
#endif
