...
int DB_t_tif_tradeserial_his_read_lock_by_c0_and_trans_year_and_trans_mon_day_and_serial_no(char *v_trans_year,char *v_trans_mon_day,int v_serial_no,T_t_tif_tradeserial_his *pt_tif_tradeserial_his);
