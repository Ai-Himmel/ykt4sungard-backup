...
#define SYSPARA_EXPIREDAYCNT 		3		//过期流水天数
#define SYSPARA_POSMAXDAYCNT		4 		//POS流水允许未上传的最大天数
#define SYSPARA_AUTORENEWACCMAXAMT	5		//自动平帐金额最大限额
#define SYSPARA_LOSSEFTTIME			8		//挂失生效间隔时间	
#define SYSPARA_MAXBLACKCARDVERNO 	11		//版本号
...
#define EXTTYPE_BANKCARD			1		//银行卡号
#define EXTTYPE_MOBILE				2		//手机号
#define EXTTYPE_OLDCARD				3		//老卡卡号
#define OPER_SYSTEM_KEY	"system"
#define DCFLAG_DEBIT				1     //借方
#define DCFLAG_CREDIT				2     //贷方
// 用户默认密码,长度为6个字符
#define DEFAULT_CUST_PWD	"666666"
#define CADTYPE_TMP					1		//临时卡类型			
...
#define DOWNSTATUS_DOWN				2	  //下传中
#define DOWNSTATUS_SUCCESS			3	  //下传成功
/* 门禁星期定义*/
