...
int DB_t_opersite_read_by_opercode_and_siteno(char *v_opercode,int v_siteno,T_t_opersite *pt_opersite);
int DB_t_opersite_update_by_opercode_and_siteno(char *v_opercode,int v_siteno,T_t_opersite *pt_opersite);
int DB_t_opersite_del_by_opercode_and_siteno(char *v_opercode,int v_siteno);
int DB_t_opersite_read_lock_by_c0_and_opercode_and_siteno(char *v_opercode,int v_siteno,T_t_opersite *pt_opersite);
