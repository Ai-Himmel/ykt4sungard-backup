...
int DB_t_devicetmp_read_by_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_devicetmp *pt_devicetmp);
int DB_t_devicetmp_update_by_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_devicetmp *pt_devicetmp);
int DB_t_devicetmp_del_by_batchno(char *v_batchno);
int DB_t_devicetmp_del_by_batchno_and_seqno(char *v_batchno,int v_seqno);
int DB_t_devicetmp_read_lock_by_c0_and_batchno_and_seqno(char *v_batchno,int v_seqno,T_t_devicetmp *pt_devicetmp);
