...
// 函数名: DRTPCloseSocket
// 编程  : 陈永华 2004-9-22 16:21:16
// 描述  : 提供非接收、发送线程关闭端口，以便于阻塞接收线程用错误跳出
//       增加DRTPCloseSocket()功能，便于在阻塞的接收线程外，
//       其他线程能够通过关闭本端口，迫使该阻塞端口的接收线程退出
// 返回  : int -1: hConnection为非法句柄；0：关闭本连接
// 参数  : HANDLE hConnection
