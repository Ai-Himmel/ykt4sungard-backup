...
#define E_DB_LIBDEPOSIT_N	109200	//押金记录不存在
#define E_DB_LIBDEPOSIT_I	109201	//押金记录插入错误
#define E_DB_LIBDEPOSIT_R	109202	//押金记录读取错误
#define E_DB_LIBDEPOSIT_U	109203	//押金记录更新错误
#define E_DB_LIBDEPOSIT_D	109204	//押金记录删除错误
#define E_DB_SERIAL_CARD	109205	//冲正时流水号或卡号不正确
#define E_DB_LIBDEPOSIT_H	109206	//图书馆押金未退

//门禁对接相关
#define E_GATEBAN_INTERFACE_OPER_ERR 110300 //操作指令不存在
#define E_GATEBAN_INTERFACE_SQL_ERR 110301 //查询脚本错误
#define E_GATEBAN_INTERFACE_CURSOR_ERR 110302 //游标出错
#define E_GATEBAN_INTERFACE_READ_CURSOR_ERR 110303 //读取游标错误
#define E_GATEBAN_INTERFACE_DELETE_ERR 110304 //删除对应数据错误
#define E_GATEBAN_INTERFACE_UPDATE_ERR 110305 //更新对应数据错误
#define E_GATEBAN_INTERFACE_INSERT_ERR 110306 //添加数据错误
#define E_GATEBAN_INTERFACE_QUERY_ISEMPTY 110307  //查询数据为空

// 服务费
#define E_SELF_MONEY_SHORT 	110400  // 自充值金额不足
#define E_SVR_FEE_SHORT	 	110401  // 服务费已经用超了,请先充值
#define E_DB_RPT_SVR_FEE_N	110402  // 服务费结算表无记录
#define E_DB_RPT_SVR_FEE_I	110403  // 服务费结算表插入错误
#define E_DB_RPT_SVR_FEE_R	110404  // 服务费结算表读取错误
#define E_DB_RPT_SVR_FEE_D	110405  // 服务费结算表删除错误
#define E_CARD_USED			110406  // 发卡后使用过，不能做开卡冲正
#define E_DB_CUT_SVRFEE_N		110407	// 客户服务费表无记录
#define E_DB_CUT_SVRFEE_R		110408	// 客户服务费表读取错误
#define E_DB_CUT_SVRFEE_U		110409 // 客户服务费表更新错误
#define E_DB_CUT_SVRFEE_I		110410 // 客户服务费表插入错误
#define E_DB_CUT_SVRFEE_D		110411 // 客户服务费表删除错误
#define E_SVRFEE_FEETYPE_N	        110412	//发服务费的收费类别未配置
#endif
