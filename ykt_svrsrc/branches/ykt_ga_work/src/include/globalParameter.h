...
#define GLOBAL_MAX_DIFF_MONEY	    17 // 卡库不平退卡时最大金额
#define GLOBAL_LIB_DEPOSIT			18	//图书馆收押金金额
#define GLOBAL_SERVICE_FEE			19	// 每天的服务费金额
#define GLOBAL_NOBALA_DEAL_PREDAY	 20 	//卡库不平处理到距当日天数
#define GLOBAL_NOBALA_DEAL_ENDDATE	 21  //卡库不平处理到的日期
#define GLOBAL_SVRFEE_FEETYPE		22	//发服务费的收费类别
...
/* add by HLQ 2008-11-03 成都电子科技大学车库管理系统对接使用*/
//需要同步的客户类型
#define GLOBAL_SYN_CUST_TYPE 20000
//同步挂失解挂时间戳
#define GLOBAL_SYN_TIME_STAMP 20001
