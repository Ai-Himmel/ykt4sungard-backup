...
//typedef int (* APPFUNC)(TRUSERID *handle, int iRequest, ST_PACK *rPack, ST_PACK *pArrays, int *iRetCode, char *szMsg);		// 增加一个多包接受的参数pArrays
