...
public class DateChooser extends JPanel {
     ...
     */
    public DateChooser(JTextField showDate, JComponent trigger) {
        this(new Date(), showDate, trigger);
    }

    public DateChooser(Date date, JTextField showDate, JComponent trigger) {
        this(date, "yyyy-MM-dd", showDate, trigger);
    }

    public DateChooser(String format, JTextField showDate, JComponent trigger) {
        this(new Date(), format, showDate, trigger);
    }

    public DateChooser(Date date, String format, JTextField showDate, JComponent trigger) {
        initDate = date;
    ...
    private void initLabel() {
        showDate.setText(sdf.format(initDate));
