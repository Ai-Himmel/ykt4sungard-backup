...
public class Printer {
    ...
    public boolean print() {
        ...
        try {
            ...
            //宽56mm 高100mm
            int pageWidth = Configuration.getIntProperty(Constant.PAGE_WIDTH, 50);
            int pageHeight = Configuration.getIntProperty(Constant.PAGE_HEIGHT, 100);
            MediaSize mediaSize = new MediaSize(pageWidth, pageHeight, Size2DSyntax.MM, MediaSizeName.INVOICE);
            parameters.add(MediaSizeName.INVOICE);
//            parameters.add(MediaSizeName.ISO_A4);
            ...
            if (printService == null) {
                ...
                success = true;
                logger.info("Using printer[" + printService.getName() + "], start printing");
            }
    ...
    public PrintService getPrintService(DocFlavor flavor, PrintRequestAttributeSet parameters) {
        ...
        String printServiceName = Configuration.getProperty(Constant.PRINT_SERVICE);
        ...
        String showDialog = Configuration.getProperty(Constant.SHOW_DIALOG);
