...
copy/y .\CardReader\UnFrozeCardServer.bat .\deploy\bin
copy/y ..\doc\UnFrozeCardServer.txt .\deploy
...
copy/y .\classes\app_config\CardReader.properties .\deploy\bin
copy/y .\classes\app_config\log4j.properties .\deploy\bin

cd ..\

echo "make obf main jar"
java -jar -Xmx128m -Xms128m ./src/main/assembly/allatori.jar ./src/main/assembly/obf_UnFrozeCardServer.xml
