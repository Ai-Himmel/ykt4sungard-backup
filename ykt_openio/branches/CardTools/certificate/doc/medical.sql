-- Create table
create table T_CERTIFICATERECORD
(
...
alter table T_CERTIFICATERECORD
  add constraint PK_CERTIFICATERECORD primary key (REFNO)
  using index 
  tablespace TS_YKT_CUR
  pctfree 10
  initrans 2
...
create index IDX_TRANS_DATE on T_CERTIFICATERECORD