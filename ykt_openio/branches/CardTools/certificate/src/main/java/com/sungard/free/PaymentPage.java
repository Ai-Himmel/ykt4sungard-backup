...
public class PaymentPage extends FreePagePane {
    ...
    private void init() {
        ...
        JLabel medicineLabel = new JLabel("火车票（元）：");
        JLabel dressingLabel = new JLabel("汽车票（元）：");
        JLabel injectionLabel = new JLabel("证件费（元）：");
        JLabel vaccineLabel = new JLabel("其它一（元）：");
        JLabel otherLabel = new JLabel("其它二（元）：");
...
//        centerPane.add(reverseBtn, new GridBagConstraints(2, 10, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
    ...
    private void print(Payrecord payrecord) {
        ...
        String content = "火车票收款单<br>学号：" + payrecord.getStuempno() + "<br>姓名：" + payrecord.getCustname() + "<br>班级：" + payrecord.getClassName()
                + "<br>火车票：" + payrecord.getMedicineFee() + "元<br>汽车票:"
                + payrecord.getDressingFee() + "元<br>证件费:" + payrecord.getInjectionFee() + "元<br>其它一:" + payrecord.getVaccineFee() + "元<br>其它二:" + payrecord.getOtherFee()
