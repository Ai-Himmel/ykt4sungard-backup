...
public class BgMonitor {
	...
	public String SerialLostAnalysisThreadaccelateParam="0";
	...
	public void newAnalyzeIntance() {
		...
		try {
			...
			this.SerialLostAnalysisThreadaccelateParam = config.getString("THREADS.ACCELATE.PARAMETER.SerialLostAnalysisThread");
