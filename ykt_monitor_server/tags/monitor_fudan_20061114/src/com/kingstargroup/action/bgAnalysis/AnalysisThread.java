		...
		while (!requestStop) {
			try {
				...
				BgMonitor.getIntance().accelateParam = GetPropertiesUtil
						.getInstance().getString("THREADS.ACCELATE.PARAMETER");
				BgMonitor.getIntance().SerialLostAnalysisThreadaccelateParam = GetPropertiesUtil
						.getInstance()
						.getString(
								"THREADS.ACCELATE.PARAMETER.SerialLostAnalysisThread");
