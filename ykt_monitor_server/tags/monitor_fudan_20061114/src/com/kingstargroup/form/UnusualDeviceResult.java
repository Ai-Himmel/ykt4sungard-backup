...
public class UnusualDeviceResult extends AbstractResult {
	 ...
	 * @param errorReason
	 */
	public UnusualDeviceResult(Integer id, String devphy999Id, String deviceName,
			String deviceType, String contactName, Short errorReason) {
		super();
