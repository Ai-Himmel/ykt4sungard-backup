...
function pic()
{
  ...
  HtmlEdit.focus();
  var range = HtmlEdit.document.selection.createRange();
  var arr = showModalDialog("./pages/editor/picupload.jsp", "", "dialogWidth:30em; dialogHeight:15em; status:0;help:0");  
  if (arr != null){
  var ss;
  ss=arr.split("*")
  a=ss[0];
...
if(d!=null && d!='')str1=str1+"width='"+d+"'"
if(e!=null && e!='')str1=str1+"height='"+e+"' "
