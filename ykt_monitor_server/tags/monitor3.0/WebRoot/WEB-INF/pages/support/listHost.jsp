...
<div style="width:100%;margin:8px 8px 0 10">
    ...
    <display:table name="hostList" class="monitor" export="true" id="row" cellpadding="1" cellspacing="1"
        ...
        <display:column property="alias" title="主机名称" style="width:10%;" href="host.do?method=viewMonitorHost" paramId="id" paramProperty="hostId"/>
        <display:column property="displayName" title="主机显示名" style="width:10%;"/>
        <display:column property="hostAddress" title="主机地址" style="width:10%;"/>
