...
public abstract class AbstractMonitorTermdevTemplateAll extends
	 ...
	 * default constructor
	 */
	public AbstractMonitorTermdevTemplateAll() {
	}

	/**
	 * full constructor
	 */
	public AbstractMonitorTermdevTemplateAll(String templateName,
			...
			Integer notifyOnRecovery,Integer checkFlag) {
	...
	public String toString() {
		return "AbstractMonitorTermdevTemplate [activeChecksEnabled="
				...
				+ ", checkFlag=" + checkFlag + ", checkInterval="
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((checkFlag == null) ? 0 : checkFlag.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorTermdevTemplateAll))
			return false;
		AbstractMonitorTermdevTemplateAll other = (AbstractMonitorTermdevTemplateAll) obj;
		...
		if (checkCommand == null) {
			...
			return false;
		if (checkFlag == null) {
			if (other.checkFlag != null)
				return false;
		} else if (!checkFlag.equals(other.checkFlag))
			return false;
