...
/**
 * AbstractMonitorDevscheduleddowntime entity provides the base persistence
 * definition of the MonitorDevscheduleddowntime entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMonitorDevscheduleddowntime extends
	...
	/** default constructor */
	public AbstractMonitorDevscheduleddowntime() {
	}

	/** full constructor */
	public AbstractMonitorDevscheduleddowntime(Integer downtimeType,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorDevscheduleddowntime))
			return false;
		AbstractMonitorDevscheduleddowntime other = (AbstractMonitorDevscheduleddowntime) obj;
	...
	public String toString() {
		return "AbstractMonitorDevscheduleddowntime [actualEndTime="
				+ actualEndTime + ", actualStartTime=" + actualStartTime
				+ ", authorName=" + authorName + ", commentData=" + commentData
				+ ", deviceId=" + deviceId + ", downtimeType=" + downtimeType
				+ ", duration=" + duration + ", entryTime=" + entryTime
