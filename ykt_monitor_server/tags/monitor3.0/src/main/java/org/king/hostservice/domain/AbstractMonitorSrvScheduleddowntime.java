...
/**
 * AbstractMonitorSrvScheduleddowntime entity provides the base persistence
 * definition of the MonitorSrvScheduleddowntime entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMonitorSrvScheduleddowntime extends
	...
	/** default constructor */
	public AbstractMonitorSrvScheduleddowntime() {
	}

	/** full constructor */
	public AbstractMonitorSrvScheduleddowntime(Integer downtimeType,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorSrvScheduleddowntime))
			return false;
		AbstractMonitorSrvScheduleddowntime other = (AbstractMonitorSrvScheduleddowntime) obj;
	...
	public String toString() {
		return "AbstractMonitorSrvScheduleddowntime [actualEndTime="
				...
				+ ", entryTime=" + entryTime + ", isFixed=" + isFixed
				+ ", scheduledEndTime=" + scheduledEndTime
				+ ", scheduledStartTime=" + scheduledStartTime
				+ ", scheduleddowntimeId=" + scheduleddowntimeId
				+ ", serviceId=" + serviceId + ", wasCancelled=" + wasCancelled
