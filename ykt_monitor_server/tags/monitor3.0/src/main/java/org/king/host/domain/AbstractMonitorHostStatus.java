...
/**
 * AbstractMonitorHostStatus entity provides the base persistence definition of
 * the MonitorHostStatus entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMonitorHostStatus extends
	...
	/** default constructor */
	public AbstractMonitorHostStatus() {
	}

	/** minimal constructor */
	public AbstractMonitorHostStatus(Integer hostId) {
		this.hostId = hostId;
	}
	...
	public AbstractMonitorHostStatus(Integer hostId,
			...
			Integer stateType, String lastNotification,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorHostStatus))
			return false;
		AbstractMonitorHostStatus other = (AbstractMonitorHostStatus) obj;
	...
	public String toString() {
		return "AbstractMonitorHostStatus [acknowledgementType="
				...
				+ ", currentState=" + currentState + ", eventHandler="
				+ eventHandler + ", eventHandlerEnabled=" + eventHandlerEnabled
				+ ", executionTime=" + executionTime
				+ ", flapDetectionEnabled=" + flapDetectionEnabled
				+ ", hasBeenChecked=" + hasBeenChecked + ", hostId=" + hostId
				+ ", isFlapping=" + isFlapping + ", lastCheck=" + lastCheck
				+ ", lastHardState=" + lastHardState + ", lastHardStateChange="
