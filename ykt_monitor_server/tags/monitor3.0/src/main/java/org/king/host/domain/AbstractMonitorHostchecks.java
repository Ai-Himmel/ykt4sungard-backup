...
/**
 * AbstractMonitorHostchecks entity provides the base persistence definition of
 * the MonitorHostchecks entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMonitorHostchecks extends
		org.king.framework.domain.BaseObject implements java.io.Serializable {

	// Fields

	private Integer hostCheckId;
	...
	/** default constructor */
	public AbstractMonitorHostchecks() {
	}

	/** full constructor */
	public AbstractMonitorHostchecks(Integer hostId, Integer checkType,
	...
	public Integer getHostCheckId() {
		return this.hostCheckId;
	}

	public void setHostCheckId(Integer hostCheckId) {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((hostCheckId == null) ? 0 : hostCheckId.hashCode());
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorHostchecks))
			return false;
		AbstractMonitorHostchecks other = (AbstractMonitorHostchecks) obj;
		if (checkType == null) {
		...
		if (executionTime == null) {
			...
			return false;
		if (hostCheckId == null) {
			if (other.hostCheckId != null)
				return false;
		} else if (!hostCheckId.equals(other.hostCheckId))
			return false;
		if (hostId == null) {
	...
	public String toString() {
		return "AbstractMonitorHostchecks [checkType=" + checkType
