...
public abstract class AbstractMonitorHostAll extends
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof AbstractMonitorHostAll))
            return false;
        AbstractMonitorHostAll other = (AbstractMonitorHostAll) obj;
        if (actionurl == null) {
