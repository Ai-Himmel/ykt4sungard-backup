...
/**
 * AbstractMonitorDsrvscheduleddowntime entity provides the base persistence
 * definition of the MonitorDsrvscheduleddowntime entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMonitorDsrvscheduleddowntime extends
	...
	/** default constructor */
	public AbstractMonitorDsrvscheduleddowntime() {
	}

	/** full constructor */
	public AbstractMonitorDsrvscheduleddowntime(Integer downtimeType,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorDsrvscheduleddowntime))
			return false;
		AbstractMonitorDsrvscheduleddowntime other = (AbstractMonitorDsrvscheduleddowntime) obj;
	...
	public String toString() {
		return "AbstractMonitorDsrvscheduleddowntime [actualEndTime="
				+ actualEndTime + ", actualStartTime=" + actualStartTime
				+ ", authorName=" + authorName + ", commentData=" + commentData
				+ ", devserviceId=" + devserviceId + ", downtimeType="
				+ downtimeType + ", duration=" + duration + ", entryTime="
				+ entryTime + ", isFixed=" + isFixed + ", scheduledEndTime="
