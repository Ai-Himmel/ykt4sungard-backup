 ...
 */
public class MonitorService extends AbstractMonitorService implements
	 ...
	 * minimal constructor
	 */
	public MonitorService(Integer serviceId) {
		super(serviceId);
	}
	 ...
	 * full constructor
	 */
	public MonitorService(Integer serviceId, MonitorHost monitorHost,
