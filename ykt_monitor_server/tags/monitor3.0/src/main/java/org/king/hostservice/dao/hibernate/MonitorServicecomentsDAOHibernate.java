...
import org.king.hostservice.dao.MonitorServicecomentsDAO;
 ...
 */
public class MonitorServicecomentsDAOHibernate implements
		MonitorServicecomentsDAO {

	private static final Log log = LogFactory
			.getLog(MonitorServicecomentsDAOHibernate.class);
