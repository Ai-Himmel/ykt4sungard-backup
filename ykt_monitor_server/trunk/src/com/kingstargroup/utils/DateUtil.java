...
public class DateUtil {
	...
	public static String getNewTime(String startTime, int interval) {
		try {
			...
			String retStr = sdf.format(calendar.getTime());
			System.out.println(startTime + "--" + retStr);
			return retStr;
	 ...
	 * @param firstDate
	 * @param secondDate
	 * @return firstDate=secondDate int=0 | firstDate>secondDate int>0 |
	 *         firstDate<secondDate int<0
	 */
	 ...
	 * int<0 @exception Modify History:
	 */
	public static int checkSpecialTimeSequence(String firstTime,
			String secondTime, String format) {
		try {
			java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(
					format);
			Date f = sdf.parse(firstTime);
	...
	public static String getMinDateTime(String firstTime, String secondTime) {
		try {
			java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(
					"yyyyMMddHHmmss");
			Date f = sdf.parse(firstTime);
	...
	public  static void main(String[] arg){
		 System.out.println(FormatSecond(90000));
		 System.out.println(FormatTime("20091221144127"));
	}
