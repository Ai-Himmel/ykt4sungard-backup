		...
		try {
			...
			while (iter.hasNext()) {
				...
				if ("windows".equals(operationsystem)) {
					...
					if ("down".equals(cpuratio) && "down".equals(memratio)
						...
						mapDeviceTable.setErrorReason(Long.parseLong("105"));
						// down机
						...
						if (cpu > cpuLimit) {
							...
							mapDeviceTable.setContactName(contactName);
							mapDeviceTable.setCpu(Double.parseDouble(cpuratio));
							mapDeviceTable.setDevicetime("");
							mapDeviceTable.setServertime("");
							mapDeviceTable
							...
							mapDeviceTable.setDevtypecode("0000");
							mapDeviceTable.setDevphyid(server.getSystemid());
							mapDeviceTable.setErrorReason(Long.parseLong("102"));
							mapDeviceTable.setFdevphyid("FFFFFFFF");
							mapDeviceTable
									.setHarddisk(Double.parseDouble(diskratio));
							mapDeviceTable.setId(deviceTableKey);
							mapDeviceTable.setMemory(Double.parseDouble(memratio));
							mapDeviceTable.setSysid(0);
							session.save(mapDeviceTable);
							devid_cpu += server.getId() + ",";
						}
						if (mem > memLimit) {
							// mem越界了
							MapDeviceTable mapDeviceTable = new MapDeviceTable();
							...
							mapDeviceTable.setDevtypecode("0000");
							mapDeviceTable.setDevphyid(server.getSystemid());
							mapDeviceTable.setErrorReason(Long.parseLong("103"));
							mapDeviceTable.setFdevphyid("FFFFFFFF");
							mapDeviceTable
									.setHarddisk(Double.parseDouble(diskratio));
							mapDeviceTable.setId(deviceTableKey);
						...
						if (disk > diskLimit) {
							...
							mapDeviceTable.setDevtypecode("0000");
							mapDeviceTable.setDevphyid(server.getSystemid());
							mapDeviceTable.setErrorReason(Long.parseLong("104"));
							mapDeviceTable.setFdevphyid("FFFFFFFF");
							mapDeviceTable
									.setHarddisk(Double.parseDouble(diskratio));
							mapDeviceTable.setId(deviceTableKey);
			...
			if (!"".equals(preAnalysisTime)) {
				...
				while (iterPre.hasNext()) {
					...
					if (devid_down.indexOf(String.valueOf(device.getId().getDeviceid())) == -1) {
						...
						newdevice.setErrorReason(Long.parseLong("155"));
			...
			if (!"".equals(preAnalysisTime)) {
				...
				while (iterPre.hasNext()) {
					MapDeviceTable device = (MapDeviceTable) iterPre.next();
					if (devid_disk.indexOf(String.valueOf(device.getId().getDeviceid())) == -1) {
						// 原来的好了
						device.getId().setAnalysistime(recordTime);
						device.setHarddisk(Double.parseDouble("0"));
						device.setErrorReason(Long.parseLong("154"));
						session.save(device);
					}
				}
			}
			...
			if (!"".equals(preAnalysisTime)) {
				...
				while (iterPre.hasNext()) {
					MapDeviceTable device = (MapDeviceTable) iterPre.next();
					if (devid_mem.indexOf(String.valueOf(device.getId().getDeviceid())) == -1) {
						// 原来的好了
						device.getId().setAnalysistime(recordTime);
						device.setMemory(Double.parseDouble("0"));
						device.setErrorReason(Long.parseLong("153"));
						session.save(device);
					}
				}
			}
			...
			if (!"".equals(preAnalysisTime)) {
				...
				while (iterPre.hasNext()) {
					MapDeviceTable device = (MapDeviceTable) iterPre.next();
					if (devid_cpu.indexOf(String.valueOf(device.getId().getDeviceid())) == -1) {
						// 原来的好了
						device.getId().setAnalysistime(recordTime);
						device.setCpu(Double.parseDouble("0"));
						device.setErrorReason(Long.parseLong("152"));
						session.save(device);
					}
				}
			}
