	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (httpSession.getAttribute("userLogin") != null) {
			...
			try {
				...
				sqlAreaOne
						.append("select distinct(b.devphyid) as handan from Devicestatus b,MapSetsTable c where b.deviceid=c.devid and (b.devstatus=1 or b.devstatus=2)  and (1<>1 ");
				sqlServerOne
						.append("select distinct(b.devphyid) as handan from Devicestatus b,MapFathersetsTable c where b.devphyid=c.systemid and (b.devstatus=1 or b.devstatus=2) and (1<>1 ");
				sqlServiceOne
				...
				sqlAreaTwo
						.append("select distinct(b.devphyid) as fenglin from Devicestatus b,MapSetsTable c where b.deviceid=c.devid and (b.devstatus=1 or b.devstatus=2) and (1<>1 ");
				sqlDevTwo
						.append(
				...
				sqlAreaThree
						.append("select distinct(b.devphyid) as jiangwan from Devicestatus b,MapSetsTable c where b.deviceid=c.devid and (b.devstatus=1 or b.devstatus=2) and (1<>1 ");
				sqlDevThree
						.append(
				...
				sqlAreaFour
						.append("select distinct(b.devphyid) as zhangjiang from Devicestatus b,MapSetsTable c where b.deviceid=c.devid and (b.devstatus=1 or b.devstatus=2) and (1<>1 ");
				sqlDevFour
						.append(
				...
				while (enumration.hasMoreElements()) {
					...
					if (name.startsWith("Item_")) {
						...
						for (int i = 0; i < errCodeList.size(); i++) {
							...
							if (mapStateDic.getTagcode() != null
									&& mapStateDic.getTagcode().equals(
											name.substring(5))) {
								sqlAreaOne.append("or (b.errreason = 101"
										+ mapStateDic.getErrorcode() + ") ");
								sqlAreaTwo.append("or (b.errreason = 101"
										+ mapStateDic.getErrorcode() + ") ");
								sqlAreaThree.append("or (b.errreason = 101"
										+ mapStateDic.getErrorcode() + ") ");
								sqlAreaFour.append("or (b.errreason = 101"
										+ mapStateDic.getErrorcode() + ") ");
								sqlServerOne
										.append("or (b.errreason = 105) ");
								sqlServerTwo
										.append("or (b.errreason = 105) ");
								sqlServerThree
										.append("or (b.errreason = 105) ");
						...
						if ("3012".equals(name.substring(5))) {
							if ("1".equals(value)) {
								sqlAreaOne.append("or (b.errreason = 102) ");
								sqlAreaTwo.append("or (b.errreason = 102) ");
								sqlAreaThree
										.append("or (b.errreason = 102) ");
								sqlAreaFour.append("or (b.errreason = 102) ");
								sqlServerOne
										.append("or (b.errreason = 102) ");
								sqlServerTwo
										.append("or (b.errreason = 102) ");
							...
							if ("1".equals(value)) {
								sqlAreaOne.append("or (b.errreason = 103) ");
								sqlAreaTwo.append("or (b.errreason = 103) ");
								sqlAreaThree
										.append("or (b.errreason = 103) ");
								sqlAreaFour.append("or (b.errreason = 103) ");
								sqlServerOne
										.append("or (b.errreason = 103) ");
								sqlServerTwo
										.append("or (b.errreason = 103) ");
							...
							if ("1".equals(value)) {
								sqlAreaOne.append("or (b.errreason = 104) ");
								sqlAreaTwo.append("or (b.errreason = 104) ");
								sqlAreaThree
										.append("or (b.errreason = 104) ");
								sqlAreaFour.append("or (b.errreason = 104) ");
								sqlServerOne
										.append("or (b.errreason = 104) ");
								sqlServerTwo
										.append("or (b.errreason = 104) ");
							...
							if ("1".equals(value)) {
								sqlAreaOne.append("or b.errreason = 11 ");
								sqlAreaTwo.append("or b.errreason = 11 ");
								sqlAreaThree.append("or b.errreason = 11 ");
								sqlAreaFour.append("or b.errreason = 11 ");
							}
							...
							if ("1".equals(value)) {
								sqlAreaOne.append("or b.errreason = 12 ");
								sqlAreaTwo.append("or b.errreason = 12 ");
								sqlAreaThree.append("or b.errreason = 12 ");
								sqlAreaFour.append("or b.errreason = 12 ");
							}
