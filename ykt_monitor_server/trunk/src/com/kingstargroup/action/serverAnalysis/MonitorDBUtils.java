...
public class MonitorDBUtils {
	...
	private  long port = 0;// db connection port
	...
	private MonitorDBUtils(String dbtype, String ipAddr, long port,
...
//	}
	...
	public static boolean checkDBstatus(String db,String ip,long port,String dbname,String username,String password){
