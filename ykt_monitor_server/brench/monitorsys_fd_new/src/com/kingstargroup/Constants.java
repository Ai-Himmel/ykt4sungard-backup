...
public class Constants {
     ...
     */
    public static final String USER_KEY = "MapUserTable";
    ...
    /**
     * Default mail server adress
     */
    public static final String SERVER_ADRESS = "10.49.188.100";
    public static final String USER_NAME = "linqing.he@kingstargroup.com";
    public static final String PASSWORD = "linqing305";
    /**
    ...
    public static final String JNDI_DATASOURCE="jdbc/MonitorSys";
    
    public static final String DEPT_EDIT_KEY="";
