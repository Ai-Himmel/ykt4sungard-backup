	...
	private List AreaAnalysis(int i){
		...
		try {
			...
			case 1: 
				...
				.createQuery("select a.areaNo from TPifArea a where a.areaNo=2 or a.fatherAreaNo=2 or " +
						"a.fatherAreaNo in(select b.areaNo from TPifArea b where b.fatherAreaNo=2) or " +
						"a.fatherAreaNo in(select c.areaNo from TPifArea c where c.fatherAreaNo in" +
						"(select d.areaNo from TPifArea d where d.fatherAreaNo=2))");
				List listOne = queryOne.list();
				returnList = listOne;
				break;
			case 2:
				Query queryTwo= session
				.createQuery("select a.areaNo from TPifArea a where a.areaNo=3 or a.fatherAreaNo=3 or " +
						"a.fatherAreaNo in(select b.areaNo from TPifArea b where b.fatherAreaNo=3) or " +
						"a.fatherAreaNo in(select c.areaNo from TPifArea c where c.fatherAreaNo in" +
						"(select d.areaNo from TPifArea d where d.fatherAreaNo=3))");
				List listTwo = queryTwo.list();
				returnList = listTwo;
				break;
			case 3:
				Query queryThree= session
				.createQuery("select a.areaNo from TPifArea a where a.areaNo=48 or a.fatherAreaNo=48 or " +
						"a.fatherAreaNo in(select b.areaNo from TPifArea b where b.fatherAreaNo=48) or " +
						"a.fatherAreaNo in(select c.areaNo from TPifArea c where c.fatherAreaNo in" +
						"(select d.areaNo from TPifArea d where d.fatherAreaNo=48))");//张江校区
				List listThree = queryThree.list();
				returnList = listThree;
				break;
			case 4:
				Query queryFour= session
				.createQuery("select a.areaNo from TPifArea a where a.areaNo=56 or a.fatherAreaNo=56 or " +
						"a.fatherAreaNo in(select b.areaNo from TPifArea b where b.fatherAreaNo=56) or " +
						"a.fatherAreaNo in(select c.areaNo from TPifArea c where c.fatherAreaNo in" +
						"(select d.areaNo from TPifArea d where d.fatherAreaNo=56))");//江湾校区
