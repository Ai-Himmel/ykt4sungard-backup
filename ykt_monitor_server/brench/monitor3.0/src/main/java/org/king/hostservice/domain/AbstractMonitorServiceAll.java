...
public abstract class AbstractMonitorServiceAll extends
	 ...
	 * default constructor
	 */
	public AbstractMonitorServiceAll() {
	}

	/**
	 * minimal constructor
	 */
	public AbstractMonitorServiceAll(Integer serviceId) {
		this.serviceId = serviceId;
	}

	protected AbstractMonitorServiceAll(Integer serviceId,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorServiceAll))
			return false;
		AbstractMonitorServiceAll other = (AbstractMonitorServiceAll) obj;
		if (actionurl == null) {
