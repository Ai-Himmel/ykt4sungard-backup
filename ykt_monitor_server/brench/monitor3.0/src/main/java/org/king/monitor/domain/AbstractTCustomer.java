...
public abstract class AbstractTCustomer implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractTCustomer(long custid, long custtype, long feetype,
			String status, String custname, String stuempno, String areacode,
			...
			String useflag, String lastsaved, String classcode,
			long holdcardcnt, String eaccflag) {
		this.custid = custid;
