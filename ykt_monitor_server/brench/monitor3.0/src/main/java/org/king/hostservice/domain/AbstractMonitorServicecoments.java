...
/**
 * AbstractMonitorServicecoments entity provides the base persistence definition
 * of the MonitorServicecoments entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMonitorServicecoments extends
	...
	/** default constructor */
	public AbstractMonitorServicecoments() {
	}

	/** full constructor */
	public AbstractMonitorServicecoments(Date entryTime, BigDecimal entryType,
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorServicecoments))
			return false;
		AbstractMonitorServicecoments other = (AbstractMonitorServicecoments) obj;
		if (authorName == null) {
	...
	public String toString() {
		return "AbstractMonitorServicecoments [authorName=" + authorName
				...
				+ ", expires=" + expires + ", isDeleted=" + isDeleted
				+ ", isPersistent=" + isPersistent + ", serviceId=" + serviceId
				+ "]";
	}
