...
/**
 * AbstractMonitorUnbalanceAccount entity provides the base persistence
 * definition of the MonitorUnbalanceAccount entity. @author MyEclipse
 * Persistence Tools
 */

public abstract class AbstractMonitorUnbalanceAccount extends
	...
	/** default constructor */
	public AbstractMonitorUnbalanceAccount() {
	}

	/** full constructor */
	public AbstractMonitorUnbalanceAccount(String accname, Integer custid,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractMonitorUnbalanceAccount other = (AbstractMonitorUnbalanceAccount) obj;
		if (accname == null) {
	...
	public String toString() {
		return "AbstractMonitorUnbalanceAccount [accname=" + accname
				+ ", accno=" + accno + ", analysedate=" + analysedate
				+ ", availbal=" + availbal + ", cardbal=" + cardbal
				+ ", cardno=" + cardno + ", custid=" + custid + ", dpscnt="
				+ dpscnt + ", enterdate=" + enterdate + ", largestubamount="
				+ largestubamount + ", lastdate=" + lastdate
				+ ", lasttransdate=" + lasttransdate + ", paycnt=" + paycnt
				+ ", purseno=" + purseno + ", unbalanceamount="
				+ unbalanceamount + "]";
	}
}