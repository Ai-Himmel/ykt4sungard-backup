...
/**
 * AbstractMonitorServiceStatus entity provides the base persistence definition
 * of the MonitorServiceStatus entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractMonitorServiceStatus extends
	...
	/** default constructor */
	public AbstractMonitorServiceStatus() {
	}

	/** minimal constructor */
	public AbstractMonitorServiceStatus(Integer serviceId) {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof AbstractMonitorServiceStatus))
			return false;
		AbstractMonitorServiceStatus other = (AbstractMonitorServiceStatus) obj;
	...
	public String toString() {
		return "AbstractMonitorServiceStatus [acknowledgementType="
				...
				+ retryCheckInterval + ", serviceId=" + serviceId
