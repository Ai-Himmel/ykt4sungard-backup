...
/**
 * Allen 该方法用于替代弹出框的方式显示错误信息
 */
AjaxAnywhere.prototype.showError = function(errorMsg) {
    ...
    if (div == null) {
        ...
        div.style.backgroundColor = "#FE3E00";
    ...
    div.style.left = (document.body.scrollLeft + document.body.offsetWidth - 150 - (document.all?20:0)) + "px";
    div.style.display = "";
    window.setTimeout("ajaxAnywhere.hideError();", 1000);
}
AjaxAnywhere.prototype.hideError = function() {
    var div = document.getElementById("AA_" + this.id + "_loading_div");
    if (div != null){
        //还原加载loading时的设置
        ...
        div.style.left = (document.body.scrollLeft + document.body.offsetWidth - 100 - (document.all?20:0)) + "px";
    }
}
