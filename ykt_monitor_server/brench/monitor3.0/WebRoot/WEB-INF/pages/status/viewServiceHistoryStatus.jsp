...
<div style="width:100%;margin:8px 8px 0 10">
    <html:form action="serviceHistoryStatus.do?method=viewServiceHistoryStatus" method="post">
            ...
            <tr>
                <td class="listr3">
                    ...
                    <html:select property="state" >
                        ...
                        <html:option value="2">unknow</html:option>
                        <html:option value="3">critical</html:option>
    ...
    <display:table name="monitorServiceCheck" class="monitor" export="true" id="row" cellpadding="1" cellspacing="1"
                   requestURI="serviceHistoryStatus.do?method=viewServiceHistoryStatus" form="monitorServiceHistoryStatusForm">
        <display:column property="state"  title="状态" style="width:5%;" decorator="serviceStatusDecorator"/>
        ...
        <display:column property="output" title="状态信息" style="width:15%;white-space: nowrap;cursor:hand;" maxLength="50"/>
