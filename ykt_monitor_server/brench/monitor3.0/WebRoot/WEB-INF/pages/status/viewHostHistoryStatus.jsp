...
<head>
    ...
    <script type="text/javascript">
        ...
        function goBack(){
            ...
            var url = "hostHistoryStatus.do?method=listHostHistoryStatus&timePeriodId="+timePeriodId;
...
<div style="width:100%;margin:8px 8px 0 10">
    <html:form action="hostHistoryStatus.do?method=viewHostHistoryStatus" method="post">
    ...
    <display:table name="monitorHostchecks" class="monitor" export="true" id="row" cellpadding="1" cellspacing="1"
                   requestURI="hostHistoryStatus.do?method=viewHostHistoryStatus" form="monitorHostHistoryStatusForm">
        <display:column property="state"  title="状态" style="width:5%;" decorator="hostStatusDecorator"/>
