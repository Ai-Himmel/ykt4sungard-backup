...
<div id="top_left">
  <div id="top_right">
    <div class="info">用户名:&nbsp;<b style="color:#FFF25F"><%=userName %></b>,&nbsp;角色:<%=personName %>&nbsp;|&nbsp;<a href="javascript:void(0);" class="info">修改密码</a>&nbsp;|&nbsp;<a href="logoutAction.do?method=logout"  class="info" target="_parent">注销</a></div>
  </div>
</div>
</div>
<div id="line"></div>
