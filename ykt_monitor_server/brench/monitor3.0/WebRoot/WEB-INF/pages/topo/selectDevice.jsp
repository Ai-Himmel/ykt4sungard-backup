...
<script type="text/javascript">
    ...
    function doBinding(p_oForm, p_oSel) {
        ...
        var url = "group.do?method=bindingDevice";
...
<form action="grantRoleMenu" styleId="blankForm">
    ...
    <input type="hidden" name="deviceGroupId" value="<c:out value="${deviceGroupId}"/>"/>
        ...
        <TR>
            ...
            <TD height="320">
                <IFRAME name='DataFrame'
                        src="group.do?method=listEnableDevice&deviceGroupId=<c:out value="${deviceGroupId}"/>"
