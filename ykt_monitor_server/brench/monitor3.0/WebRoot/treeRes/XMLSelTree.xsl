...
<xsl:template match="TreeNode">
	...
	<div class="clsItem" type="leaf">
		...
		<span class="clsLabel" type="label" onclick="MouseClick(this)" onmousedown="NodeMouseDown(this);" onmouseover="NodeMouseOver(this);" onmouseout="NodeMouseOut(this);"  oncontextmenu="RightClick(this);" >
			<xsl:choose>
                <xsl:when test="@DisableData">
					<xsl:attribute name="style">position:relative; left:-1px;color:darkgray;</xsl:attribute>
				</xsl:when>
	...
	<xsl:choose>
        ...
        <xsl:when test="@DisableData">
			<xsl:element name="input">
				<xsl:attribute name="type">checkbox</xsl:attribute>
				<xsl:attribute name="read">1</xsl:attribute>
				<xsl:attribute name="name">DisableData</xsl:attribute>
				<xsl:attribute name="onclick">MouseClick(this)</xsl:attribute>
				...
				<xsl:attribute name="value">
					<xsl:value-of select="@DisableData" />
				</xsl:attribute>
			</xsl:element>
		</xsl:when>
	</xsl:choose>		
