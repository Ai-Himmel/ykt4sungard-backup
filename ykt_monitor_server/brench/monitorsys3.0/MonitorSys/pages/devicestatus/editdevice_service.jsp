								...
								<html:form action="/devicestatus.do?method=updateDeviceStatus">
									<table width="60%">
										<tr>
											<td>
												已修复
												<html:radio property="receive" value="3"
													onclick="javascript:diffshow('3');" />
											</td>
											<td>
												忽略
											...
											<td>
                                                                                                                                 报废
                                                <html:radio property="receive" value="6"
                                                    onclick="javascript:diffshow('6');" />
                                            </td>
										</tr>
									</table>
									...
									<table width="60%" border="1" cellpadding="1"
										...
										<tr>
											<td COLSPAN="2" align="center">
												<input name="send" type="button" value="保存" onclick="javascript:return sub();" />
