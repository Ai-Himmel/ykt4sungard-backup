...
public class ErrInfoDevices extends AbstractResult {
	 ...
	 * @param errorReason
	 */
	public ErrInfoDevices(String analysistiem,long id, String devphy999Id, String deviceName,
			String deviceType, String contactName, long errorReason) {
		super();
		// TODO Auto-generated constructor stub
		this.analysistime = analysistiem;
		this.id = id;
