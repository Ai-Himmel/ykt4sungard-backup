...
public class BsheetverErrorAnalysisThread extends Thread implements
	...
	public void anaylize() {
		...
		try {
			...
			// .createSQLQuery(
			// "select {dev.*} from ykt_cur.t_pif_device dev where dev.device_id
			// in(select distinct d.device_id "
			...
			// + "and d.BSHEETVER<>'000000000000') order by dev.bsheetver with
			// ur")
